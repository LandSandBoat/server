...
xi.data.guildShops =
{
    ...
    ['Tilala'] =
    {
        ...
        stock   =
        {
            ...
            { id = xi.item.SPOOL_OF_SILK_THREAD,    initial = 20,  maxStock = 120, targetStock = 24,  buyMax = 4060,   restockRate = 4 },
    ...
    ['Wahnid'] =
    {
        ...
        stock   =
        {
            ...
            { id = xi.item.PEELED_LOBSTER,          initial = 144, maxStock = 240, targetStock = 180, buyMax = 1470,   restockRate = 12 },
