...
{
    [xi.effect.ADDLE              ] = { 2, 0,                       0,               xi.effect.NOCTURNE, xi.element.FIRE,    xi.immunity.ADDLE,      xi.mod.SLOWRES,     0,                          xi.mod.SLOW_MEVA,     xi.mod.ADDLE_IMMUNOBREAK    }, -- Addle cant be immunobroken?
    ...
    [xi.effect.CURSE_I            ] = { 2, 0,                       0,               0,                  xi.element.DARK,    xi.immunity.CURSE,      xi.mod.CURSERES,    0,                          xi.mod.CURSE_MEVA,    0                           },
    ...
    [xi.effect.ELEGY              ] = { 1, 0,                       0,               0,                  xi.element.EARTH,   xi.immunity.ELEGY,      xi.mod.SLOWRES,     0,                          xi.mod.SLOW_MEVA,     0                           },
    ...
    [xi.effect.MUTE               ] = { 1, 0,                       0,               0,                  xi.element.WIND,    xi.immunity.SILENCE,    xi.mod.SILENCERES,  xi.mod.SILENCE_RES_RANK,    xi.mod.SILENCE_MEVA,  xi.mod.SILENCE_IMMUNOBREAK  },
    [xi.effect.NOCTURNE           ] = { 1, xi.effect.ADDLE,         0,               0,                  xi.element.FIRE,    xi.immunity.ADDLE,      xi.mod.SLOWRES,     0,                          xi.mod.SLOW_MEVA,     0                           },
