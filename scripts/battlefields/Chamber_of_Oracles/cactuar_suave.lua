...
content.loot =
{
    ...
    {
        { itemId = xi.item.CACTUAR_NEEDLE,             weight = 10000 },
    },

    {
        { itemId = xi.item.BAG_OF_CACTUS_STEMS,        weight = 10000 },
    },

    {
        { itemId = xi.item.TAILLEFERS_DAGGER,          weight =  1875 },
        { itemId = xi.item.SCHILTRON_SPEAR,            weight =  1875 },
        { itemId = xi.item.ZISKAS_CROSSBOW,            weight =  1875 },
        { itemId = xi.item.UNJI,                       weight =  1875 },
    ...
    {
        { itemId = xi.item.CACTUAR_RIBBON,             weight =  2500 },
...

    {
        ...
        { itemId = xi.item.KING_MAKER,                 weight =  1500 },
        { itemId = xi.item.BALANS_SWORD,               weight =  1500 },
        { itemId = xi.item.ARGENT_DAGGER,              weight =  1500 },
        { itemId = xi.item.CAPRICORN_STAFF,            weight =  1500 },
