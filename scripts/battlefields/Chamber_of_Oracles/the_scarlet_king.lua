...
content.loot =
{
    ...
    {
        { itemId = xi.item.LOCK_OF_MANTICORE_HAIR,     weight = 1000 }, -- Manticore Hair
    },

    {
        { itemId = xi.item.BALANS_SWORD,               weight = 187 },
        { itemId = xi.item.KING_MAKER,                 weight = 188 },
        { itemId = xi.item.CAPRICORN_STAFF,            weight = 187 },
        { itemId = xi.item.ARGENT_DAGGER,              weight = 188 },
...

    {
        ...
        { itemId = xi.item.THANATOS_BASELARD,          weight = 150 },
        { itemId = xi.item.BALINS_SWORD,               weight = 150 },
        { itemId = xi.item.WYVERN_PERCH,               weight = 150 },
        { itemId = xi.item.WOODVILLES_AXE,             weight = 150 },
        { itemId = xi.item.LIGHT_SPIRIT_PACT,          weight =  50 },
        { itemId = xi.item.SCROLL_OF_CURE_V,           weight =  50 },
        { itemId = xi.item.SCROLL_OF_RAISE_III,        weight =  50 },
        { itemId = xi.item.SCROLL_OF_SHELL_IV,         weight =  50 },
        { itemId = xi.item.SCROLL_OF_THUNDER_III,      weight =  50 },
    },
