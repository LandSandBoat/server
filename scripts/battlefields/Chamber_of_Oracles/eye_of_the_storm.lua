...
content.loot =
{
    ...
    {
        { itemId = xi.item.WYVERN_WING,                weight = 1000 },
    },
    ...
    {
        { itemId = xi.item.BALINS_SWORD,               weight = 187 },
        { itemId = xi.item.THANATOS_BASELARD,          weight = 188 },
        { itemId = xi.item.WOODVILLES_AXE,             weight = 187 },
        { itemId = xi.item.WYVERN_PERCH,               weight = 188 },
    ...
    {
        { itemId = xi.item.BOURDONASSE,                weight = 250 },
...

    {
        ...
        { itemId = xi.item.SCHILTRON_SPEAR,            weight = 150 },
        { itemId = xi.item.TAILLEFERS_DAGGER,          weight = 150 },
        { itemId = xi.item.UNJI,                       weight = 150 },
        { itemId = xi.item.ZISKAS_CROSSBOW,            weight = 150 },
