...
content.loot =
{
    ...
    {
        { itemId = xi.item.SCROLL_OF_CURE_V,           weight = 150 },
        { itemId = xi.item.SCROLL_OF_SHELL_IV,         weight = 150 },
        { itemId = xi.item.LIGHT_SPIRIT_PACT,          weight = 150 },
        { itemId = xi.item.SCROLL_OF_RAISE_III,        weight = 150 },
        { itemId = xi.item.SCROLL_OF_THUNDER_III,      weight = 150 },
