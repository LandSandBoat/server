...
{
    {
        { itemId = xi.item.GIL,                        weight = 10000, amount = 24000 }, -- Gil
    },
    ...
    {
        { itemId = xi.item.SCROLL_OF_CURE_V,           weight =  1500 },
        { itemId = xi.item.SCROLL_OF_SHELL_IV,         weight =  1500 },
        { itemId = xi.item.LIGHT_SPIRIT_PACT,          weight =  1500 },
        { itemId = xi.item.SCROLL_OF_RAISE_III,        weight =  1500 },
        { itemId = xi.item.SCROLL_OF_THUNDER_III,      weight =  1500 },
