...
content.loot =
{
    ...
    {
        { itemId = xi.item.OCEAN_SASH,                 weight =  1600 },
        { itemId = xi.item.JUNGLE_SASH,                weight =  1600 },
        { itemId = xi.item.STEPPE_SASH,                weight =  1600 },
        { itemId = xi.item.DESERT_SASH,                weight =  1600 },
        { itemId = xi.item.FOREST_SASH,                weight =  1600 },
