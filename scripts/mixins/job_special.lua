...
local familyEES =
{
    ...
    [xi.mobSpecies.DYNAMIS_FOMOR     ] = xi.mobSkill.EES_SHADE,
    [xi.mobSpecies.HYDRA_FOMOR       ] = xi.mobSkill.EES_SHADE,
    ...
    [xi.mobSpecies.BLIZZARD_GIGAS    ] = xi.mobSkill.EES_GIGAS,
    [xi.mobSpecies.BERGLISI          ] = xi.mobSkill.EES_GIGAS,
    [xi.mobSpecies.HECATONCHEIRS     ] = xi.mobSkill.EES_GIGAS,
    ...
    [xi.mobSpecies.DYNAMIS_GOBLIN    ] = xi.mobSkill.EES_GOBLIN,
    [xi.mobSpecies.GOBLIN_S          ] = xi.mobSkill.EES_GOBLIN,
    ...
    [xi.mobSpecies.DYNAMIS_KINDRED   ] = xi.mobSkill.EES_KINDRED,
    ...
    [xi.mobSpecies.DYNAMIS_ORC       ] = xi.mobSkill.EES_ORC,
    [xi.mobSpecies.ORC_S             ] = xi.mobSkill.EES_ORC,
    [xi.mobSpecies.MASKED_ORC_S      ] = xi.mobSkill.EES_ORC,
    [xi.mobSpecies.WARCHIEF          ] = xi.mobSkill.EES_ORC,
    [xi.mobSpecies.QUADAV            ] = xi.mobSkill.EES_QUADAV,
    [xi.mobSpecies.DYNAMIS_QUADAV    ] = xi.mobSkill.EES_QUADAV,
    [xi.mobSpecies.QUADAV_S          ] = xi.mobSkill.EES_QUADAV,
    [xi.mobSpecies.HORNED_QUADAV_S   ] = xi.mobSkill.EES_QUADAV,
    [xi.mobSpecies.DESTROYER         ] = xi.mobSkill.EES_TROLL,
    [xi.mobSpecies.GENERAL           ] = xi.mobSkill.EES_TROLL,
    [xi.mobSpecies.HEAVY_TROLL       ] = xi.mobSkill.EES_TROLL,
    [xi.mobSpecies.LIGHT_TROLL       ] = xi.mobSkill.EES_TROLL,
    [xi.mobSpecies.PLATED_TROLL      ] = xi.mobSkill.EES_TROLL,
    [xi.mobSpecies.DYNAMIS_YAGUDO    ] = xi.mobSkill.EES_YAGUDO,
    [xi.mobSpecies.YAGUDO_S          ] = xi.mobSkill.EES_YAGUDO,
    [xi.mobSpecies.WHITEHEAD_YAGUDO_S] = xi.mobSkill.EES_YAGUDO,
