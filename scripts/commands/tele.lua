...
commandObj.onTrigger = function(player, tele)
    ...
    if
        player:getZoneID() == 26 or player:getZoneID() == 48 or
        player:getZoneID() == 94 or player:getZoneID() == 80 or
        player:getZoneID() == 87 or player:getZoneID() == 50 or
        player:getZoneID() == 53 or
        (player:getZoneID() >= 230 and player:getZoneID() <= 257)
    then
        if tele == 'altep' then
        ...
        elseif tele == 'dem' then
            if player:hasKeyItem(xi.ki.DEM_GATE_CRYSTAL) then
        ...
        elseif tele == 'mea' then
            if player:hasKeyItem(xi.ki.MEA_GATE_CRYSTAL) then
        ...
        elseif tele == 'vahzl' then
            if player:hasKeyItem(xi.ki.VAHZL_GATE_CRYSTAL) then
        ...
        elseif tele == 'yhoat' then
            if player:hasKeyItem(xi.ki.YHOATOR_GATE_CRYSTAL) then
        ...
        elseif tele == 'jugner' then
            if player:hasKeyItem(xi.ki.JUGNER_GATE_CRYSTAL) then
        ...
        elseif tele == 'meriph' then
            if player:hasKeyItem(xi.ki.MERIPHATAUD_GATE_CRYSTAL) then
        ...
        elseif tele == 'pashow' then
            if player:hasKeyItem(xi.ki.PASHHOW_GATE_CRYSTAL) then
