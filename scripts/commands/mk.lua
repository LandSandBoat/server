...
local npcToDoorMap = {
    ...
    [zones[xi.zone.PORT_BASTOK].npc.DRAWBRIDGE_1]                      = { zones[xi.zone.PORT_BASTOK].npc.DRAWBRIDGE_1, check = isGM },
    [zones[xi.zone.PORT_BASTOK].npc.DRAWBRIDGE_2]                      = { zones[xi.zone.PORT_BASTOK].npc.DRAWBRIDGE_2, check = isGM },
    [zones[xi.zone.PORT_BASTOK].npc.DRAWBRIDGE_3]                      = { zones[xi.zone.PORT_BASTOK].npc.DRAWBRIDGE_3, check = isGM },
