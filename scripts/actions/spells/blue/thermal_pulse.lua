...
spellObject.onSpellCast = function(caster, target, spell)
    ...
    params.tMultiplier = 2.75 -- Using numbers in bg-wiki instead of https://wiki.ffo.jp/html/22468.html. As per policy "Whenever in doubt, balance content against players"
