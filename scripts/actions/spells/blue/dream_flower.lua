...
spellObject.onSpellCast = function(caster, target, spell)
    ...
    params.power           = 1
    params.tick            = 0
    params.duration        = 120 -- https://wiki.ffo.jp/html/5502.html says the duration might be reduced based on number of targets. Might need to be fixed in the future
