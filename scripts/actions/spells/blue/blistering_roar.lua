...
-- Enemies within area of effect are frozen with fear (Terror)
-- Spell cost: 43 MP
-- Monster Type: Lizard (Gabbrath)
...
-- AoE Terror effect (fan-shaped)
-- Duration depends on Blue Magic Skill and Magic Accuracy
-- Learned from Gabbrath-type monsters
-----------------------------------
---@type TSpell
local spellObject = {}
