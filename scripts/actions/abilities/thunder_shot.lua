...
abilityObject.onUseAbility = function(player, target, ability, action)
    ...
    dmg       = addBonusesAbility(player, xi.element.LIGHTNING, target, dmg, params)
    ...
    dmg            = dmg * applyResistanceAbility(player, target, xi.element.LIGHTNING, xi.skill.NONE, bonusAcc)
    dmg            = adjustForTarget(target, dmg, xi.element.LIGHTNING)
