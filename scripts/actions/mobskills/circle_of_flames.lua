...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    damage = xi.mobskills.mobFinalAdjustments(damage, mob, skill, target, xi.attackType.MAGICAL, xi.damageType.FIRE, xi.mobskills.shadowBehavior.WIPE_SHADOWS, nil, nil)
