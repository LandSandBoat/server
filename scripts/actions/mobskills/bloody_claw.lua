...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    local dmg = xi.mobskills.mobFinalAdjustments(info.dmg, mob, skill, target, xi.attackType.PHYSICAL, xi.damageType.SLASHING, xi.mobskills.shadowBehavior.IGNORE_SHADOWS, nil, info.allHitsBlockedWithShieldMastery)
