...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    local dmg = xi.mobskills.mobFinalAdjustments(info.dmg, mob, skill, target, xi.attackType.PHYSICAL, xi.damageType.BLUNT, info.hitslanded * math.random(2, 3), nil, info.allHitsBlockedWithShieldMastery)
