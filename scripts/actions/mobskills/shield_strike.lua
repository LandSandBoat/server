...
mobskillObject.onMobWeaponSkill = function(target, mob, skill)
    ...
    local dmg = xi.mobskills.mobFinalAdjustments(info.dmg, mob, skill, target, xi.attackType.PHYSICAL, xi.damageType.BLUNT, xi.mobskills.shadowBehavior.NUMSHADOWS_1, nil, info.allHitsBlockedWithShieldMastery)
