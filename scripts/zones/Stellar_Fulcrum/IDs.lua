...
zones[xi.zone.STELLAR_FULCRUM] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7606, -- Entering the battlefield for [Return to Delkfutt's Tower/The Indomitable Triumvirate/The Dauntless Duo/The Solitary Demolisher/Heroine's Combat/Mercenary Camp/Ode of Life Bestowing/Return to Delkfutt's Tower/True Love/A Fond Farewell]!
        NO_BATTLEFIELD_ENTRY          = 7608, -- The door will not budge.
    },
    mob =
    {
