...
zones[xi.zone.BEARCLAW_PINNACLE] =
{
    text =
    {
        ...
        MEMBERS_OF_YOUR_PARTY         = 7380, -- Currently, <number> members of your party (including yourself) have clearance to enter the battlefield.
        MEMBERS_OF_YOUR_ALLIANCE      = 7381, -- Currently, <number> members of your alliance (including yourself) have clearance to enter the battlefield.
        TIME_LIMIT_FOR_THIS_BATTLE_IS = 7383, -- The time limit for this battle is <number> minutes.
        THERE_IS_A_CRACK              = 7384, -- There is a crack in the <item>. It no longer contains a monster.
        ...
        ZEPHYR_RIPS                   = 7434, -- The <item> rips!
        CONQUEST_BASE                 = 7443, -- Tallying conquest results...
        ENTERING_THE_BATTLEFIELD_FOR  = 7606, -- Entering the battlefield for [Flames for the Dead/Follow the White Rabbit/When Hell Freezes Over/Brothers/Holy Cow/Taurassic Park]!
        BLOWN_AWAY                    = 7629, -- The explosion has blown you out of the area!
        BEGINS_TO_MELT                = 7686, -- The Snoll Tzar has begun to melt!
        LARGE_STEAM                   = 7687, -- The Snoll Tzar is emitting a large amount of steam.
        SHOOK_SALT                    = 7688, -- The Snoll Tzar shakes off the salt!
    },
    mob =
    {
