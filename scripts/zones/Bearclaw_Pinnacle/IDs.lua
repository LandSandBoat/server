...
zones[xi.zone.BEARCLAW_PINNACLE] =
{
    text =
    {
        ...
        MEMBERS_OF_YOUR_PARTY         = 7378, -- Currently, <number> members of your party (including yourself) have clearance to enter the battlefield.
        MEMBERS_OF_YOUR_ALLIANCE      = 7379, -- Currently, <number> members of your alliance (including yourself) have clearance to enter the battlefield.
        TIME_LIMIT_FOR_THIS_BATTLE_IS = 7381, -- The time limit for this battle is <number> minutes.
        THERE_IS_A_CRACK              = 7382, -- There is a crack in the <item>. It no longer contains a monster.
        A_CRACK_HAS_FORMED            = 7383, -- A crack has formed on the <item>, and the beast inside has been unleashed!
        ...
        ZEPHYR_RIPS                   = 7432, -- The <item> rips!
        ...
        BLOWN_AWAY                    = 7627, -- The explosion has blown you out of the area!
        BEGINS_TO_MELT                = 7684, -- The Snoll Tzar has begun to melt!
        LARGE_STEAM                   = 7685, -- The Snoll Tzar is emitting a large amount of steam.
        SHOOK_SALT                    = 7686, -- The Snoll Tzar shakes off the salt!
    },
    mob =
    {
