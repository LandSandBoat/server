...
zones[xi.zone.BEARCLAW_PINNACLE] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7597, -- Entering the battlefield for [Flames for the Dead/Follow the White Rabbit/When Hell Freezes Over/Brothers/Holy Cow/Taurassic Park]!
        BLOWN_AWAY                    = 7620, -- The explosion has blown you out of the area!
        BEGINS_TO_MELT                = 7677, -- The Snoll Tzar has begun to melt!
        LARGE_STEAM                   = 7678, -- The Snoll Tzar is emitting a large amount of steam.
        SHOOK_SALT                    = 7679, -- The Snoll Tzar shakes off the salt!
    },
    mob =
    {
