...
zones[xi.zone.PHANAUET_CHANNEL] =
{
    text =
    {
        ...
        TRAVEL_ANY_FASTER             = 7383, -- Cannot this vessel travel any faster? At my age, every minute counts!
        ARE_WE_THERE_YET              = 7384, -- <Sigh> Are we there yet?
        RICHE_DAVOI_WATERFALL         = 7427, -- <item>...Davoi...waterfall...
    },
    mob =
    {
    },
