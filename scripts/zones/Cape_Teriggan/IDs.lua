...
zones[xi.zone.CAPE_TERIGGAN] =
{
    text =
    {
        ...
        ALREADY_HAVE_ALL_FRAGS        = 7692,  -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
        FOUND_ALL_FRAGS               = 7693,  -- You have obtained <keyitem>! You now have all 8 fragments of light!
        ...
        MUST_MOVE_CLOSER              = 7708,  -- You will have to move closer to remove the <keyitem>.
