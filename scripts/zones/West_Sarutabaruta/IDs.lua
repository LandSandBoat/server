...
zones[xi.zone.WEST_SARUTABARUTA] =
{
    text =
    {
        ...
        SIGN_5                        = 7405,  -- Northeast: Central Tower, Horutoto Ruins East: East Sarutabaruta West: Giddeus
        SIGN_7                        = 7406,  -- South: Windurst East: East Sarutabaruta
        SIGN_9                        = 7407,  -- West: Giddeus North: East Sarutabaruta South: Windurst
        SIGN_11                       = 7408,  -- North: East Sarutabaruta Southeast: Windurst
        SIGN_13                       = 7409,  -- East: Port Windurst West: West Tower, Horutoto Ruins
        SIGN_15                       = 7410,  -- East: East Sarutabaruta West: Giddeus Southeast: Windurst
        SIGN_17                       = 7411,  -- Northwest: Northwest Tower, Horutoto Ruins East: Outpost Southwest: Giddeus
        PAORE_KUORE_DIALOG            = 7413,  -- Welcome to Windurst! Proceed through this gateway to entaru Port Windurst.
        KOLAPO_OILAPO_DIALOG          = 7414,  -- Hi-diddly-diddly! This is the gateway to Windurst! The grasslands you're on now are known as West Sarutabaruta.
        MAATA_ULAATA                  = 7415,  -- Hello-wello! This is the central tower of the Horutoto Ruins. It's one of the several ancient-wancient magic towers which dot these grasslands.
        COME_FROM_THE_ORASTERY        = 7416,  -- I am Fuahah. I've come from the Orastery's Mage Academy to investigate the Horutoto Ruins.
        FERAL_CARDIANS                = 7417,  -- Beneath this magic tower lurk some of the feral Cardians that have escaped from the care of the Manustery. So be very-wery careful down there!
        IPUPU_DIALOG                  = 7418,  -- I decided to take a little strolly-wolly, but before I realized it, I found myself way out here! Now I am sorta stuck... Woe is me!
        FROST_DEPOSIT_TWINKLES        = 7425,  -- A frost deposit at the base of the tree twinkles in the starlight.
        MELT_BARE_HANDS               = 7427,  -- It looks like it would melt if you touched it with your bare hands...
        HARVESTING_IS_POSSIBLE_HERE   = 7463,  -- Harvesting is possible here if you have <item>.
        CONQUEST                      = 7479,  -- You've earned conquest points!
        GARRISON_BASE                 = 7833,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        ...
        VOIDWALKER_DESPAWN            = 7919,  -- The monster fades before your eyes, a look of disappointment on its face.
        REGIME_REGISTERED             = 10210, -- New training regime registered!
        DONT_SWAP_JOBS                = 10211, -- Changing your job will result in the cancellation of your current training regime.
        REGIME_CANCELED               = 10212, -- Training regime canceled.
        ...
        VOIDWALKER_SPAWN_MOB          = 11373, -- A monster materializes out of nowhere!
