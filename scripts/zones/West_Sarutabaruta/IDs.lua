...
zones[xi.zone.WEST_SARUTABARUTA] =
{
    text =
    {
        ...
        GARRISON_BASE                 = 7819,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        PLAYER_OBTAINS_ITEM           = 7866,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7867,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7868,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7869,  -- You already possess that temporary item.
        NO_COMBINATION                = 7874,  -- You were unable to enter a combination.
        VOIDWALKER_DESPAWN            = 7905,  -- The monster fades before your eyes, a look of disappointment on its face.
        REGIME_REGISTERED             = 10195, -- New training regime registered!
        DONT_SWAP_JOBS                = 10196, -- hanging your job will result in the cancellation of your current training regime.
        REGIME_CANCELED               = 10197, -- Training regime canceled.
        VOIDWALKER_NO_MOB             = 11355, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 11356, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 11357, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 11358, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 11360, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 11361, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 11362, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 11363, -- Obtained key item: <keyitem>!
