        ...
        if battlefield:getLocalVar("crateOpenedF6") ~= 1 then
            switch (mobID): caseof
            {
                [ID.mob.TEMENOS_E_MOB[6]] = function()
                    ...
                    tpz.limbus.spawnRandomCrate(ID.npc.TEMENOS_E_CRATE[6], player, "crateMaskF6", battlefield:getLocalVar("crateMaskF6"), true)
                end,
                [ID.mob.TEMENOS_E_MOB[6]+1] = function()
                    GetNPCByID(ID.npc.TEMENOS_E_CRATE[6]+1):setPos(mobX, mobY, mobZ)
                    tpz.limbus.spawnRandomCrate(ID.npc.TEMENOS_E_CRATE[6]+1, player, "crateMaskF6", battlefield:getLocalVar("crateMaskF6"), true)
                end,
                [ID.mob.TEMENOS_E_MOB[6]+2] = function()
                    GetNPCByID(ID.npc.TEMENOS_E_CRATE[6]+2):setPos(mobX, mobY, mobZ)
                    tpz.limbus.spawnRandomCrate(ID.npc.TEMENOS_E_CRATE[6]+2, player, "crateMaskF6", battlefield:getLocalVar("crateMaskF6"), true)
                end,
                [ID.mob.TEMENOS_E_MOB[6]+3] = function()
                    GetNPCByID(ID.npc.TEMENOS_E_CRATE[6]+3):setPos(mobX, mobY, mobZ)
                    tpz.limbus.spawnRandomCrate(ID.npc.TEMENOS_E_CRATE[6]+3, player, "crateMaskF6", battlefield:getLocalVar("crateMaskF6"), true)
                end,
