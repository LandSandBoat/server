...
zones[xi.zone.TEMENOS] =
{
    text =
    {
        ...
        HUM                           = 7041, -- placeholder
        GATE_OPEN                     = 7040, -- placeholder
        TIME_EXTENDED                 = 7033, -- placeholder
        TIME_LEFT                     = 7034, -- placeholder
        YOU_INSERT_THE_CARD_POLISHED  = 7046, -- placeholder
        CITADEL_BASE                  = 7030, -- placeholder
    },
    mob =
    {
    },
