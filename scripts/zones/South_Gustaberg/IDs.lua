...
zones[xi.zone.SOUTH_GUSTABERG] =
{
    text =
    {
        ...
        MONSTER_TRACKS                = 7418, -- You see monster tracks on the ground.
        MONSTER_TRACKS_FRESH          = 7419, -- You see fresh monster tracks on the ground.
        FIRE_GOOD                     = 7422, -- The fire seems to be good enough for cooking.
        FIRE_PUT                      = 7423, -- You put <item> in the fire.
        FIRE_TAKE                     = 7424, -- You take <item> out of the fire.
        FIRE_LONGER                   = 7425, -- It may take a little while more to cook the <item>.
        MEAT_ALREADY_PUT              = 7426, -- The <item> is already in the fire.
        ...
        UNITY_WANTED_BATTLE_INTERACT  = 7614, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        ...
        REGIME_REGISTERED             = 9913, -- New training regime registered!
    },
    mob =
    {
