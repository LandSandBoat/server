...
entity.onMobFight = function(mob, target)
    -- Every 17-35 seconds unless extended by a spell cast spawn a random Prince or Princess. If none remain then summon the Bastard.
    local drawInTable =
    {
        conditions =
        {
    ...
    then
        mob:setLocalVar('spawn_time', GetSystemTime() + math.random(17, 35))
