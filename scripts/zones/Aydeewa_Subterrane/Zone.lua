...
zone_object.onEventFinish = function(player, csid, option)
    if
        csid == 3 and
        option == 13 and
        npcUtil.completeQuest(player, xi.quest.log_id.AHT_URHGAN, xi.quest.id.ahtUrhgan.AN_EMPTY_VESSEL, {title=xi.title.BEARER_OF_THE_MARK_OF_ZAHAK, ki=xi.ki.MARK_OF_ZAHAK, var={"AnEmptyVesselProgress", "EmptyVesselStone"}})
