...
zones[xi.zone.AYDEEWA_SUBTERRANE] =
{
    text =
    {
        ...
        BLOOD_STAINS            = 8009, -- The ground is smeared with bloodstains...
        DRAWS_NEAR              = 8034, -- Something draws near!
        COMMON_SENSE_SURVIVAL   = 8906, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
