...
zones[xi.zone.PROMYVION_DEM] =
{
    ...
    mob =
    {
        MEMORY_RECEPTACLES =
        {
            [16850972] = { 1, 3, 16851277, 1 },
            [16851026] = { 2, 5, 16851281, 4 },
            [16851033] = { 2, 5, 16851282, 4 },
            [16851040] = { 2, 5, 16851283, 4 },
            [16851047] = { 2, 5, 16851284, 4 },
            [16851073] = { 3, 7, 16851278, 3 },
            [16851082] = { 3, 7, 16851279, 3 },
            [16851091] = { 3, 7, 16851280, 3 },
            [16851152] = { 4, 7, 16851285, 3 },
            [16851161] = { 4, 7, 16851286, 3 },
            [16851170] = { 4, 7, 16851287, 3 },
        },
