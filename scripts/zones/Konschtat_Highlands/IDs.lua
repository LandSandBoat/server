...
zones[xi.zone.KONSCHTAT_HIGHLANDS] =
{
    text =
    {
        ...
        UNITY_WANTED_BATTLE_INTERACT  = 7686,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        ...
        LEARNS_SPELL                  = 11919, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 11921, -- You are assaulted by an uncanny sensation.
