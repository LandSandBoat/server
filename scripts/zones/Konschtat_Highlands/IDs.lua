...
zones[xi.zone.KONSCHTAT_HIGHLANDS] =
{
    text =
    {
        ...
        ALREADY_OBTAINED_TELE         = 7227,  -- You already possess the gate crystal for this telepoint.
        ...
        SIGNPOST3                     = 7402,  -- North: Valkurm Dunes South: North Gustaberg East: Gusgen Mines, Pashhow Marshlands
        SIGNPOST2                     = 7403,  -- North: Pashhow Marshlands West: Valkurm Dunes, North Gustaberg Southeast: Gusgen Mines
        SIGNPOST_DIALOG_1             = 7404,  -- North: Valkurm Dunes South: To Gustaberg
        SIGNPOST_DIALOG_2             = 7405,  -- You see something stuck behind the signpost.
        SOMETHING_BURIED_HERE         = 7406,  -- Something has been buried here.
        BLACKENED_SPOT_ON_GROUND      = 7455,  -- There is a blackened spot on the ground...
        BLACKENED_SHOULD_PLACE        = 7456,  -- This is the blackened spot you were told about. You should place <item> here.
        PLACE_BLACKENED_SPOT          = 7457,  -- You place <item> on the blackened spot.
        BLACKENED_NOTHING_HAPPENS     = 7458,  -- You place <item> on the blackened spot, but nothing happens.
        BLACKENED_MUST_BE_CLOSER      = 7459,  -- You have to be closer to place anything on the blackened spot.
        NOT_THE_TIME_FOR_THAT         = 7468,  -- This is not the time for that!
        TELEPOINT_HAS_BEEN_SHATTERED  = 7495,  -- The telepoint has been shattered into a thousand pieces...
        TIME_ELAPSED                  = 7551,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
        MEMORIES_SEALED_OFF           = 7608,  -- A portion of your memories has been sealed off.
