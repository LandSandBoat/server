...
zones[xi.zone.KONSCHTAT_HIGHLANDS] =
{
    text =
    {
        ...
        SIGNPOST3                     = 7391,  -- North: Valkurm Dunes South: North Gustaberg East: Gusgen Mines, Pashhow Marshlands
        SIGNPOST2                     = 7392,  -- North: Pashhow Marshlands West: Valkurm Dunes, North Gustaberg Southeast: Gusgen Mines
        SIGNPOST_DIALOG_1             = 7393,  -- North: Valkurm Dunes South: To Gustaberg
        SIGNPOST_DIALOG_2             = 7394,  -- You see something stuck behind the signpost.
        SOMETHING_BURIED_HERE         = 7395,  -- Something has been buried here.
