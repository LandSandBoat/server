...
zones[xi.zone.KONSCHTAT_HIGHLANDS] =
{
    text =
    {
        ...
        ALREADY_OBTAINED_TELE        = 7215,  -- You already possess the gate crystal for this telepoint.
        ...
        SIGNPOST3                    = 7390,  -- North: Valkurm Dunes South: North Gustaberg East: Gusgen Mines, Pashhow Marshlands
        SIGNPOST2                    = 7391,  -- North: Pashhow Marshlands West: Valkurm Dunes, North Gustaberg Southeast: Gusgen Mines
        SIGNPOST_DIALOG_1            = 7392,  -- North: Valkurm Dunes South: To Gustaberg
        SIGNPOST_DIALOG_2            = 7393,  -- You see something stuck behind the signpost.
        SOMETHING_BURIED_HERE        = 7394,  -- Something has been buried here.
