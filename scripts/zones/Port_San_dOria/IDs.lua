...
zones[xi.zone.PORT_SAN_DORIA] =
{
    text =
    {
        ...
        RECEIVE_BAYLD                  = 6479,  -- You receive <number> bayld!
        ...
        RECEIVED_CONQUEST_POINTS       = 6887,  -- You received <number> conquest points!
        ...
        IMPERIAL_STANDING_INCREASED    = 11167, -- Your Imperial Standing has increased!
        EARNED_ALLIED_NOTES            = 11168, -- You have earned <number> Allied Note[/s]!
        OBTAINED_GUILD_POINTS          = 11169, -- Obtained: <number> guild points.
