...
zones[xi.zone.CLOISTER_OF_TREMORS] =
{
    text =
    {
        ...
        TITAN_UNLOCKED                   = 7586, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7674, -- Entering the battlefield for [Trial by Earth/The Puppet Master/Trial-Size Trial by Earth/Waking the Beast/Sugar-coated Directive/Trial by Earth]!
