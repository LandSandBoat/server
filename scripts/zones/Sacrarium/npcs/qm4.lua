...
entity.onTrigger = function(player, npc)
    ...
    if (cop == xi.mission.id.cop.THE_SECRETS_OF_WORSHIP and copStat == 3 and not player:hasKeyItem(xi.ki.RELIQUIARIUM_KEY) and not prof:isSpawned() and profLoc == 4) then
