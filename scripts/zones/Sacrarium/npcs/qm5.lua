...
function onTrigger(player, npc)
    ...
    if (cop == tpz.mission.id.cop.THE_SECRETS_OF_WORSHIP and copStat == 3 and not player:hasKeyItem(tpz.ki.RELIQUIARIUM_KEY) and not prof:isSpawned() and profLoc == 5) then
