...
zones[xi.zone.LALOFF_AMPHITHEATER] =
{
    text =
    {
        ...
        NO_RESPONSE_CANNOT_ESCAPE     = 7249, -- There is no response. You cannot escape!
        ...
        INK_HAS_FADED                 = 7543, -- The illuminink on the <item> has faded.
        ...
        LARGE_CRACK_RUNNING_DOWN      = 7598, -- The <item> has a large crack running straight down the side.
        ENTERING_THE_BATTLEFIELD_FOR  = 7605, -- Entering the battlefield for [Ark Angels (1)/Ark Angels (2)/Ark Angels (3)/Ark Angels (4)/Ark Angels (5)/Divine Might/Ark Angels (1)/Ark Angels (2)/Ark Angels (3)/Ark Angels (4)/Ark Angels (5)/Divine Might]!
        THE_SEAL_FADES                = 7616, -- The seal on the <item> flares brightly for an instant, then fades away!
    },
    mob =
    {
