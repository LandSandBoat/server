...
zones[xi.zone.TALACCA_COVE] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7376, -- It appears as if something had been thrust into the rockface here...
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7711, -- Entering the battlefield for [Call to Arms/Compliments to the Chef/Puppetmaster Blues/Breaking the Bonds of Fate/Legacy of the Lost/★Legacy of the Lost/An Imperial Heist]!
        YOU_CAN_NOW_BECOME_A_CORSAIR  = 7809, -- You can now become a corsair!
        NOBODY_COMES_TO_HELP          = 7860, -- Nobody comes to help. The Imp Bandsman looks dejected.
        HELP_HAS_ARRIVED              = 7861, -- Help has arrived!
        QULTADA_CARDS_DEALT           = 7862, -- The cards have been dealt. Now let us begin our little gamble of luck and skill.
        QULTADA_GO_EASY               = 7863, -- You need not go easy on me... I certainly will not go easy on you.
        QULTADA_QUICK_START           = 7864, -- Oho... That was a quick start.
        QULTADA_BETTER_LUCK           = 7865, -- You could not put a dent in my tricorne with attacks like that. Better luck next time.
        QULTADA_NOT_BAD               = 7866, -- Not bad...
        QULTADA_ANTE_UP               = 7867, -- Ante up!
        QULTADA_TRY_YOUR_LUCK         = 7868, -- Let's try your luck!
        QULTADA_GET_AWAY              = 7869, -- Think you can get away?
        QULTADA_BEHOLD                = 7870, -- Behold my trump card... Time for you to fold!
        QULTADA_TOO_BAD               = 7871, -- Too bad. I was hoping for a bit more excitement.
        QULTADA_LADY_DESTINY          = 7872, -- Does Lady Destiny smile upon you today? Or is it merely Fate's mocking grin? Now is the time to offer your prayers!
        QULTADA_LUCK_OF_CORSAIR       = 7873, -- The luck of the corsair is a wonderful thing!
        QULTADA_FIVE_ROLL             = 7874, -- Ha! Lady Luck, stay with me!
        QULTADA_AS_LUCK               = 7875, -- As luck would have it...
        QULTADA_DO_NOT_FAIL           = 7876, -- Luck, do not fail me again...
