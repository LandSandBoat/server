...
entity.phList =
{
    [ID.mob.SWASHSTOX_BEADBLINKER[1] - 3] = ID.mob.SWASHSTOX_BEADBLINKER[1], -- Confirmed on retail
    [ID.mob.SWASHSTOX_BEADBLINKER[2] - 3] = ID.mob.SWASHSTOX_BEADBLINKER[2], -- Confirmed on retail
}
