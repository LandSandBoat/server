...
entity.onMobSpellChoose = function(mob, target)
    ...
    local spellListCombat =
    {
        ...
        [4] = { xi.magic.spell.BIO_III,      target, false, xi.action.type.ENFEEBLING_TARGET, xi.effect.BIO,        4, 100 },
        ...
        [7] = { xi.magic.spell.BLIZZARD_III, target, false, xi.action.type.DAMAGE_TARGET,     nil,                  0, 100 },
        [8] = { xi.magic.spell.CURE_IV,      target, true,  xi.action.type.HEALING_TARGET,    33,                   0, 100 },
        ...
        [17] = { xi.magic.spell.PROTECT_IV,  target, true,  xi.action.type.ENHANCING_TARGET,  xi.effect.PROTECT,    4, 100 },
        [18] = { xi.magic.spell.REGEN,       target, true,  xi.action.type.ENHANCING_TARGET,  xi.effect.REGEN,      1, 100 },
        [19] = { xi.magic.spell.SHELL_IV,    target, true,  xi.action.type.ENHANCING_TARGET,  xi.effect.SHELL,      4, 100 },
        ...
        [22] = { xi.magic.spell.SLOW,        target, false, xi.action.type.ENFEEBLING_TARGET, xi.effect.SLOW,       3, 100 },
        [23] = { xi.magic.spell.STONE_IV,    target, false, xi.action.type.DAMAGE_TARGET,     nil,                  0, 100 },
        [24] = { xi.magic.spell.STONESKIN,   target, false, xi.action.type.ENHANCING_TARGET,  xi.effect.STONESKIN,  0, 100 },
        [25] = { xi.magic.spell.THUNDER_III, target, false, xi.action.type.DAMAGE_TARGET,     nil,                  0, 100 },
    }

    -- Water III upgrades to Water IV if the mob is level 80.
    if mob:getMainLvl() >= 80 then
        table.insert(spellListCombat, { xi.magic.spell.WATER_IV, target, false, xi.action.type.DAMAGE_TARGET, nil, 0, 100 })
    else
        table.insert(spellListCombat, { xi.magic.spell.WATER_III, target, false, xi.action.type.DAMAGE_TARGET, nil, 0, 100 })
    end
