...
zones[xi.zone.SACRIFICIAL_CHAMBER] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7250, -- The old wooden door is locked tight.
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7674, -- Entering the battlefield for [The Temple of Uggalepih/Jungle Boogymen/Amphibian Assault/Project: Shantottofication/Whom Wilt Thou Call/Jungle Boogymen/Amphibian Assault]!
    },
    mob =
    {
