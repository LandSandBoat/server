...
zones[tpz.zone.CRAWLERS_NEST_S] =
{
    text =
    {
        ...
        CARRIED_OVER_POINTS     = 7521, -- You have carried over <number> points.
        LOGIN_CAMPAIGN_UNDERWAY = 7522, -- The <month> ≺year≻ Login Campaign is currently underway!
        LOGIN_NUMBER            = 7523, -- In celebration of your most recent login no. <number>...
