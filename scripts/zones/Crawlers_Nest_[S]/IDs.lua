...
zones[xi.zone.CRAWLERS_NEST_S] =
{
    text =
    {
        ...
        ITEM_DELIVERY_DIALOG          = 7695, -- Hello! Any packages to sendy-wend?
        COMMON_SENSE_SURVIVAL         = 8660, -- It appears that you have arrived at a new survival guide provided by the Servicemen's Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
