...
zones[xi.zone.MAZE_OF_SHAKHRAMI] =
{
    text =
    {
        ...
        ALREADY_HAVE_SHELLING_PIECE   = 7085,  -- You already have <item>. (Heaven Cent: only one Shelling Piece at a time)
        TAKE_THIS_COIN                = 7086,  -- Take this coin? Yes/No (rendered by the coin cutscenes, events 48-50)
        COIN_ALEXANDER_NORTHEAST      = 7087,  -- You picked up a coin with Alexander drawn to the northeast. (authentic)
        COIN_SHIVA_EAST               = 7088,  -- You picked up a coin with Shiva drawn to the east. (authentic)
        COIN_ODIN_NORTH               = 7089,  -- You picked up a coin with Odin drawn to the north. (authentic)
        COIN_ODIN_EAST                = 7090,  -- You picked up a coin with Odin drawn to the east. (counterfeit)
        COIN_TITAN_NORTH              = 7091,  -- You picked up a coin with Titan drawn to the north. (counterfeit)
        COIN_LEVIATHAN_SOUTH          = 7092,  -- You picked up a coin with Leviathan drawn to the south. (counterfeit)
        COIN_SHIVA_WEST               = 7093,  -- You picked up a coin with Shiva drawn to the west. (counterfeit)
        COIN_IFRIT_NORTHWEST          = 7094,  -- You picked up a coin with Ifrit drawn to the northwest. (authentic)
