...
zones[xi.zone.MAZE_OF_SHAKHRAMI] =
{
    text =
    {
        ...
        SUBMERGE                      = 7084,  -- You submerged the <item> into the pool of water.
        CANNOT_SUBMERGE               = 7085,  -- You cannot submerge more than one Ahriman Lens at a time.
        WATER_POOL                    = 7086,  -- Water forms a pool here.
        NOT_READY                     = 7087,  -- It does not seem to have become a <item> yet. You need to wait a bit longer.
