...
zones[xi.zone.MAZE_OF_SHAKHRAMI] =
{
    text =
    {
        ...
        CHEST_EMPTY                   = 7073,  -- The chest looks empty.
        TOO_RUSTY                     = 7074,  -- The chest is too rusty to open.
        ALEXANDER_NE                  = 7075,  -- You picked up a coin with Alexander drawn to the northeast.<7F31>
        SHIVA_EAST                    = 7076,  -- You picked up a coin with Shiva drawn to the east.<7F31>
        ODIN_NORTH                    = 7077,  -- You picked up a coin with Odin drawn to the north.<7F31>
        ODIN_EAST                     = 7078,  -- You picked up a coin with Odin drawn to the east.<7F31>
        TITAN_NORTH                   = 7079,  -- You picked up a coin with Titan drawn to the north.<7F31>
        LEAVIATHAN_SOUTH              = 7080,  -- You picked up a coin with Leviathan drawn to the south.<7F31>
        SHIVA_WEST                    = 7081,  -- You picked up a coin with Shiva drawn to the west.<7F31>
        IFRIT_NW                      = 7082,  -- You picked up a coin with Ifrit drawn to the northwest.<7F31>
        ...
        IRON_DOOR                     = 7278,  -- You might be able to open it if you had the key.
