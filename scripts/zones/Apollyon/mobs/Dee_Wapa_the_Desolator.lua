...
entity.onMobFight = function(mob, target)
    ...
    if battlefield then
        ...
        if
            ...
            GetMobByID(ID.mob.APOLLYON_CS_MOB[3] + 4):isDead() and
            GetMobByID(ID.mob.APOLLYON_CS_MOB[3] + 5):isDead() and
            wave == 1
        then
        ...
        elseif
            ...
            GetMobByID(ID.mob.APOLLYON_CS_MOB[3] + 7):isDead() and
            GetMobByID(ID.mob.APOLLYON_CS_MOB[3] + 8):isDead() and
            wave == 2
        then
            mob:setLocalVar("wave", 1)
