...
zones[xi.zone.APOLLYON] =
{
    text =
    {
        ...
        HUM                           = 7041, -- placeholder: Nothing out of the ordinary happens.
        GATE_OPEN                     = 7040, -- placeholder: Jump into the vortex?
        TIME_EXTENDED                 = 7033, -- placeholder: Alter egos may be used here
        TIME_LEFT                     = 7034, -- placeholder: The maximum level
        YOU_INSERT_THE_CARD_POLISHED  = 7046, -- placeholder: Your bags feel heavier
        CITADEL_BASE                  = 7030, -- placeholder: The cutscene has terminated
    },
    mob =
    {
