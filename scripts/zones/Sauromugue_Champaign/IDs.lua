...
zones[xi.zone.SAUROMUGUE_CHAMPAIGN] =
{
    text =
    {
        ...
        MANY_TIGER_BONES              = 7248,  -- There are many tiger bones here...
        OLD_SABERTOOTH_DIALOG_I       = 7254,  -- You hear the distant roar of a tiger. It sounds as if the beast is approaching slowly...
        OLD_SABERTOOTH_DIALOG_II      = 7255,  -- The sound of the tiger's footsteps is growing louder.
        ...
        FOUND_ITEM_WITH_EASE          = 7346,  -- It appears your chocobo found this item with ease.
        THF_AF_MOB                    = 7433,  -- Something has come down from the tower!
        THF_AF_WALL_OFFSET            = 7452,  -- It is impossible to climb this wall with your bare hands.
        ...
        UNITY_WANTED_BATTLE_INTERACT  = 7585,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        TIME_ELAPSED                  = 7667,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
        ...
        LEARNS_SPELL                  = 12505, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12507, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 12514, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
