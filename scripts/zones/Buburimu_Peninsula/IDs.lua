...
zones[xi.zone.BUBURIMU_PENINSULA] =
{
    text =
    {
        ...
        GARRISON_BASE                  = 7804,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        ...
        UNITY_WANTED_BATTLE_INTERACT   = 8192,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
