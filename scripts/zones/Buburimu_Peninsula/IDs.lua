...
zones[xi.zone.BUBURIMU_PENINSULA] =
{
    text =
    {
        ...
        FIVEOFSPADES_DIALOG            = 7250,  -- GiMmefIvE! FiVe isA cArdIanOF WiN-DuRst! FIvEiS OnpA-tRol!
        FISHING_MESSAGE_OFFSET         = 7256,  -- You can't fish here.
        DIG_THROW_AWAY                 = 7269,  -- You dig up <item>, but your inventory is full. You regretfully throw the <item> away.
        FIND_NOTHING                   = 7271,  -- You dig and you dig, but find nothing.
        AMK_DIGGING_OFFSET             = 7337,  -- You spot some familiar footprints. You are convinced that your moogle friend has been digging in the immediate vicinity.
        SONG_RUNES_DEFAULT             = 7376,  -- An old momument. A melancholy song of two separated lovers is written upon it.
        SONG_RUNES_REQUIRE             = 7390,  -- If only you had <item>, you could jot down the lyrics.
        SONG_RUNES_WRITING             = 7391,  -- You write down the lyrics on the <item>.
        SIGN_1                         = 7398,  -- West: Tahrongi Canyon Southeast: Mhaura
        SIGN_2                         = 7399,  -- West: Tahrongi Canyon South: Mhaura
        SIGN_3                         = 7400,  -- West: Tahrongi Canyon Southwest: Mhaura
        SIGN_4                         = 7401,  -- West: Mhaura and Tahrongi Canyon
        SIGN_5                         = 7402,  -- West: Mhaura Northwest: Tahrongi Canyon
        LOGGING_IS_POSSIBLE_HERE       = 7403,  -- Logging is possible here if you have <item>.
        CONQUEST                       = 7419,  -- You've earned conquest points!
