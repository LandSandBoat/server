...
zones[xi.zone.SEA_SERPENT_GROTTO] =
{
    text =
    {
        ...
        SAHAGIN_DOOR_INSIDE        = 7341,  -- The door is tightly shut.
        SAHAGIN_DOOR_OUTSIDE       = 7342,  -- This door has an oddly shaped keyhole. It looks as if once you enter, you may not be able to get out the way you came in.
        SAHAGIN_DOOR_TRADED        = 7343,  -- The <item> breaks!
        FIRST_CHECK                = 7347,  -- You do not see anything out of the ordinary.
        SECOND_CHECK               = 7348,  -- You do not see anything out of the ordinary...
        THIRD_CHECK                = 7349,  -- It looks like a rock wall.
        FOURTH_CHECK               = 7350,  -- It looks like a rock wall...
        FIFTH_CHECK                = 7351,  -- You see a small indentation in the wall.
        SILVER_CHECK               = 7352,  -- You see something silver glittering around the indentation.
        MYTHRIL_CHECK              = 7353,  -- You find something that looks like mythril dust scattered about the indentation.
        GOLD_CHECK                 = 7354,  -- You see something gold glittering around the indentation.
        COMPLETED_CHECK            = 7355,  -- It is a door you can open using <item>!
        SENSE_OMINOUS_PRESENCE     = 7369,  -- You sense an ominous presence...
        BODY_NUMB_DREAD            = 7557,  -- Your body goes numb with dread!
        ...
        COMMON_SENSE_SURVIVAL      = 10749, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        MASAN_PH =
