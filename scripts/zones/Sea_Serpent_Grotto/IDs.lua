...
zones[xi.zone.SEA_SERPENT_GROTTO] =
{
    text =
    {
        ...
        SAHAGIN_DOOR_INSIDE           = 7354,  -- The door is tightly shut.
        SAHAGIN_DOOR_OUTSIDE          = 7355,  -- This door has an oddly shaped keyhole. It looks as if once you enter, you may not be able to get out the way you came in.
        SAHAGIN_DOOR_TRADED           = 7356,  -- The <item> breaks!
        FIRST_CHECK                   = 7360,  -- You do not see anything out of the ordinary.
        SECOND_CHECK                  = 7361,  -- You do not see anything out of the ordinary...
        THIRD_CHECK                   = 7362,  -- It looks like a rock wall.
        FOURTH_CHECK                  = 7363,  -- It looks like a rock wall...
        FIFTH_CHECK                   = 7364,  -- You see a small indentation in the wall.
        SILVER_CHECK                  = 7365,  -- You see something silver glittering around the indentation.
        MYTHRIL_CHECK                 = 7366,  -- You find something that looks like mythril dust scattered about the indentation.
        GOLD_CHECK                    = 7367,  -- You see something gold glittering around the indentation.
        COMPLETED_CHECK               = 7368,  -- It is a door you can open using <item>!
        SENSE_OMINOUS_PRESENCE        = 7382,  -- You sense an ominous presence...
        BODY_NUMB_DREAD               = 7570,  -- Your body goes numb with dread!
        ...
        COMMON_SENSE_SURVIVAL         = 10762, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        UNITY_WANTED_BATTLE_INTERACT  = 10842, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
