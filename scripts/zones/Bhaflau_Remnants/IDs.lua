...
zones[xi.zone.BHAFLAU_REMNANTS] =
{
    text =
    {
        ...
        TEMP_ITEM                     = 7247, -- Obtained temporary item: <item>.
        ...
        TIME_REMAINING_MINUTES        = 7426, -- Time remaining: <number> [minute/minutes] (Earth time).
        TIME_REMAINING_SECONDS        = 7427, -- Time remaining: <number> [second/seconds] (Earth time).
        PARTY_FALLEN                  = 7429, -- All party members have fallen in battle. Mission failure in <number> [minute/minutes].
        DOOR_IS_SEALED                = 7440, -- The door is sealed...
        SOCKET_TRIGGER                = 7444, -- You hear a ragged sighing from beneath the floor...
        SLOT_TRIGGER                  = 7445, -- You hear a scuttering sound from beneath the floor...
