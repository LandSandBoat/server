...
zones[xi.zone.SHIP_BOUND_FOR_MHAURA] =
{
    text =
    {
        ...
        ON_WAY_TO_MHAURA              = 7350, -- We're on our way to Mhaura. We should be there in [less than an hour/about 1 hour/about 2 hours/about 3 hours/about 4 hours/about 5 hours/about 6 hours/about 7 hours] (# [minute/minutes] in Earth time).
