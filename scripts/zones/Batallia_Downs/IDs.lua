...
zones[xi.zone.BATALLIA_DOWNS] =
{
    text =
    {
        ...
        SPARKLING_LIGHT          = 7343,  -- The ground is sparkling with a strange light.
        SENSE_SOMETHING_LURKING  = 7433,  -- You sense something lurking close by!
        ...
        COMMON_SENSE_SURVIVAL    = 12847, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        RAPTOR_OVERCOME_MUNCHIES = 13000, -- The raptor has overcome the munchies! (<number>/<number>)
        RAPTOR_SECOND_WIND       = 13001, -- The raptor has gained a second wind!
        MEET_SYRILLIA            = 13002, -- Meet up with Syrillia.
        RAPTOR_SPEEDS_OFF        = 13003, -- The raptor speeds off into the sunset...
    },
    mob =
    {
