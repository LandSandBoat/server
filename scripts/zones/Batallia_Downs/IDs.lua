...
zones[xi.zone.BATALLIA_DOWNS] =
{
    text =
    {
        ...
        SPARKLING_LIGHT               = 7357,  -- The ground is sparkling with a strange light.
        SENSE_SOMETHING_LURKING       = 7447,  -- You sense something lurking close by!
        NO_GRASS_GROWING_HERE         = 7496,  -- There is no grass growing here...
        YOU_ARE_BEING_ATTACKED        = 7633,  -- You are being attacked!
        YOU_FIND_NOTHING              = 7636,  -- You find nothing.
        ...
        VOIDWALKER_DESPAWN            = 7747,  -- The monster fades before your eyes, a look of disappointment on its face.
        ...
        FRAGMENT_FAR_TOO_SMALL        = 11332, -- You obtain <keyitem>. However, it is far too small to house an adequate amount of energy. Alone, it serves no purpose.
        FRAGMENTS_MELD                = 11333, -- The tiny fragments of Lilisette's memory meld together to form <keyitem>!
        SEE_WEATHERED_GRAVESTONE      = 11334, -- You see a weathered gravestone.
        VOIDWALKER_NO_MOB             = 11335, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 11336, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 11337, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 11338, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 11340, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 11341, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 11342, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 11343, -- Obtained key item: <keyitem>!
        LEARNS_SPELL                  = 12843, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12845, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 12852, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        RAPTOR_OVERCOME_MUNCHIES      = 13005, -- The raptor has overcome the munchies! (<number>/<number>)
        RAPTOR_SECOND_WIND            = 13006, -- The raptor has gained a second wind!
        MEET_SYRILLIA                 = 13007, -- Meet up with Syrillia.
        RAPTOR_SPEEDS_OFF             = 13008, -- The raptor speeds off into the sunset...
    },
    mob =
    {
