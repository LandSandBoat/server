...
zones[xi.zone.BASTOK_MARKETS] =
{
    text =
    {
        ...
        REINBERTA_EXPERT_ALT         = 7149,  -- It looks as if you are ready to take the next step in your goldsmithing career. Try your hand at <item>.
        REINBERTA_EXPERT_BASE        = 7201,  -- Ah, you've returned. And that look of confidence on your face tells me you've already grasped the contents of <key item>...
