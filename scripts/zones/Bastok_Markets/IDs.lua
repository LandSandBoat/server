...
zones[xi.zone.BASTOK_MARKETS] =
{
    text =
    {
        ...
        YOU_HAVE_JOINED_UNITY         = 14584, -- ou have joined [Pieuje's/Ayame's/Invincible Shield's/Apururu's/Maat's/Aldo's/Jakoh Wahcondalo's/Naja Salaheem's/Flaviria's/Yoran-Oran's/Sylvie's] Unity!
        HAVE_ALREADY_CHANGED_UNITY    = 14660, -- ou have already changed Unities. Please wait until the next tabulation period.
    },
    mob =
    {
    },
