...
local function hasKeyItem(player)
    if (player:hasKeyItem(xi.keyItem.WAY_OF_THE_ALCHEMIST) or
        ...
        player:hasKeyItem(xi.keyItem.WAY_OF_THE_TANNER)) then return true end
    return false
end
...
entity.onEventUpdate = function(player, csid, option) end

entity.onEventFinish = function(player, csid, option) end
