...
zones[xi.zone.KORROLOKA_TUNNEL] =
{
    text =
    {
        ...
        ENTERED_SPRING           = 7328,  -- The water in this spring is pleasant and tepid. This looks like a nice place to warm yourself up.
        LEFT_SPRING_EARLY        = 7329,  -- You are not warm enough yet. You will need to spend more time than that in the spring to get your body heated up.
        LEFT_SPRING_CLEAN        = 7330,  -- Your whole body is piping hot, and the smell of the Rafflesia pollen is gone!
        MORION_WORM_1            = 7333,  -- It appears to be a hole made by some kind of animal. Fragments of iron ore are scattered around the area...
        REGIME_REGISTERED        = 9461,  -- New training regime registered!
        PLAYER_OBTAINS_ITEM      = 10513, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM    = 10514, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM = 10515, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP     = 10516, -- You already possess that temporary item.
        NO_COMBINATION           = 10521, -- You were unable to enter a combination.
