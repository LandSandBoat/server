...
zones[xi.zone.KORROLOKA_TUNNEL] =
{
    text =
    {
        ...
        MINING_IS_POSSIBLE_HERE  = 7315,  -- Mining is possible here if you have <item>.
        ENTERED_SPRING           = 7331,  -- The water in this spring is pleasant and tepid. This looks like a nice place to warm yourself up.
        LEFT_SPRING_EARLY        = 7332,  -- You are not warm enough yet. You will need to spend more time than that in the spring to get your body heated up.
        LEFT_SPRING_CLEAN        = 7333,  -- Your whole body is piping hot, and the smell of the Rafflesia pollen is gone!
        MORION_WORM_1            = 7336,  -- It appears to be a hole made by some kind of animal. Fragments of iron ore are scattered around the area...
        REGIME_REGISTERED        = 9464,  -- New training regime registered!
        PLAYER_OBTAINS_ITEM      = 10516, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM    = 10517, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM = 10518, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP     = 10519, -- You already possess that temporary item.
        NO_COMBINATION           = 10524, -- You were unable to enter a combination.
        COMMON_SENSE_SURVIVAL    = 10548, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        CARGO_CRAB_COLIN_PH =
