...
zones[xi.zone.EASTERN_ALTEPA_DESERT] =
{
    text =
    {
        ...
        ALREADY_OBTAINED_TELE         = 7677,  -- You already possess the gate crystal for this telepoint.
        GARRISON_BASE                 = 7704,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        PLAYER_OBTAINS_ITEM           = 7777,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7778,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7779,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7780,  -- You already possess that temporary item.
        NO_COMBINATION                = 7785,  -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT  = 7847,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 9963,  -- New training regime registered!
        COMMON_SENSE_SURVIVAL         = 11099, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
