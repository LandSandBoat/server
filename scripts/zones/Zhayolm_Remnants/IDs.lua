...
zones[xi.zone.ZHAYOLM_REMNANTS] =
{
    text =
    {
        ...
        NOT_RESPONDING                = 7447, -- The device doesn't respond...
        DOOR_IS_SEALED_MYSTERIOUS     = 7452, -- The door is sealed by some mysterious force...
        SOCKET_TRIGGER                = 7453, -- You hear a ragged sighing from beneath the floor...
        SLOT_TRIGGER                  = 7454, -- You hear a scuttering sound from beneath the floor...
    },
    mob =
    {
