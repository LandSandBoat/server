...
zones[xi.zone.ZHAYOLM_REMNANTS] =
{
    text =
    {
        ...
        NOT_RESPONDING                = 7448, -- The device doesn't respond...
        DOOR_IS_SEALED_MYSTERIOUS     = 7453, -- The door is sealed by some mysterious force...
        SOCKET_TRIGGER                = 7454, -- You hear a ragged sighing from beneath the floor...
        SLOT_TRIGGER                  = 7455, -- You hear a scuttering sound from beneath the floor...
    },
    mob =
    {
