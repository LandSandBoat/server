...
zones[xi.zone.MORIMAR_BASALT_FIELDS] =
{
    text =
    {
        ...
        REACHED_KINETIC_UNIT_LIMIT    = 7623, -- You have reached your limit of kinetic units and cannot charge your artifact any further.
        CANNOT_RECEIVE_KINETIC        = 7624, -- There is no response. You apparently cannot receive kinetic units from this item.
        ARTIFACT_HAS_BEEN_CHARGED     = 7625, -- Your artifact has been charged with <number> kinetic unit[/s]. Your current stock of kinetic units totals <number>.
        ARTIFACT_TERMINAL_VOLUME      = 7626, -- Your artifact has been charged to its terminal volume of kinetic units.
        SURPLUS_LOST_TO_AETHER        = 7627, -- A surplus of <number> kinetic unit[/s] has been lost to the aether.
        LEARNS_SPELL                  = 7875, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 7877, -- You are assaulted by an uncanny sensation.
        RIVER_UNSUITABLE_FOR_SWIMMING = 7886, -- This river is not suitable for swimming.
        SHARP_THORNS_PROTRUDE         = 8038, -- Sharp thorns protrude from the surface.
        HOMEPOINT_SET                 = 8191, -- Home point set!
    },
    mob =
    {
