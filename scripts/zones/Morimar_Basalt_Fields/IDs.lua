...
zones[xi.zone.MORIMAR_BASALT_FIELDS] =
{
    text =
    {
        ...
        WAYPOINT_ATTUNED              = 7605, -- Your <keyitem> has been attuned to a geomagnetic fount[/ at the frontier station/ at Frontier Bivouac #1/ at Frontier Bivouac #2/ at Frontier Bivouac #3/ at Frontier Bivouac #4/ at Frontier Bivouac #5]!
        ...
        HOMEPOINT_SET                 = 8184, -- Home point set!
    },
    mob =
    {
