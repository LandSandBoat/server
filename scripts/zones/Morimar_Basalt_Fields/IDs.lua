...
zones[xi.zone.MORIMAR_BASALT_FIELDS] =
{
    text =
    {
        ...
        CANNOT_RECEIVE_KINETIC        = 7607, -- There is no response. You apparently cannot receive kinetic units from this item.
        ...
        LEARNS_SPELL                  = 7858, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 7860, -- You are assaulted by an uncanny sensation.
        HOMEPOINT_SET                 = 8174, -- Home point set!
    },
    mob =
    {
    },
