...
zones[xi.zone.BOSTAUNIEUX_OUBLIETTE] =
{
    text =
    {
        ...
        CHUMIA_DIALOG            = 7315,  -- Welcome to Bostaunieux Oubliette...
        SEEMS_LOCKED             = 7317,  -- It seems to be locked.
        SPIRAL_HELL_LEARNED      = 7424,  -- You have learned the weapon skill Spiral Hell!
        SENSE_OMINOUS_PRESENCE   = 7425,  -- You sense an ominous presence...
        ITEMS_ITEMS_LA_LA        = 7428,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY      = 7434,  -- The Goblin slipped away when you were not looking...
        ...
        COMMON_SENSE_SURVIVAL    = 10632, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        SEWER_SYRUP_PH          =
