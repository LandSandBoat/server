...
zones[xi.zone.WINDURST_WATERS] =
{
    text =
    {
        ...
        PIKETO_PUKETO_EXPERT_ALT   = 7224,  -- It's about time you moved on to the next culinarian level. Here then... Whip me up <item>.
        PIKETO_PUKETO_EXPERT_BASE  = 7273,  -- You're back, and the smile on your face tells me that you've fully digested the contents of <keyitem>.
