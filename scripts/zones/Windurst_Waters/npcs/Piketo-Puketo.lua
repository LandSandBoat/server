...
entity.onTrigger = function(player, npc)
    ...
    if expertQuestStatus == 550 then
        ...
        --]]
        player:showText(npc, ID.text.PIKETO_PUKETO_EXPERT_BASE,  0, xi.keyItem.WAY_OF_THE_CULINARIAN)
        player:showText(npc, ID.text.PIKETO_PUKETO_EXPERT_ALT, testItem)
        player:showText(npc, ID.text.PIKETO_PUKETO_EXPERT_BASE + 2)
    else
