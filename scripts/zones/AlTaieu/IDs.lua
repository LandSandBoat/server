...
zones[xi.zone.ALTAIEU] =
{
    text =
    {
        ...
        QUASILUMIN_01           = 7372, -- This is Al'Taieu. The celestial capital overflowing with the blessings of Altana.
        NOTHING_OF_INTEREST     = 7482, -- There is nothing of interest here.
        OMINOUS_SHADOW          = 7483, -- An ominous shadow falls over you...
        AMULET_SHATTERED        = 7504, -- The <item> held by <name> has shattered...
        LIGHT_STOLEN            = 7505, -- The <item> was stolen by Nag'molada...
        RETURN_AMULET_TO_PRISHE = 7530, -- You return the <item> to Prishe.
        HOMEPOINT_SET           = 7571, -- Home point set!
    },
    mob =
    {
