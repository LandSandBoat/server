...
zones[xi.zone.ALTAIEU] =
{
    text =
    {
        ...
        QUASILUMIN_01                 = 7385, -- This is Al'Taieu. The celestial capital overflowing with the blessings of Altana.
        IMPERVIOUS_FIELD_BLOCKS       = 7466, -- An impervious field of energy blocks your path...
        NOTHING_OF_INTEREST           = 7495, -- There is nothing of interest here.
        OMINOUS_SHADOW                = 7496, -- An ominous shadow falls over you...
        AMULET_SHATTERED              = 7517, -- The <item> held by <name> has shattered...
        LIGHT_STOLEN                  = 7518, -- The <item> was stolen by Nag'molada...
        OBTAIN_BUT_STOLEN             = 7519, -- You obtain the <item>, only to have it stolen by Nag'molada...
        RETURN_AMULET_TO_PRISHE       = 7543, -- You return the <item> to Prishe.
        HOMEPOINT_SET                 = 7584, -- Home point set!
    },
    mob =
    {
