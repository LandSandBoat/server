...
zones[xi.zone.ALTAIEU] =
{
    text =
    {
        ...
        QUASILUMIN_01                 = 7383, -- This is Al'Taieu. The celestial capital overflowing with the blessings of Altana.
        IMPERVIOUS_FIELD_BLOCKS       = 7464, -- An impervious field of energy blocks your path...
        NOTHING_OF_INTEREST           = 7493, -- There is nothing of interest here.
        OMINOUS_SHADOW                = 7494, -- An ominous shadow falls over you...
        AMULET_SHATTERED              = 7515, -- The <item> held by <name> has shattered...
        LIGHT_STOLEN                  = 7516, -- The <item> was stolen by Nag'molada...
        OBTAIN_BUT_STOLEN             = 7517, -- You obtain the <item>, only to have it stolen by Nag'molada...
        RETURN_AMULET_TO_PRISHE       = 7541, -- You return the <item> to Prishe.
        HOMEPOINT_SET                 = 7582, -- Home point set!
    },
    mob =
    {
