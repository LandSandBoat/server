...
zones[xi.zone.DYNAMIS_QUFIM] =
{
    text =
    {
        ...
        DYNAMIS_TIME_BEGIN            = 7335, -- The sands of the <item> have begun to fall. You have <number> minutes (Earth time) remaining in Dynamis.
        DYNAMIS_TIME_EXTEND           = 7336, -- Your stay in Dynamis has been extended by <number> minute[/s].
        DYNAMIS_TIME_UPDATE_1         = 7337, -- You will be expelled from Dynamis in <number> [second/minute] (Earth time).
        DYNAMIS_TIME_UPDATE_2         = 7338, -- You will be expelled from Dynamis in <number> [seconds/minutes] (Earth time).
        DYNAMIS_TIME_EXPIRED          = 7340, -- The sands of the hourglass have emptied...
        DYNAMIS_SUB_UNLOCKED          = 7345, -- Memories of skills long forgotten come flooding back to you...
        OMINOUS_PRESENCE              = 7352, -- You feel an ominous presence, as if something might happen if you possessed <item>.
    },
    mob =
    {
        TIME_EXTENSION =
