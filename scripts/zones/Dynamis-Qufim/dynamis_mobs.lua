...
-- Sea Monk NM Area
xi.dynamis.mobList[zoneID][43 ].info = {nil, "Water Elemental", nil, nil, nil}           -- (043) (Reduces Antaeus' resistance to water)
xi.dynamis.mobList[zoneID][40 ].info = {"NM", "Scolopendra", nil, nil, nil}              -- (040) (Reduces Antaeus' HP regeneration rate)
-- Southwest Area
xi.dynamis.mobList[zoneID][44 ].info = {nil, "Fire Elemental", nil, nil, nil}            -- (044) (Reduces Antaeus' resistance to fire)
-- Giant Bat Area
xi.dynamis.mobList[zoneID][45 ].info = {nil, "Thunder Elemental", nil, nil, nil}         -- (045) (Reduces Antaeus' resistance to thunder)
xi.dynamis.mobList[zoneID][41 ].info = {"NM", "Stringes", nil, nil, nil}                 -- (041) (Reduces Antaeus' physical attack damage)
-- Northeast Area
xi.dynamis.mobList[zoneID][46 ].info = {nil, "Air Elemental", nil, nil, nil}             -- (046) (Reduces Antaeus' resistance to wind)
xi.dynamis.mobList[zoneID][47 ].info = {nil, "Light Elemental", nil, nil, nil}           -- (047) (Reduces Antaeus' resistance to light)
-- Boss Area
xi.dynamis.mobList[zoneID][48 ].info = {nil, "Ice Elemental", nil, nil, nil}             -- (048) (Reduces Antaeus' resistance to ice)
xi.dynamis.mobList[zoneID][64 ].info = {"NM", "Antaeus", nil, nil, "MegaBoss_Killed"}    -- (064) (Spawns 065-138)
-- Golem NM Area
xi.dynamis.mobList[zoneID][49 ].info = {nil, "Earth Elemental", nil, nil, nil}           -- (049) (Reduces Antaeus' resistance to earth)
xi.dynamis.mobList[zoneID][50 ].info = {nil, "Dark Elemental", nil, nil, nil}            -- (050) (Reduces Antaeus' resistance to dark)
...
xi.dynamis.mobList[zoneID][1  ].pos = { -260.608, -19.032, 43.783, 6    } -- Adamantking Effigy      (001-Q)
xi.dynamis.mobList[zoneID][2  ].pos = { -249.283, -19.988, 45.831, 6    } -- Adamantking Effigy      (002-Q)
xi.dynamis.mobList[zoneID][3  ].pos = { -207.631, -19.944, 106.263, 28  } -- Adamantking Effigy      (003-Q)
xi.dynamis.mobList[zoneID][4  ].pos = { -193.663, -19.635, 131.329, 68  } -- Adamantking Effigy      (004-Q)
xi.dynamis.mobList[zoneID][5  ].pos = { -205.758, -20.089, 162.879, 203 } -- Adamantking Effigy      (005-Q)
xi.dynamis.mobList[zoneID][6  ].pos = { -118.681, 20.019, 195.651, 27   } -- Adamantking Effigy      (006-Q)
xi.dynamis.mobList[zoneID][7  ].pos = { -116.667, -19.829, 207.454, 48  } -- Adamantking Effigy      (007-Q)
xi.dynamis.mobList[zoneID][8  ].pos = { -1.307, -19.138, -17.269, 129   } -- Manifest Icon           (008-Y)
xi.dynamis.mobList[zoneID][9  ].pos = { 13.437, -20.824, -21.301, 128   } -- Manifest Icon           (009-Y)
xi.dynamis.mobList[zoneID][10 ].pos = { 37.826, -19.383, -14.216, 237   } -- Manifest Icon           (010-Y)
xi.dynamis.mobList[zoneID][11 ].pos = { 60.955, -19.612, 11.245, 81     } -- Manifest Icon           (011-Y)
xi.dynamis.mobList[zoneID][12 ].pos = { 81.461, -19.891, 6.198, 107     } -- Manifest Icon           (012-Y)
xi.dynamis.mobList[zoneID][13 ].pos = { 93.956, -20.051, -14.926, 137   } -- Manifest Icon           (013-Y)
xi.dynamis.mobList[zoneID][14 ].pos = { 109.566, -19.994, -6.029, 113   } -- Manifest Icon           (014-Y)
xi.dynamis.mobList[zoneID][15 ].pos = { 121.584, -20.000, 0.963, 180    } -- Manifest Icon           (015-Y)
xi.dynamis.mobList[zoneID][16 ].pos = { 140.120, -19.025, 75.671, 154   } -- Serjeant Tombstone      (016-O)
xi.dynamis.mobList[zoneID][17 ].pos = { 138.601, -19.895, 65.463, 165   } -- Serjeant Tombstone      (017-O)
xi.dynamis.mobList[zoneID][18 ].pos = { 151.705, -19.830, 68.108, 146   } -- Serjeant Tombstone      (018-O)
xi.dynamis.mobList[zoneID][19 ].pos = { 101.349, -20.176, 150.119, 38   } -- Serjeant Tombstone      (019-O)
xi.dynamis.mobList[zoneID][20 ].pos = { 111.338, -19.739, 150.965, 48   } -- Serjeant Tombstone      (020-O)
xi.dynamis.mobList[zoneID][21 ].pos = { 55.335, -19.323, 234.979, 79    } -- Serjeant Tombstone      (021-O)
xi.dynamis.mobList[zoneID][22 ].pos = { 56.364, -20.275, 249.147, 44    } -- Serjeant Tombstone      (022-O)
xi.dynamis.mobList[zoneID][23 ].pos = { 0.556, -20.427, 242.431, 50     } -- Serjeant Tombstone      (023-O)
xi.dynamis.mobList[zoneID][24 ].pos = { 1.133, -19.029, 260.556, 129    } -- Serjeant Tombstone      (024-O)
xi.dynamis.mobList[zoneID][25 ].pos = { -91.348, -19.634, 242.081, 171  } -- Goblin Replica          (025-G)
xi.dynamis.mobList[zoneID][26 ].pos = { -85.062, -19.723, 267.683, 91   } -- Goblin Replica          (026-G)
xi.dynamis.mobList[zoneID][27 ].pos = { -216.469, -19.178, 319.638, 255 } -- Goblin Replica          (027-G)
xi.dynamis.mobList[zoneID][28 ].pos = { -254.048, -20.000, 300.553, 224 } -- Goblin Replica          (028-G)
xi.dynamis.mobList[zoneID][29 ].pos = { -256.694, -20.000, 313.411, 231 } -- Goblin Replica          (029-G)
xi.dynamis.mobList[zoneID][30 ].pos = { -253.725, -20.000, 329.286, 9   } -- Goblin Replica          (030-G)
xi.dynamis.mobList[zoneID][31 ].pos = { -250.551, -19.933, 341.246, 43  } -- Goblin Replica          (031-G)
xi.dynamis.mobList[zoneID][32 ].pos = { -288.097, -11.721, 475.140, 225 } -- Goblin Replica          (032-G)
xi.dynamis.mobList[zoneID][33 ].pos = { -312.791, -11.762, 483.752, 247 } -- Goblin Replica          (033-G)
xi.dynamis.mobList[zoneID][34 ].pos = { -546.876, -8.836, 416.088, 8    } -- Goblin Replica          (034-G)
xi.dynamis.mobList[zoneID][35 ].pos = { -550.221, -7.494, 422.123, 13   } -- Goblin Replica          (035-G)
xi.dynamis.mobList[zoneID][36 ].pos = { 174.031, 20.747, -202.030, 204  } -- Goblin Replica          (036-G)
xi.dynamis.mobList[zoneID][37 ].pos = { 163.990, 20.081, -208.679, 232  } -- Goblin Replica          (037-G)
xi.dynamis.mobList[zoneID][38 ].pos = { 140.386, 17.982, -431.949, 214  } -- Goblin Replica          (038-G)
xi.dynamis.mobList[zoneID][39 ].pos = { 142.936, 18.121, -436.945, 196  } -- Goblin Replica          (039-G)
xi.dynamis.mobList[zoneID][65 ].pos = { -108.072, -20.30, 191.006, 154  } -- Goblin Replica          (065-G)
xi.dynamis.mobList[zoneID][66 ].pos = { -112.225, -20.560, 188.736, 160 } -- Goblin Replica          (066-G)
xi.dynamis.mobList[zoneID][67 ].pos = { -77.407, -19.770, 19.093, 134   } -- Goblin Replica          (067-G)
xi.dynamis.mobList[zoneID][68 ].pos = { -59.591, -19.733, -2.097, 34    } -- Goblin Replica          (068-G)
xi.dynamis.mobList[zoneID][69 ].pos = { 21.350, -19.769, 187.950, 155   } -- Goblin Replica          (069-G)
xi.dynamis.mobList[zoneID][70 ].pos = { -2.647, -20.584, 191.007, 239   } -- Goblin Replica          (070-G)
xi.dynamis.mobList[zoneID][71 ].pos = { -44.788, -20.040, 122.724, 162  } -- Goblin Replica          (071-G)
xi.dynamis.mobList[zoneID][72 ].pos = { -45.871, -20.082, 75.716, 94    } -- Goblin Replica          (072-G)
xi.dynamis.mobList[zoneID][73 ].pos = { 5.245, -20.007, 125.149, 223    } -- Goblin Replica          (073-G)
xi.dynamis.mobList[zoneID][74 ].pos = { -7.265, -18.019, 101.000, 9     } -- Goblin Replica          (074-G)
xi.dynamis.mobList[zoneID][75 ].pos = { -18.812, -17.300, 104.154, 9    } -- Goblin Replica          (075-G)
...
xi.dynamis.mobList[zoneID][48 ].pos = { -221.369, -19.805, 437.399, 56  } -- Ice Elemental           (048)
...
xi.dynamis.mobList[zoneID][40 ].pos = { -264.477, -3.417, 24.961, 60    } -- Scolopendra             ( 040 )
xi.dynamis.mobList[zoneID][41 ].pos = { 149.787, 21.221, -409.158, 185  } -- Stringes                ( 041 )
xi.dynamis.mobList[zoneID][64 ].pos = { -257.040, -20.000, 319.628, 254 } -- Antaeus                 ( 064 )
xi.dynamis.mobList[zoneID][42 ].pos = { -535.544, -13.042, 386.895, 51  } -- Suttung                 ( 042 )
xi.dynamis.mobList[zoneID][43 ].pos = { -278.296, -19.902, 74.020, 57   } -- Water Elemental         ( 043 )
xi.dynamis.mobList[zoneID][44 ].pos = { 19.150, -19.260, -86.259, 193   } -- Fire Elemental          ( 044 )
xi.dynamis.mobList[zoneID][45 ].pos = { 158.148, 20.219, -230.048, 184  } -- Thunder Elemental       ( 045 )
xi.dynamis.mobList[zoneID][46 ].pos = { 163.632, -19.481, 133.232, 94   } -- Air Elemental           ( 046 )
xi.dynamis.mobList[zoneID][47 ].pos = { 29.825, -19.906, 288.771, 77    } -- Light Elemental         ( 047 )
xi.dynamis.mobList[zoneID][48 ].pos = { -214.001, -19.742, 392.671, 60  } -- Ice Elemental           ( 048 )
xi.dynamis.mobList[zoneID][49 ].pos = { -338.197, -12.949, 531.737, 70  } -- Earth Elemental         ( 049 )
xi.dynamis.mobList[zoneID][50 ].pos = { -428.031, -12.956, 337.849, 136 } -- Dark Elemental          ( 050 )
...
xi.dynamis.mobList[zoneID][25 ].eyes = xi.dynamis.eyes.BLUE
xi.dynamis.mobList[zoneID][26 ].eyes = xi.dynamis.eyes.GREEN
xi.dynamis.mobList[zoneID][27 ].eyes = xi.dynamis.eyes.BLUE
