...
entity.onTrigger = function(player, npc)
    ...
    elseif expertQuestStatus == 550 then
        ...
        --]]
        player:showText(npc, ID.text.FAULPIE_EXPERT_BASE, 0, xi.keyItem.WAY_OF_THE_TANNER)
        player:showText(npc, ID.text.FAULPIE_EXPERT_ALT, testItem)
        player:showText(npc, ID.text.FAULPIE_EXPERT_BASE + 2)
    else
