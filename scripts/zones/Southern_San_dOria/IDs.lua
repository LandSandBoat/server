...
zones[xi.zone.SOUTHERN_SAN_DORIA] =
{
    text =
    {
        ...
        FAULPIE_EXPERT_ALT             = 6849,  -- I can see you are ready to move on. I want you to make me <item>.
        FAULPIE_EXPERT_BASE            = 7027,  -- Now here's a [man/woman] who knows the contents of <key item>.
