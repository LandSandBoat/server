...
zones[xi.zone.ABYSSEA_ALTEPA] =
{
    text =
    {
        ...
        OBTAINS_DOMINION_NOTES        = 7883,  -- <name> obtains <number> Dominion note[/s] (Total: <number>).
        DOMINION_SIGNED_ON            = 10418, -- You have signed on for Dominion Ops!
        CANCELED_OBJECTIVE            = 10419, -- You have canceled your objective.
    },
    mob =
    {
