...
zones[xi.zone.ABYSSEA_ALTEPA] =
{
    ...
    mob =
    {
        RANI_1              = GetFirstID("Rani"),
        ORTHUS_1            = GetFirstID("Orthrus"),
        DRAGUA_1            = GetFirstID("Dragua"),
        BENNU_1             = GetFirstID("Bennu"),
        RANI_2              = GetFirstID("Rani") + 4,
        ORTHUS_2            = GetFirstID("Orthrus") + 4,
        DRAGUA_2            = GetFirstID("Dragua") + 4,
        BENNU_2             = GetFirstID("Bennu") + 4,
        RANI_3              = GetFirstID("Rani") + 8,
        ORTHUS_3            = GetFirstID("Orthrus") + 8,
        DRAGUA_3            = GetFirstID("Dragua") + 8,
        BENNU_3             = GetFirstID("Bennu") + 8,
