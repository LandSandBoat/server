...
zones[xi.zone.PORT_WINDURST] =
{
    text =
    {
        ...
        GP_OBTAINED                     = 11740, -- Obtained: <number> guild points.
        NOT_HAVE_ENOUGH_GP              = 11741, -- You do not have enough guild points.
        RYAN_SHOP_DIALOG                = 11855, -- I have no time for white-livered scum that rely on magic alone. If you're with me then check out these wares from across the high seas.
        DROZGA_SHOP_DIALOG              = 11856, -- Ho there, young [man/lady]! Not only is Ryan a boorish lout, but his craftsmanship leaves much to be desired, as well. You're better off buyin' from me.
        CONQUEST                        = 11922, -- You've earned conquest points!
        KOHLO_LAKOLO_DIALOG_A           = 12465, -- On your Star Onion Brigade honor, you can't tell anybody that Joker is hiding in the ghosty house!
        LEBONDUR_OPEN_DIALOG            = 12576, -- I've risked my life traveling all the way from Vollbow to bring you these fine goods!
        LEBONDUR_CLOSED_DIALOG          = 12577, -- Where is my shipment from Vollbow? This is terrible for my image as a respected importer...
        SATTSUHAHKANPARI_OPEN_DIALOG    = 12578, -- You can look, but don't touch! And rememberrr, you break it, you bought it!
        SATTSUHAHKANPARI_CLOSED_DIALOG  = 12579, -- You've heard of the Elshimo Uplands, haven't you? Well, if you'll hold on a minute, I'll have a shipment of goods coming in any time now.
        BLACK_HALO_LEARNED              = 12675, -- You have learned the weapon skill Black Halo!
        KUCHAMALKOBHI_SHOP_DIALOG       = 12724, -- How about a nice suit of adventurer-issue armorrr? Be careful though. We offer no rrrefunds!
        ALIZABE_OPEN_DIALOG             = 12904, -- Don't tell anybody, but I've managed to get my hands on some items from Tavnazia! Take a look!
        ALIZABE_CLOSED_DIALOG           = 12905, -- Pssst! Have you heard of Tavnazia? Boy, do they have some sweet items on those islands...
        ALIZABE_COP_NOT_COMPLETED       = 12906, -- It won't be long before I set up shop right here in this very place. And once I start, there won't be no stoppin' me!
