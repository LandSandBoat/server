...
zones[xi.zone.HALVUNG] =
{
    text =
    {
        ...
        WIDE_TRENCH                   = 7909, -- There is a wide trench around the gate here. There are three keyholes of differing sizes inside the trench.
        MINING_IS_POSSIBLE_HERE       = 7932, -- Mining is possible here if you have <item>.
        BLUE_FLAMES                   = 7971, -- You can see blue flames flickering from a hole in the ground here...
        SICKLY_SWEET                  = 8023, -- A sickly sweet fragrance pervades the air...
        THIN_LAYER_OF_CINDER          = 8030, -- The ground is carpeted in a thin layer of cinder.
        DRAWS_NEAR                    = 8045, -- Something draws near!
        DULL_PIECE                    = 8046, -- A dull piece of metal lies on the ground. It appears to be a bracelet of sorts, but the layers of grime covering its surface render it wholly unwearable.
        LIFT_LEVER                    = 8049, -- You lift the lever with all your might!
