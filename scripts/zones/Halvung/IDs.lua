...
zones[xi.zone.HALVUNG] =
{
    text =
    {
        ...
        PARTY_MEMBERS_HAVE_FALLEN     = 7789, -- All party members have fallen in battle. Now leaving the battlefield.
        THE_PARTY_WILL_BE_REMOVED     = 7796, -- If all party members' HP are still zero after # minute[/s], the party will be removed from the battlefield.
        ...
        SICKLY_SWEET                  = 8020, -- A sickly sweet fragrance pervades the air...
        THIN_LAYER_OF_CINDER          = 8027, -- The ground is carpeted in a thin layer of cinder.
