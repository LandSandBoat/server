...
zones[xi.zone.HALVUNG] =
{
    text =
    {
        ...
        SICKLY_SWEET                  = 8056, -- A sickly sweet fragrance pervades the air...
        THIN_LAYER_OF_CINDER          = 8063, -- The ground is carpeted in a thin layer of cinder.
        DRAWS_NEAR                    = 8078, -- Something draws near!
        DULL_PIECE                    = 8079, -- A dull piece of metal lies on the ground. It appears to be a bracelet of sorts, but the layers of grime covering its surface render it wholly unwearable.
        LIFT_LEVER                    = 8082, -- You lift the lever with all your might!
        UNITY_WANTED_BATTLE_INTERACT  = 8121, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
