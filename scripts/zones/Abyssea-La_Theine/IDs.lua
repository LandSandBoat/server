...
zones[xi.zone.ABYSSEA_LA_THEINE] =
{
    ...
    mob =
    {
        ...
        BRIAREUS_1              = GetFirstID("Briareus"),
        CARABOSSE_1             = GetFirstID("Carabosse"),
        HADHAYOSH_1             = GetFirstID("Hadhayosh"),
        BRIAREUS_2              = GetFirstID("Briareus") + 10,
        CARABOSSE_2             = GetFirstID("Carabosse") + 10,
        HADHAYOSH_2             = GetFirstID("Hadhayosh") + 10,
        BRIAREUS_3              = GetFirstID("Briareus") + 13,
        CARABOSSE_3             = GetFirstID("Carabosse") + 13,
        HADHAYOSH_3             = GetFirstID("Hadhayosh") + 13,
    },
    npc =
    {
        QM_POPS =
