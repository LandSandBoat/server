...
local titleInfo =
{
    ...
    },
    {
        ...
        title =
        {
            ...
            xi.title.FAKEMOUSTACHED_INVESTIGATOR,
    ...
    },
    {
        ...
        title =
        {
            xi.title.HAKKURURINKURUS_BENEFACTOR,
            xi.title.SPOILSPORT,
            ...
            xi.title.DOWN_PIPER_PIPEUPPERER,
            xi.title.DOCTOR_YORANORAN_SUPPORTER,
            xi.title.DOCTOR_SHANTOTTO_SUPPORTER,
            xi.title.PROFESSOR_KORUMORU_SUPPORTER,
            xi.title.STARORDAINED_WARRIOR,
