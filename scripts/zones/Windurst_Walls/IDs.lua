...
zones[xi.zone.WINDURST_WALLS] =
{
    text =
    {
        ...
        RECEIVE_BAYLD                  = 7100,  -- You receive <number> bayld!
        ...
        RECEIVED_CONQUEST_POINTS       = 8446,  -- You received <number> conquest points!
        ...
        IMPERIAL_STANDING_INCREASED    = 9648,  -- Your Imperial Standing has increased!
        EARNED_ALLIED_NOTES            = 9649,  -- You have earned <number> Allied Note[/s]!
        OBTAINED_GUILD_POINTS          = 9650,  -- Obtained: <number> guild points.
