...
zones[xi.zone.WINDURST_WALLS] =
{
    text =
    {
        ...
        FULL_INVENTORY_AFTER_TRADE     = 6550,  -- You cannot obtain the <item>. Try trading again after sorting your inventory.
        ...
        ITEMS_OBTAINED                 = 6563,  -- You obtain <number> <item>!
        ITEM_RETURNED                  = 6566,  -- The <item> is returned to you.
        ...
        ITEM_DELIVERY_DIALOG           = 7003,  -- We can deliver goods to your residence or to the residences of your friends.
        ...
        RETRIBUTION_LEARNED            = 9104,  -- You have learned the weapon skill Retribution!
        YOU_CANNOT_ENTER_DYNAMIS       = 9127,  -- You cannot enter Dynamis - [Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia] for <number> [day/days] (Vana'diel time).
        PLAYERS_HAVE_NOT_REACHED_LEVEL = 9129,  -- Players who have not reached level <number> are prohibited from entering Dynamis.
        DYNA_NPC_DEFAULT_MESSAGE       = 9141,  -- The strands of grass here have been tied together.
        ...
        LINK_CONCIERGE_ONE_PER_DAY     = 11261, -- In the interest of fairness, I am unable to distribute multiple linkpearls to someone on the same day. Please come back tomorrow.
        LINK_CONCIERGE_REGISTERED      = 11318, -- Your registration is officially complete.
        LINK_CONCIERGE_REGISTERED_2    = 11319, -- May your journeys lead you to many as-yet-unmet friends, and may the bonds you forge last a lifetime.
        LINK_CONCIERGE_LS_TAKEN        = 11320, -- Another member of that linkshell currently has an active registration. Please wait until that registration expires and try again.
    },
    mob =
    {
    },
