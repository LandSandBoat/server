...
zones[xi.zone.WINDURST_WALLS] =
{
    text =
    {
        ...
        DOORS_SEALED_SHUT              = 7770,  -- The doors are firmly sealed shut.
        MOGHOUSE_EXIT                  = 8227,  -- You have learned your way through the back alleys of Windurst! Now you can exit to any area from your residence.
        RECEIVED_CONQUEST_POINTS       = 8455,  -- You received <number> conquest points!
        SCAVNIX_SHOP_DIALOG            = 8711,  -- <Pshoooooowaaaaa> I'm goood Goblin from underwooorld.  I find lotshhh of gooodieshhh.  You want try shhhome chipshhh? Cheap for yooou.
        RETRIBUTION_LEARNED            = 9099,  -- You have learned the weapon skill Retribution!
        YOU_CANNOT_ENTER_DYNAMIS       = 9122,  -- You cannot enter Dynamis - [Dummy/San d'Oria/Bastok/Windurst/Jeuno/Beaucedine/Xarcabard/Valkurm/Buburimu/Qufim/Tavnazia] for <number> [day/days] (Vana'diel time).
        PLAYERS_HAVE_NOT_REACHED_LEVEL = 9124,  -- Players who have not reached level <number> are prohibited from entering Dynamis.
        DYNA_NPC_DEFAULT_MESSAGE       = 9136,  -- The strands of grass here have been tied together.
        IMPERIAL_STANDING_INCREASED    = 9657,  -- Your Imperial Standing has increased!
        EARNED_ALLIED_NOTES            = 9658,  -- You have earned <number> Allied Note[/s]!
        OBTAINED_GUILD_POINTS          = 9659,  -- Obtained: <number> guild points.
        TEAR_IN_FABRIC_OF_SPACE        = 10872, -- There appears to be a tear in the fabric of space...
        UNABLE_RACE_CHANGE             = 11509, -- You were unable to use the specified appearance for your character.
    },
    mob =
    {
    },
