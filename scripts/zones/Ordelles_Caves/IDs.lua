...
zones[xi.zone.ORDELLES_CAVES] =
{
    text =
    {
        ...
        A_SQUIRES_TEST_II_DIALOG_I    = 7367,  -- You place your hands into the pool.
        A_SQUIRES_TEST_II_DIALOG_II   = 7370,  -- The dew from the stalactite slips through your fingers.
        A_SQUIRES_TEST_II_DIALOG_III  = 7371,  -- You have already obtained the dew.
