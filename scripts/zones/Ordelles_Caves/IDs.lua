...
zones[xi.zone.ORDELLES_CAVES] =
{
    text =
    {
        ...
        RUILLONT_INITIAL_DIALOG       = 7352,  -- Confound it! If I only had my sword, I'd cut through these fiends single-handedly...
        A_SQUIRE_S_TEST_II_DIALOG_I   = 7363,  -- You place your hands into the pool.
        A_SQUIRE_S_TEST_II_DIALOG_II  = 7366,  -- The dew from the stalactite slips through your fingers.
        A_SQUIRE_S_TEST_II_DIALOG_III = 7367,  -- You have already obtained the dew.
        CHEST_UNLOCKED                = 7399,  -- You unlock the chest!
        GERWITZS_AXE_DIALOG           = 7421,  -- Mine axe shall rend thy throat!
        GERWITZS_SWORD_DIALOG         = 7422,  -- Mine sword shall pierce thy tongue!
        GERWITZS_SOUL_DIALOG          = 7423,  -- Long have I waited. I will tell all...
