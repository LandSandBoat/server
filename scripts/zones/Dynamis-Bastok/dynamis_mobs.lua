----------------------------------------------------------------------------------------------------
--                                      Dynamis-Bastok                                            --
--              Primary Source of Information: https://enedin.be/dyna/html/zoneID/bas.htm           --
...
--
-- 3. Setup wave spawning requirements. This is handled through a localvar set on the zoneID based on
--    the onMobDeath() function of the NM. By default this will only be the MegaBoss.
--    xi.dynamis.mobList[zoneID].waveDefeatRequirements[2] = {zoneID:getLocalVar("MegaBoss_Killed") == 1}
--
...
-- xi.dynamis.mobList[zoneID][8  ].patrolPath = { home.x, home.y, home.z,     dest.x,  dest.y, dest.z,    spawn.x,   spawn.y, spawn.z  }    -- Entrance Bridge W

xi.dynamis.mobList[zoneID].patrolPaths = {6, 35, 11, 21, 14, 12, 9, 34, 25, 32, 58, 60, 61, 59, 61, 63, 62, 75, 76, 70, 71, 47, 49, 50, 104, 102 }
...
xi.dynamis.mobList[zoneID][58 ].patrolPath = {  -78,    0,    4,    -70,    0,    9, 1, 1 ,1 } -- W1 Under Bridge NE
xi.dynamis.mobList[zoneID][60 ].patrolPath = {  -78,    0,   -4,    -70,    0,   -9, 0, 0, 0 } -- W1 Under Bridge SE
