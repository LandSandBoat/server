...
zones[xi.zone.WINDURST_WATERS_S] =
{
    text =
    {
        ...
        PELFTRIX_SHOP_DIALOG          = 7220,  -- Boodlix's Emporium open for business! Boodlix's gots whats you wants, at the price yous likes! It's okay, we takes yours gils, too!
        MOG_LOCKER_OFFSET             = 7485,  -- Your Mog Locker lease is valid until <timestamp>, kupo.
        REGIME_CANCELED               = 7755,  -- Current training regime canceled.
        HUNT_ACCEPTED                 = 7773,  -- Hunt accepted!
        USE_SCYLDS                    = 7774,  -- You use <number> [scyld/scylds]. Scyld balance: <number>.
        HUNT_RECORDED                 = 7785,  -- You record your hunt.
        OBTAIN_SCYLDS                 = 7787,  -- You obtain <number> [scyld/scylds]! Current balance: <number> [scyld/scylds].
        HUNT_CANCELED                 = 7791,  -- Hunt canceled.
        ...
        POGIGI_TURN_IN                = 13426, -- Just as we suspected. This contains a great deal of information that will prove vital to our cause. Hm, what's this? Not sure what to make of this... Doesn't seem to be terribly important. Here, why don't you hang onto it? See if you can't get some use out of it down the road.
        RETRIEVE_DIALOG_ID            = 15003, -- You retrieve <item> from the porter moogle's care.
        NOT_ENOUGH_NOTES              = 15028, -- You tryin' to cheat me? That's not nearly enough notes!
        COMMON_SENSE_SURVIVAL         = 15064, -- It appears that you have arrived at a new survival guide provided by the Servicemen's Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
    },
