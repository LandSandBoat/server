...
zones[xi.zone.CHAMBER_OF_ORACLES] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR     = 7609, -- Entering the battlefield for [Through the Quicksand Caves/Legion XI Comitatensis/Shattering Stars (SAM)/Shattering Stars (NIN)/Shattering Stars (DRG)/Cactuar Suave/Eye of the Storm/The Scarlet King/Roar! A Cat Burglar Bares Her Fangs/Dragon Scales/★Legion XI Comitatensis]!
        PLACED_INTO_THE_PEDESTAL         = 7644, -- It appears that something should be placed into this pedestal.
        ...
        DOOR_IS_FIRMLY_SHUT              = 7648, -- The door is firmly shut.
        YOU_DECIDED_TO_SHOW_UP           = 7666, -- So, you decided to show up. Now it's time to see what you're really made of, heh heh heh.
        LOOKS_LIKE_YOU_WERENT_READY      = 7667, -- Looks like you weren't ready for me, were you? Now go home, wash your face, and come back when you think you've got what it takes.
        YOUVE_COME_A_LONG_WAY            = 7668, -- Hm. That was a mighty fine display of skill there, <name>. You've come a long way...
        TEACH_YOU_TO_RESPECT_ELDERS      = 7669, -- I'll teach you to respect your elders!
        TAKE_THAT_YOU_WHIPPERSNAPPER     = 7670, -- Take that, you whippersnapper!
        NOW_THAT_IM_WARMED_UP            = 7671, -- Now that I'm warmed up...
        THAT_LL_HURT_IN_THE_MORNING      = 7672, -- Ungh... That'll hurt in the morning...
    },
    mob =
    {
