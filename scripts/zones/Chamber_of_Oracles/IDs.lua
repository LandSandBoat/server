...
zones[xi.zone.CHAMBER_OF_ORACLES] =
{
    text =
    {
        ...
        PLACED_INTO_THE_PEDESTAL         = 7625, -- It appears that something should be placed into this pedestal.
        YOU_PLACE_THE                    = 7626, -- You place the <item> into the pedestal.
        IS_SET_IN_THE_PEDESTAL           = 7627, -- The <item> is set in the pedestal.
        HAS_LOST_ITS_POWER               = 7628, -- The <item> has lost its power.
