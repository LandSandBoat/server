...
zones[xi.zone.CHAMBER_OF_ORACLES] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY             = 7249, -- A mysterious force is sealing the platform.
        ...
        ENTERING_THE_BATTLEFIELD_FOR     = 7603, -- Entering the battlefield for [Through the Quicksand Caves/Legion XI Comitatensis/Shattering Stars (SAM)/Shattering Stars (NIN)/Shattering Stars (DRG)/Cactuar Suave/Eye of the Storm/The Scarlet King/Roar! A Cat Burglar Bares Her Fangs/Dragon Scales/Legion XI Comitatensis]!
        PLACED_INTO_THE_PEDESTAL         = 7638, -- It appears that something should be placed into this pedestal.
        YOU_PLACE_THE                    = 7639, -- You place the <item> into the pedestal.
        IS_SET_IN_THE_PEDESTAL           = 7640, -- The <item> is set in the pedestal.
        HAS_LOST_ITS_POWER               = 7641, -- The <item> has lost its power.
        DOOR_IS_FIRMLY_SHUT              = 7642, -- The door is firmly shut.
        YOU_DECIDED_TO_SHOW_UP           = 7660, -- So, you decided to show up. Now it's time to see what you're really made of, heh heh heh.
        LOOKS_LIKE_YOU_WERENT_READY      = 7661, -- Looks like you weren't ready for me, were you? Now go home, wash your face, and come back when you think you've got what it takes.
        YOUVE_COME_A_LONG_WAY            = 7662, -- Hm. That was a mighty fine display of skill there, <name>. You've come a long way...
        TEACH_YOU_TO_RESPECT_ELDERS      = 7663, -- I'll teach you to respect your elders!
        TAKE_THAT_YOU_WHIPPERSNAPPER     = 7664, -- Take that, you whippersnapper!
        NOW_THAT_IM_WARMED_UP            = 7665, -- Now that I'm warmed up...
        THAT_LL_HURT_IN_THE_MORNING      = 7666, -- Ungh... That'll hurt in the morning...
    },
    mob =
    {
