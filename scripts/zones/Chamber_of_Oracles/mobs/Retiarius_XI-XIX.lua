...
local enfeebleTable =
{
    [1] = { xi.magic.spell.FROST,       xi.effect.FROST     },
    [2] = { xi.magic.spell.DROWN,       xi.effect.DROWN     },
    [3] = { xi.magic.spell.RASP,        xi.effect.RASP      },
    [4] = { xi.magic.spell.POISONGA_II, xi.effect.POISON    },
    [5] = { xi.magic.spell.BIO_II,      xi.effect.BIO       },
