...
zones[xi.zone.YUHTUNGA_JUNGLE] =
{
    text =
    {
        ...
        FLOWER_BLOOMING             = 7663,  -- A large flower is blooming.
        FOUND_NOTHING_IN_FLOWER     = 7666,  -- You find nothing inside the flower.
        FEEL_DIZZY                  = 7667,  -- You feel slightly dizzy. You must have breathed in too much of the pollen.
        ...
        LOGGING_IS_POSSIBLE_HERE    = 7704,  -- Logging is possible here if you have <item>.
