...
zones[xi.zone.YUHTUNGA_JUNGLE] =
{
    text =
    {
        ...
        FLOWER_BLOOMING               = 7674,  -- A large flower is blooming.
        FOUND_NOTHING_IN_FLOWER       = 7677,  -- You find nothing inside the flower.
        FEEL_DIZZY                    = 7678,  -- You feel slightly dizzy. You must have breathed in too much of the pollen.
        SOMETHING_BETTER              = 7691,  -- Don't you have something better to do right now?
        CANNOT_REMOVE_FRAG            = 7694,  -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
        ALREADY_OBTAINED_FRAG         = 7695,  -- You have already obtained this monument's <keyitem>. Try searching for another.
        ALREADY_HAVE_ALL_FRAGS        = 7696,  -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
        FOUND_ALL_FRAGS               = 7697,  -- You have obtained <keyitem>! You now have all 8 fragments of light!
        ZILART_MONUMENT               = 7698,  -- It is an ancient Zilart monument.
        TOUCHING_RED_JEWEL            = 7700,  -- Touching the red jewel has infuriated the Opo-opos of the forest. It would be wise to leave immediately.
        THE_OPO_OPOS_ATTACK           = 7714,  -- The Opo-opos attack!
        LOGGING_IS_POSSIBLE_HERE      = 7715,  -- Logging is possible here if you have <item>.
        HARVESTING_IS_POSSIBLE_HERE   = 7722,  -- Harvesting is possible here if you have <item>.
        ...
        TIME_ELAPSED                  = 7857,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
        ...
        UNITY_WANTED_BATTLE_INTERACT  = 7948,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
