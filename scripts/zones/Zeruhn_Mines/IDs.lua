...
zones[xi.zone.ZERUHN_MINES] =
{
    text =
    {
        ...
        MAKARIM_DIALOG_I              = 7333,  -- Be careful on your way out. Remember, you should give my report to Naji, one of the Mythril Musketeers on post at the President's Office.
        ZELMAN_CANT_RUN_AROUND        = 7358,  -- I can't run around doing everything she tells me to--I have my dignity to uphold!
        MINING_IS_POSSIBLE_HERE       = 7365,  -- Mining is possible here if you have <item>.
        PLAYER_OBTAINS_ITEM           = 7422,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7423,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7424,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7425,  -- You already possess that temporary item.
        NO_COMBINATION                = 7430,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 9508,  -- New training regime registered!
