...
zones[xi.zone.MISAREAUX_COAST] =
{
    text =
    {
        ...
        DOOR_CLOSED                   = 7368, -- The door is locked tight.
        SNOWMINT_POINT_LOCKED         = 7371, -- This gate leads to Snowmint Point. However, it seems to be locked...
        BEEP_BEEP                     = 7593, -- Beep...beep...beep...beep...
        BEEP_CLICK_WHIR               = 7594, -- Beeeep. Click, whirrr...
        BUZZ_BEEP_BEEP                = 7595, -- Buzz... Beep beep!
        FOUL_STENCH_OF_DEATH          = 7596, -- You sense the foul stench of death...
        CREATURE_HAS_APPEARED         = 7620, -- A creature has appeared out of nowhere!
        NOTHING_ELSE_OF_INTEREST      = 7621, -- There is nothing else of interest here.
        LOGGING_IS_POSSIBLE_HERE      = 7622, -- Logging is possible here if you have <item>.
        A_SHATTERED_SHIELD            = 7676, -- The ground here is littered with the pieces of a shattered shield...
        SNATCHED_AWAY                 = 7677, -- The <item> is suddenly snatched away!
        DROP_OF_OIL                   = 7679, -- A drop of oil trickles down the cheek of the mannequin.
        LARGE_DROPS_OF_OIL            = 7680, -- Large drops of oil begin pouring from the eyes on the mannequin.
        NOTHING_HERE_YET              = 7681, -- There is nothing here yet. Check again in the morning.
        ALREADY_BAITED                = 7682, -- The trap already contains <item>.
        APPEARS_TO_BE_TRAP            = 7683, -- There appears to be some kind of trap here. Bits of fish are lying around the area.
        DID_NOT_CATCH_ANYTHING        = 7684, -- You did not catch anything.
        PUT_IN_TRAP                   = 7685, -- You put <item> in the trap.
        ...
        HOMEPOINT_SET                 = 8879, -- Home point set!
    },
    mob =
    {
