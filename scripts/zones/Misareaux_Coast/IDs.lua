...
zones[xi.zone.MISAREAUX_COAST] =
{
    text =
    {
        ...
        BEEP_BEEP                     = 7597, -- Beep...beep...beep...beep...
        BEEP_CLICK_WHIR               = 7598, -- Beeeep. Click, whirrr...
        BUZZ_BEEP_BEEP                = 7599, -- Buzz... Beep beep!
        FOUL_STENCH_OF_DEATH          = 7600, -- You sense the foul stench of death...
        CREATURE_HAS_APPEARED         = 7624, -- A creature has appeared out of nowhere!
        NOTHING_ELSE_OF_INTEREST      = 7625, -- There is nothing else of interest here.
        LOGGING_IS_POSSIBLE_HERE      = 7626, -- Logging is possible here if you have <item>.
        A_SHATTERED_SHIELD            = 7680, -- The ground here is littered with the pieces of a shattered shield...
        SNATCHED_AWAY                 = 7681, -- The <item> is suddenly snatched away!
        DROP_OF_OIL                   = 7683, -- A drop of oil trickles down the cheek of the mannequin.
        LARGE_DROPS_OF_OIL            = 7684, -- Large drops of oil begin pouring from the eyes on the mannequin.
        NOTHING_HERE_YET              = 7685, -- There is nothing here yet. Check again in the morning.
        ALREADY_BAITED                = 7686, -- The trap already contains <item>.
        APPEARS_TO_BE_TRAP            = 7687, -- There appears to be some kind of trap here. Bits of fish are lying around the area.
        DID_NOT_CATCH_ANYTHING        = 7688, -- You did not catch anything.
        PUT_IN_TRAP                   = 7689, -- You put <item> in the trap.
        COMMON_SENSE_SURVIVAL         = 8660, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        ...
        HOMEPOINT_SET                 = 8883, -- Home point set!
    },
    mob =
    {
