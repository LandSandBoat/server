...
zones[xi.zone.MISAREAUX_COAST] =
{
    text =
    {
        ...
        APPEARS_TO_BE_TRAP       = 7669, -- There appears to be some kind of trap here. Bits of fish are lying around the area.
        DID_NOT_CATCH_ANYTHING   = 7670, -- You did not catch anything.
        PUT_IN_TRAP              = 7671, -- You put <item> in the trap.
        COMMON_SENSE_SURVIVAL    = 8642, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        HOMEPOINT_SET            = 8865, -- Home point set!
    },
    mob =
    {
        OKYUPETE_PH =
