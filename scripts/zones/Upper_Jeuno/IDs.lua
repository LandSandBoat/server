...
zones[xi.zone.UPPER_JEUNO] =
{
    text =
    {
        ...
        HOMEPOINT_SET                    = 6694,  -- Home point set!
        MOG_LOCKER_OFFSET                = 6812,  -- Your Mog Locker lease is valid until <timestamp>, kupo.
        GLYKE_SHOP_DIALOG                = 6995,  -- Can I help you?
        MEJUONE_SHOP_DIALOG              = 6996,  -- Welcome to the Chocobo Shop.
        VIETTES_SHOP_DIALOG              = 6997,  -- Welcome to Viette's Finest Weapons.
        DURABLE_SHIELDS_SHOP_DIALOG      = 6998,  -- Welcome to Durable Shields.
        MP_SHOP_DIALOG                   = 6999,  -- Welcome to M & P's Market.
        GUIDE_STONE                      = 7000,  -- Up: Ru'Lude Gardens Down: Lower Jeuno (facing Bastok)
        IT_READS_STAFF_ONLY              = 7002,  -- It reads, Staff Only.
        LEILLAINE_SHOP_DIALOG            = 7025,  -- Hello. Are you feeling all right?
        YOU_CAN_NOW_BECOME_A_BEASTMASTER = 7205,  -- You can now become a beastmaster.
        CONQUEST                         = 7761,  -- You've earned conquest points!
        ITEM_DELIVERY_DIALOG             = 8094,  -- Delivering goods to residences everywhere!
        DECIMATION_LEARNED               = 8217,  -- You have learned the weapon skill Decimation!
        LEND_PRISHE_AMULET               = 8354,  -- You lend the <item> to Prishe.
        YOU_OBTAIN_ITEM                  = 11198, -- You obtain <item>!
        UNLOCK_DANCER                    = 11848, -- You can now become a dancer!
    },
    mob =
    {
    },
