...
zones[xi.zone.UPPER_JEUNO] =
{
    text =
    {
        ...
        HOMEPOINT_SET                    = 6683,  -- Home point set!
        MOG_LOCKER_OFFSET                = 6801,  -- Your Mog Locker lease is valid until <timestamp>, kupo.
        GLYKE_SHOP_DIALOG                = 6984,  -- Can I help you?
        MEJUONE_SHOP_DIALOG              = 6985,  -- Welcome to the Chocobo Shop.
        VIETTES_SHOP_DIALOG              = 6986,  -- Welcome to Viette's Finest Weapons.
        ...
        ITEM_DELIVERY_DIALOG             = 8083,  -- Delivering goods to residences everywhere!
        DECIMATION_LEARNED               = 8206,  -- You have learned the weapon skill Decimation!
        LEND_PRISHE_AMULET               = 8343,  -- You lend the <item> to Prishe.
        UNLOCK_DANCER                    = 11837, -- You can now become a dancer!
    },
    mob =
    {
    },
