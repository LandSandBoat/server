...
function onTrade(player,npc,trade)
    if     npcUtil.tradeHasExactly(trade, 10050) then player:startEvent(10227, 10050, tpz.ki.TRAINERS_WHISTLE, tpz.mount.TIGER - 1) player:setCharVar("FullSpeedAheadReward", tpz.ki.TIGER_COMPANION)
