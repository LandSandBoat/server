...
zones[xi.zone.THE_BOYAHDA_TREE] =
{
    text =
    {
        ...
        CHEST_UNLOCKED                = 7175,  -- You unlock the chest!
        CAN_SEE_SKY                   = 7188,  -- You can see the sky from here.
        SOMETHING_NOT_RIGHT           = 7189,  -- Something is not right!
        CANNOT_SEE_MOON               = 7190,  -- You cannot see the moon right now.
        CONQUEST_BASE                 = 7191,  -- Tallying conquest results...
        WARDEN_SPEECH                 = 7350,  -- Pi...!
        WARDEN_TRANSLATION            = 7351,  -- The warden appears to want something from you...
        ...
        HOMEPOINT_SET                 = 11452, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 11510, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
