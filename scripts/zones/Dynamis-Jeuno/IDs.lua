...
zones[xi.zone.DYNAMIS_JEUNO] =
{
    text =
    {
        ...
        DYNAMIS_TIME_BEGIN            = 7237, -- The sands of the <item> have begun to fall. You have <number> minutes (Earth time) remaining in Dynamis.
        DYNAMIS_TIME_EXTEND           = 7238, -- Your stay in Dynamis has been extended by <number> minute[/s].
        DYNAMIS_TIME_UPDATE_1         = 7239, -- You will be expelled from Dynamis in <number> [second/minute] (Earth time).
