...
zones[xi.zone.PORT_BASTOK] =
{
    text =
    {
        ...
        RECEIVE_BAYLD                 = 7210,  -- You receive <number> bayld!
        ...
        RECEIVED_CONQUEST_POINTS      = 8155,  -- You received <number> conquest points!
        ...
        IMPERIAL_STANDING_INCREASED   = 12689, -- Your Imperial Standing has increased!
        EARNED_ALLIED_NOTES           = 12690, -- You have earned <number> Allied Note[/s]!
