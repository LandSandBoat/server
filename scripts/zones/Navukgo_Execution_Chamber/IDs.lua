...
zones[xi.zone.NAVUKGO_EXECUTION_CHAMBER] =
{
    text =
    {
        ...
        SHAMARHAAN_LET_US_BEGIN       = 7636, -- Let us begin.
        SHAMARHAAN_AUTOMATON_POWER    = 7637, -- Do not underestimate my automaton's power!
        SHAMARHAAN_NOT_READY          = 7638, -- Unfortunately, it looks like you are still not ready yet...
        SHAMARHAAN_MAGNIFICENT        = 7639, -- Magnificent work...
        SHAMARHAAN_GOT_TRICKS         = 7640, -- I've got a few tricks up my own sleeve!
        SHAMARHAAN_LETS_TRY           = 7641, -- Hmm... Let's try this one...
        SHAMARHAAN_FULL_STEAM         = 7642, -- Full steam ahead!
        SHAMARHAAN_ENOUGH             = 7643, -- Enough. I have no desire to watch this foolishness all day.
        SHAMARHAAN_UNDERESTIMATED     = 7644, -- It looks like I underestimated you!
