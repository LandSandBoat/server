...
zones[xi.zone.NAVUKGO_EXECUTION_CHAMBER] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7271, -- The door is locked.
        ...
        IMPERIAL_ORDER_BREAKS         = 7591, -- The <item> breaks!
        ENTERING_THE_BATTLEFIELD_FOR  = 7604, -- Entering the battlefield for [Tough Nut to Crack/Happy Caster/Omens/Achieving True Power/Shield of Diplomacy/An Imperial Heist]!
        KARABABA_ENOUGH               = 7649, -- That's quite enough...
        KARABABA_ROUGH                = 7650, -- Time for me to start playing rough!
        KARABARA_FIRE                 = 7651, -- Fuel for the fire! It doesn't pay to invoke my ire!
        KARABARA_ICE                  = 7652, -- Well, if you won't play nice, I'll put your sorry hide on ice!
        KARABARA_WIND                 = 7653, -- This battle is growing stale. How about we have a refreshing gale!
        KARABARA_EARTH                = 7654, -- Sometimes it comes as quite a shock, how much damage you can deal with simple rock!
        KARABARA_LIGHTNING            = 7655, -- How I love to rip things asunder! Witness the power of lightning and thunder!
        KARABARA_WATER                = 7656, -- Water is more dangerous than most expect. Never fear, I'll teach you respect!
        KARABABA_QUIT                 = 7664, -- What a completely useless shield. It's time for me to quit the field.
    },
    mob =
    {
