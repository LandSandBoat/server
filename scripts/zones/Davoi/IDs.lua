...
zones[xi.zone.DAVOI] =
{
    text =
    {
        ...
        CAVE_HAS_BEEN_SEALED_OFF    = 7356, -- The cave has been sealed off by some sort of barrier.
        MAY_BE_SOME_WAY_TO_BREAK    = 7357, -- There may be some way to break through.
        POWER_OF_THE_ORB_ALLOW_PASS = 7359, -- The disruptive power of the orb allows passage through the barrier.
        QUEMARICOND_DIALOG          = 7378, -- I can't believe I've lost my way! They must have used an Orcish spell to change the terrain! Yes, that must be it!
        YOU_SEE_NOTHING             = 7412, -- There is nothing here.
        AN_ORCISH_STORAGE_HOLE      = 7454, -- An Orcish storage hole. There is something inside, but you cannot open it without a key.
        A_WELL                      = 7456, -- A well, presumably dug by Orcs.
        CHEST_UNLOCKED              = 7475, -- You unlock the chest!
        WHERE_THE_TONBERRY_TOLD_YOU = 7924, -- This is where the Tonberry from Carpenters' Landing told you to bring the <item>...
        NOTHING_TO_DO               = 7925, -- You have nothing left to do here.
        UNDER_ATTACK                = 7927, -- You are under attack!
        COMMON_SENSE_SURVIVAL       = 7976, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        HAWKEYED_DNATBAT_PH =
