...
return {
    ...
    ['_45g']         = { messageSpecial = ID.text.COLOR_OF_BLOOD },
    ['_45h']         = { messageSpecial = ID.text.COLOR_OF_BLOOD },
    ['_45i']         = { messageSpecial = ID.text.COLOR_OF_BLOOD },
    ['_45j']         = { messageSpecial = ID.text.COLOR_OF_BLOOD },
    ['Bernal']       = { event = 31 },
