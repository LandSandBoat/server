...
zones[xi.zone.GARLAIGE_CITADEL] =
{
    text =
    {
        ...
        WHATS_WRONG                   = 7457,  -- What's wrong?
        CMON_LETS_SKEDADDLE           = 7458,  -- C'mon! Let's skeda-da-daddle!
        I_THANK_YOU                   = 7459,  -- I thank you from the bee-bop-bottom of my itsy-bitsy heartaru! You can collect your reward from Dehn!
        RAN_OUT_OF_TIME               = 7460,  -- Well, ding-dang-dong! We've run out of time!
        THERE_YOU_ARE                 = 7461,  -- There you are! I was starting to get the heeby-weeby-jeebies waiting for you in this creepy-crawly place. Let's skeda-da-daddle!
        TIME_LIMIT                    = 7462,  -- You have # minutes (Earth time) to complete this quest.
        LOST_SIGHT                    = 7463,  -- You have lost sight of Wanzo-Unzozo...
        BYE_BYE                       = 7464,  -- I'll see you around sometime! Bye-bee-bye!
        LETS_GO                       = 7465,  -- I'm ready when you and your buddie-wuddies are. Let's go go go!
