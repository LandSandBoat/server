...
zones[xi.zone.GARLAIGE_CITADEL] =
{
    text =
    {
        ...
        DEVICE_NOT_WORKING       = 7240,  -- The device is not working.
        SYS_OVERLOAD             = 7249,  -- Warning! Sys...verload! Enterin...fety mode. ID eras...d.
        YOU_LOST_THE             = 7254,  -- You lost the <item>.
        SPARKLING_LIGHT          = 7266,  -- The ground is sparkling with a strange light.
        A_GATE_OF_STURDY_STEEL   = 7278,  -- A gate of sturdy steel.
        OPEN_WITH_THE_RIGHT_KEY  = 7284,  -- You might be able to open it with the right key.
        BANISHING_GATES          = 7293,  -- The first banishing gate begins to open...
        BANISHING_GATES_CLOSING  = 7296,  -- The first banishing gate starts to close.
        YOU_FIND_NOTHING         = 7300,  -- You find nothing special.
        HOLE_IN_THE_CEILING      = 7301,  -- There is a hole in the ceiling.
        PRESENCE_FROM_CEILING    = 7302,  -- You sense a presence from in the ceiling.
        HEAT_FROM_CEILING        = 7303,  -- You feel a terrible heat from the ceiling.
        THE_PRESENCE_MOVES       = 7307,  -- The presence in the ceiling seems to have moved to the east.
        CHEST_UNLOCKED           = 7333,  -- You unlock the chest!
        ITEMS_ITEMS_LA_LA        = 7460,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY      = 7466,  -- The Goblin slipped away when you were not looking...
        COMBINE_INTO_A_CHUNK     = 7521,  -- You combine the % you have collected into a single chunk.
