...
zones[xi.zone.CAEDARVA_MIRE] =
{
    text =
    {
        ...
        STAGING_GATE_AZOUPH           = 7331, -- Azouph Isle Staging Point.
        STAGING_GATE_DVUCCA           = 7334, -- Dvucca Isle Staging Point.
        ...
        LOGGING_IS_POSSIBLE_HERE      = 7363, -- Logging is possible here if you have <item>.
        LEG_STUCK                     = 7370, -- Your leg is stuck in the swampy ground!
        MYSTERIOUS_EFFECT             = 7371, -- You gain some mysterious effect from the swamp!
        HAND_OVER_TO_IMMORTAL         = 7444, -- You hand over the % to the Immortal.
        YOUR_IMPERIAL_STANDING        = 7445, -- Your Imperial Standing has increased!
        CANNOT_ENTER                  = 7483, -- You cannot enter at this time. Please wait a while before trying again.
        AREA_FULL                     = 7484, -- This area is fully occupied. You were unable to enter.
        MEMBER_NO_REQS                = 7488, -- Not all of your party members meet the requirements for this objective. Unable to enter area.
        MEMBER_TOO_FAR                = 7492, -- One or more party members are too far away from the entrance. Unable to enter area.
        JAZARAATS_HEADSTONE           = 7552, -- The name Sir Jazaraat is engraved on the headstone...
        SOMEONE_SLIPPED               = 7599, -- It looks like someone slipped here...
        HIDEOUS_BEAST_EMERGES         = 7600, -- A hideous beast emerges from the depths of the swamp!
        SEAPRINCES_TOMBSTONE          = 8076, -- It appears to be the grave of a great soul to an age long past.
        SHED_LEAVES                   = 8082, -- The ground is strewn with shed leaves...
        SICKLY_SWEET                  = 8087, -- A sickly sweet fragrance pervades the air...
        STIFLING_STENCH               = 8093, -- A stifling stench pervades the air...
        SHREDDED_SCRAPS               = 8100, -- Shredded scraps of paper are scattered all over...
        DRAWS_NEAR                    = 8109, -- Something draws near!
        HOMEPOINT_SET                 = 9002, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 9060, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
