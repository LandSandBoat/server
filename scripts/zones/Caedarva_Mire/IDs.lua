...
zones[xi.zone.CAEDARVA_MIRE] =
{
    text =
    {
        ...
        STAGING_GATE_DVUCCA           = 7335, -- Dvucca Isle Staging Point.
        ...
        HIDEOUS_BEAST_EMERGES         = 7601, -- A hideous beast emerges from the depths of the swamp!
        SEAPRINCES_TOMBSTONE          = 8077, -- It appears to be the grave of a great soul to an age long past.
        SHED_LEAVES                   = 8083, -- The ground is strewn with shed leaves...
        SICKLY_SWEET                  = 8088, -- A sickly sweet fragrance pervades the air...
        STIFLING_STENCH               = 8094, -- A stifling stench pervades the air...
        SHREDDED_SCRAPS               = 8101, -- Shredded scraps of paper are scattered all over...
        DRAWS_NEAR                    = 8110, -- Something draws near!
        HOMEPOINT_SET                 = 9003, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 9061, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
