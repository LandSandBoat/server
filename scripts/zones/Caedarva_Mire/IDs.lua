...
zones[xi.zone.CAEDARVA_MIRE] =
{
    text =
    {
        ...
        STAGING_GATE_AZOUPH           = 7325, -- Azouph Isle Staging Point.
        STAGING_GATE_DVUCCA           = 7328, -- Dvucca Isle Staging Point.
        ...
        LOGGING_IS_POSSIBLE_HERE      = 7357, -- Logging is possible here if you have <item>.
        HAND_OVER_TO_IMMORTAL         = 7438, -- You hand over the % to the Immortal.
        YOUR_IMPERIAL_STANDING        = 7439, -- Your Imperial Standing has increased!
        ...
        JAZARAATS_HEADSTONE           = 7540, -- The name Sir Jazaraat is engraved on the headstone...
        SEAPRINCES_TOMBSTONE          = 8064, -- It appears to be the grave of a great soul to an age long past.
        SHED_LEAVES                   = 8070, -- The ground is strewn with shed leaves...
        SICKLY_SWEET                  = 8075, -- A sickly sweet fragrance pervades the air...
        STIFLING_STENCH               = 8081, -- A stifling stench pervades the air...
        SHREDDED_SCRAPS               = 8088, -- Shredded scraps of paper are scattered all over...
        DRAWS_NEAR                    = 8097, -- Something draws near!
        HOMEPOINT_SET                 = 8990, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 9048, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        COMMON_SENSE_SURVIVAL         = 9070, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
