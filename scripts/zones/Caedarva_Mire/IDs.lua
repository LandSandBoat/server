...
zones[xi.zone.CAEDARVA_MIRE] =
{
    text =
    {
        ...
        JAZARAATS_HEADSTONE           = 7541, -- The name Sir Jazaraat is engraved on the headstone...
        SEAPRINCES_TOMBSTONE          = 8065, -- It appears to be the grave of a great soul to an age long past.
        SHED_LEAVES                   = 8071, -- The ground is strewn with shed leaves...
        SICKLY_SWEET                  = 8076, -- A sickly sweet fragrance pervades the air...
        STIFLING_STENCH               = 8082, -- A stifling stench pervades the air...
        SHREDDED_SCRAPS               = 8089, -- Shredded scraps of paper are scattered all over...
        DRAWS_NEAR                    = 8098, -- Something draws near!
        HOMEPOINT_SET                 = 8991, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 9049, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        COMMON_SENSE_SURVIVAL         = 9071, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
