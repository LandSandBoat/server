...
zones[xi.zone.MINE_SHAFT_2716] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7085, -- The old wooden door is locked tight.
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7598, -- Entering the battlefield for [A Century of Hardship/Return to the Depths/Bionic Bug/Pulling the Strings/Automaton Assault/The Mobline Comedy/To Movalpolos!]!
    },
    mob =
    {
