...
zones[xi.zone.CEIZAK_BATTLEGROUNDS] =
{
    text =
    {
        ...
        WAYPOINT_ATTUNED              = 7601, -- Your <keyitem> has been attuned to a geomagnetic fount[/ at the frontier station/ at Frontier Bivouac #1/ at Frontier Bivouac #2/ at Frontier Bivouac #3]!
        ...
        HOMEPOINT_SET                 = 7804, -- Home point set!
        MONSTER_APPEAR                = 8027, -- A monster appears!
        SPRING_STEP                   = 8035, -- The spring has returned to your step.
        LEARNS_SPELL                  = 8047, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 8049, -- You are assaulted by an uncanny sensation.
        ENERGIES_COURSE               = 8050, -- The arcane energies begin to course within your veins.
        MYSTICAL_WARMTH               = 8051, -- You feel a mystical warmth welling up inside you!
    },
    mob =
    {
