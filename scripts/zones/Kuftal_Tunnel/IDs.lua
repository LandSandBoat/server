...
zones[xi.zone.KUFTAL_TUNNEL] =
{
    text =
    {
        ...
        DO_NOT_SEE_ANYTHING           = 7349,  -- You do not see anything out of the ordinary.
        FELL                          = 7352,  -- The piece of wood fell off the cliff!
        EVIL                          = 7353,  -- You sense an evil presence...
        FISHBONES                     = 7367,  -- Fish bones lie scattered about the area...
        SENSE_OMINOUS_PRESENCE        = 7369,  -- You sense an ominous presence...
        REGIME_REGISTERED             = 10353, -- New training regime registered!
        PLAYER_OBTAINS_ITEM           = 11405, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 11406, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 11407, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 11408, -- You already possess that temporary item.
        NO_COMBINATION                = 11413, -- You were unable to enter a combination.
