...
zones[xi.zone.KUFTAL_TUNNEL] =
{
    text =
    {
        ...
        DO_NOT_SEE_ANYTHING           = 7352,  -- You do not see anything out of the ordinary.
        FELL                          = 7355,  -- The piece of wood fell off the cliff!
        EVIL                          = 7356,  -- You sense an evil presence...
        FISHBONES                     = 7370,  -- Fish bones lie scattered about the area...
        SENSE_OMINOUS_PRESENCE        = 7372,  -- You sense an ominous presence...
        REGIME_REGISTERED             = 10356, -- New training regime registered!
        PLAYER_OBTAINS_ITEM           = 11408, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 11409, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 11410, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 11411, -- You already possess that temporary item.
        NO_COMBINATION                = 11416, -- You were unable to enter a combination.
