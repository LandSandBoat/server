...
zones[xi.zone.SHIP_BOUND_FOR_SELBINA_PIRATES] =
{
    text =
    {
        ...
        ON_WAY_TO_SELBINA             = 7351, -- We're on our way to Selbina. We should be there in [less than an hour/about 1 hour/about 2 hours/about 3 hours/about 4 hours/about 5 hours/about 6 hours/about 7 hours] (<number> [minute/minutes] in Earth time).
