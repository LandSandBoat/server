...
zones[xi.zone.NORTH_GUSTABERG] =
{
    text =
    {
        ...
        SENSE_EVIL_PRESENCE           = 7340,  -- You sense an evil presence...
        SPARKLING_LIGHT               = 7381,  -- The ground is sparkling with a strange light.
        SHINING_OBJECT_SLIPS_AWAY     = 7445,  -- The shining object slips through your fingers and is washed further down the stream.
        REACH_WATER_FROM_HERE         = 7452,  -- You can reach the water from here.
        ...
        VOIDWALKER_DESPAWN            = 8121,  -- The monster fades before your eyes, a look of disappointment on its face.
        REGIME_REGISTERED             = 10411, -- New training regime registered!
        VOIDWALKER_NO_MOB             = 11530, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 11531, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 11532, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 11533, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 11535, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 11536, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 11537, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 11538, -- Obtained key item: <keyitem>!
