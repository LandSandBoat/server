...
zones[xi.zone.NORTH_GUSTABERG] =
{
    text =
    {
        ...
        SENSE_EVIL_PRESENCE           = 7351,  -- You sense an evil presence...
        SPARKLING_LIGHT               = 7392,  -- The ground is sparkling with a strange light.
        SHINING_OBJECT_SLIPS_AWAY     = 7456,  -- The shining object slips through your fingers and is washed further down the stream.
        REACH_WATER_FROM_HERE         = 7463,  -- You can reach the water from here.
        ...
        GARRISON_BASE                 = 7867,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
