...
zones[xi.zone.PROMYVION_HOLLA] =
{
    text =
    {
        ...
        BARRIER_WOVEN                 = 7229, -- It appears to be a barrier woven from the energy of overflowing memories...
        EERIE_GREEN_GLOW              = 7231, -- The sphere is emitting an eerie green glow.
    },
    mob =
    {
