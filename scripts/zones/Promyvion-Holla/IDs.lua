...
zones[xi.zone.PROMYVION_HOLLA] =
{
    text =
    {
        ...
        BARRIER_WOVEN                 = 7231, -- It appears to be a barrier woven from the energy of overflowing memories...
        EERIE_GREEN_GLOW              = 7233, -- The sphere is emitting an eerie green glow.
    },
    mob =
    {
