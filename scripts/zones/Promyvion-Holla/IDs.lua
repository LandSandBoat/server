...
zones[xi.zone.PROMYVION_HOLLA] =
{
    ...
    mob =
    {
        MEMORY_RECEPTACLES =
        {
            [16842781] = { 1, 3, 16843060, 1 },
            [16842841] = { 2, 5, 16843056, 4 },
            [16842848] = { 2, 5, 16843057, 4 },
            [16842855] = { 2, 5, 16843058, 4 },
            [16842862] = { 2, 5, 16843059, 4 },
            [16842888] = { 3, 7, 16843053, 3 },
            [16842897] = { 3, 7, 16843054, 3 },
            [16842906] = { 3, 7, 16843055, 3 },
            [16842940] = { 4, 7, 16843061, 3 },
            [16842949] = { 4, 7, 16843062, 3 },
            [16842958] = { 4, 7, 16843063, 3 },
        },
