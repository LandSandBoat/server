...
zones[xi.zone.ULEGUERAND_RANGE] =
{
    text =
    {
        ...
        SOMETHING_GLITTERING     = 7337, -- You see something glittering beneath the surface of the ice.
        WHAT_LIES_BENEATH        = 7338, -- There are many cold <item> scattered around the area. Could someone be trying to melt the ice to retrieve what lies beneath?
        SOMETHING_GLITTERING_BUT = 7339, -- You see something glittering below the surface here, but the ice encases it completely.
