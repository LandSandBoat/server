...
zones[xi.zone.ULEGUERAND_RANGE] =
{
    text =
    {
        ...
        SOMETHING_GLITTERING     = 7340, -- You see something glittering beneath the surface of the ice.
        WHAT_LIES_BENEATH        = 7341, -- There are many cold <item> scattered around the area. Could someone be trying to melt the ice to retrieve what lies beneath?
        SOMETHING_GLITTERING_BUT = 7342, -- You see something glittering below the surface here, but the ice encases it completely.
        HOMEPOINT_SET            = 8334, -- Home point set!
    },
    mob =
    {
        SKVADER_PH =
