...
zones[xi.zone.ULEGUERAND_RANGE] =
{
    text =
    {
        ...
        SOMETHING_GLITTERING          = 7351, -- You see something glittering beneath the surface of the ice.
        WHAT_LIES_BENEATH             = 7352, -- There are many cold <item> scattered around the area. Could someone be trying to melt the ice to retrieve what lies beneath?
        SOMETHING_GLITTERING_BUT      = 7353, -- You see something glittering below the surface here, but the ice encases it completely.
        HOMEPOINT_SET                 = 8345, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 8403, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
