...
local prospectorItems =
{
    ...
    {
    --  Sel      Item                         Cost
        [ 1] = { xi.item.RAVAGERS_MASK,      5000 },
        [ 2] = { xi.item.TANTRA_CROWN,       5000 },
        [ 3] = { xi.item.ORISON_CAP,         5000 },
        [ 4] = { xi.item.GOETIA_PETASOS,     5000 },
        [ 5] = { xi.item.ESTOQUEURS_CHAPPEL, 5000 },
        [ 6] = { xi.item.RAIDERS_BONNET,     5000 },
        [ 7] = { xi.item.FORBIDDEN_KEY,       500 },
        [ 8] = { xi.item.SHADOW_THRONE,   2000000 },
    },
    ...
    {
    --  Sel     Item                                      Cost
        [1] = { xi.keyItem.MAP_OF_ABYSSEA_ATTOHWA,        4500 },
