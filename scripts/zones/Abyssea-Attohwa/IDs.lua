...
zones[xi.zone.ABYSSEA_ATTOHWA] =
{
    ...
    mob =
    {
        ...
        SMOK_1                      = GetFirstID("Smok"),
        TITLACAUAN_1                = GetFirstID("Titlacauan"),
        ULHUADSHI_1                 = GetFirstID("Ulhuadshi"),
        ITZPAPALOTL_1               = GetFirstID("Itzpapalotl"),
        SMOK_2                      = GetFirstID("Smok") + 4,
        TITLACAUAN_2                = GetFirstID("Titlacauan") + 4,
        ULHUADSHI_2                 = GetFirstID("Ulhuadshi") + 4,
        ITZPAPALOTL_2               = GetFirstID("Itzpapalotl") + 4,
        SMOK_3                      = GetFirstID("Smok") + 8,
        TITLACAUAN_3                = GetFirstID("Titlacauan") + 8,
        ULHUADSHI_3                 = GetFirstID("Ulhuadshi") + 8,
        ITZPAPALOTL_3               = GetFirstID("Itzpapalotl") + 8,
    },
    npc =
    {
    },
