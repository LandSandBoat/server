...
zones[xi.zone.PALBOROUGH_MINES] =
{
    text =
    {
        ...
        THE_MACHINE_SEEMS_TO_BE_WORKING    = 7393, -- The machine seems to be working, but you cannot discern its purpose.
        SOMETHING_FALLS_OUT_OF_THE_MACHINE = 7396, -- Something falls out of the machine!
        YOU_CANT_CARRY_ANY_MORE_ITEMS      = 7399, -- There seems to be more left in the machine, but you can't carry any more items.
        MINING_IS_POSSIBLE_HERE            = 7420, -- Mining is possible here if you have <item>.
