...
zones[xi.zone.CRAWLERS_NEST] =
{
    text =
    {
        ...
        ANYTHING_WRONG                = 7283,  -- Is anything wrong?
        COME_ON_FOLLOW_ME             = 7284,  -- Come on, let's go. Follow me.
        GREAT_HELP                    = 7285,  -- You've been a great help. You can pick up your payment from Trilok.
        RAN_OUT_OF_TIME               = 7287,  -- We've run out of time...
        TIME_LIMIT                    = 7288,  -- You have # minutes (Earth time) to complete this quest.
        BEEN_A_PLEASURE               = 7290,  -- It has been a pleasure, but I must be on my way. May our paths cross again someday...
        ARE_YOU_READY                 = 7291,  -- Are you ready? If your colleagues are accompanying us, tell them we are setting off.
