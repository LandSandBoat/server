...
zones[xi.zone.CRAWLERS_NEST] =
{
    text =
    {
        ...
        SOMEONE_HAS_BEEN_DIGGING_HERE = 7267,  -- Someone has been digging here.
        EQUIPMENT_NOT_PURIFIED        = 7268,  -- Your equipment has not been completely purified.
        YOU_BURY_THE                  = 7270,  -- You bury the <item> and <item>.
        NOTHING_WILL_HAPPEN_YET       = 7273,  -- It seems that nothing will happen yet.
        NOTHING_SEEMS_TO_HAPPEN       = 7274,  -- Nothing seems to happen.
        COMBINE_INTO_A_CLUMP          = 7344,  -- You combine the % you have accumulated into a single clump.
        PLAYER_OBTAINS_ITEM           = 7349,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7350,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7351,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7352,  -- You already possess that temporary item.
        NO_COMBINATION                = 7357,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 9435,  -- New training regime registered!
        COMMON_SENSE_SURVIVAL         = 11387, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        DEMONIC_TIPHIA_PH =
