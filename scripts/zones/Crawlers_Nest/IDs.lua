...
zones[tpz.zone.CRAWLERS_NEST] =
{
    text =
    {
        ...
        SOMEONE_HAS_BEEN_DIGGING_HERE = 7261,  -- Someone has been digging here.
        EQUIPMENT_NOT_PURIFIED        = 7262,  -- Your equipment has not been completely purified.
        YOU_BURY_THE                  = 7264,  -- You bury the <item> and <item>.
        NOTHING_WILL_HAPPEN_YET       = 7267,  -- It seems that nothing will happen yet.
        NOTHING_SEEMS_TO_HAPPEN       = 7268,  -- Nothing seems to happen.
        REGIME_REGISTERED             = 9429,  -- New training regime registered!
        ...
        COMMON_SENSE_SURVIVAL         = 11381, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        DEMONIC_TIPHIA_PH =
