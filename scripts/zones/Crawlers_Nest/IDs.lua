...
zones[tpz.zone.CRAWLERS_NEST] =
{
    text =
    {
        ...
        CARRIED_OVER_POINTS           = 7189, -- You have carried over <number> points.
        LOGIN_CAMPAIGN_UNDERWAY       = 7190, -- The <month> ≺year≻ Login Campaign is currently underway!
        LOGIN_NUMBER                  = 7191, -- In celebration of your most recent login no. <number>...
