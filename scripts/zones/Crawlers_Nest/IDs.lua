...
zones[xi.zone.CRAWLERS_NEST] =
{
    text =
    {
        ...
        SOMEONE_HAS_BEEN_DIGGING_HERE = 7278,  -- Someone has been digging here.
        EQUIPMENT_NOT_PURIFIED        = 7279,  -- Your equipment has not been completely purified.
        YOU_BURY_THE                  = 7281,  -- You bury the <item> and <item>.
        NOTHING_WILL_HAPPEN_YET       = 7284,  -- It seems that nothing will happen yet.
        NOTHING_SEEMS_TO_HAPPEN       = 7285,  -- Nothing seems to happen.
        COMBINE_INTO_A_CLUMP          = 7355,  -- You combine the % you have accumulated into a single clump.
        PLAYER_OBTAINS_ITEM           = 7360,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7361,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7362,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7363,  -- You already possess that temporary item.
        NO_COMBINATION                = 7368,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 9446,  -- New training regime registered!
        LEARNS_SPELL                  = 11364, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 11366, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 11398, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
