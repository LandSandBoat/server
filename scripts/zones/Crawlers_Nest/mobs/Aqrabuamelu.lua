...
entity.onSpikesDamage = function(mob, target, damage)
    ...
    dmg = math.floor(dmg * xi.spells.damage.calculateAbsorption(target, xi.element.ICE, false, true, false, false))
    dmg = math.floor(dmg * xi.spells.damage.calculateNullification(target, xi.element.ICE, false, true, false, false))
