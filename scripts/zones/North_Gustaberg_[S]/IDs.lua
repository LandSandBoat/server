...
zones[xi.zone.NORTH_GUSTABERG_S] =
{
    text =
    {
        ...
        LYCOPODIUM_ENTRANCED          = 7074, -- The lycopodium is entranced by a sparkling light...
        ...
        VOIDWALKER_MOB_HINT           = 8196, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 8197, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 8199, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 8200, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 8201, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 8202, -- Obtained key item: <keyitem>!
        COMMON_SENSE_SURVIVAL         = 9094, -- It appears that you have arrived at a new survival guide provided by the Servicemen's Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
