...
zones[xi.zone.XARCABARD] =
{
    text =
    {
        ...
        BEASTMEN_BANNER                = 7160,  -- There was a curse on the beastmen's banner!
        ALREADY_OBTAINED_TELE          = 7390,  -- You already possess the gate crystal for this telepoint.
        CONQUEST                       = 7403,  -- You've earned conquest points!
        ONLY_SHARDS                    = 7736,  -- Only shards of ice lie upon the ground.
        BLOCKS_OF_ICE                  = 7737,  -- You can hear blocks of ice moving from deep within the cave.
        PERENNIAL_SNOW_DEFAULT         = 7738,  -- How many millennia has this snow been here, hidden from the rays of the sun?
        PERENNIAL_SNOW_WAIT            = 7740,  -- The <keyitem> you buried is not yet purified.
        ...
        UNITY_WANTED_BATTLE_INTERACT   = 8249,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
