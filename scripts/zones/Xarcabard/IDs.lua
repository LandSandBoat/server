...
zones[xi.zone.XARCABARD] =
{
    text =
    {
        ...
        BEASTMEN_BANNER                = 7145,  -- There was a curse on the beastmen's banner!
        ALREADY_OBTAINED_TELE          = 7375,  -- You already possess the gate crystal for this telepoint.
        CONQUEST                       = 7388,  -- You've earned conquest points!
        ONLY_SHARDS                    = 7721,  -- Only shards of ice lie upon the ground.
        BLOCKS_OF_ICE                  = 7722,  -- You can hear blocks of ice moving from deep within the cave.
        PERENNIAL_SNOW_DEFAULT         = 7723,  -- How many millennia has this snow been here, hidden from the rays of the sun?
