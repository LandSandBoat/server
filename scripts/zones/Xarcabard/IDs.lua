...
zones[xi.zone.XARCABARD] =
{
    text =
    {
        ...
        SENSE_EVIL                     = 7371,  -- You can sense an evil force around you.
        DO_NOT_SENSE                   = 7372,  -- You do not sense anything out of the ordinary.
        ALREADY_OBTAINED_TELE          = 7392,  -- You already possess the gate crystal for this telepoint.
        CONQUEST                       = 7405,  -- You've earned conquest points!
        ONLY_SHARDS                    = 7738,  -- Only shards of ice lie upon the ground.
        BLOCKS_OF_ICE                  = 7739,  -- You can hear blocks of ice moving from deep within the cave.
        PERENNIAL_SNOW_DEFAULT         = 7740,  -- How many millennia has this snow been here, hidden from the rays of the sun?
        PERENNIAL_SNOW_WAIT            = 7742,  -- The <keyitem> you buried is not yet purified.
        CAVERN_CONTINUES               = 7797,  -- The cavern continues on for quite a distance.
        NOTHING_MORE                   = 7798,  -- There is nothing more to be done here.
        ...
        DYNA_NPC_DEFAULT_MESSAGE       = 7903,  -- There is a symbol carved into the rock here.
        GARRISON_BASE                  = 8058,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        PLAYER_OBTAINS_ITEM            = 8181,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM          = 8182,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM       = 8183,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP           = 8184,  -- You already possess that temporary item.
        NO_COMBINATION                 = 8189,  -- You were unable to enter a combination.
        VOIDWALKER_DESPAWN             = 8220,  -- The monster fades before your eyes, a look of disappointment on its face.
        UNITY_WANTED_BATTLE_INTERACT   = 8251,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED              = 10367, -- New training regime registered!
        VOIDWALKER_NO_MOB              = 11486, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR         = 11487, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT            = 11488, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB           = 11489, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1        = 11491, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2        = 11492, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI            = 11493, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI           = 11494, -- Obtained key item: <keyitem>!
