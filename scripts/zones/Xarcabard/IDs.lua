...
zones[xi.zone.XARCABARD] =
{
    text =
    {
        ...
        BEASTMEN_BANNER                = 7148,  -- There was a curse on the beastmen's banner!
        ALREADY_OBTAINED_TELE          = 7378,  -- You already possess the gate crystal for this telepoint.
        CONQUEST                       = 7391,  -- You've earned conquest points!
        ONLY_SHARDS                    = 7724,  -- Only shards of ice lie upon the ground.
        BLOCKS_OF_ICE                  = 7725,  -- You can hear blocks of ice moving from deep within the cave.
        PERENNIAL_SNOW_DEFAULT         = 7726,  -- How many millennia has this snow been here, hidden from the rays of the sun?
        PERENNIAL_SNOW_WAIT            = 7728,  -- The <keyitem> you buried is not yet purified.
