...
zones[xi.zone.XARCABARD] =
{
    text =
    {
        ...
        BEASTMEN_BANNER                = 7159,  -- There was a curse on the beastmen's banner!
        ALREADY_OBTAINED_TELE          = 7389,  -- You already possess the gate crystal for this telepoint.
        CONQUEST                       = 7402,  -- You've earned conquest points!
        ONLY_SHARDS                    = 7735,  -- Only shards of ice lie upon the ground.
        BLOCKS_OF_ICE                  = 7736,  -- You can hear blocks of ice moving from deep within the cave.
        PERENNIAL_SNOW_DEFAULT         = 7737,  -- How many millennia has this snow been here, hidden from the rays of the sun?
        PERENNIAL_SNOW_WAIT            = 7739,  -- The <keyitem> you buried is not yet purified.
        ...
        DYNA_NPC_DEFAULT_MESSAGE       = 7900,  -- There is a symbol carved into the rock here.
        GARRISON_BASE                  = 8055,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        ...
        VOIDWALKER_DESPAWN             = 8217,  -- The monster fades before your eyes, a look of disappointment on its face.
        UNITY_WANTED_BATTLE_INTERACT   = 8248,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED              = 10364, -- New training regime registered!
        VOIDWALKER_NO_MOB              = 11483, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR         = 11484, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT            = 11485, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB           = 11486, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1        = 11488, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2        = 11489, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI            = 11490, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI           = 11491, -- Obtained key item: <keyitem>!
        LEARNS_SPELL                   = 11540, -- <name> learns <spell>!
        UNCANNY_SENSATION              = 11542, -- You are assaulted by an uncanny sensation.
