...
zones[xi.zone.HAZHALM_TESTING_GROUNDS] =
{
    text =
    {
        ...
        LAMP_POWER_FADED              = 8067, -- The power of the % has faded. You may no longer occupy this chamber.
        TOO_MANY_ADVENTURERS          = 8069, -- There are too many adventurers in the chamber.
        TIMEOUT_WARNING               = 8070, -- ----== Warning! ==---- Your reservation of this chamber will end in <number> [minute/minutes].
        TIMEOUT_WARNING_SECONDS       = 8071, -- ----== Warning! ==---- Your reservation of this chamber will end in <number> [second/seconds].
