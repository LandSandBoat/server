...
zones[xi.zone.GHELSBA_OUTPOST] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY             = 7727, -- This looks like an Orcish dwelling. The door is firmly shut.
        ENTERING_THE_BATTLEFIELD_FOR     = 7752, -- Entering the battlefield for [Save the Children/The Holy Crest/Wings of Fury/Petrifying Pair/Toadal Recall/Mirror, Mirror]!
