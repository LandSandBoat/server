...
zones[xi.zone.ROLANBERRY_FIELDS] =
{
    text =
    {
        ...
        NOT_ENOUGH_GIL                = 6422,  -- You do not have enough gil.
        ...
        AWAIT_YOUR_CHALLENGE          = 12192, -- We await your challenge, traveler.
        LACK_LEGION_POINTS            = 12229, -- It would seem that you lack the necessary amount of Legion points.
        LEARNS_SPELL                  = 12277, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12279, -- You are assaulted by an uncanny sensation.
