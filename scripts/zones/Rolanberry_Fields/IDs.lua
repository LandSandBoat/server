...
zones[xi.zone.ROLANBERRY_FIELDS] =
{
    text =
    {
        ...
        SIGN                          = 7420,  -- North: Grand Duchy of Jeuno, Sauromugue Champaign South: Pashhow Marshlands
        TIME_ELAPSED                  = 7477,  -- Time elapsed: <number> [hour/hours] (Vana'diel time) <number> [minute/minutes] and <number> [second/seconds] (Earth time)
        PLAYER_OBTAINS_ITEM           = 7601,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7602,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7603,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7604,  -- You already possess that temporary item.
        NO_COMBINATION                = 7609,  -- You were unable to enter a combination.
        VOIDWALKER_DESPAWN            = 7640,  -- The monster fades before your eyes, a look of disappointment on its face.
        UNITY_WANTED_BATTLE_INTERACT  = 7671,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 9787,  -- New training regime registered!
        VOIDWALKER_NO_MOB             = 10960, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 10961, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 10962, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 10963, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 10965, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 10966, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 10967, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 10968, -- Obtained key item: <keyitem>!
        ...
        LEARNS_SPELL                  = 12272, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12274, -- You are assaulted by an uncanny sensation.
