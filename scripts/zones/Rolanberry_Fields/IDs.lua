...
zones[xi.zone.ROLANBERRY_FIELDS] =
{
    text =
    {
        ...
        UNITY_WANTED_BATTLE_INTERACT  = 7673,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        ...
        AWAIT_YOUR_CHALLENGE          = 12189, -- We await your challenge, traveler.
        LACK_LEGION_POINTS            = 12226, -- It would seem that you lack the necessary amount of Legion points.
        LEARNS_SPELL                  = 12274, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12276, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 12283, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
