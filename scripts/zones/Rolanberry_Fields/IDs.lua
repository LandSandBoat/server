...
zones[xi.zone.ROLANBERRY_FIELDS] =
{
    text =
    {
        ...
        VOIDWALKER_DESPAWN            = 7631,  -- The monster fades before your eyes, a look of disappointment on its face.
        UNITY_WANTED_BATTLE_INTERACT  = 7662,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 9778,  -- New training regime registered!
        VOIDWALKER_NO_MOB             = 10951, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 10952, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 10953, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 10954, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 10956, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 10957, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 10958, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 10959, -- Obtained key item: <keyitem>!
        AWAIT_YOUR_CHALLENGE          = 12178, -- We await your challenge, traveler.
        LACK_LEGION_POINTS            = 12215, -- It would seem that you lack the necessary amount of Legion points.
        LEARNS_SPELL                  = 12263, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12265, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 12272, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
