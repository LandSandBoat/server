...
entity.onTrigger = function(player, npc)
    ...
    elseif expertQuestStatus == 550 then
        ...
        --]]
        player:showText(npc, ID.text.ABD_AL_RAZIQ_EXPERT_BASE,  0, xi.keyItem.WAY_OF_THE_ALCHEMIST)
        player:showText(npc, ID.text.ABD_AL_RAZIQ_EXPERT_ALT, testItem)
        player:showText(npc, ID.text.ABD_AL_RAZIQ_EXPERT_BASE + 2)
    else
