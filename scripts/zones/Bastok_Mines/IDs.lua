...
zones[xi.zone.BASTOK_MINES] =
{
    text =
    {
        ...
        CHOCOBO_FEEDING_SLEEP          = 12858, -- Your chocobo is sleeping soundly. You cannot feed it now.
        CHOCOBO_FEEDING_RUN_AWAY       = 12859, -- Your chocobo has run away. You cannot feed it now.
        CHOCOBO_FEEDING_STILL_EGG      = 12860, -- You cannot feed a chocobo that has not hatched yet.
        CHOCOBO_FEEDING_ITEM           = 13943, -- #: %
        COMMON_SENSE_SURVIVAL          = 16048, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        TEAR_IN_FABRIC_OF_SPACE        = 16647, -- There appears to be a tear in the fabric of space...
    },
    mob =
    {
    },
