...
zones[xi.zone.BASTOK_MINES] =
{
    text =
    {
        ...
        ABD_AL_RAZIQ_EXPERT_ALT        = 7128,  -- Make ≺item> and I will further entrust you with the secrets of the universe.
        ABD_AL_RAZIQ_EXPERT_BASE       = 7250,  -- Say not a word, ≺Player Name≻. It is as plain as day to me. You have familiarized yourself with the contents of <key item>
