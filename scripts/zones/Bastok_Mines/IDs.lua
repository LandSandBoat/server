...
zones[xi.zone.BASTOK_MINES] =
{
    text =
    {
        ...
        GIFT_THANK_YOU                 = 12278, -- Thank you! Thank you! Thank you!
        ONLY_TWO_HANDS                 = 12281, -- Another present? Sorry, but I only have two hands, (Player Gender)≻[Mr./Ms.] Adventurer!
        JOY_TO_CHILDREN                = 12285, -- ou've brought joy to the children of Vana'diel!
        BARRELS_JOY_TO_CHILDREN        = 12286, -- ou've brought barrelfuls of joy to the children of Vana'diel!
        STARLIGHT_CARD_1               = 12404, -- It's time once again for the Starlight Celebration!≺Prompt≻
        STARLIGHT_CARD_RED             = 12411, -- Oh, I just remembered! I think that the cards are all addressed to people who are wearing red...≺Prompt≻
        STARLIGHT_FAME_DIALOG          = 12428, -- [You haven't brought any happiness to the children!/You've done some good./You have done fairly well./You have given the children much joy!/You have brought smile upon smile to the children!/You have the children bursting with glee!/The children love you!] [What a disappointment./You just need to give a little extra effort!/Keep it up!/You make a good smilebringer./Excellent work!/Stupendous job!/Even I think you're great!]
        ...
        STARLIGHT_VENDOR_MOOGLE        = 14471, -- Welcome, kupo!
        STARLIGHT_CARD_2               = 15591, -- Kupo ho ho! Merry Starlight! As with past celebrations, we've prepared a veritable mountain of presents for all adventurers, kupo.≺Prompt≻
        STARLIGHT_CARD_6               = 15601, -- Happy delivering, kupo!≺Prompt≻
        STARLIGHT_CARD_CONFIRM         = 15607, -- Here's a little something for your kindness.≺Prompt≻
        STARLIGHT_CARD_5               = 15616, -- You're truly a role model for all adventurers, kupo! Now then, we'd like you to take this card and give it to a ≺Multiple Choice (Parameter 0)≻[male Hume/female Hume/male Elvaan/female Elvaan/male Tarutaru/female Tarutaru/Mithra/Galka] adventurer.≺Prompt≻
        STARLIGHT_CARD_4               = 15617, -- If you happen to forget who the card's recipient is, just show it to me, kupo.≺Prompt≻
        STARLIGHT_CARD_CHECK           = 15618, -- Let' see... This addressee of this card is a ≺Multiple Choice (Parameter 0)≻[male Hume/female Hume/male Elvaan/female Elvaan/male Tarutaru/female Tarutaru/Mithra/Galka] adventurer, kupo.≺Prompt≻
        STARLIGHT_CARD_WRONG           = 15619, -- Are you trying to pull a fast one, kupo!? This card isn't yours to give, nor is it addressed to you, so please take it back to where you found it.≺Prompt≻
        STARLIGHT_CARD_3               = 15621, -- We'd also appreciate your help in distributing cards, kupo. All you're required to do is deliver this card to the addressee. We're counting on you!≺Prompt≻
