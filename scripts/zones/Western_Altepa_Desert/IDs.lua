...
zones[xi.zone.WESTERN_ALTEPA_DESERT] =
{
    text =
    {
        ...
        AMK_DIGGING_OFFSET            = 7307,  -- You spot some familiar footprints. You are convinced that your moogle friend has been digging in the immediate vicinity.
        FOUND_ITEM_WITH_EASE          = 7316,  -- It appears your chocobo found this item with ease.
        THE_DOOR_IS_LOCKED            = 7346,  -- The door is locked.
        DOES_NOT_RESPOND              = 7347,  -- It does not respond.
        CANNOT_REMOVE_FRAG            = 7363,  -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
        ALREADY_OBTAINED_FRAG         = 7364,  -- You have already obtained this monument's <keyitem>. Try searching for another.
        ALREADY_HAVE_ALL_FRAGS        = 7365,  -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
        FOUND_ALL_FRAGS               = 7366,  -- You have obtained <keyitem>! You now have all 8 fragments of light!
        ZILART_MONUMENT               = 7367,  -- It is an ancient Zilart monument.
        FEEL_SOMETHING_PRICKLY        = 7385,  -- You feel something prickly...
        MANY_STONES_LITTER_AREA       = 7386,  -- Many stones litter the area.
        EVIL_LOOMING_ABOVE_YOU        = 7387,  -- You sense something evil looming above you.
        ...
        UNITY_WANTED_BATTLE_INTERACT  = 7716,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
