...
zones[xi.zone.CHATEAU_DORAGUILLE] =
{
    text =
    {
        ...
        PRINCE_TRION_CHAMBERS   = 7263, -- Prince Trion went to his chambers a short while ago and has yet to return. You should go speak with him there.
        WHAT_TRION_WILL_SAY     = 7264, -- I do not know what Prince Trion will say...but I leave your actions to your judgment. You are free to do as you will.
        KNEW_YOU_WERE_THE_ONE   = 7267, -- <name>! I knew you were the one for the job. But don't rest on your laurels!
        HIS_MAJESTY_AWAITS      = 7271, -- Go, <name>. His Majesty awaits!
