...
local prospectorItems =
{
    ...
    {
    --  Sel      Item                        Cost
        [1] = { xi.item.CREED_ARMET,        5000 },
        [2] = { xi.item.BALE_BURGEONET,     5000 },
        [3] = { xi.item.FERINE_CABASSET,    5000 },
        [4] = { xi.item.AOIDOS_CALOT,       5000 },
        [5] = { xi.item.SYLVAN_GAPETTE,     5000 },
        [6] = { xi.item.FORBIDDEN_KEY,       500 },
        [7] = { xi.item.SHADOW_THRONE,   2000000 },
    },
