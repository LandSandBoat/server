...
zones[xi.zone.ILRUSI_ATOLL] =
{
    text =
    {
        ...
        ASSAULT_41_START        = 7461, -- Commencing <assault>! Objective: Rescue the agent
        ASSAULT_42_START        = 7462, -- Commencing <assault>! Objective: Destroy the assassins
        ASSAULT_43_START        = 7463, -- Commencing <assault>! Objective: Defeat Sagelord Molaal Ja
        ASSAULT_44_START        = 7464, -- Commencing <assault>! Objective: Steal the supplies
        ASSAULT_45_START        = 7465, -- Commencing <assault>! Objective: Apprehend the spy
        ASSAULT_46_START        = 7466, -- Commencing <assault>! Objective: Recover the treasure
        ASSAULT_47_START        = 7467, -- Commencing <assault>! Objective: Annihilate the enemy
        ASSAULT_48_START        = 7468, -- Commencing <assault>! Objective: Neutralize the marids
        ASSAULT_49_START        = 7469, -- Commencing <assault>! Objective: Gather pathological data
        ASSAULT_50_START        = 7470, -- Commencing <assault>! Objective: Defeat Orochi
        ...
        CHEST                   = 7529, -- The chest contains...
        GOLDEN                  = 7530, -- ...a golden figurehead!
    },
    mob =
    {
        [1] =
