...
zones[xi.zone.JADE_SEPULCHER] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7371, -- A decorative door. It appears to be locked...
        TESTIMONY_IS_TORN             = 7390, -- Your <item> is torn...
        TESTIMONY_WEARS               = 7391, -- Your <item> [/rips into shreds!/is on the verge of tearing apart.../is showing signs of wear...] (# [use remains/uses remain].)
        ...
        ORB_IS_CRACKED                = 7642, -- There is a crack in the %. It no longer contains a monster.
        A_CRACK_HAS_FORMED            = 7643, -- A crack has formed on the <item>, and the beast inside has been unleashed!
        ...
        IMPERIAL_ORDER_BREAKS         = 7692, -- The <item> breaks!
        ENTERING_THE_BATTLEFIELD_FOR  = 7705, -- Entering the battlefield for [Making a Mockery/Shadows of the Mind/The Beast Within/Moment of Truth/Puppet in Peril/Puppet in Peril/Tateeya's Worries/An Imperial Heist]!
    },
    mob =
    {
