...
zones[tpz.zone.LOWER_DELKFUTTS_TOWER] =
{
    text =
    {
        ...
        CARRIED_OVER_POINTS              = 7188, -- You have carried over <number> points.
        LOGIN_CAMPAIGN_UNDERWAY          = 7189, -- The <month> ≺year≻ Login Campaign is currently underway!
        LOGIN_NUMBER                     = 7190, -- In celebration of your most recent login no. <number>...
