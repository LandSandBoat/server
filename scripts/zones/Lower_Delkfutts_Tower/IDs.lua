...
zones[xi.zone.LOWER_DELKFUTTS_TOWER] =
{
    text =
    {
        ...
        PLAYER_OBTAINS_ITEM              = 8628,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM            = 8629,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM         = 8630,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP             = 8631,  -- You already possess that temporary item.
        NO_COMBINATION                   = 8636,  -- You were unable to enter a combination.
        REGIME_REGISTERED                = 10714, -- New training regime registered!
        COMMON_SENSE_SURVIVAL            = 11771, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        HIPPOLYTOS_PH =
