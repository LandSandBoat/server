...
zones[xi.zone.LOWER_DELKFUTTS_TOWER] =
{
    text =
    {
        ...
        SOMETHING_HUGE_BEARING_DOWN      = 7504,  -- Something huge is bearing down upon you!
        ...
        LEARNS_SPELL                     = 11773, -- <name> learns <spell>!
        UNCANNY_SENSATION                = 11775, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL            = 11782, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
