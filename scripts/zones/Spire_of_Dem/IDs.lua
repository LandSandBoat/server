...
zones[xi.zone.SPIRE_OF_DEM] =
{
    text =
    {
        ...
        ORB_IS_CRACKED                = 7382, -- There is a crack in the %. It no longer contains a monster.
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7623, -- Entering the battlefield for [Ancient Flames Beckon/You Are What You Eat/Empty Dreams]!
        CANT_REMEMBER                 = 7653, -- You cannot remember when exactly, but you have obtained <item>!
    },
    mob =
    {
