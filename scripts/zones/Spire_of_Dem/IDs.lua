...
zones[xi.zone.SPIRE_OF_DEM] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7104, -- You can hear a faint scraping sound from within, but the way is barred by some strange membrane...
        ...
        FADES_INTO_NOTHINGNESS        = 7437, -- The % fades into nothingness...
        ENTERING_THE_BATTLEFIELD_FOR  = 7628, -- Entering the battlefield for [Ancient Flames Beckon/You Are What You Eat/Empty Dreams]!
        CANT_REMEMBER                 = 7658, -- You cannot remember when exactly, but you have obtained <item>!
    },
    mob =
    {
