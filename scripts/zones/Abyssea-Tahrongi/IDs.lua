...
zones[xi.zone.ABYSSEA_TAHRONGI] =
{
    ...
    mob =
    {
        ...
        CHLORIS_1           = GetFirstID("Chloris"),
        GLAVOID_1           = GetFirstID("Glavoid"),
        LACOVIE_1           = GetFirstID("Lacovie"),
        CHLORIS_2           = GetFirstID("Chloris") + 17,
        GLAVOID_2           = GetFirstID("Glavoid") + 17,
        LACOVIE_2           = GetFirstID("Lacovie") + 17,
        CHLORIS_3           = GetFirstID("Chloris") + 20,
        GLAVOID_3           = GetFirstID("Glavoid") + 20,
        LACOVIE_3           = GetFirstID("Lacovie") + 20,
    },
}
