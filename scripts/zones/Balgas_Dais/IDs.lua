...
zones[xi.zone.BALGAS_DAIS] =
{
    text =
    {
        ...
        MACAN_WHISKERS_SLIGHTLY       = 7665, -- Gadangan's whiskers begin to twitch slightly.
        MACAN_WHISKERS_RAPIDLY        = 7666, -- Gadangan's whiskers begin to twitch rapidly.
        MACAN_WHISKERS_WILDLY         = 7667, -- Gadangan's whiskers begin to twitch wildly.
        MACAN_WHISKERS_VIOLENTLY      = 7668, -- Gadangan's whiskers begin to twitch violently.
        MACAN_WHISKERS_UNCONTROLLABLY = 7669, -- Gadangan's whiskers begin to twitch uncontrollably.
