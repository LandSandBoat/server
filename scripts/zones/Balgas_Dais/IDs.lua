...
zones[xi.zone.BALGAS_DAIS] =
{
    text =
    {
        ...
        SOUL_GEM_REACTS               = 7679, -- The <keyitem> reacts to the <keyitem>, sending a jolt of energy through your veins!
        PROMISE_ME_YOU_WONT_GO_DOWN   = 7694, -- Promise you won't go down too easy, okay?
        IM_JUST_GETTING_WARMED_UP     = 7695, -- Haha! I'm just getting warmed up!
        YOU_PACKED_MORE_OF_A_PUNCH    = 7696, -- Hah! You pack more of a punch than I thoughtaru. But I won't go down as easy as old Maat!
        WHATS_THIS_STRANGE_FEELING    = 7697, -- What's this strange feeling...? It's not supposed to end...like...
        HUH_IS_THAT_ALL               = 7698, -- Huh? Is that all? I haven't even broken a sweataru...
        YIKEY_WIKEYS                  = 7699, -- Yikey-wikeys! Get that thing away from meee!
        WHATS_THE_MATTARU             = 7700, -- <Pant, wheeze>... What's the mattaru, <name>? Too much of a pansy-wansy to fight fair?
    },
    mob =
    {
