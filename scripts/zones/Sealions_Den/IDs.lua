...
zones[xi.zone.SEALIONS_DEN] =
{
    text =
    {
        ...
        IRON_GATE_LOCKED              = 7098, -- A solid iron gate. It is tightly locked...
        ...
        TENZEN_MSG_OFFSET             = 7925, -- You will fall to my blade!
        MAKKI_CHEBUKKI_OFFSET         = 7929, -- Samurai Sky Pirate Power!
        KUKKI_CHEBUKKI_OFFSET         = 7934, -- What? Nooo!
        CHERUKIKI_OFFSET              = 7940, -- We're doomed!
    },
    mob =
    {
