...
zones[xi.zone.SEALIONS_DEN] =
{
    text =
    {
        ...
        IRON_GATE_LOCKED              = 7104, -- A solid iron gate. It is tightly locked...
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7603, -- Entering the battlefield for [One to Be Feared/The Warrior's Path/The Warrior's Path/One to Be Feared]!
        TENZEN_MSG_OFFSET             = 7931, -- You will fall to my blade!
        MAKKI_CHEBUKKI_OFFSET         = 7935, -- Samurai Sky Pirate Power!
        KUKKI_CHEBUKKI_OFFSET         = 7940, -- What? Nooo!
        CHERUKIKI_OFFSET              = 7946, -- We're doomed!
    },
    mob =
    {
