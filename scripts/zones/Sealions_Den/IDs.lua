...
zones[xi.zone.SEALIONS_DEN] =
{
    text =
    {
        ...
        IRON_GATE_LOCKED              = 7106, -- A solid iron gate. It is tightly locked...
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7605, -- Entering the battlefield for [One to Be Feared/The Warrior's Path/The Warrior's Path/One to Be Feared]!
        COSMIC_ELUCIDATION            = 7901, -- You are overwhelmed by Tenzen's Cosmic Elucidation!
        TENZEN_MSG_OFFSET             = 7933, -- You will fall to my blade!
        MAKKI_CHEBUKKI_OFFSET         = 7937, -- Samurai Sky Pirate Power!
        KUKKI_CHEBUKKI_OFFSET         = 7942, -- What? Nooo!
        CHERUKIKI_OFFSET              = 7948, -- We're doomed!
    },
    mob =
    {
