...
entity.onTrigger = function(player, npc)
    ...
    if orderUp == xi.questStatus.QUEST_ACCEPTED and not orderGrevan then
        ...
        if player:getQuestStatus(xi.quest.log_id.ADOULIN, xi.quest.id.adoulin.HYPOCRITICAL_OATH) == xi.questStatus.QUEST_COMPLETED then
            if player:getQuestStatus(xi.quest.log_id.ADOULIN, xi.quest.id.adoulin.NOTSOCLEAN_BILL) == xi.questStatus.QUEST_COMPLETED then
