...
zones[ xi.zone.WESTERN_ADOULIN] =
{
    text =
    {
        ...
        YOU_HAVE_JOINED_UNITY      = 12986, -- You have joined [Pieuje's/Ayame's/Invincible Shield's/Apururu's/Maat's/Aldo's/Jakoh Wahcondalo's/Naja Salaheem's/Flaviria's/Yoran-Oran's/Sylvie's] Unity!
        HAVE_ALREADY_CHANGED_UNITY = 13062, -- You have already changed Unities. Please wait until the next tabulation period.
    },
    mob =
    {
    },
