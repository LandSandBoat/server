...
zones[xi.zone.LA_THEINE_PLATEAU] =
{
    text =
    {
        ...
        RESCUE_DRILL                  = 7402,  -- Rescue drills in progress. Try to stay out of the way.
        FAURBELLANT_1                 = 7442,  -- Greetings. traveler. Sorry, I've little time to chat. I must focus on my prayer.
        FAURBELLANT_2                 = 7443,  -- Ah, the <item>! Thank you for making such a long journey to bring this! May the Gates of Paradise open to all.
        FAURBELLANT_3                 = 7444,  -- Please deliver that <item> to the high priest in the San d'Oria Cathedral.
        FAURBELLANT_4                 = 7445,  -- My thanks again for your services. May the Gates of Paradise open to all.
        ...
        VOIDWALKER_DESPAWN            = 7956,  -- The monster fades before your eyes, a look of disappointment on its face.
        UNITY_WANTED_BATTLE_INTERACT  = 7987,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        MEMORIES_SEALED_OFF           = 8081,  -- A portion of your memories has been sealed off.
        REGIME_REGISTERED             = 10136, -- New training regime registered!
        VOIDWALKER_NO_MOB             = 11309, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 11310, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 11311, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 11312, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 11314, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 11315, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 11316, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 11317, -- Obtained key item: <keyitem>!
        LEARNS_SPELL                  = 12335, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 12337, -- You are assaulted by an uncanny sensation.
