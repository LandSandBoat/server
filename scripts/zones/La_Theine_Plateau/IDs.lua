...
zones[xi.zone.LA_THEINE_PLATEAU] =
{
    text =
    {
        ...
        RESCUE_DRILL                 = 7391,  -- Rescue drills in progress. Try to stay out of the way.
        FAURBELLANT_1                = 7431,  -- Greetings. traveler. Sorry, I've little time to chat. I must focus on my prayer.
        FAURBELLANT_2                = 7432,  -- Ah, the <item>! Thank you for making such a long journey to bring this! May the Gates of Paradise open to all.
        FAURBELLANT_3                = 7433,  -- Please deliver that <item> to the high priest in the San d'Oria Cathedral.
        FAURBELLANT_4                = 7434,  -- My thanks again for your services. May the Gates of Paradise open to all.
