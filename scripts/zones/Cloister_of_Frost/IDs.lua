...
zones[xi.zone.CLOISTER_OF_FROST] =
{
    text =
    {
        ...
        SHIVA_UNLOCKED                   = 7580, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ...
        ATTACH_SEAL                      = 7779, -- <player> attaches <item> to the protocrystal.
        POWER_STYMIES                    = 7780, -- An unseen power stymies your efforts to attach <item> to the protocrystal.
    },
    mob =
    {
    },
