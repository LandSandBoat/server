...
zones[xi.zone.CLOISTER_OF_FROST] =
{
    text =
    {
        ...
        SHIVA_UNLOCKED                   = 7587, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7675, -- Entering the battlefield for [Trial by Ice/Class Reunion/Trial-Size Trial by Ice/Waking the Beast/Sugar-coated Directive/Trial by Ice]!
        ...
        ALREADY_HAVE_ALL_FRAGS           = 7685, -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
        FOUND_ALL_FRAGS                  = 7686, -- You have obtained <keyitem>! You now have all 8 fragments of light!
        ZILART_MONUMENT                  = 7687, -- It is an ancient Zilart monument.
        ATTACH_SEAL                      = 7786, -- <player> attaches <item> to the protocrystal.
        POWER_STYMIES                    = 7787, -- An unseen power stymies your efforts to attach <item> to the protocrystal.
    },
    mob =
    {
