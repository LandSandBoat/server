...
zones[xi.zone.CLOISTER_OF_FROST] =
{
    text =
    {
        ...
        SHIVA_UNLOCKED                   = 7572, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ...
        ALREADY_HAVE_ALL_FRAGS           = 7668, -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
        FOUND_ALL_FRAGS                  = 7669, -- You have obtained <keyitem>! You now have all 8 fragments of light!
