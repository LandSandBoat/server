...
zones[xi.zone.CLOISTER_OF_FROST] =
{
    text =
    {
        ...
        SHIVA_UNLOCKED                   = 7588, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7676, -- Entering the battlefield for [Trial by Ice/Class Reunion/Trial-Size Trial by Ice/Waking the Beast/Sugar-coated Directive/Trial by Ice]!
        ...
        ATTACH_SEAL                      = 7787, -- <player> attaches <item> to the protocrystal.
        POWER_STYMIES                    = 7788, -- An unseen power stymies your efforts to attach <item> to the protocrystal.
    },
    mob =
    {
