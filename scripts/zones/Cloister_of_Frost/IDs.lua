...
zones[xi.zone.CLOISTER_OF_FROST] =
{
    text =
    {
        ...
        YOU_CANNOT_ENTER_THE_BATTLEFIELD = 7233, -- You cannot enter the battlefield at present. Please wait a little longer.
        ...
        PROTOCRYSTAL                     = 7257, -- It is a giant crystal.
        ...
        SHIVA_UNLOCKED                   = 7591, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7679, -- Entering the battlefield for [Trial by Ice/Class Reunion/Trial-Size Trial by Ice/Waking the Beast/Sugar-coated Directive/★Trial by Ice]!
        ...
        ATTACH_SEAL                      = 7790, -- <player> attaches <item> to the protocrystal.
