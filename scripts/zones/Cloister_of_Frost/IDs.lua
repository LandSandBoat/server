...
zones[xi.zone.CLOISTER_OF_FROST] =
{
    text =
    {
        ...
        SHIVA_UNLOCKED                   = 7576, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        CANNOT_REMOVE_FRAG               = 7670, -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
        ALREADY_OBTAINED_FRAG            = 7671, -- You have already obtained this monument's <keyitem>. Try searching for another.
