...
zones[xi.zone.ABYSSEA_GRAUBERG] =
{
    text =
    {
        ...
        PLAYER_GAINED_EXPERIENCE    = 6998,  -- <name> gained <number> [points of experience/limit points].
        ...
        OBTAINS_DOMINION_NOTES      = 7872,  -- <name> obtains <number> Dominion note[/s] (Total: <number>).
        DOMINION_SIGNED_ON          = 10408, -- You have signed on for Dominion Ops!
        CANCELED_OBJECTIVE          = 10409, -- You have canceled your objective.
    },
    mob =
    {
    },
