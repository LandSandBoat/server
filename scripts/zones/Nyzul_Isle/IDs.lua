...
zones[xi.zone.NYZUL_ISLE] =
{
    text =
    {
        ...
        TEMP_ITEM_OBTAINED            = 7348, -- Obtained temporary item: <item>
        ...
        RESTRICTION_JOB_ABILITIES     = 7376, -- Job abilities are restricted.
        RESTRICTION_WEAPON_SKILLS     = 7378, -- Weapon skills are restricted.
        RESTRICTION_WHITE_MAGIC       = 7380, -- White magic is restricted.
        RESTRICTION_BLACK_MAGIC       = 7382, -- Black Magic is restricted.
        RESTRICTION_SONGS             = 7384, -- Songs are restricted.
        RESTRICTION_NINJITSU          = 7386, -- Ninjutsu is restricted.
        RESTRICTION_SUMMON_MAGIC      = 7388, -- Summon Magic is restricted.
        RESTRICTION_BLUE_MAGIC        = 7390, -- Blue Magic is restricted.
        AFFLICTION_ATTACK_SPEED_DOWN  = 7392, -- Afflicted by Attack Speed Down.
        AFFLICTION_CASTING_SPEED_DOWN = 7394, -- Afflicted by Casting Speed Down.
        AFFLICTION_STR_DOWN           = 7396, -- Afflicted by STR Down.
        AFFLICTION_DEX_DOWN           = 7398, -- Afflicted by DEX Down.
        AFFLICTION_VIT_DOWN           = 7400, -- Afflicted by VIT Down.
        AFFLICTION_AGI_DOWN           = 7402, -- Afflicted by AGI Down.
        AFFLICTION_INT_DOWN           = 7404, -- Afflicted by INT Down.
        AFFLICTION_MND_DOWN           = 7406, -- Afflicted by MND Down.
        AFFLICTION_CHR_DOWN           = 7408, -- Afflicted by CHR Down.
        RECEIVED_REGAIN_EFFECT        = 7410, -- Received Regain effect.
        RECEIVED_REGEN_EFFECT         = 7412, -- Received Regen effect.
        RECEIVED_REFRESH_EFFECT       = 7414, -- Received Refresh effect.
        RECEIVED_FLURRY_EFFECT        = 7416, -- Received Flurry effect.
        RECEIVED_CONCENTRATION_EFFECT = 7418, -- Received Concentration effect.
        RECEIVED_STR_BOOST            = 7420, -- Received STR Boost.
        RECEIVED_DEX_BOOST            = 7422, -- Received DEX Boost.
        RECEIVED_VIT_BOOST            = 7424, -- Received VIT Boost.
        RECEIVED_AGI_BOOST            = 7426, -- Received AGI Boost.
        RECEIVED_INT_BOOST            = 7428, -- Received INT Boost.
        RECEIVED_MND_BOOST            = 7430, -- Received MND Boost.
        RECEIVED_CHR_BOOST            = 7432, -- Received CHR Boost.
        ...
        DIVINE_MIGHT                  = 7537, -- Incredible. Feel the infinite power of divine might! Alexander will lead Aht Urhgan to certain victory!
