...
entity.onTrigger = function(player, npc)
    ...
    local stock =
    {
        ...
        { xi.item.SHEET_OF_BAST_PARCHMENT,      30 },
        ...
        { xi.item.JAR_OF_TOAD_OIL,             600 },
        { xi.item.GINGER_ROOT,                 300 },
        { xi.item.HANDFUL_OF_BAY_LEAVES,       300 },
        { xi.item.SHINOBI_TABI,                 40 },
        ...
        { xi.item.SCROLL_OF_KURAYAMI_NI,     10000 },
