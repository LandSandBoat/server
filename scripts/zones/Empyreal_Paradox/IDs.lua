...
zones[xi.zone.EMPYREAL_PARADOX] =
{
    text =
    {
        ...
        PRISHE_TEXT                   = 7697, -- You're about to learn how strong the will to live makes us!
        SELHTEUS_TEXT                 = 7710, -- The...Emptiness... Is this...how it was meant...to be...?
        PROMATHIA_TEXT                = 7713, -- Give thyself to the apathy within...
        QM_TEXT                       = 7811, -- The air before you appears warped and distorted...
    },
    mob =
    {
