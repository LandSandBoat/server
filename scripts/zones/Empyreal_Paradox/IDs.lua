...
zones[xi.zone.EMPYREAL_PARADOX] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7603, -- Entering the battlefield for [Dawn/Apocalypse Nigh/Both Paths Taken/Dawn/The Winds of Time/Sealed Fate]!
        PRISHE_TEXT                   = 7705, -- You're about to learn how strong the will to live makes us!
        SELHTEUS_TEXT                 = 7718, -- The...Emptiness... Is this...how it was meant...to be...?
        PROMATHIA_TEXT                = 7721, -- Give thyself to the apathy within...
        AIR_WARPED_AND_DISTORTED      = 7819, -- The air before you appears warped and distorted...
    },
    mob =
    {
