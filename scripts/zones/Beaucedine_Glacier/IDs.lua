...
zones[xi.zone.BEAUCEDINE_GLACIER] =
{
    text =
    {
        ...
        CONQUEST                       = 7501,  -- You've earned conquest points!
        ...
        GARRISON_BASE                  = 8243,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        ...
        UNITY_WANTED_BATTLE_INTERACT   = 8646,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED              = 10762, -- New training regime registered!
        VOIDWALKER_NO_MOB              = 11881, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR         = 11882, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT            = 11883, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB           = 11884, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1        = 11886, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2        = 11887, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI            = 11888, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI           = 11889, -- Obtained key item: <keyitem>!
        LEARNS_SPELL                   = 12779, -- <name> learns <spell>!
        UNCANNY_SENSATION              = 12781, -- You are assaulted by an uncanny sensation.
