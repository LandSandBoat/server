...
zones[xi.zone.THE_SHRINE_OF_RUAVITAU] =
{
    text =
    {
        ...
        SMALL_HOLE_HERE          = 7343,  -- There is a small hole here. It appears to be damp inside...
        KIRIN_OFFSET             = 7354,  -- I am Kirin, master of the Shijin. The one who stands above all. You, who have risen above your mortal status to contend with the gods... It is time to reap your reward.
