...
entity.onMobMobskillChoose = function(mob, target, skillId)
    local skillList =
    {
        xi.mobSkill.THUNDER_BREAK_1,
        xi.mobSkill.CRYSTAL_RAIN_1,
        xi.mobSkill.CRYSTAL_WEAPON_STONE_1,
    }

    local mimicTable =
    {
        [mob:getID() - 3] = { crystalWeapon = xi.mobSkill.CRYSTAL_WEAPON_FIRE_1,  elementalBreak = xi.mobSkill.ICE_BREAK_1     }, -- Fire Golem
        [mob:getID() - 2] = { crystalWeapon = xi.mobSkill.CRYSTAL_WEAPON_WATER_1, elementalBreak = xi.mobSkill.ICE_BREAK_1     }, -- Water Golem
        [mob:getID() - 1] = { crystalWeapon = xi.mobSkill.CRYSTAL_WEAPON_WIND_1,  elementalBreak = xi.mobSkill.THUNDER_BREAK_1 }, -- Wind Golem
    }
    ...
    for golemID, mimicSkills in pairs(mimicTable) do
        ...
        if chosenSkill == xi.mobSkill.CRYSTAL_WEAPON_STONE_1 then
            mimicSkill = mimicSkills.crystalWeapon
        elseif chosenSkill == xi.mobSkill.THUNDER_BREAK_1 then
