...
entity.onMobMobskillChoose = function(mob, target, skillId)
    local skillList =
    {
        ...
        xi.mobSkill.CRYSTAL_WEAPON_WATER_1,
    }

    local mimicTable =
    {
        [mob:getID() - 1] = { crystalWeapon = xi.mobSkill.CRYSTAL_WEAPON_FIRE_1,  elementalBreak = xi.mobSkill.ICE_BREAK_1     }, -- Fire Golem
    ...
    for golemID, mimicSkills in pairs(mimicTable) do
        ...
        if chosenSkill == xi.mobSkill.CRYSTAL_WEAPON_WATER_1 then
