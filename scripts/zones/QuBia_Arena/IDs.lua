...
zones[xi.zone.QUBIA_ARENA] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7603, -- Entering the battlefield for [The Rank 5 Mission/Come Into My Parlor/E-vase-ive Action/Infernal Swarm/The Heir to the Light/Shattering Stars (PLD)/Shattering Stars (DRK)/Shattering Stars (BRD)/Demolition Squad/Die by the Sword/Let Sleeping Dogs Die/Brothers D'Aurphe/Undying Promise/Factory Rejects/Idol Thoughts/An Awful Autopsy/Celery/Mirror Images/A Furious Finale/Clash of the Comrades/Those Who Lurk in Shadows/Beyond Infinity/Factory Rejects/Demolition Squad/Brothers D'Aurphe/Mumor's Encore]!
        FLAT_PREPARE                  = 7642, -- I am Trion, of San d'Oria!
        FLAT_LAND                     = 7643, -- Feel the fire of my forefathers!
        RLB_PREPARE                   = 7644, -- The darkness before me that shrouds the light of good...
        RLB_LAND                      = 7645, -- ...Return to the hell you crawled out from!
        SAVAGE_PREPARE                = 7646, -- The anger, the pain, and the will to survive... Let the spirit of San d'Oria converge within this blade.
        SAVAGE_LAND                   = 7647, -- And with this blade I will return the glory to my kingdom's people!
        ...
        SOUL_GEM_REACTS               = 8009, -- The <keyitem> reacts to the <keyitem>, sending a jolt of energy through your veins!
        PROMISE_ME_YOU_WONT_GO_DOWN   = 8024, -- Promise you won't go down too easy, okay?
        IM_JUST_GETTING_WARMED_UP     = 8025, -- Haha! I'm just getting warmed up!
        YOU_PACKED_MORE_OF_A_PUNCH    = 8026, -- Hah! You pack more of a punch than I thoughtaru. But I won't go down as easy as old Maat!
        WHATS_THIS_STRANGE_FEELING    = 8027, -- What's this strange feeling...? It's not supposed to end...like...
        HUH_IS_THAT_ALL               = 8028, -- Huh? Is that all? I haven't even broken a sweataru...
        YIKEY_WIKEYS                  = 8029, -- Yikey-wikeys! Get that thing away from meee!
        WHATS_THE_MATTARU             = 8030, -- <Pant, wheeze>... What's the mattaru, <name>? Too much of a pansy-wansy to fight fair?
    },
