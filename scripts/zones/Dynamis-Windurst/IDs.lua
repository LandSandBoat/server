...
zones[xi.zone.DYNAMIS_WINDURST] =
{
    ...
    mob =
    {
        TIME_EXTENSION =
        {
            { minutes = 10, ki = xi.keyItem.CRIMSON_GRANULES_OF_TIME,   mob = 17543258 },
            { minutes = 10, ki = xi.keyItem.AZURE_GRANULES_OF_TIME,     mob = 17543342 },
            { minutes = 10, ki = xi.keyItem.AMBER_GRANULES_OF_TIME,     mob = 17543372 },
            { minutes = 15, ki = xi.keyItem.ALABASTER_GRANULES_OF_TIME, mob = 17543446 },
            { minutes = 15, ki = xi.keyItem.OBSIDIAN_GRANULES_OF_TIME,  mob = 17543259 },
        },
