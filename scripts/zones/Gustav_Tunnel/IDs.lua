...
zones[xi.zone.GUSTAV_TUNNEL] =
{
    text =
    {
        ...
        BAD_FEELING_ABOUT_PLACE       = 7326,  -- You have a bad feeling about this place.
        SENSE_OMINOUS_PRESENCE        = 7328,  -- You sense an ominous presence...
        UNITY_WANTED_BATTLE_INTERACT  = 7449,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 9596,  -- New training regime registered!
        PLAYER_OBTAINS_ITEM           = 10648, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 10649, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 10650, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 10651, -- You already possess that temporary item.
        NO_COMBINATION                = 10656, -- You were unable to enter a combination.
