...
zones[xi.zone.GUSTAV_TUNNEL] =
{
    text =
    {
        ...
        UNABLE_TO_OBTAIN_ITEM    = 10635, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM = 10636, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP     = 10637, -- You already possess that temporary item.
        NO_COMBINATION           = 10642, -- You were unable to enter a combination.
        COMMON_SENSE_SURVIVAL    = 10666, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
