...
zones[xi.zone.GUSTAV_TUNNEL] =
{
    text =
    {
        ...
        BAD_FEELING_ABOUT_PLACE  = 7315,  -- You have a bad feeling about this place.
        SENSE_OMINOUS_PRESENCE   = 7317,  -- You sense an ominous presence...
        REGIME_REGISTERED        = 9585,  -- New training regime registered!
        PLAYER_OBTAINS_ITEM      = 10637, -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM    = 10638, -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM = 10639, -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP     = 10640, -- You already possess that temporary item.
        NO_COMBINATION           = 10645, -- You were unable to enter a combination.
