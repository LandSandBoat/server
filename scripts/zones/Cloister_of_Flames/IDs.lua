...
zones[xi.zone.CLOISTER_OF_FLAMES] =
{
    text =
    {
        ...
        IFRIT_UNLOCKED                   = 7591, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7679, -- Entering the battlefield for [Trial by Fire/Trial-Size Trial by Fire/Waking the Beast/Sugar-coated Directive/★Trial by Fire]!
        ATTACH_SEAL                      = 7738, -- <player> attaches <item> to the protocrystal.
