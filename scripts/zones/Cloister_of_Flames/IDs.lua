...
zones[xi.zone.CLOISTER_OF_FLAMES] =
{
    text =
    {
        ...
        IFRIT_UNLOCKED                   = 7588, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7676, -- Entering the battlefield for [Trial by Fire/Trial-Size Trial by Fire/Waking the Beast/Sugar-coated Directive/Trial by Fire]!
        ATTACH_SEAL                      = 7735, -- <player> attaches <item> to the protocrystal.
        POWER_STYMIES                    = 7736, -- An unseen power stymies your efforts to attach <item> to the protocrystal.
    },
    mob =
    {
