...
zones[xi.zone.CLOISTER_OF_FLAMES] =
{
    text =
    {
        ...
        IFRIT_UNLOCKED                   = 7592, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7680, -- Entering the battlefield for [Trial by Fire/Trial-Size Trial by Fire/Waking the Beast/Sugar-coated Directive/★Trial by Fire]!
