...
zones[xi.zone.CLOISTER_OF_FLAMES] =
{
    text =
    {
        ...
        IFRIT_UNLOCKED                   = 7580, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ATTACH_SEAL                      = 7727, -- <player> attaches <item> to the protocrystal.
        POWER_STYMIES                    = 7728, -- An unseen power stymies your efforts to attach <item> to the protocrystal.
    },
    mob =
    {
    },
