...
zone_object.onZoneIn = function(player, prevZone)
    ...
    if (player:getCurrentMission(ZILART) == xi.mission.id.zilart.AWAKENING and player:getMissionStatus(xi.mission.log_id.ZILART) == 0 or player:getMissionStatus(xi.mission.log_id.ZILART) == 2) then
        cs = 176
    end
