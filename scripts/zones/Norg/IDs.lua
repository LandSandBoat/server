...
zones[xi.zone.NORG] =
{
    text =
    {
        ...
        YOU_CAN_NOW_BECOME_A_SAMURAI  = 10218, -- You accept the <item> from Gilgamesh. You can now become a samurai.
        CARRYING_TOO_MUCH_ALREADY     = 10219, -- I wish to give you your reward, but you seem to be carrying too much already. Come back when you have more room in your pack.
        JIROKICHI_SHOP_DIALOG         = 10365, -- Heh-heh-heh. Feast your eyes on these beauties. You won't find stuff like this anywhere!
        VULIAIE_SHOP_DIALOG           = 10366, -- Please, stay and have a look. You may find something you can only buy here.
        ACHIKA_SHOP_DIALOG            = 10367, -- Can I interest you in some armor forged in the surrounding regions?
        CHIYO_SHOP_DIALOG             = 10368, -- Magic scrolls! Magic scrolls! We've got parchment hot off the sheep!
        SPASIJA_DELIVERY_DIALOG       = 10369, -- Hiya! I can deliver packages to anybody, anywhere, anytime. What do you say?
        PALEILLE_DELIVERY_DIALOG      = 10370, -- We can deliver parcels to any residence in Vana'diel.
        DOOR_IS_LOCKED                = 10375, -- The door is locked tight.
        ...
        TACHI_KASHA_LEARNED           = 10825, -- You have learned the weapon skill Tachi: Kasha!
        BLADE_KU_LEARNED              = 10850, -- You have learned the weapon skill Blade: Ku!
        RETRIEVE_DIALOG_ID            = 11303, -- You retrieve <item> from the porter moogle's care.
        COMMON_SENSE_SURVIVAL         = 12313, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        DIDYA_GET_BUMPED              = 12341, -- Didya get bumped about by the waves on yer way here, <name>? No matter. The boss be waitin' inside fer ya.
    },
    mob =
    {
    },
