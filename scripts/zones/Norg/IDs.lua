...
zones[tpz.zone.NORG] =
{
    text =
    {
        ...
        CARRIED_OVER_POINTS          = 6449, -- You have carried over <number> points.
        LOGIN_CAMPAIGN_UNDERWAY      = 6450, -- The <month> ≺year≻ Login Campaign is currently underway!
        LOGIN_NUMBER                 = 6451, -- In celebration of your most recent login no. <number>...
