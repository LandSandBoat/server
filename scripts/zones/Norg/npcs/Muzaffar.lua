...
function onTrade(player, npc, trade)
    ...
    if (player:getQuestStatus(tpz.quest.log_id.NORG, tpz.quest.id.outlands.BLACK_MARKET) == QUEST_ACCEPTED or player:getQuestStatus(tpz.quest.log_id.NORG, tpz.quest.id.outlands.BLACK_MARKET) == QUEST_COMPLETED) then
...
function onEventFinish(player, csid, option)
    ...
    elseif (csid == 17) then
        ...
        if (player:getQuestStatus(tpz.quest.log_id.NORG, tpz.quest.id.outlands.BLACK_MARKET) == QUEST_ACCEPTED) then
