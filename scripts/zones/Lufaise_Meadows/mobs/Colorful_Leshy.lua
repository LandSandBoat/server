...
entity.onMobInitialize = function(mob)
    mob:setLocalVar('timeToGrow', GetSystemTime() + math.randomInt(43200, 86400)) -- Colorful in 12 to 24 hours
end

local function disturbMob(mob)
    GetMobByID(mob:getID() + 1):setLocalVar('timeToGrow', GetSystemTime() + math.randomInt(43200, 86400)) -- Defoliate in 12 to 24 hours
end
...
entity.onMobDespawn = function(mob)
    ...
    if phIndex ~= 0 then
        ...
        mob:setLocalVar('timeToGrow', GetSystemTime() + math.randomInt(3200, 86400)) -- Colorful in 12 to 24 hours
    end
end
