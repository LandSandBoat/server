...
zones[xi.zone.MOG_GARDEN] =
{
    text =
    {
        ...
        STARS_ON_KEYITEM              = 7504, -- <number> star[/s] on your <item> [has/have] come aglow. A total of <number> star[/s] twinkle[s/] softly inside your <item>.
        MOGLOCKER_MESSAGE_OFFSET      = 7520, -- Your particular paid period of Mog Locker patronage has been extended until the following time, kupo! Earth Time: #/#/# at #:#:#.
        RETRIEVE_DIALOG_ID            = 8571, -- You retrieve <item> from the porter moogle's care.
    },
    mob =
    {
    },
