...
zones[xi.zone.DANGRUF_WADI] =
{
    text =
    {
        ...
        CRYSTALLINE_DUST              = 7365,  -- The area is littered with a white crystalline dust.
        PLANT_EXTRACT                 = 7366,  -- A plant extract is smeared around the area.
        BROKEN_EGGS                   = 7367,  -- A number of broken eggs lie scattered about.
        YOU_PLACE_ITEM                = 7368,  -- You place <item> down.
        YOU_BEAT_GOBLIN               = 7370,  -- You beat the Goblin!
        GOBLIN_BEAT_YOU               = 7371,  -- The Goblin beat you...
        YOU_GAVE_UP                   = 7372,  -- You gave up...
        BEAT_SALTVIX                  = 7377,  -- You hear a voice... (...Hmph! All happy 'cause [he/she] beat Saltvix...Won't stand chance 'gainst Grasswix of North...)
        DONT_WASTE_TIME               = 7387,  -- You hear a voice... (Grasswix don't waste time with losers...)
        BEAT_GRASSWIX                 = 7388,  -- You hear a voice... (...can't believe it! How could Grasswix lose! Eggblix of Cavern...he no lose!)
        JUST_WONT_DO                  = 7398,  -- You hear a voice... (...just won't do...nope...nope...)
        BEAT_EGGBLIX                  = 7399,  -- (...Lucky, ya are! Don't forget to say hi to our sister at Drachenfall!)
        CHEST_UNLOCKED                = 7459,  -- You unlock the chest!
        SMALL_HOLE                    = 7513,  -- There is a small hole here.
        PLAYER_OBTAINS_ITEM           = 8390,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8391,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8392,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8393,  -- You already possess that temporary item.
        NO_COMBINATION                = 8398,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 10476, -- New training regime registered!
