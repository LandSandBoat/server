...
zones[xi.zone.DANGRUF_WADI] =
{
    text =
    {
        ...
        CRYSTALLINE_DUST              = 7360,  -- The area is littered with a white crystalline dust.
        PLANT_EXTRACT                 = 7361,  -- A plant extract is smeared around the area.
        BROKEN_EGGS                   = 7362,  -- A number of broken eggs lie scattered about.
        YOU_PLACE_ITEM                = 7363,  -- You place <item> down.
        YOU_BEAT_GOBLIN               = 7365,  -- You beat the Goblin!
        GOBLIN_BEAT_YOU               = 7366,  -- The Goblin beat you...
        YOU_GAVE_UP                   = 7367,  -- You gave up...
        BEAT_SALTVIX                  = 7372,  -- You hear a voice... (...Hmph! All happy 'cause [he/she] beat Saltvix...Won't stand chance 'gainst Grasswix of North...)
        DONT_WASTE_TIME               = 7382,  -- You hear a voice... (Grasswix don't waste time with losers...)
        BEAT_GRASSWIX                 = 7383,  -- You hear a voice... (...can't believe it! How could Grasswix lose! Eggblix of Cavern...he no lose!)
        JUST_WONT_DO                  = 7393,  -- You hear a voice... (...just won't do...nope...nope...)
        BEAT_EGGBLIX                  = 7394,  -- (...Lucky, ya are! Don't forget to say hi to our sister at Drachenfall!)
        CHEST_UNLOCKED                = 7454,  -- You unlock the chest!
        SMALL_HOLE                    = 7508,  -- There is a small hole here.
