...
zones[xi.zone.BEHEMOTHS_DOMINION] =
{
    text =
    {
        ...
        SOMETHING_BETTER         = 7319,  -- Don't you have something better to do right now?
        CANNOT_REMOVE_FRAG       = 7322,  -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
        ALREADY_OBTAINED_FRAG    = 7323,  -- You have already obtained this monument's <keyitem>. Try searching for another.
        FOUND_ALL_FRAGS          = 7325,  -- You have obtained <keyitem>! You now have all 8 fragments of light!
        ZILART_MONUMENT          = 7326,  -- It is an ancient Zilart monument.
        PLAYER_OBTAINS_ITEM      = 7347,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM    = 7348,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM = 7349,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP     = 7350,  -- You already possess that temporary item.
        NO_COMBINATION           = 7355,  -- You were unable to enter a combination.
