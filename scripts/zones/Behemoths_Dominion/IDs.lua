...
zones[xi.zone.BEHEMOTHS_DOMINION] =
{
    text =
    {
        ...
        SOMETHING_BETTER         = 7322,  -- Don't you have something better to do right now?
        CANNOT_REMOVE_FRAG       = 7325,  -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
        ALREADY_OBTAINED_FRAG    = 7326,  -- You have already obtained this monument's <keyitem>. Try searching for another.
        FOUND_ALL_FRAGS          = 7328,  -- You have obtained <keyitem>! You now have all 8 fragments of light!
        ZILART_MONUMENT          = 7329,  -- It is an ancient Zilart monument.
