...
zones[xi.zone.BEHEMOTHS_DOMINION] =
{
    text =
    {
        ...
        IRREPRESSIBLE_MIGHT           = 6412,  -- An aura of irrepressible might threatens to overwhelm you...
        ...
        THERE_ARE_SYMBOLS             = 7332,  -- There are some symbols inscribed upon it.
        YOU_HEAR_A_NOISE              = 7334,  -- You hear a noise behind you.
        AIR_AROUND_YOU_CHANGED        = 7338,  -- The air around you has suddenly changed!
        SOMETHING_BETTER              = 7339,  -- Don't you have something better to do right now?
        CANNOT_REMOVE_FRAG            = 7342,  -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
        ALREADY_OBTAINED_FRAG         = 7343,  -- You have already obtained this monument's <keyitem>. Try searching for another.
        FOUND_ALL_FRAGS               = 7345,  -- You have obtained <keyitem>! You now have all 8 fragments of light!
        ZILART_MONUMENT               = 7346,  -- It is an ancient Zilart monument.
        PLAYER_OBTAINS_ITEM           = 7367,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7368,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7369,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7370,  -- You already possess that temporary item.
        NO_COMBINATION                = 7375,  -- You were unable to enter a combination.
        UNITY_WANTED_BATTLE_INTERACT  = 7437,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
