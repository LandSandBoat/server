...
zones[xi.zone.BEHEMOTHS_DOMINION] =
{
    text =
    {
        ...
        AIR_AROUND_YOU_CHANGED        = 7332,  -- The air around you has suddenly changed!
        SOMETHING_BETTER              = 7333,  -- Don't you have something better to do right now?
        CANNOT_REMOVE_FRAG            = 7336,  -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
        ALREADY_OBTAINED_FRAG         = 7337,  -- You have already obtained this monument's <keyitem>. Try searching for another.
        FOUND_ALL_FRAGS               = 7339,  -- You have obtained <keyitem>! You now have all 8 fragments of light!
        ...
        UNITY_WANTED_BATTLE_INTERACT  = 7431,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 9547,  -- New training regime registered!
        LEARNS_SPELL                  = 11536, -- <name> learns <spell>!
        UNCANNY_SENSATION             = 11538, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL         = 11545, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
