...
zones[xi.zone.BEHEMOTHS_DOMINION] =
{
    text =
    {
        ...
        IRREPRESSIBLE_MIGHT           = 6413,  -- An aura of irrepressible might threatens to overwhelm you...
        ...
        SOMETHING_BETTER              = 7340,  -- Don't you have something better to do right now?
        CANNOT_REMOVE_FRAG            = 7343,  -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
        ALREADY_OBTAINED_FRAG         = 7344,  -- You have already obtained this monument's <keyitem>. Try searching for another.
        ALREADY_HAVE_ALL_FRAGS        = 7345,  -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
        FOUND_ALL_FRAGS               = 7346,  -- You have obtained <keyitem>! You now have all 8 fragments of light!
        ZILART_MONUMENT               = 7347,  -- It is an ancient Zilart monument.
        ...
        UNITY_WANTED_BATTLE_INTERACT  = 7438,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 9554,  -- New training regime registered!
