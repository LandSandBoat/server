...
zones[xi.zone.INNER_HORUTOTO_RUINS] =
{
    text =
    {
        ...
        NOT_BROKEN_ORB                = 7252,  -- The Mana Orb in this receptacle is not broken.
        EXAMINED_RECEPTACLE           = 7253,  -- You have already examined this receptacle.
        DOOR_FIRMLY_CLOSED            = 7280,  -- The door is firmly closed.
        CAT_BURGLARS_HIDEOUT          = 7281,  -- It looks like that Cat Burglar's hideout lies behind this door! You were able to confirm <keyitem>!
