...
zones[xi.zone.INNER_HORUTOTO_RUINS] =
{
    text =
    {
        ...
        NOT_BROKEN_ORB            = 7238,  -- The Mana Orb in this receptacle is not broken.
        EXAMINED_RECEPTACLE       = 7239,  -- You have already examined this receptacle.
        DOOR_FIRMLY_CLOSED        = 7266,  -- The door is firmly closed.
        CAT_BURGLARS_HIDEOUT      = 7267,  -- It looks like that Cat Burglar's hideout lies behind this door! You were able to confirm <keyitem>!
