...
zones[xi.zone.INNER_HORUTOTO_RUINS] =
{
    text =
    {
        ...
        NOT_BROKEN_ORB            = 7241,  -- The Mana Orb in this receptacle is not broken.
        EXAMINED_RECEPTACLE       = 7242,  -- You have already examined this receptacle.
        DOOR_FIRMLY_CLOSED        = 7269,  -- The door is firmly closed.
        CAT_BURGLARS_HIDEOUT      = 7270,  -- It looks like that Cat Burglar's hideout lies behind this door! You were able to confirm <keyitem>!
