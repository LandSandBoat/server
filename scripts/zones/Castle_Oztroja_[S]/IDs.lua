...
zones[xi.zone.CASTLE_OZTROJA_S] =
{
    ...
    mob =
    {
        ...
        DEE_ZELKO_THE_ESOTERIC = DYNAMIC_LOOKUP,
        MARQUIS_FORNEUS        = DYNAMIC_LOOKUP,
        LOO_KUTTO_THE_PENSIVE  = DYNAMIC_LOOKUP,
        FLESHGNASHER           = DYNAMIC_LOOKUP,
        VEE_LADU_THE_TITTERER  = DYNAMIC_LOOKUP,
        MAA_ILLMU_THE_BESTOWER = DYNAMIC_LOOKUP,
        ASTERION               = DYNAMIC_LOOKUP,
        SUU_XICU_THE_CANTABILE = DYNAMIC_LOOKUP,
    },
