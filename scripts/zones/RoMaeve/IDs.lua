...
zones[xi.zone.ROMAEVE] =
{
    text =
    {
        ...
        PILE_OF_RUBBLE           = 7397,  -- It is nothing but a pile of rubble.
        A_CHILL_RUNS_DOWN_SPINE  = 7398,  -- A chill runs down your spine.
        SENSE_OMINOUS_PRESENCE   = 7401,  -- You sense an ominous presence...
        ITEMS_ITEMS_LA_LA        = 7404,  -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY      = 7410,  -- The Goblin slipped away when you were not looking...
        PLAYER_OBTAINS_ITEM      = 7433,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM    = 7434,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM = 7435,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP     = 7436,  -- You already possess that temporary item.
        NO_COMBINATION           = 7441,  -- You were unable to enter a combination.
        REGIME_REGISTERED        = 9619,  -- New training regime registered!
