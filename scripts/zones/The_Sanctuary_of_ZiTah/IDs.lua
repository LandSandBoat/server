...
zones[xi.zone.THE_SANCTUARY_OF_ZITAH] =
{
    text =
    {
        ...
        AIR_HAS_SUDDENLY_CHANGED      = 7750,  -- The air around you has suddenly changed!
        SOMETHING_BETTER              = 7751,  -- Don't you have something better to do right now?
        CANNOT_REMOVE_FRAG            = 7754,  -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
        ALREADY_OBTAINED_FRAG         = 7755,  -- You have already obtained this monument's <keyitem>. Try searching for another.
        FOUND_ALL_FRAGS               = 7757,  -- You have obtained <keyitem>! You now have all 8 fragments of light!
        ZILART_MONUMENT               = 7758,  -- It is an ancient Zilart monument.
        AIR_REMAINS_STAGNANT          = 7770,  -- The air in this area remains stagnant. You begin to feel sick... It would be wise to leave immediately.
        LOOKS_LIKE_STURDY_BRANCH      = 7780,  -- This looks like a sturdy branch. You will need <item> to cut it off.
        BEAUTIFUL_STURDY_BRANCH       = 7781,  -- It is a beautiful, sturdy branch.
        SENSE_STRONG_EVIL_PRESENCE    = 7783,  -- You can sense a strong, evil presence!
        STRANGE_FORCE_PREVENTS        = 7784,  -- Some strange force is preventing you from cutting all the way through.
        STRANGE_FORCE_VANISHED        = 7785,  -- The strange force has vanished, and <item> has newly sprouted in the cut!
        NO_LONGER_SENSE_EVIL          = 7786,  -- You no longer sense the evil presence, but there is still a feeling of unrest throughout the forest.
        NEWLY_SPROUTED_GLOWING        = 7787,  -- The newly sprouted <item> is glowing softly. You no longer feel as if you are being watched.
        NOT_THE_TIME_FOR_THAT         = 7788,  -- This is not the time for that!
