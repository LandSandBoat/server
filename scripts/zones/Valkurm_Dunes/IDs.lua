...
zones[xi.zone.VALKURM_DUNES] =
{
    text =
    {
        ...
        SONG_RUNES_DEFAULT             = 7337,  -- Lyrics on the old monument sing the story of lovers torn apart.
        UNLOCK_BARD                    = 7358,  -- You can now become a bard!
        SIGNPOST2                      = 7366,  -- Northeast: La Theine Plateau Southeast: Konschtat Highlands West: Selbina
        SIGNPOST1                      = 7367,  -- Northeast: La Theine Plateau Southeast: Konschtat Highlands Southwest: Selbina
