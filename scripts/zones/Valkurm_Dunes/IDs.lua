...
zones[xi.zone.VALKURM_DUNES] =
{
    text =
    {
        ...
        PICK_UP_THE_ITEM               = 7837,  -- You pick up the <item>.
        TOO_FAR_AWAY                   = 7838,  -- You are too far away.
        ...
        NOTHING_TRY_AGAIN              = 7842,  -- Nothing happens.  Please wait a moment and try again.
        ...
        WHAT_COULD_THAT_BE             = 7845,  -- Wh-whatever could that be!?
        NO_LONGER_FEEL_CHILL           = 7858,  -- You no longer feel a chill.  The chart maylose is power if you venture too far.
