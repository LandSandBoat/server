...
zone_object.onInitialize = function(zone)
    ...
    if RESPAWN_SAVE_TIME then
        GetMobByID(ID.mob.LIKHO):setRespawnTime(math.random(RESPAWN_SAVE_TIME_MIN, RESPAWN_SAVE_TIME_MAX))
    else
    ...
    if RESPAWN_SAVE_TIME then
        GetMobByID(ID.mob.MARQUIS_ALLOCEN):setRespawnTime(math.random(RESPAWN_SAVE_TIME_MIN, RESPAWN_SAVE_TIME_MAX))
    else
    ...
    if RESPAWN_SAVE_TIME then
        GetMobByID(ID.mob.MARQUIS_AMON):setRespawnTime(math.random(RESPAWN_SAVE_TIME_MIN, RESPAWN_SAVE_TIME_MAX))
    else
    ...
    if RESPAWN_SAVE_TIME then
        GetMobByID(ID.mob.DUKE_HABORYM):setRespawnTime(math.random(RESPAWN_SAVE_TIME_MIN, RESPAWN_SAVE_TIME_MAX))
    else
    ...
    if RESPAWN_SAVE_TIME then
        GetMobByID(ID.mob.GRAND_DUKE_BATYM):setRespawnTime(math.random(RESPAWN_SAVE_TIME_MIN, RESPAWN_SAVE_TIME_MAX))
    else
