...
zones[xi.zone.THE_SHROUDED_MAW] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7097, -- An unfathomable light is rising from this strangely marked platform...
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7604, -- Entering the battlefield for [Darkness Named/Test Your Mite/Waking Dreams/Waking Dreams]!
    },
    mob =
    {
