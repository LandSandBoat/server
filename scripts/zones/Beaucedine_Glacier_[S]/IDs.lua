...
zones[xi.zone.BEAUCEDINE_GLACIER_S] =
{
    text =
    {
        ...
        GATHERED_DAWNDROPS_LIGHT      = 8690, -- The gathered dawndrops unleash a brilliant light, melding together to form <keyitem>!
        RETRACED_ALL_JUNCTIONS        = 8691, -- You have retraced all junctions of eventualities. Hasten back to where Cait Sith and Lilisette await.
