...
zoneObject.onInitialize = function(zone)
    ...
    zone:registerCuboidTriggerArea(1, -301, -50, -22, -297, -49, -17) -- central porter on map 3
    zone:registerCuboidTriggerArea(2, -275, -54,   3, -271, -53,   7) -- NE porter on map 3
    zone:registerCuboidTriggerArea(3, -275, -54, -47, -271, -53, -42) -- SE porter on map 3
    zone:registerCuboidTriggerArea(4, -330, -54,   3, -326, -53,   7) -- NW porter on map 3
    zone:registerCuboidTriggerArea(5, -328, -54, -47, -324, -53, -42) -- SW porter on map 3
    zone:registerCuboidTriggerArea(6, -528, -74,  84, -526, -73,  89) -- N porter on map 4
    zone:registerCuboidTriggerArea(7, -528, -74,  30, -526, -73,  36) -- S porter on map 4
