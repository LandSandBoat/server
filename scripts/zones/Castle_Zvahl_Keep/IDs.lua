...
zones[xi.zone.CASTLE_ZVAHL_KEEP] =
{
    text =
    {
        ...
        ITEMS_ITEMS_LA_LA       = 7233, -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY     = 7239, -- The Goblin slipped away when you were not looking...
        HOMEPOINT_SET           = 7282, -- Home point set!
    },
    mob =
    {
        BARON_VAPULA_PH   =
