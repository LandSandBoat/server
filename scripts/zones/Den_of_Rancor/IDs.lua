...
zones[xi.zone.DEN_OF_RANCOR] =
{
    text =
    {
        ...
        LANTERN_OFFSET                = 7226,  -- The grating will not budge.
        ...
        HOMEPOINT_SET                 = 10555, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 10613, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
