...
entity.onTrigger = function(player, npc)
    player:messageSpecial(denOfRancorID.text.LANTERN_OFFSET + 13, xi.item.FLAME_OF_CRIMSON_RANCOR, xi.item.UNLIT_LANTERN) -- You could use this flame to light an unlit lantern.
end
