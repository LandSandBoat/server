...
zones[xi.zone.CLOISTER_OF_TIDES] =
{
    text =
    {
        ...
        LEVIATHAN_UNLOCKED               = 7586, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7674, -- Entering the battlefield for [Trial by Water/Trial-Size Trial by Water/Waking the Beast/Sugar-coated Directive/Trial by Water]!
