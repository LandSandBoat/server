...
zones[xi.zone.CLOISTER_OF_STORMS] =
{
    text =
    {
        ...
        RAMUH_UNLOCKED                   = 7588, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
        ENTERING_THE_BATTLEFIELD_FOR     = 7676, -- Entering the battlefield for [Trial by Lightning/Carbuncle Debacle/Trial-Size Trial by Lightning/Waking the Beast/Sugar-coated Directive/Trial by Lightning]!
        ATTACH_SEAL                      = 7769, -- <player> attaches <item> to the protocrystal.
        POWER_STYMIES                    = 7770, -- An unseen power stymies your efforts to attach <item> to the protocrystal.
    },
    mob =
    {
