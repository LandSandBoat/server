...
zones[tpz.zone.MIDDLE_DELKFUTTS_TOWER] =
{
    text =
    {
        ...
        CARRIED_OVER_POINTS      = 7162, -- You have carried over <number> points.
        LOGIN_CAMPAIGN_UNDERWAY  = 7163, -- The <month> ≺year≻ Login Campaign is currently underway!
        LOGIN_NUMBER             = 7164, -- In celebration of your most recent login no. <number>...
