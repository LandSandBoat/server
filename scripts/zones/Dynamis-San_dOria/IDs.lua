...
zones[xi.zone.DYNAMIS_SAN_DORIA] =
{
    text =
    {
        ...
        DYNAMIS_TIME_EXTEND           = 7235, -- Your stay in Dynamis has been extended by <number> minute[/s].
        DYNAMIS_TIME_UPDATE_1         = 7236, -- You will be expelled from Dynamis in <number> [second/minute] (Earth time).
        DYNAMIS_TIME_UPDATE_2         = 7237, -- You will be expelled from Dynamis in <number> [seconds/minutes] (Earth time).
