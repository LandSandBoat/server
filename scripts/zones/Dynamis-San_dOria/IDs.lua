...
zones[xi.zone.DYNAMIS_SAN_DORIA] =
{
    ...
    mob =
    {
        TIME_EXTENSION =
        {
            { minutes = 10, ki = xi.keyItem.CRIMSON_GRANULES_OF_TIME,   mob = 17535026 },
            { minutes = 10, ki = xi.keyItem.AZURE_GRANULES_OF_TIME,     mob = 17535057 },
            { minutes = 10, ki = xi.keyItem.AMBER_GRANULES_OF_TIME,     mob = 17535139 },
            { minutes = 15, ki = xi.keyItem.ALABASTER_GRANULES_OF_TIME, mob = 17535131 },
            { minutes = 15, ki = xi.keyItem.OBSIDIAN_GRANULES_OF_TIME,  mob = 17535128 },
        },
