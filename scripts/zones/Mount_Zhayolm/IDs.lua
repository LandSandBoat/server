...
zones[xi.zone.MOUNT_ZHAYOLM] =
{
    text =
    {
        ...
        SHED_LEAVES                   = 7565, -- The ground is strewn with shed leaves...
        SICKLY_SWEET                  = 7570, -- A sickly sweet fragrance pervades the air...
        ACIDIC_ODOR                   = 7571, -- An acidic odor pervades the air...
        PUTRID_ODOR                   = 7572, -- A putrid odor threatens to overwhelm you...
        STIFLING_STENCH               = 7576, -- A stifling stench pervades the air...
        DRAWS_NEAR                    = 7592, -- Something draws near!
        HOMEPOINT_SET                 = 8741, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 8799, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
