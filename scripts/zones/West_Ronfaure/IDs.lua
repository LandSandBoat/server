...
zones[xi.zone.WEST_RONFAURE] =
{
    text =
    {
        ...
        GACHEMAGE_DIALOG         = 7338,  -- Orcish scouts lurk in the shadows. Consider yourself warned!
        ADALEFONT_DIALOG         = 7339,  -- If you sense danger, just flee into the city. I'll not endanger myself on your account!
        LAILLERA_DIALOG          = 7340,  -- I mustn't chat while on duty. Sorry.
        PICKPOCKET_GACHEMAGE     = 7341,  -- A pickpocket? Now that you mention it, I did see a woman flee the city. She ran west.
        PICKPOCKET_ADALEFONT     = 7342,  -- What, someone picked your pocket? And you call yourself an adventurer!
        PICKPOCKET_COLMAIE       = 7343,  -- A pickpocket? Hmm... Can't say I've seen anyone like that around here.
        PICKPOCKET_LAILLERA      = 7344,  -- A pickpocket, you say? I don't think anybody came through here.
        AAVELEON_HEALED          = 7346,  -- My wounds are healed, thanks to you!
        PICKPOCKET_AAVELEON      = 7372,  -- A pickpocket, out here? Phew, my wallet is safe.
        PALCOMONDAU_REPORT       = 7384,  -- Scout reporting! All is quiet on the road to Ghelsba!
        PALCOMONDAU_DIALOG       = 7385,  -- Let me be! I must patrol the road to Ghelsba.
        ZOVRIACE_REPORT          = 7387,  -- Scout reporting! All is quiet on the roads to La Theine!
        ZOVRIACE_DIALOG          = 7389,  -- Let me be! I return to Southgate with word on La Theine.
        PICKPOCKET_PALCOMONDAU   = 7390,  -- A pickpocket? No, I haven't seen anyone matching that description. I've only seen Aaveleon, and a rather brusque woman.
        PICKPOCKET_ZOVRIACE      = 7391,  -- A pickpocket, out here? Can't say I've seen anyone like that. I'll keep my eyes peeled.
        DISMAYED_CUSTOMER        = 7415,  -- You find some worthless scraps of paper.
        CONQUEST                 = 7537,  -- You've earned conquest points!
