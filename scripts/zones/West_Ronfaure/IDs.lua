...
zones[xi.zone.WEST_RONFAURE] =
{
    text =
    {
        ...
        PICKPOCKET_COLMAIE       = 7337,  -- A pickpocket? Hmm... Can't say I've seen anyone like that around here.
        PICKPOCKET_LAILLERA      = 7338,  -- A pickpocket, you say? I don't think anybody came through here.
        AAVELEON_HEALED          = 7340,  -- My wounds are healed, thanks to you!
        PICKPOCKET_AAVELEON      = 7366,  -- A pickpocket, out here? Phew, my wallet is safe.
        ...
        PICKPOCKET_PALCOMONDAU   = 7384,  -- A pickpocket? No, I haven't seen anyone matching that description. I've only seen Aaveleon, and a rather brusque woman.
