...
zones[xi.zone.ABYSSEA_KONSCHTAT] =
{
    text =
    {
        ...
        ALREADY_POSSESS_KEY_ITEM    = 7395, -- It appears you already possess that key item.
        ...
        INPUT_ERROR                 = 7543, -- Please input a two-digit combination between [minimum]～[maximum].
