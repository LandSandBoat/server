...
zones[xi.zone.ABYSSEA_KONSCHTAT] =
{
    ...
    mob =
    {
        ...
        KUKULKAN_1              = GetFirstID("Kukulkan"),
        ECCENTRIC_EVE_1         = GetFirstID("Eccentric_Eve"),
        BLOODEYE_VILEBERRY_1    = GetFirstID("Bloodeye_Vileberry") + 3,
        ECCENTRIC_EVE_2         = GetFirstID("Eccentric_Eve") + 62,
        KUKULKAN_2              = GetFirstID("Kukulkan") + 198,
        BLOODEYE_VILEBERRY_2    = GetFirstID("Bloodeye_Vileberry") + 3,
        ECCENTRIC_EVE_3         = GetFirstID("Eccentric_Eve") + 65,
        KUKULKAN_3              = GetFirstID("Kukulkan") + 201,
        BLOODEYE_VILEBERRY_3    = GetFirstID("Bloodeye_Vileberry") + 6,
    },
    npc =
    {
    },
