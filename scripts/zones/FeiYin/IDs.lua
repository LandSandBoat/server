...
zones[xi.zone.FEIYIN] =
{
    text =
    {
        ...
        SOFTLY_SHIMMERING_LIGHT            = 7497,  -- You see a softly shimmering light...
        YOU_REACH_OUT_TO_THE_LIGHT         = 7498,  -- You reach out to the light, and one facet of a curious seed-shaped emblem materializes on the back of your hand. It emanates an otherworldly [red/orange/yellow/green/cerulean/blue/golden/silver/white] radiance.
        THE_LIGHT_DWINDLES                 = 7499,  -- However, the light dwindles and grows dim almost at once...
        EVEN_GREATER_INTENSITY             = 7500,  -- The emblem on your hand glows with even greater intensity!
        YOU_REACH_FOR_THE_LIGHT            = 7501,  -- You reach for the light, but there is no discernable effect...
        SCINTILLATING_BURST_OF_LIGHT       = 7502,  -- As you extend your hand, there is a scintillating burst of light! Now complete, the Mark of Seed glows with near-blinding intensity!
        MARK_OF_SEED_FLICKERS              = 7511,  -- The glow of the Mark of Seed flickers and dims ever so slightly...
        MARK_OF_SEED_GROWS_FAINTER         = 7512,  -- The Mark of Seed grows fainter still. Before long, it will fade away entirely...
        MARK_OF_SEED_IS_ABOUT_TO_DISSIPATE = 7513,  -- The Mark of Seed is about to dissipate entirely! Only a faint outline remains...
        MARK_OF_SEED_HAS_VANISHED          = 7514,  -- The Mark of Seed has vanished without a trace...
        ...
        LEARNS_SPELL                       = 10653, -- <name> learns <spell>!
        UNCANNY_SENSATION                  = 10655, -- You are assaulted by an uncanny sensation.
        HOMEPOINT_SET                      = 10704, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT       = 10762, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
        MIND_HOARDER_PH =
