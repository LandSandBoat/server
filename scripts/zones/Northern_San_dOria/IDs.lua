...
zones[xi.zone.NORTHERN_SAN_DORIA] =
{
    text =
    {
        ...
        CHEUPIRUDAUX_EXPERT_ALT  = 7027,  -- From the looks of you, it seems that you're ready for the next step. Make me <item>.
        CHEUPIRUDAUX_EXPERT_BASE = 7075,  -- Back so soon? Haha! I knew that devouring the contents of <key item>...
        MEVREAUCHE_EXPERT_ALT    = 7102,  -- I believe you are ready to move on to the next rank. Craft me <item>.
        MEVREAUCHE_EXPERT_BASE   = 7151,  -- Your confident mien speaks volumes to me. You have reviewed the contents of <key item>...
