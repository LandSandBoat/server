...
zones[xi.zone.NORTHERN_SAN_DORIA] =
{
    text =
    {
        ...
        DEEP_IN_MAZE                  = 12661, -- Doctor Oiheavurese sadi tthat a wyvern egg has been laid deep in the Maze of Shakhrami, Could this be true?
        NEVER_HEARD_DOC               = 12673, -- I've never heard the Doctor mention any Yachemidot.
