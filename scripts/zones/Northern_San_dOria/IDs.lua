...
zones[xi.zone.NORTHERN_SAN_DORIA] =
{
    text =
    {
        ...
        LAID_DEEP                     = 12665, -- Doctor Oiheaurese said that a wyvern egg has been laid deep in the Maze of Shakhrami. Could this be true?
        NEVER_HEARD_DOC               = 12677, -- I've never heard the Doctor mention any Yachemidot. And what is all this with placing the egg on the far eastern tip of Drogaroga's Spine in the Meriphataud Mountains?
