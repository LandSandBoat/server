    ...
    if xi.events.starlightCelebration.isStarlightEnabled ~= 0 then
        ...
        elseif smilebringersconvo == 1 and (head == 15179 or head == 15178) then
            ...
            elseif fame == 4 then
                ...
                player:startEvent(32741, 0210, 0003, 0600, 0000, 7800, 0000, 0000, 0000)
            elseif fame == 5 then
                player:setLocalVar("famebefore", player:getFame(xi.quest.fame_area.HOLIDAY))
                player:startEvent(32741, 0210, 0004, 0600, 0000, 7800, 0000, 0000, 0000)
            elseif fame == 6 then
                player:setLocalVar("famebefore", player:getFame(xi.quest.fame_area.HOLIDAY))
                player:startEvent(32741, 0210, 0004, 0600, 0000, 7800, 0000, 0000, 0000)
            elseif fame == 7 then
                player:setLocalVar("famebefore", player:getFame(xi.quest.fame_area.HOLIDAY))
                player:startEvent(32741, 0210, 0005, 0600, 0000, 7800, 0000, 0000, 0000)
            elseif fame == 8 then
                player:setLocalVar("famebefore", player:getFame(xi.quest.fame_area.HOLIDAY))
                player:startEvent(32741, 0210, 0005, 0600, 0000, 7800, 0000, 0000, 0000)
            elseif fame == 9 then
                player:setLocalVar("famebefore", player:getFame(xi.quest.fame_area.HOLIDAY))
                player:startEvent(32741, 0210, 0006, 0600, 0000, 7800, 0000, 0000, 0000)
            end
        else
