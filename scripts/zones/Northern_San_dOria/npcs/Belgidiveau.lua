...
entity.onTrigger = function(player, npc)
    ...
    troubleAtTheSluice = player:getQuestStatus(xi.quest.log_id.SANDORIA, xi.quest.id.sandoria.TROUBLE_AT_THE_SLUICE)
    NeutralizerKI = player:hasKeyItem(xi.ki.NEUTRALIZER)
