...
zones[xi.zone.ATTOHWA_CHASM] =
{
    text =
    {
        ...
        GASPONIA_POISON         = 7329, -- The poison of the Gasponia has begun to spread through your body.
        OCCASIONAL_LUMPS        = 7344, -- Occasionally lumps arise in the ground here, then settle down again. It seems that there is something beneath the earth.
        HOMEPOINT_SET           = 8231, -- Home point set!
    },
    mob =
    {
        AMBUSHER_ANTLION_PH =
