...
zones[xi.zone.ARRAPAGO_REMNANTS] =
{
    text =
    {
        ...
        TIME_TO_COMPLETE              = 7456, -- You have <number> [minute/minutes] (Earth time) to complete this mission.
        MISSION_FAILED                = 7457, -- The mission has failed. Leaving area.
        TIME_REMAINING_MINUTES        = 7461, -- ime remaining: <number> [minute/minutes] (Earth time).
        TIME_REMAINING_SECONDS        = 7462, -- ime remaining: <number> [second/seconds] (Earth time).
        PARTY_FALLEN                  = 7464, -- ll party members have fallen in battle. Mission failure in <number> [minute/minutes].
        DOOR_IS_SEALED                = 7475, -- The door is sealed...
        DOOR_IS_SEALED_MYSTERIOUS     = 7478, -- The door is sealed by some mysterious force...
    },
    mob =
    {
        [1] =
