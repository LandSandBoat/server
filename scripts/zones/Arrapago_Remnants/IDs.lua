...
zones[ xi.zone.ARRAPAGO_REMNANTS] =
{
    text =
    {
        ...
        SALVAGE_START              = 7236, -- You feel an incredible pressure bearing down on you. This area appears to be blanketed in some sort of intense psionic field...
        TIME_TO_COMPLETE           = 7443, -- You have <number> [minute/minutes] (Earth time) to complete this mission.
        MISSION_FAILED             = 7444, -- The mission has failed. Leaving area.
        TIME_REMAINING_MINUTES     = 7448, -- ime remaining: <number> [minute/minutes] (Earth time).
        TIME_REMAINING_SECONDS     = 7449, -- ime remaining: <number> [second/seconds] (Earth time).
        PARTY_FALLEN               = 7451, -- ll party members have fallen in battle. Mission failure in <number> [minute/minutes].
        DOOR_IS_SEALED             = 7462, -- The door is sealed...
        DOOR_IS_SEALED_MYSTERIOUS  = 7465, -- The door is sealed by some mysterious force...
