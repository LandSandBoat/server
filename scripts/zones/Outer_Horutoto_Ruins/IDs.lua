...
zones[tpz.zone.OUTER_HORUTOTO_RUINS] =
{
    text =
    {
        ...
        CARRIED_OVER_POINTS      = 7204, -- You have carried over <number> points.
        LOGIN_CAMPAIGN_UNDERWAY  = 7205, -- The <month> ≺year≻ Login Campaign is currently underway!
        LOGIN_NUMBER             = 7206, -- In celebration of your most recent login no. <number>...
