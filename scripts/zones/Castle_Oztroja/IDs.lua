...
zones[tpz.zone.CASTLE_OZTROJA] =
{
    text =
    {
        ...
        LOGIN_CAMPAIGN_UNDERWAY            = 7185, -- The [/January/February/March/April/May/June/July/August/September/October/November/December] <number> Login Campaign is currently underway!<space>
