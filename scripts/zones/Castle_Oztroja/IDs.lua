...
zones[xi.zone.CASTLE_OZTROJA] =
{
    text =
    {
        ...
        FLAME_BURNING                      = 7453, -- A mysterious flame is burning.
        YOU_HOLD                           = 7454, -- You hold <item> over the flame... A peculiar scent covers the area.
        TEBHI_ACCEPTS                      = 7456, -- Tebhi happily accepts the <item> and leaves.
        YAGUDO_AVATAR_ENGAGE               = 7466, -- Kahk-ka-ka... You filthy, dim-witted heretics! You have damned yourselves by coming here.
        YAGUDO_AVATAR_DEATH                = 7467, -- Our lord, Tzee Xicu the Manifest!  Even should our bodies be crushed and broken, may our souls endure into eternity...
        YAGUDO_KING_ENGAGE                 = 7468, -- You are not here as sacrifices, are you? Could you possibly be committing this affront in the face of a deity?  Very well, I will personally mete out your divine punishment, kyah!
        YAGUDO_KING_DEATH                  = 7469, -- You have...bested me... However, I...am...a god... I will never die...never rot...never fade...never...
        HERETICS                           = 8014, -- Kyah! Kyah! Heretics being in our midst! Kill them!
        LETTING_YOU_GO                     = 8021, -- This time I be letting you go. Be flying home, smoothskin! Ka-kyah!
        LEARNS_SPELL                       = 8310, -- <name> learns <spell>!
        UNCANNY_SENSATION                  = 8312, -- You are assaulted by an uncanny sensation.
        COMMON_SENSE_SURVIVAL              = 8319, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
