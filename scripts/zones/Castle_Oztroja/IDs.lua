...
zones[xi.zone.CASTLE_OZTROJA] =
{
    text =
    {
        ...
        FULL_INVENTORY_AFTER_TRADE         = 6576, -- You cannot obtain the <item>. Try trading again after sorting your inventory.
        ITEM_OBTAINED                      = 6580, -- Obtained: <item>.
        GIL_OBTAINED                       = 6581, -- Obtained <number> gil.
        KEYITEM_OBTAINED                   = 6583, -- Obtained key item: <keyitem>.
        NOT_ENOUGH_GIL                     = 6585, -- You do not have enough gil.
        ITEMS_OBTAINED                     = 6589, -- You obtain <number> <item>!
        ...
        FLAME_BURNING                      = 7457, -- A mysterious flame is burning.
        YOU_HOLD                           = 7458, -- You hold <item> over the flame... A peculiar scent covers the area.
        TEBHI_ACCEPTS                      = 7460, -- Tebhi happily accepts the <item> and leaves.
        YAGUDO_AVATAR_ENGAGE               = 7470, -- Kahk-ka-ka... You filthy, dim-witted heretics! You have damned yourselves by coming here.
        YAGUDO_AVATAR_DEATH                = 7471, -- Our lord, Tzee Xicu the Manifest! Even should our bodies be crushed and broken, may our souls endure into eternity...
        YAGUDO_KING_ENGAGE                 = 7472, -- You are not here as sacrifices, are you? Could you possibly be committing this affront in the face of a deity? Very well, I will personally mete out your divine punishment, kyah!
        YAGUDO_KING_DEATH                  = 7473, -- You have...bested me... However, I...am...a god... I will never die...never rot...never fade...never...
        HERETICS                           = 8018, -- Kyah! Kyah! Heretics being in our midst! Kill them!
        LETTING_YOU_GO                     = 8025, -- This time I be letting you go. Be flying home, smoothskin! Ka-kyah!
