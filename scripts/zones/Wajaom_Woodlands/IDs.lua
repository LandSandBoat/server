...
zones[xi.zone.WAJAOM_WOODLANDS] =
{
    text =
    {
        ...
        WELLSPRING                    = 7460, -- The water in this spring is an unusual color...
        GIWAHB_WATCHTOWER_LOCKED      = 7997, -- The door is locked...
        INCREASED_STANDING            = 7998, -- Your Imperial Standing has increased!
        HEADY_FRAGRANCE               = 8502, -- The heady fragrance of wine pervades the air...
        BROKEN_SHARDS                 = 8504, -- Broken shards of insect wing are scattered all over...
        PAMAMA_PEELS                  = 8506, -- Piles of pamama peels litter the ground...
        DRAWS_NEAR                    = 8532, -- Something draws near!
        COMMON_SENSE_SURVIVAL         = 9650, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
        UNITY_WANTED_BATTLE_INTERACT  = 9714, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
        CHIGOES =
