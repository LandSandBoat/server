...
zones[xi.zone.WAJAOM_WOODLANDS] =
{
    text =
    {
        ...
        HARVESTING_IS_POSSIBLE_HERE   = 7427, -- Harvesting is possible here if you have <item>.
        WELLSPRING                    = 7472, -- The water in this spring is an unusual color...
        FORGIVE_I_WILL_NOT            = 7477, -- Forgive, I will not. My pet, you hurt!
        GIWAHB_WATCHTOWER_LOCKED      = 8009, -- The door is locked...
        INCREASED_STANDING            = 8010, -- Your Imperial Standing has increased!
        HEADY_FRAGRANCE               = 8514, -- The heady fragrance of wine pervades the air...
        BROKEN_SHARDS                 = 8516, -- Broken shards of insect wing are scattered all over...
        PAMAMA_PEELS                  = 8518, -- Piles of pamama peels litter the ground...
        DRAWS_NEAR                    = 8544, -- Something draws near!
