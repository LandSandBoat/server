...
zones[xi.zone.WAJAOM_WOODLANDS] =
{
    text =
    {
        ...
        PLACE_HYDROGAUGE              = 7362, -- You set the <item> in the glowing trench.
        ENIGMATIC_LIGHT               = 7363, -- The <item> is giving off an enigmatic light.
        LEYPOINT                      = 7418, -- An eerie red glow emanates from this stone platform. The surrounding air feels alive with energy...
        HARVESTING_IS_POSSIBLE_HERE   = 7426, -- Harvesting is possible here if you have <item>.
        WELLSPRING                    = 7471, -- The water in this spring is an unusual color...
        FORGIVE_I_WILL_NOT            = 7476, -- Forgive, I will not. My pet, you hurt!
        GIWAHB_WATCHTOWER_LOCKED      = 8008, -- The door is locked...
        INCREASED_STANDING            = 8009, -- Your Imperial Standing has increased!
        HEADY_FRAGRANCE               = 8513, -- The heady fragrance of wine pervades the air...
        BROKEN_SHARDS                 = 8515, -- Broken shards of insect wing are scattered all over...
        PAMAMA_PEELS                  = 8517, -- Piles of pamama peels litter the ground...
        DRAWS_NEAR                    = 8543, -- Something draws near!
        COMMON_SENSE_SURVIVAL         = 9661, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
