...
zones[xi.zone.CARPENTERS_LANDING] =
{
    text =
    {
        ...
        YOU_WISH_TO_KNOW_MISTALLE     = 7236, -- You wish to know of the Knights Mistalle?
        SQUASH_ANOTHER_WORM           = 7237, -- You're just like everyone else! A maggot looking for a scandal! Well, it's time for me to squash another worm!
        BEGONE_TRESPASSER             = 7256, -- Begone, trespasser! This land belongs to the Knights Mi- This land belongs to Count Teulomme!
        CRYPTONBERRY_FALLEN_TREE      = 7258, -- A tree has fallen here...
        CRYPTONBERRY_EXECUTOR_POP     = 7259, -- You feel a wave of hatred wash over you!
        ...
        COMMON_SENSE_SURVIVAL         = 7569, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        ORCTRAP_PH            =
