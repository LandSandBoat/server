...
zones[xi.zone.CARPENTERS_LANDING] =
{
    text =
    {
        ...
        DIG_THROW_AWAY             = 7291, -- You dig up <items>, but your inventory is full. You regretfully throw the <item> away.
        FIND_NOTHING               = 7293, -- You dig and you dig, but find nothing.
