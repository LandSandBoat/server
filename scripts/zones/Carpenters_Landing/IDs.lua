...
zones[xi.zone.CARPENTERS_LANDING] =
{
    text =
    {
        ...
        TOO_POOR                      = 7444, -- I'm sorry, [sir/madame]. You don't have enough gil to purchase a ticket.
        BARGE_TICKET_REMAINING        = 7457, -- You use your %. (# trip[/s] remaining)
        BARGE_TICKET_USED             = 7458, -- You use up your %.
        BARGE_TICKET_ADDED            = 7459, -- # ticket[/s] [was/were] added to your %.
