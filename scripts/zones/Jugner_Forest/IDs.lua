...
zones[xi.zone.JUGNER_FOREST] =
{
    text =
    {
        ...
        FISHING_MESSAGE_OFFSET   = 7711,  -- You can't fish here.
        DIG_THROW_AWAY           = 7724,  -- You dig up <item>, but your inventory is full. You regretfully throw the <item> away.
        FIND_NOTHING             = 7726,  -- You dig and you dig, but find nothing.
        AMK_DIGGING_OFFSET       = 7792,  -- You spot some familiar footprints. You are convinced that your moogle friend has been digging in the immediate vicinity.
        LOGGING_IS_POSSIBLE_HERE = 7904,  -- Logging is possible here if you have <item>.
        VOIDWALKER_OBTAIN_KI     = 7911,  -- Obtained key item: <keyitem>!
        CONQUEST                 = 8055,  -- You've earned conquest points!
