...
zones[xi.zone.QUICKSAND_CAVES] =
{
    text =
    {
        ...
        ANCIENT_LETTERS_UNREAD   = 7337,  -- Ancient letters are carved here, but you are unable to read them.
        POOL_OF_WATER            = 7360,  -- It is a pool of water.
        SENSE_SOMETHING_EVIL     = 7361,  -- You sense something evil.
        YOU_FIND_NOTHING_OUT     = 7362,  -- You find nothing out of the ordinary.
