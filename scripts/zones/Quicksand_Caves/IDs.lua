...
zones[xi.zone.QUICKSAND_CAVES] =
{
    text =
    {
        ...
        DOOR_FIRMLY_SHUT              = 7342,  -- The door is firmly shut.
        ANCIENT_LETTERS_UNREAD        = 7351,  -- Ancient letters are carved here, but you are unable to read them.
        POOL_OF_WATER                 = 7374,  -- It is a pool of water.
        SENSE_SOMETHING_EVIL          = 7375,  -- You sense something evil.
        YOU_FIND_NOTHING_OUT          = 7376,  -- You find nothing out of the ordinary.
        YOU_FIND_NOTHING              = 7377,  -- You find nothing.
        SOMETHING_ATTACKING_YOU       = 7381,  -- Something is attacking from behind you!
        SOMETHING_IS_BURIED           = 7382,  -- Something is buried in this fallen pillar.
        SENSE_OMINOUS_PRESENCE        = 7386,  -- You sense an ominous presence...
        PLAYER_OBTAINS_ITEM           = 8294,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8295,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8296,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8297,  -- You already possess that temporary item.
        NO_COMBINATION                = 8302,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 10380, -- New training regime registered!
