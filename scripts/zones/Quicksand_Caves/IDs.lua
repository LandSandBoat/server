...
zones[xi.zone.QUICKSAND_CAVES] =
{
    ...
    mob =
    {
        ...
        VALOR           = DYNAMIC_LOOKUP,
        HONOR           = DYNAMIC_LOOKUP,
        CENTURIO_IV_VII = DYNAMIC_LOOKUP,
        TRIARIUS_IV_XIV = DYNAMIC_LOOKUP,
        PRINCEPS_IV_XLV = DYNAMIC_LOOKUP,
        MIMIC           = DYNAMIC_LOOKUP,
        ANCIENT_VESSEL  = DYNAMIC_LOOKUP,
        TRIBUNUS_VII_I  = DYNAMIC_LOOKUP,
        GIRTABLULU      = DYNAMIC_LOOKUP,
    },
