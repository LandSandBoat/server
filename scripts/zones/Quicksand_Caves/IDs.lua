...
zones[xi.zone.QUICKSAND_CAVES] =
{
    text =
    {
        ...
        DOOR_FIRMLY_SHUT              = 7349,  -- The door is firmly shut.
        ANCIENT_LETTERS_UNREAD        = 7358,  -- Ancient letters are carved here, but you are unable to read them.
        POOL_OF_WATER                 = 7381,  -- It is a pool of water.
        SENSE_SOMETHING_EVIL          = 7382,  -- You sense something evil.
        YOU_FIND_NOTHING_OUT          = 7383,  -- You find nothing out of the ordinary.
        YOU_FIND_NOTHING              = 7384,  -- You find nothing.
        MUST_MOVE_CLOSER              = 7385,  -- You must move closer to pick it up.
        THIS_IS_NOT_THE_TIME          = 7386,  -- This is not the time for that!
        FAINT_TRACES_OF_MAGIC         = 7387,  -- You sense faint traces of magic force.
        SOMETHING_ATTACKING_YOU       = 7388,  -- Something is attacking from behind you!
        SOMETHING_IS_BURIED           = 7389,  -- Something is buried in this fallen pillar.
