...
zones[xi.zone.QUICKSAND_CAVES] =
{
    text =
    {
        ...
        DOOR_FIRMLY_SHUT         = 7331,  -- The door is firmly shut.
        ANCIENT_LETTERS_UNREAD   = 7340,  -- Ancient letters are carved here, but you are unable to read them.
        POOL_OF_WATER            = 7363,  -- It is a pool of water.
        SENSE_SOMETHING_EVIL     = 7364,  -- You sense something evil.
        YOU_FIND_NOTHING_OUT     = 7365,  -- You find nothing out of the ordinary.
        YOU_FIND_NOTHING         = 7366,  -- You find nothing.
        SOMETHING_IS_BURIED      = 7371,  -- Something is buried in this fallen pillar.
        ...
        HOMEPOINT_SET            = 11431, -- Home point set!
    },
    mob =
    {
