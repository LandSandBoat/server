...
zones[xi.zone.QUICKSAND_CAVES] =
{
    text =
    {
        ...
        DOOR_FIRMLY_SHUT              = 7345,  -- The door is firmly shut.
        ANCIENT_LETTERS_UNREAD        = 7354,  -- Ancient letters are carved here, but you are unable to read them.
        POOL_OF_WATER                 = 7377,  -- It is a pool of water.
        SENSE_SOMETHING_EVIL          = 7378,  -- You sense something evil.
        YOU_FIND_NOTHING_OUT          = 7379,  -- You find nothing out of the ordinary.
        YOU_FIND_NOTHING              = 7380,  -- You find nothing.
        SOMETHING_ATTACKING_YOU       = 7384,  -- Something is attacking from behind you!
        SOMETHING_IS_BURIED           = 7385,  -- Something is buried in this fallen pillar.
        SENSE_OMINOUS_PRESENCE        = 7389,  -- You sense an ominous presence...
