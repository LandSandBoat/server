...
zones[xi.zone.QUICKSAND_CAVES] =
{
    text =
    {
        ...
        DOOR_FIRMLY_SHUT              = 7343,  -- The door is firmly shut.
        ANCIENT_LETTERS_UNREAD        = 7352,  -- Ancient letters are carved here, but you are unable to read them.
        POOL_OF_WATER                 = 7375,  -- It is a pool of water.
        SENSE_SOMETHING_EVIL          = 7376,  -- You sense something evil.
        YOU_FIND_NOTHING_OUT          = 7377,  -- You find nothing out of the ordinary.
        YOU_FIND_NOTHING              = 7378,  -- You find nothing.
        SOMETHING_ATTACKING_YOU       = 7382,  -- Something is attacking from behind you!
        SOMETHING_IS_BURIED           = 7383,  -- Something is buried in this fallen pillar.
        SENSE_OMINOUS_PRESENCE        = 7387,  -- You sense an ominous presence...
        PLAYER_OBTAINS_ITEM           = 8295,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8296,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8297,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8298,  -- You already possess that temporary item.
        NO_COMBINATION                = 8303,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 10381, -- New training regime registered!
        HOMEPOINT_SET                 = 11443, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 11501, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
    },
    mob =
    {
