...
zones[xi.zone.QUICKSAND_CAVES] =
{
    text =
    {
        ...
        MUST_MOVE_CLOSER              = 7384,  -- You must move closer to pick it up.
        THIS_IS_NOT_THE_TIME          = 7385,  -- This is not the time for that!
        FAINT_TRACES_OF_MAGIC         = 7386,  -- You sense faint traces of magic force.
