...
zones[xi.zone.EAST_RONFAURE] =
{
    text =
    {
        ...
        RAYOCHINDOT_DIALOG            = 7428,  -- If you are outmatched, run to the city as quickly as you can.
        CROTEILLARD_DIALOG            = 7429,  -- Sorry, no chatting while I'm on duty.
        ANDELAIN_DIALOG               = 7430,  -- My name is Andelain. As part of my devotions, I come here each day to pray.
        MAY_ONLY_EAT                  = 7431,  -- During this time, I may eat only three <item> a day for nourishment. No more, no less. And no other food may I eat.
        THANKS_TO_GODDESS             = 7432,  -- Thanks be to the Goddess in her benevolence!
        CANNOT_ACCEPT_ALMS            = 7433,  -- I am currently undergoing devotions, and as such, am not allowed to take alms from those on the road. I am sorry, but I cannot accept this.
        GATES_OF_PARADISE_OPEN        = 7434,  -- May the Gates of Paradise open to all...
        APPRECIATE_OFFER_DECLINE      = 7435,  -- I appreciate your offer, but I only need one <item>. Thank you for your kindness.
        THE_WATER_SPARKLES            = 7453,  -- The water sparkles in the light.
        CHEVAL_RIVER_WATER            = 7454,  -- You fill your waterskin with water from the river. You now have <item>.
        BLESSED_WATERSKIN             = 7473,  -- To get water, trade the waterskin you hold with the river.
        LOGGING_IS_POSSIBLE_HERE      = 7504,  -- Logging is possible here if you have <item>.
