...
zones[xi.zone.THRONE_ROOM] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7245, -- The door is sealed shut with an evil curse.
        ...
        MEMBERS_OF_YOUR_ALLIANCE      = 7535, -- Currently, <number> members of your alliance (including yourself) have clearance to enter the battlefield.
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7600, -- Entering the battlefield for [The Shadow Lord Battle/Where Two Paths Converge/Kindred Spirits/Survival of the Wisest/Smash! A Malevolent Menace/Kindred Spirits/The Shadow Lord Battle/True Love/A Fond Farewell/Kipdrix the Faithful]!
        NO_HIDE_AWAY                  = 7715, -- I have not been hiding away from my troubles!
        FEEL_MY_PAIN                  = 7716, -- Feel my twenty years of pain!
        YOUR_ANSWER                   = 7717, -- Is that your answer!?
        RETURN_TO_THE_DARKNESS        = 7718, -- Return with your soul to the darkness you came from!
        CANT_UNDERSTAND               = 7719, -- You--a man who has never lived bound by the chains of his country--how can you understand my pain!?
        BLADE_ANSWER                  = 7720, -- Let my blade be the answer!
    },
    mob =
    {
