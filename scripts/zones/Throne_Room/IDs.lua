...
zones[xi.zone.THRONE_ROOM] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7254, -- The door is sealed shut with an evil curse.
        UNABLE_TO_PROTECT             = 7293, -- You were unable to protect Captain Volker. Now leaving the battlefield.
        ...
        MEMBERS_OF_YOUR_PARTY         = 7543, -- Currently, <number> members of your party (including yourself) have clearance to enter the battlefield.
        MEMBERS_OF_YOUR_ALLIANCE      = 7544, -- Currently, <number> members of your alliance (including yourself) have clearance to enter the battlefield.
        ...
        NO_HIDE_AWAY                  = 7724, -- I have not been hiding away from my troubles!
        FEEL_MY_PAIN                  = 7725, -- Feel my twenty years of pain!
        YOUR_ANSWER                   = 7726, -- Is that your answer!?
        RETURN_TO_THE_DARKNESS        = 7727, -- Return with your soul to the darkness you came from!
        CANT_UNDERSTAND               = 7728, -- You--a man who has never lived bound by the chains of his country--how can you understand my pain!?
        BLADE_ANSWER                  = 7729, -- Let my blade be the answer!
    },
    mob =
    {
