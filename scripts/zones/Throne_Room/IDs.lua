...
zones[xi.zone.THRONE_ROOM] =
{
    text =
    {
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7596, -- Entering the battlefield for [The Shadow Lord Battle/Where Two Paths Converge/Kindred Spirits/Survival of the Wisest/Smash! A Malevolent Menace/Kindred Spirits/The Shadow Lord Battle/True Love/A Fond Farewell/Kipdrix the Faithful]!
        NO_HIDE_AWAY                  = 7711, -- I have not been hiding away from my troubles!
        FEEL_MY_PAIN                  = 7712, -- Feel my twenty years of pain!
        YOUR_ANSWER                   = 7713, -- Is that your answer!?
