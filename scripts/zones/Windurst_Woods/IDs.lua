...
zones[xi.zone.WINDURST_WOODS] =
{
    text =
    {
        ...
        MOKOP_WINDY_CIT               = 7587,  -- O`h, I left you behindt O`nly to return to you, oh Windurst!t S`o rich, your glory sends me blind,t L`o, praise the Star Sibyl, oh Windurst!t
        MOKOP_NOT_WINDY_CIT           = 7588,  -- Windurst is the besty!t You can forget about the resty!t The air, so fair, has a different smell!t It improves my tone, can't you tell?t
        ...
        CHOCOBO_FEEDING_SLEEP         = 10639, -- Your chocobo is sleeping soundly. You cannot feed it now.
        CHOCOBO_FEEDING_RUN_AWAY      = 10640, -- Your chocobo has run away. You cannot feed it now.
        CHOCOBO_FEEDING_STILL_EGG     = 10641, -- You cannot feed a chocobo that has not hatched yet.
        CHOCOBO_FEEDING_ITEM          = 11724, -- #: %
        TRRRADE_IN_SPARKS             = 13868, -- You want to trrrade in sparks, do you?
        DO_NOT_POSSESS_ENOUGH         = 13887, -- You do not possess enough <item> to complete the transaction.
        NOT_ENOUGH_SPARKS             = 13888, -- You do not possess enough sparks of eminence to complete the transaction.
        MAX_SPARKS_LIMIT_REACHED      = 13889, -- You have reached the maximum number of sparks that you can exchange this week (<number>). Your ability to purchase skill books and equipment will be restricted until next week.
        YOU_NOW_HAVE_AMT_CURRENCY     = 13899, -- You now have <number> [sparks of eminence/conquest points/points of imperial standing/Allied Notes/bayld/Fields of Valor points/assault points (Leujaoam)/assault points (Mamool Ja Training Grounds)/assault points (Lebros Cavern)/assault points (Periqia)/assault points (Ilrusi Atoll)/cruor/kinetic units/obsidian fragments/mweya plasm corpuscles/ballista points/Unity accolades/pinches of Escha silt/resistance credits].
        YOU_HAVE_JOINED_UNITY         = 14418, -- ou have joined [Pieuje's/Ayame's/Invincible Shield's/Apururu's/Maat's/Aldo's/Jakoh Wahcondalo's/Naja Salaheem's/Flaviria's/Yoran-Oran's/Sylvie's] Unity!
        HAVE_ALREADY_CHANGED_UNITY    = 14494, -- ou have already changed Unities. Please wait until the next tabulation period.
    },
    mob =
    {
    },
