...
entity.onEventFinish = function(player, csid, option)
    ...
    elseif csid == 308 then
        player:addQuest(tpz.quest.log_id.WINDURST, tpz.quest.id.windurst.LEGENDARY_PLAN_B)
    ...
    elseif csid == 655 then
        player:addQuest(tpz.quest.log_id.WINDURST, tpz.quest.id.windurst.THE_ALL_NEW_C_3000)
