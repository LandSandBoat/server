...
entity.onTrade = function(player, npc, trade)
    -- CHOCOBILIOUS
    if
        player:getQuestStatus(xi.quest.log_id.WINDURST, xi.quest.id.windurst.CHOCOBILIOUS) == xi.questStatus.QUEST_ACCEPTED and
    ...
    -- PAYING LIP SERVICE
    elseif player:getQuestStatus(xi.quest.log_id.WINDURST, xi.quest.id.windurst.PAYING_LIP_SERVICE) >= xi.questStatus.QUEST_ACCEPTED then
...
entity.onEventFinish = function(player, csid, option, npc)
    ...
    elseif csid == 479 then
        if player:getQuestStatus(xi.quest.log_id.WINDURST, xi.quest.id.windurst.PAYING_LIP_SERVICE) == xi.questStatus.QUEST_ACCEPTED then
