...
entity.onTrade = function(player, npc, trade)
    if
        ...
        player:getQuestStatus(xi.quest.log_id.WINDURST, xi.quest.id.windurst.LURE_OF_THE_WILDCAT) == xi.questStatus.QUEST_COMPLETED and
...
entity.onTrigger = function(player, npc)
    ...
    if lureWindurst ~= xi.questStatus.QUEST_COMPLETED and xi.settings.main.ENABLE_TOAU == 1 then
