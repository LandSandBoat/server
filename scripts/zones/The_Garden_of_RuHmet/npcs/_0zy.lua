...
entity.onTrigger = function(player, npc)
    ...
    if ((player:getCurrentMission(xi.mission.log_id.COP) == xi.mission.id.cop.DAWN and player:getCharVar("PromathiaStatus") > 0) or player:getCurrentMission(xi.mission.log_id.COP) > xi.mission.id.cop.DAWN) then
