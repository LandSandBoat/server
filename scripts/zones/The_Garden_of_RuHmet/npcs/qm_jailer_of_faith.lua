...
entity.onTrade = function(player, npc, trade)
    if npcUtil.tradeHas(trade, xi.items.HIGH_QUALITY_EUVHI_ORGAN) and npcUtil.popFromQM(player, npc, ID.mob.JAILER_OF_FAITH, { radius = 1 }) then -- High-Quality Euvhi Organ
        player:confirmTrade()
    end
end
