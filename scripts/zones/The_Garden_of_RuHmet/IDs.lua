...
zones[xi.zone.THE_GARDEN_OF_RUHMET] =
{
    text =
    {
        ...
        CONQUEST_BASE                 = 7453, -- Tallying conquest results...
        PORTAL_WONT_OPEN_ON_THIS_SIDE = 7626, -- The portal won't open from this side.
        NO_NEED_INVESTIGATE           = 7632, -- There is no need to investigate further.
        PORTAL_SEALED                 = 7661, -- The portal is firmly sealed by a mysterious energy.
        UNKNOWN_PRESENCE              = 7769, -- You sense some unknown presence...
        NONE_HOSTILE                  = 7770, -- You sense some unknown presence, but it does not seem hostile.
        MENACING_CREATURES            = 7771, -- Menacing creatures appear out of nowhere!
        SHEER_ANIMOSITY               = 7772, -- <name> is enveloped in sheer animosity!
        HOMEPOINT_SET                 = 7777, -- Home point set!
    },
