...
zones[xi.zone.THE_GARDEN_OF_RUHMET] =
{
    text =
    {
        ...
        CONQUEST_BASE                 = 7459, -- Tallying conquest results...
        ENTERING_THE_BATTLEFIELD_FOR  = 7622, -- Entering the battlefield for [When Angels Fall/]!
        YOU_MUST_MOVE_CLOSER          = 7630, -- You must move closer.
        PORTAL_WONT_OPEN_ON_THIS_SIDE = 7632, -- The portal won't open from this side.
        NO_NEED_INVESTIGATE           = 7638, -- There is no need to investigate further.
        PORTAL_SEALED                 = 7667, -- The portal is firmly sealed by a mysterious energy.
        UNKNOWN_PRESENCE              = 7775, -- You sense some unknown presence...
        NONE_HOSTILE                  = 7776, -- You sense some unknown presence, but it does not seem hostile.
        MENACING_CREATURES            = 7777, -- Menacing creatures appear out of nowhere!
        SHEER_ANIMOSITY               = 7778, -- <name> is enveloped in sheer animosity!
