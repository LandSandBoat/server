...
zones[xi.zone.THE_GARDEN_OF_RUHMET] =
{
    text =
    {
        ...
        CLEARED_BUT_MEMBERS_ENGAGED   = 7080, -- You are cleared to enter the battlefield, but you cannot while party members are engaged in combat.
        ...
        CONQUEST_BASE                 = 7465, -- Tallying conquest results...
        ENTERING_THE_BATTLEFIELD_FOR  = 7628, -- Entering the battlefield for [When Angels Fall/]!
        YOU_MUST_MOVE_CLOSER          = 7636, -- You must move closer.
        PORTAL_WONT_OPEN_ON_THIS_SIDE = 7638, -- The portal won't open from this side.
        NO_NEED_INVESTIGATE           = 7644, -- There is no need to investigate further.
        PORTAL_SEALED                 = 7673, -- The portal is firmly sealed by a mysterious energy.
        FORTITUDE_QM                  = 7780, -- You hear something vaguely resembling a voice emanating from the depths of your soul. Bring...mem...ries...hrah...
        UNKNOWN_PRESENCE              = 7781, -- You sense some unknown presence...
        NONE_HOSTILE                  = 7782, -- You sense some unknown presence, but it does not seem hostile.
        MENACING_CREATURES            = 7783, -- Menacing creatures appear out of nowhere!
        SHEER_ANIMOSITY               = 7784, -- <name> is enveloped in sheer animosity!
        FAITH_QM                      = 7786, -- You hear something vaguely resembling a voice emanating from the depths of your soul. Bring me...euv...recccepta...
