...
zones[xi.zone.BEADEAUX_S] =
{
    text =
    {
        ...
        CAMPAIGN_RESULTS_TALLIED      = 7509, -- Campaign results tallied.
        PARTY_MEMBERS_HAVE_FALLEN     = 7944, -- All party members have fallen in battle. Now leaving the battlefield.
