...
local menuMetadata =
{
    [1] =
    {
        ...
        [xi.keyItem.VIRIDIAN_KEY] =
        {
            ...
            reqKeyItems =
            {
                xi.keyItem.BOWL_OF_BLAND_GOBLIN_SALAD,
                xi.keyItem.JUG_OF_GREASY_GOBLIN_JUICE,
                xi.keyItem.CHUNK_OF_SMOKED_GOBLIN_GRUB,
            }
        },
        [xi.keyItem.WHITE_CORAL_KEY] =
        {
        ...
        [xi.keyItem.BLUE_CORAL_KEY] =
        {
            ...
            reqKeyItems =
            {
                xi.keyItem.STURDY_METAL_STRIP,
                xi.keyItem.PIECE_OF_RUGGED_TREE_BARK,
                xi.keyItem.SAVORY_LAMB_ROAST,
            },
        },
        [xi.keyItem.BLACK_CORAL_KEY] =
        {
            ...
            reqKeyItems =
            {
                xi.keyItem.MOLDY_WORM_EATEN_CHEST,
            },
        },
        [xi.keyItem.MOOGLE_KEY] =
        {
        ...
        [xi.keyItem.BIRD_KEY] =
        {
            ...
            reqKeyItems  =
            {
                xi.keyItem.AMBER_COUNTERSEAL,
                xi.keyItem.AZURE_COUNTERSEAL,
                xi.keyItem.CERULEAN_COUNTERSEAL,
                xi.keyItem.EMERALD_COUNTERSEAL,
                xi.keyItem.SCARLET_COUNTERSEAL,
                xi.keyItem.VIOLET_COUNTERSEAL,
            },
            prereqKeyItems =
            {
        ...
        [xi.keyItem.BOMB_KEY] =
        {
            ...
            reqKeyItems =
            {
                xi.keyItem.LUMINOUS_PURPLE_FRAGMENT,
                xi.keyItem.LUMINOUS_YELLOW_FRAGMENT,
                xi.keyItem.LUMINOUS_BLUE_FRAGMENT,
                xi.keyItem.LUMINOUS_BEIGE_FRAGMENT,
                xi.keyItem.LUMINOUS_RED_FRAGMENT,
                xi.keyItem.LUMINOUS_GREEN_FRAGMENT,
            },
        },
    },
    [2] =
    {
        {
            ...
            relevantKeyItems =
            {
                xi.keyItem.SEEDSPALL_ROSEUM,
                xi.keyItem.SEEDSPALL_CAERULUM,
                xi.keyItem.SEEDSPALL_VIRIDIS,
            },
        },
        {
            expansion        = 2,
        ...
        },
        {
            ...
            relevantKeyItems =
            {
                xi.keyItem.ORB_OF_CUPS,
                xi.keyItem.ORB_OF_COINS,
                xi.keyItem.ORB_OF_BATONS,
                xi.keyItem.ORB_OF_SWORDS,
            },
        },
        {
            expansion        = 2,
        ...
        },
        {
            ...
            relevantKeyItems =
            {
                xi.keyItem.WATER_SAP_CRYSTAL,
                xi.keyItem.EARTH_SAP_CRYSTAL,
                xi.keyItem.ICE_SAP_CRYSTAL,
                xi.keyItem.WIND_SAP_CRYSTAL,
                xi.keyItem.LIGHTNING_SAP_CRYSTAL,
                xi.keyItem.FIRE_SAP_CRYSTAL,
                xi.keyItem.LIGHT_SAP_CRYSTAL,
                xi.keyItem.DARK_SAP_CRYSTAL,
            },
        },
        {
            expansion        = 3,
            ...
            relevantKeyItems =
            {
                xi.keyItem.TABLET_OF_HEXES_GREED,
                xi.keyItem.TABLET_OF_HEXES_ENVY,
                xi.keyItem.TABLET_OF_HEXES_MALICE,
                xi.keyItem.TABLET_OF_HEXES_DECEIT,
                xi.keyItem.TABLET_OF_HEXES_PRIDE,
                xi.keyItem.TABLET_OF_HEXES_BALE,
                xi.keyItem.TABLET_OF_HEXES_DESPAIR,
                xi.keyItem.TABLET_OF_HEXES_REGRET,
                xi.keyItem.TABLET_OF_HEXES_RAGE,
                xi.keyItem.TABLET_OF_HEXES_AGONY,
                xi.keyItem.TABLET_OF_HEXES_DOLOR,
                xi.keyItem.TABLET_OF_HEXES_RANCOR,
                xi.keyItem.TABLET_OF_HEXES_STRIFE,
                xi.keyItem.TABLET_OF_HEXES_PENURY,
                xi.keyItem.TABLET_OF_HEXES_BLIGHT,
                xi.keyItem.TABLET_OF_HEXES_DEATH,
            },
        },
    },
}
...
entity.onTrade = function(player, npc, trade)
    ...
    local ki     = xi.keyItem.MOOGLE_KEY
    local asaKit = player:getCharVar(menuMetadata[1][ki].reqItemCharVar)

    if -- Crimson Key: Trade Seedspall's Lux, Luna, Astrum
        trade:hasItemQty(menuMetadata[1][xi.keyItem.CRIMSON_KEY].reqItems[1], 1) and
        trade:hasItemQty(menuMetadata[1][xi.keyItem.CRIMSON_KEY].reqItems[2], 1) and
        trade:hasItemQty(menuMetadata[1][xi.keyItem.CRIMSON_KEY].reqItems[3], 1) and
        count == 3 and
        player:getCurrentMission(xi.mission.log_id.ACP) == xi.mission.id.acp.A_CRYSTALLINE_PROPHECY_FIN
    then
        ki = xi.keyItem.CRIMSON_KEY
        tradeForKeyItem(player, trade, ki)
    elseif -- White Coral Key: orcish plate armor, quadav backscale, yagudo caulk
        trade:hasItemQty(menuMetadata[1][xi.keyItem.WHITE_CORAL_KEY].reqItems[1], 1) and
        trade:hasItemQty(menuMetadata[1][xi.keyItem.WHITE_CORAL_KEY].reqItems[2], 1) and
        trade:hasItemQty(menuMetadata[1][xi.keyItem.WHITE_CORAL_KEY].reqItems[3], 1) and
        count == 3 and
        player:getCurrentMission(xi.mission.log_id.AMK) == xi.mission.id.amk.A_MOOGLE_KUPO_DETAT_FIN
    then
        ki = xi.keyItem.WHITE_CORAL_KEY
        tradeForKeyItem(player, trade, ki)
...
entity.onEventUpdate = function(player, csid, option, npc)
    if csid == 323 then
        if option == 100 then -- Viridian Key
            if verifyReqKeyItems(player, xi.keyItem.VIRIDIAN_KEY) then
                player:updateEvent(1)
            else
                player:updateEvent(0)
            end
        elseif option == 101 then -- blue coral Key
            if verifyReqKeyItems(player, xi.keyItem.BLUE_CORAL_KEY) then
                player:updateEvent(3)
            else
                player:updateEvent(0)
            end
        elseif option == 102 then -- black coral Key
            local ki = xi.keyItem.BLACK_CORAL_KEY
        ...
        elseif option == 103 then -- Moogle Key
            local entry = menuMetadata[1][xi.keyItem.MOOGLE_KEY]
        ...
        elseif option == 104 then -- Bird Key
            local completedSeals = verifyReqKeyItems(player, xi.keyItem.BIRD_KEY)
        ...
        elseif option == 105 then -- Bomb Key
            if not verifyReqKeyItems(player, xi.keyItem.BOMB_KEY) then
...
entity.onEventFinish = function(player, csid, option, npc)
    if csid == 323 then
        ...
        elseif option == 100 then -- Viridian Key
            takeReqKeyItems(player, xi.keyItem.VIRIDIAN_KEY)
        elseif option == 101 then -- blue coral Key
            takeReqKeyItems(player, xi.keyItem.BLUE_CORAL_KEY)
        elseif option == 102 then -- black coral Key
        ...
        elseif option == 103 then -- Bird Key prereqs to run the bcnms
            npcUtil.giveKeyItem(player, menuMetadata[1][xi.keyItem.BIRD_KEY].prereqKeyItems)
        elseif option == 104 then -- Bomb Key
            takeReqKeyItems(player, xi.keyItem.BOMB_KEY)
        elseif option == 105 then -- Bird Key
            takeReqKeyItems(player, xi.keyItem.BIRD_KEY)
