...
entity.onEventFinish = function(player, csid, option)
    ...
    if csid == 128 and player:getNation() ~= xi.nation.SANDORIA then
        -- TODO: This mission should be set earlier after talking to embassy leader.  Add your
        -- nation to the conditional after converting until this is nuked
    ...
    elseif csid == 60 and player:getNation() ~= xi.nation.SANDORIA then
