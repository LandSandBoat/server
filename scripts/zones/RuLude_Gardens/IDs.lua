...
zones[tpz.zone.RULUDE_GARDENS] =
{
    text =
    {
        ...
        CARRIED_OVER_POINTS              = 6567, -- You have carried over <number> points.
        LOGIN_CAMPAIGN_UNDERWAY          = 6568, -- The <month> ≺year≻ Login Campaign is currently underway!
        LOGIN_NUMBER                     = 6569, -- In celebration of your most recent login no. <number>...
