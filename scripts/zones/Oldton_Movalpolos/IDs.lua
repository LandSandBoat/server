...
zones[xi.zone.OLDTON_MOVALPOLOS] =
{
    text =
    {
        ...
        MINING_IS_POSSIBLE_HERE = 7706, -- Mining is possible here if you have <item>.
        RAKOROK_DIALOGUE        = 7730, -- Nsy pipul. Gattohre! I bisynw!
        CHEST_UNLOCKED          = 7754, -- You unlock the chest!
