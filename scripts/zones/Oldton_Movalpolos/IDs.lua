...
zones[xi.zone.OLDTON_MOVALPOLOS] =
{
    text =
    {
        ...
        STUPID_PEOPLE                 = 7722, -- Stupid people. You don't getting what I'm saying.
        BEING_SMART                   = 7731, -- Good, good. You being smart. Very, very clever.
        ALREADY_HAVE                  = 7733, -- You already having one. You don't needing two of the same thing.
        REFUSE_TO_GIVE                = 7734, -- When Brakobrik realizes that you already possess the item he is trying to give you, he refuses to give you another one.
        FIGURING_OUT                  = 7735, -- ... You figuring it out?
        DONT_BEING_MAD                = 7736, -- Okay, okay. Don't being mad. You can having my treasure. It being very shiny. Very pretty.
