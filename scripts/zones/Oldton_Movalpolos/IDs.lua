...
zones[xi.zone.OLDTON_MOVALPOLOS] =
{
    text =
    {
        ...
        NO_FIRES_NO_BOMBS             = 7725, -- This place being for garbage. No fires. No bombs.
        KILLING_BOMBS                 = 7730, -- Killing bombs. Bringing <item>.
        REFUSES_TO_GIVE_ANOTHER       = 7738, -- When Brakobrik realizes that you already possess the item he is trying to give you, he refuses to give you another one.
