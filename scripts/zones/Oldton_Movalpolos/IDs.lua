...
zones[ xi.zone.OLDTON_MOVALPOLOS] =
{
    text =
    {
        ...
        MINING_IS_POSSIBLE_HERE = 7700, -- Mining is possible here if you have <item>.
        RAKOROK_DIALOGUE        = 7724, -- Nsy pipul. Gattohre! I bisynw!
        CHEST_UNLOCKED          = 7748, -- You unlock the chest!
