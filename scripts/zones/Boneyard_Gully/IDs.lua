...
zones[xi.zone.BONEYARD_GULLY] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7096, -- An ominous veil of pitch-black gas blocks your path. You cannot proceed any further...
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7604, -- Entering the battlefield for [Head Wind/Like the Wind/Sheep in Antlion's Clothing/Shell We Dance?/Totentanz/Tango with a Tracker/Requiem of Sin/Antagonistic Ambuscade/Head Wind]!
        TUCHULCHA_SANDPIT             = 7760, -- Tuchulcha retreats beneath the soil!
    },
    mob =
    {
