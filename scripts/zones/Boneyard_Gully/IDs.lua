...
zones[xi.zone.BONEYARD_GULLY] =
{
    text =
    {
        ...
        HOW_IS_THIS_POSSIBLE          = 7713, -- H-how...is this possible...?
        TIME_WASTED                   = 7714, -- Enough time has been wasted!
        FOLLOW_LEAD                   = 7715, -- Follow my lead!
        TIME_TO_DIE                   = 7716, -- Time to die!
        SINS_JUDGED                   = 7717, -- Your sins will be judged!
