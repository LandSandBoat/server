...
zones[xi.zone.BONEYARD_GULLY] =
{
    text =
    {
        ...
        HOW_IS_THIS_POSSIBLE          = 7716, -- H-how...is this possible...?
        TIME_WASTED                   = 7717, -- Enough time has been wasted!
        FOLLOW_LEAD                   = 7718, -- Follow my lead!
        TIME_TO_DIE                   = 7719, -- Time to die!
        SINS_JUDGED                   = 7720, -- Your sins will be judged!
        I_LOST                        = 7727, -- I...I can't have lost...
        READY_TO_REAP                 = 7728, -- Ready to rrrreap!
        MASSACRE_BEGIN                = 7729, -- Let the massacrrre begin!
