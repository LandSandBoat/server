...
zones[xi.zone.RUAUN_GARDENS] =
{
    text =
    {
        ...
        IT_IS_ALREADY_FUNCTIONING     = 7327,  -- It is already functioning.
        CHEST_UNLOCKED                = 7361,  -- You unlock the chest!
        SKY_GOD_OFFSET                = 7378,  -- A strange insignia pointing north is carved into the wall.
        ...
        REGIME_REGISTERED             = 9744,  -- New training regime registered!
        HOMEPOINT_SET                 = 11665, -- Home point set!
        COMMON_SENSE_SURVIVAL         = 11685, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
