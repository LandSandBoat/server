...
zones[tpz.zone.METALWORKS] =
{
    text =
    {
        ...
        CARRIED_OVER_POINTS         = 6482, -- You have carried over <number> points.
        LOGIN_CAMPAIGN_UNDERWAY     = 6483, -- The <month> ≺year≻ Login Campaign is currently underway!
        LOGIN_NUMBER                = 6484, -- In celebration of your most recent login no. <number>...
