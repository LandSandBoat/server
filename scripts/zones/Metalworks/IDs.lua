...
zones[xi.zone.METALWORKS] =
{
    text =
    {
        ...
        GHEMP_EXPERT_ALT            = 6823,  -- The metal you forge has begun to shine. I think it's time you took up the challenge of making <item>. 
        GHEMP_EXPERT_BASE           = 6846,  -- Don't tell me. You've read through <key item>, and now you're ready to fire up the forge.
