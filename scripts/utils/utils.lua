...
-- Generates a number from a normal distribution. If lower and/or upper is defined,
-- then the number is resampled up to 5 total times to follow the normal distribution.
-- Examples:
