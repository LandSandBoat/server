...
xi.msg.basic =
{
    ...
    EXP_GAINED                      = 8,   -- <player> gains <number> experience points.
    ...
    WAIT_LONGER                     = 94,  -- You must wait longer to perform that action. (In yellowish text)
    ...
    ITEM_EXP_GAINED                 = 105, -- <player> gains <number> experience points.
    ...
    LIMIT_POINTS_GAINED             = 371, -- <player> gains <number> limit points.
