...
xi.mobPools =
{
    ...
    BOMB_BASTARD           = 494,  -- Bomb Prince/Princess/Bastard mob pool for Self-Destruct Bomb behavior
    BOMB_PRINCE            = 496,  -- Bomb Prince/Princess/Bastard mob pool for Self-Destruct Bomb behavior
    BOMB_PRINCESS          = 497,  -- Bomb Prince/Princess/Bastard mob pool for Self-Destruct Bomb behavior
