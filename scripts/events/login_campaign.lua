...
local loginCampaignStart  = { year = 2000, month = 1, day = 1, hour = 0 }
local loginCampaignEnd    = { year = 2099, month = 12, day = 31, hour = 23 }
local loginCampaignRedeem = { year = 2099, month = 12, day = 31, hour = 23 }
