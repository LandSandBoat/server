...
entity.onEventFinish = function(player, csid, option)
    ...
    elseif option == 393220 then -- HP Boost
        player:addStatusEffect(xi.effect.MAX_HP_BOOST, 20, 0, 3600)
        player:addHP(350)
        player:delCurrency("cruor", 50)
    elseif option == 458756 then -- MP Boost
        player:addStatusEffect(xi.effect.MAX_MP_BOOST, 20, 0, 3600)
        player:addMP(350)
        player:delCurrency("cruor", 120)
    elseif option == 524292 then -- STR-DEX Boost
        player:addStatusEffect(xi.effect.STR_BOOST, 10, 0, 3600)
        player:addStatusEffect(xi.effect.DEX_BOOST, 10, 0, 3600)
        player:delCurrency("cruor", 120)
    elseif option == 589828 then -- VIT-AGI Boost
        player:addStatusEffect(xi.effect.VIT_BOOST, 10, 0, 3600)
        player:addStatusEffect(xi.effect.AGI_BOOST, 10, 0, 3600)
        player:delCurrency("cruor", 100)
    elseif option == 655364 then -- INT-MND-CHR Boost
        player:addStatusEffect(xi.effect.INT_BOOST, 10, 0, 3600)
        player:addStatusEffect(xi.effect.MND_BOOST, 10, 0, 3600)
        player:addStatusEffect(xi.effect.CHR_BOOST, 10, 0, 3600)
        player:delCurrency("cruor", 100)
