        ...
        [xi.zone.HEAVENS_TOWER] =
        {
            ['Kupipi'] =
            {
                onTrigger = function(player, npc)
                    -- NOTE: No cap has been provided to determine if there is separate dialogue.
                    -- This exists as a stopgap to ensure that the player can receive the item in case of full inventory, or having already progressed.
