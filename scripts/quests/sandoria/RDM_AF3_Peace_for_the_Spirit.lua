...
-- Miser Murphy (FeiYin) !gotoid 17612849
-- Dry Fountain !gotoid 17613243
-- Oaken Box (GC) !gotoid 17596815
-----------------------------------
...
quest.sections =
{
...

    {
        ...
        [xi.zone.GARLAIGE_CITADEL] =
        {
            ...
            {
                onTrigger = function(player, npc)
                    if quest:getVar(player, 'Prog') == 4 and
                ...
                onTrade = function(player, npc, trade)
                    if npcUtil.tradeHasExactly(trade, xi.items.NAIL_PULLER) and
                        quest:getVar(player, 'Prog') == 4 then
