...
local function isFightInProgress()
    return GetMobByID(templeID.mob.COOK_OFFSET):isAlive() or
        GetMobByID(templeID.mob.COOK_OFFSET + 1):isAlive() or
        GetMobByID(templeID.mob.COOK_OFFSET + 2):isAlive() or
        GetMobByID(templeID.mob.COOK_OFFSET + 3):isAlive()
end
