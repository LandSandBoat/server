        ...
        [xi.zone.RULUDE_GARDENS] =
        {
            ['Taillegeas'] =
            {
                onTrigger = function(player, npc)
                    ...
                    return quest:progressEvent(10057, { [0] = warriorsPathComplete,
        ...
        [xi.zone.RULUDE_GARDENS] =
        {
            ['Taillegeas'] =
            {
                onTrigger = function(player, npc)
                    ...
                    return quest:progressEvent(10059, { [0] = warriorsPathComplete,
                                                        [1] = questItemSets[questItemSet].items[1],
                                                        [2] = questItemSets[questItemSet].items[2],
                                                        [3] = questItemSets[questItemSet].items[3],
                                                        [4] = questItemSets[questItemSet].items[4] or 0,
                ...
                onTrade = function(player, npc, trade)
                    ...
                    then
                        return quest:progressEvent(10058, { [0] = warriorsPathComplete,
                                                            [6] = questItemSet - 1,
                                                            })
                    end
                end,
