...
-- Structure:           [spellId] = {  Stat used, vNPC, mNPC,  vPC,   I,  M0,  M50, M100, M200, M300, M400, M500, bonusMAcc },
    ...
    [xi.magic.spell.AERO_IV     ] = { xi.mod.INT,  440,   2,  440, 472, 2.0,   1.0,   0.5,  0.25,  0.125,  0.0625, 0.03125, 20 },
    ...
    [xi.magic.spell.TORNADO     ] = { xi.mod.INT,  552,   2,  552, 577, 2.0,   1.0,   0.5,  0.25,  0.125,  0.0625,  0.0313,  0 },
    ...
    [xi.magic.spell.BLIZZARD_IV ] = { xi.mod.INT,  506,   2,  506, 541, 2.0,   1.0,   0.5,  0.25,  0.125,  0.0625, 0.03125, 20 },
    ...
    [xi.magic.spell.FREEZE      ] = { xi.mod.INT,  526,   2,  526, 552, 2.0,   1.0,   0.5,  0.25,  0.125,  0.0625,  0.0313,  0 },
    ...
    [xi.magic.spell.FLARE       ] = { xi.mod.INT,  657,   2,  657, 684, 2.0,   1.0,   0.5,  0.25,  0.125,  0.0625,  0.0313,   },
    ...
    [xi.magic.spell.QUAKE       ] = { xi.mod.INT,  577,   2,  577, 603, 2.0,   1.0,   0.5,  0.25,  0.125,  0.0625,  0.0313,  0 },
    ...
    [xi.magic.spell.BURST       ] = { xi.mod.INT,  603,   2,  603, 630, 2.0,   1.0,   0.5,  0.25,  0.125,  0.0625,  0.0313,  0 },
    ...
    [xi.magic.spell.FLOOD       ] = { xi.mod.INT,  630,   2,  630, 657, 2.0,   1.0,   0.5,  0.25,   0.125, 0.0625,  0.0313,  0 },
...
-- Structure:           [spellId] = {  Stat used, vNPC, mNPC,  vPC,   I,  M0,  M50, M100, M200, M300, M400, M500 },
    ...
    [xi.magic.spell.AEROGA_III  ] = { xi.mod.INT,  527,  1.5,  527, 589, 1.5,  0.75,  0.375,    0.188,    0.0938,    0.0469,    0.0234 },
    ...
    [xi.magic.spell.WATERGA     ] = { xi.mod.INT,   74,    1,   74,  93, 1.0,    0.5,    0.25,    0.125,    0.0625,    0.313,   0.0156 },
