...
xi.spells.enhancing.calculateSpellBasePower = function(caster, target, spell, spellId, spellEffect)
...
xi.spells.enhancing.calculateSpellFinalPower = function(caster, target, spell, basePower, spellGroup, tier, spellEffect)
...
xi.spells.enhancing.calculateSpellDuration = function(caster, target, spell, spellId, spellGroup, spellEffect)
...
xi.spells.enhancing.useEnhancingSpell = function(caster, target, spell)
    ...
    --------------------------------------------------
    local basePower  = xi.spells.enhancing.calculateSpellBasePower(caster, target, spell, spellId, spellEffect)
    local finalPower = xi.spells.enhancing.calculateSpellFinalPower(caster, target, spell, basePower, spellGroup, tier, spellEffect)
    local duration   = xi.spells.enhancing.calculateSpellDuration(caster, target, spell, spellId, spellGroup, spellEffect)
