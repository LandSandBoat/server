...
-- Structure:                 [spellId] = { Tier, Main Effect,      subEffect,                Main Modifier,          Merit Effect,             Job-Point Effect,     power Sreq Pcap Mult Div SVP },
    ...
    -- Carol II - Enhanced versions with higher resistance cap (100 vs 80) and nullification rate (15% vs 10%)
    [xi.magic.spell.FIRE_CAROL_II     ] = { 2, xi.effect.CAROL,     xi.element.FIRE,          xi.mod.CAROL_EFFECT,    0,                        0,                   25, 400, 100,  10, 10, true  },
    [xi.magic.spell.ICE_CAROL_II      ] = { 2, xi.effect.CAROL,     xi.element.ICE,           xi.mod.CAROL_EFFECT,    0,                        0,                   25, 400, 100,  10, 10, true  },
    [xi.magic.spell.WIND_CAROL_II     ] = { 2, xi.effect.CAROL,     xi.element.WIND,          xi.mod.CAROL_EFFECT,    0,                        0,                   25, 400, 100,  10, 10, true  },
    [xi.magic.spell.EARTH_CAROL_II    ] = { 2, xi.effect.CAROL,     xi.element.EARTH,         xi.mod.CAROL_EFFECT,    0,                        0,                   25, 400, 100,  10, 10, true  },
    [xi.magic.spell.LIGHTNING_CAROL_II] = { 2, xi.effect.CAROL,     xi.element.THUNDER,       xi.mod.CAROL_EFFECT,    0,                        0,                   25, 400, 100,  10, 10, true  },
    [xi.magic.spell.WATER_CAROL_II    ] = { 2, xi.effect.CAROL,     xi.element.WATER,         xi.mod.CAROL_EFFECT,    0,                        0,                   25, 400, 100,  10, 10, true  },
    [xi.magic.spell.LIGHT_CAROL_II    ] = { 2, xi.effect.CAROL,     xi.element.LIGHT,         xi.mod.CAROL_EFFECT,    0,                        0,                   25, 400, 100,  10, 10, true  },
    [xi.magic.spell.DARK_CAROL_II     ] = { 2, xi.effect.CAROL,     xi.element.DARK,          xi.mod.CAROL_EFFECT,    0,                        0,                   25, 400, 100,  10, 10, true  },
    -- Etude
