...
spellObject.onSpellCast = function(caster, target, spell)
    ...
    then
        ...
        if resist <= 0.125 then
            ...
            caster:addStatusEffect(xi.effect.CHR_BOOST, power, tick, duration) -- Caster gains CHR
            target:addStatusEffect(xi.effect.CHR_DOWN, power, tick, duration)  -- Target loses CHR
        end
    end
