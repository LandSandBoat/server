...
spell_object.onSpellCast = function(caster, target, spell)
    ...
    then
        ...
        if resist <= 0.125 then
            ...
            caster:addStatusEffect(xi.effect.VIT_BOOST, power, tick, duration) -- Caster gains VIT
            target:addStatusEffect(xi.effect.VIT_DOWN, power, tick, duration)  -- Target loses VIT
        end
    end
