...
local noteRewardItems =
{
    [xi.zone.SOUTHERN_SAN_DORIA_S] =
    {
        [0] = -- Common
        {
            ...
            [0] = { xi.item.SPRINTERS_SHOES,                 100, false },
            [1] = { xi.item.SCROLL_OF_INSTANT_RETRACE,        10, false },
            [2] = { xi.item.IRON_RAM_JACK_COAT,              100, true  },
            [3] = { xi.item.PILGRIM_TUNICA,                  100, true  },
            [4] = { xi.item.IRON_RAM_SHIELD,                 100, true  },
            [5] = { xi.item.RECALL_RING_JUGNER,              100, false },
            [6] = { xi.item.RECALL_RING_PASHHOW,             100, false },
            [7] = { xi.item.RECALL_RING_MERIPHATAUD,         100, false },
            [8] = { xi.item.CIPHER_OF_VALAINERALS_ALTER_EGO, 100, false },
            [9] = { xi.item.CIPHER_OF_ADELHEIDS_ALTER_EGO,   100, false },
        },

        [1] = -- Stars of Service
        {
            [0] = { xi.item.IRON_RAM_CHAINMAIL, 250, true },
            [1] = { xi.item.IRON_RAM_MUFFLERS,  250, true },
            [2] = { xi.item.IRON_RAM_SOLLERETS, 250, true },
            [3] = { xi.item.IRON_RAM_HELM,      250, true },
            [4] = { xi.item.IRON_RAM_BREECHES,  250, true },
        },

        [2] = -- Emblems of Service
        {
            [0] = { xi.item.IRON_RAM_HORN,     500, true },
            [1] = { xi.item.IRON_RAM_LANCE,    500, true },
            [2] = { xi.item.IRON_RAM_PICK,     500, true },
            [3] = { xi.item.IRON_RAM_SALLET,   500, true },
            [4] = { xi.item.IRON_RAM_DASTANAS, 500, true },
        },

        [3] = -- Wings of Service
        {
            [0] = { xi.item.IRON_RAM_GREAVES, 1000, true },
            [1] = { xi.item.IRON_RAM_HOSE,    1000, true },
        },

        [4] = -- Medals of Service
        {
            [0] = { xi.item.PATRONUS_RING,      1000, true },
            [1] = { xi.item.FOX_EARRING,        1000, true },
            [2] = { xi.item.TEMPLE_EARRING,     1000, true },
            [3] = { xi.item.CRIMSON_BELT,       1000, true },
            [4] = { xi.item.ROSE_STRAP,         1000, true },
            [5] = { xi.item.IRON_RAM_HAUBERK,   1000, true },
            [6] = { xi.item.ROYAL_GUARD_LIVERY, 1000, true },
            [7] = { xi.item.ALLIED_RING,        1000, true },
        },

        [5] = -- Medals of Altana
        {
            [0] = { xi.item.GRIFFINCLAW,             1000, true },
            [1] = { xi.item.ROYAL_KNIGHT_SIGIL_RING, 1000, true },
        },
    },
    ...
    [xi.zone.BASTOK_MARKETS_S] =
    {
        [0] = -- Common
        {
            [0] = { xi.item.SPRINTERS_SHOES,                 100, false },
            [1] = { xi.item.SCROLL_OF_INSTANT_RETRACE,        10, false },
            [2] = { xi.item.FOURTH_DIVISION_TUNICA,          100, true  },
            [3] = { xi.item.PILGRIM_TUNICA,                  100, true  },
            [4] = { xi.item.FOURTH_DIVISION_GUN,             100, true  },
            [5] = { xi.item.RECALL_RING_JUGNER,              100, false },
            [6] = { xi.item.RECALL_RING_PASHHOW,             100, false },
            [7] = { xi.item.RECALL_RING_MERIPHATAUD,         100, false },
            [8] = { xi.item.CIPHER_OF_VALAINERALS_ALTER_EGO, 100, false },
        ...
        [1] = -- Stars of Service
        {
            [0] = { xi.item.FOURTH_DIVISION_CUIRASS,   250, true },
            [1] = { xi.item.FOURTH_DIVISION_GAUNTLETS, 250, true },
            [2] = { xi.item.FOURTH_DIVISION_SABATONS,  250, true },
            [3] = { xi.item.FOURTH_DIVISION_ARMET,     250, true },
            [4] = { xi.item.FOURTH_DIVISION_CUISSES,   250, true },
        },

        [2] = -- Emblems of Service
        {
            [0] = { xi.item.FOURTH_DIVISION_TOPOROK, 1000, true },
            [1] = { xi.item.FOURTH_DIVISION_MACE,    1000, true },
            [2] = { xi.item.FOURTH_DIVISION_ZAGHNAL, 1000, true },
            [3] = { xi.item.FOURTH_DIVISION_HAUBE,   1000, true },
            [4] = { xi.item.FOURTH_DIVISION_HENTZES, 1000, true },
        },

        [3] = -- Wings of Service
        {
            [0] = { xi.item.FOURTH_DIVISION_SCHUHS, 1000, true },
            [1] = { xi.item.FOURTH_DIVISION_SCHOSS, 1000, true },
        },

        [4] = -- Medals of Service
        {
            [0] = { xi.item.SHIELD_COLLAR,            1000, true },
            [1] = { xi.item.STURMS_REPORT,            1000, true },
            [2] = { xi.item.SONIAS_PLECTRUM,          1000, true },
            [3] = { xi.item.BULL_NECKLACE,            1000, true },
            [4] = { xi.item.ARRESTOR_MANTLE,          1000, true },
            [5] = { xi.item.FOURTH_DIVISION_BRUNNE,   1000, true },
            [6] = { xi.item.MYTHRIL_MUSKETEER_LIVERY, 1000, true },
            [7] = { xi.item.ALLIED_RING,              1000, true },
        },

        [5] = -- Medals of Altana
        {
            [0] = { xi.item.LEX_TALIONIS,           1000, true },
            [1] = { xi.item.FOURTH_DIVISION_MANTLE, 1000, true },
        },
    },
    ...
    [xi.zone.WINDURST_WATERS_S] =
    {
        [0] = -- Common
        {
            [0] = { xi.item.SPRINTERS_SHOES,                 100, false },
            [1] = { xi.item.SCROLL_OF_INSTANT_RETRACE,        10, false },
            [2] = { xi.item.COBRA_UNIT_TUNICA,               100, true  },
            [3] = { xi.item.PILGRIM_TUNICA,                  100, true  },
            [4] = { xi.item.COBRA_UNIT_CLAYMORE,             100, true  },
            [5] = { xi.item.RECALL_RING_JUGNER,              100, false },
            [6] = { xi.item.RECALL_RING_PASHHOW,             100, false },
            [7] = { xi.item.RECALL_RING_MERIPHATAUD,         100, false },
            [8] = { xi.item.CIPHER_OF_VALAINERALS_ALTER_EGO, 100, false },
        ...
        [1] = -- Stars of Service
        {
            [0] = { xi.item.COBRA_UNIT_COAT,     250, true },
            [1] = { xi.item.COBRA_UNIT_CUFFS,    250, true },
            [2] = { xi.item.COBRA_UNIT_PIGACHES, 250, true },
            [3] = { xi.item.COBRA_UNIT_HAT,      250, true },
            [4] = { xi.item.COBRA_UNIT_SLOPS,    250, true },
        },

        [2] = -- Emblems of Service
        {
            [0] = { xi.item.COBRA_UNIT_BAGHNAKHS, 1000, true },
            [1] = { xi.item.COBRA_UNIT_KNIFE,     1000, true },
            [2] = { xi.item.COBRA_UNIT_BOW,       1000, true },
            [3] = { xi.item.COBRA_UNIT_CAP,       1000, true },
            [4] = { xi.item.COBRA_UNIT_MITTENS,   1000, true },
            [5] = { xi.item.COBRA_UNIT_CLOCHE,    1000, true },
            [6] = { xi.item.COBRA_UNIT_GLOVES,    1000, true },
        },

        [3] = -- Wings of Service
        {
            [0] = { xi.item.COBRA_UNIT_LEGGINGS, 1000, true },
            [1] = { xi.item.COBRA_UNIT_SUBLIGAR, 1000, true },
            [2] = { xi.item.COBRA_UNIT_CRACKOWS, 1000, true },
            [3] = { xi.item.COBRA_UNIT_TREWS,    1000, true },
        },

        [4] = -- Medals of Service
        {
            [0] = { xi.item.CAPRICORNIAN_ROPE,  1000, true },
            [1] = { xi.item.EARTHY_BELT,        1000, true },
            [2] = { xi.item.COUGAR_PENDANT,     1000, true },
            [3] = { xi.item.CROCODILE_COLLAR,   1000, true },
            [4] = { xi.item.ARIESIAN_GRIP,      1000, true },
            [5] = { xi.item.COBRA_UNIT_HARNESS, 1000, true },
            [6] = { xi.item.COBRA_UNIT_ROBE,    1000, true },
            [7] = { xi.item.ALLIED_RING,        1000, true }
        },

        [5] = -- Medals of Altana
        {
            [0] = { xi.item.SAMUDRA,               1000, true },
            [1] = { xi.item.MERCENARY_MAJOR_CHARM, 1000, true },
        },
    },
}
