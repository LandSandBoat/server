...
-----------------------------------
xi.geo.addAura = function(target, tickEffect, tickPower, targetType)
    target:addStatusEffectEx(xi.effect.COLURE_ACTIVE, xi.effect.COLURE_ACTIVE, 0, 3, 0, tickEffect, tickPower, targetType, xi.effectFlag.AURA)
end
...
xi.geo.spawnLuopan = function(player, target, modelID, tickEffect, tickPower, targetType, spell)
    ...
    -- Attach effect
    xi.geo.addAura(luopan, tickEffect, tickPower, targetType)
