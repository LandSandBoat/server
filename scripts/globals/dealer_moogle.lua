...
local kuponLookup =
{
    ...
    [xi.item.MOG_KUPON_A_DBCD   ] = { xi.keyItem.MOG_KUPON_A_DBCD,    1 },
    [xi.item.MOG_KUPON_A_DXAR   ] = { xi.keyItem.MOG_KUPON_A_DXAR,    2 },
    [xi.item.MOG_KUPON_AW_ABS   ] = { xi.keyItem.MOG_KUPON_AW_ABS,    3 },
    [xi.item.MOG_KUPON_AW_PAN   ] = { xi.keyItem.MOG_KUPON_AW_PAN,    4 },
    [xi.item.MOG_KUPON_A_LUM    ] = { xi.keyItem.MOG_KUPON_A_LUM,     5 },
    [xi.item.MOG_KUPON_W_E85    ] = { xi.keyItem.MOG_KUPON_W_E85,     6 },
    [xi.item.MOG_KUPON_A_RJOB   ] = { xi.keyItem.MOG_KUPON_A_RJOB,    7 },
    [xi.item.MOG_KUPON_W_R90    ] = { xi.keyItem.MOG_KUPON_W_R90,     8 },
    [xi.item.MOG_KUPON_W_M90    ] = { xi.keyItem.MOG_KUPON_W_M90,     9 },
    [xi.item.MOG_KUPON_W_E90    ] = { xi.keyItem.MOG_KUPON_W_E90,    10 },
    [xi.item.MOG_KUPON_A_E2     ] = { xi.keyItem.MOG_KUPON_A_E2,     11 },
    [xi.item.MOG_KUPON_I_SEAL   ] = { xi.keyItem.MOG_KUPON_I_SEAL,   12 },
    [xi.item.MOG_KUPON_A_DEII   ] = { xi.keyItem.MOG_KUPON_A_DEII,   13 },
    [xi.item.MOG_KUPON_A_DE     ] = { xi.keyItem.MOG_KUPON_A_DE,     14 },
    [xi.item.MOG_KUPON_A_SAL    ] = { xi.keyItem.MOG_KUPON_A_SAL,    15 },
    [xi.item.MOG_KUPON_A_NYZ    ] = { xi.keyItem.MOG_KUPON_A_NYZ,    16 },
    [xi.item.MOG_KUPON_I_S5     ] = { xi.keyItem.MOG_KUPON_I_S5,     17 },
    [xi.item.MOG_KUPON_I_S2     ] = { xi.keyItem.MOG_KUPON_I_S2,     18 },
    [xi.item.MOG_KUPON_I_ORCHE  ] = { xi.keyItem.MOG_KUPON_I_ORCHE,  19 },
    [xi.item.MOG_KUPON_I_AF109  ] = { xi.keyItem.MOG_KUPON_I_AF109,  20 },
    [xi.item.MOG_KUPON_W_EWS    ] = { xi.keyItem.MOG_KUPON_W_EWS,    21 },
    [xi.item.MOG_KUPON_AW_WK    ] = { xi.keyItem.MOG_KUPON_AW_WK,    22 },
    [xi.item.MOG_KUPON_I_S3     ] = { xi.keyItem.MOG_KUPON_I_S3,     23 },
    [xi.item.MOG_KUPON_A_PK109  ] = { xi.keyItem.MOG_KUPON_A_PK109,  24 },
    [xi.item.MOG_KUPON_I_S1     ] = { xi.keyItem.MOG_KUPON_I_S1,     25 },
    [xi.item.MOG_KUPON_I_SKILL  ] = { xi.keyItem.MOG_KUPON_I_SKILL,  26 },
    [xi.item.MOG_KUPON_I_RME    ] = { xi.keyItem.MOG_KUPON_I_RME,    27 },
--  [xi.item.NOT_IN_USE         ] = { xi.keyItem.MOG_KUPON_I,        28 },
    [xi.item.MOG_KUPON_W_JOB    ] = { xi.keyItem.MOG_KUPON_W_JOB,    29 },
    [xi.item.MOG_KUPON_I_MAT    ] = { xi.keyItem.MOG_KUPON_I_MAT,    30 },
    [xi.item.MOG_KUPON_W_DEIII  ] = { xi.keyItem.MOG_KUPON_W_DEIII,  31 },
    [xi.item.MOG_KUPON_AW_MIS   ] = { xi.keyItem.MOG_KUPON_AW_MIS,   32 },
    [xi.item.MOG_KUPON_AW_VGR   ] = { xi.keyItem.MOG_KUPON_AW_VGR,   33 },
    [xi.item.MOG_KUPON_AW_VGRII ] = { xi.keyItem.MOG_KUPON_AW_VGRII, 34 },
    [xi.item.MOG_KUPON_W_PULSE  ] = { xi.keyItem.MOG_KUPON_W_PULSE,  35 },
    [xi.item.MOG_KUPON_I_STONE  ] = { xi.keyItem.MOG_KUPON_I_STONE,  36 },
    [xi.item.MOG_KUPON_AW_GFIII ] = { xi.keyItem.MOG_KUPON_AW_GFIII, 37 },
    [xi.item.MOG_KUPON_AW_GFII  ] = { xi.keyItem.MOG_KUPON_AW_GFII,  38 },
    [xi.item.MOG_KUPON_AW_GF    ] = { xi.keyItem.MOG_KUPON_AW_GF,    39 },
    [xi.item.MOG_KUPON_AW_UWIII ] = { xi.keyItem.MOG_KUPON_AW_UWIII, 40 },
    [xi.item.MOG_KUPON_AW_UWII  ] = { xi.keyItem.MOG_KUPON_AW_UWII,  41 },
    [xi.item.MOG_KUPON_AW_UW    ] = { xi.keyItem.MOG_KUPON_AW_UW,    42 },
    [xi.item.MOG_KUPON_A_AB     ] = { xi.keyItem.MOG_KUPON_A_AB,     43 },
    [xi.item.MOG_KUPON_AW_COS   ] = { xi.keyItem.MOG_KUPON_AW_COS,   44 },
    [xi.item.MOG_KUPON_AW_KUPO  ] = { xi.keyItem.MOG_KUPON_AW_KUPO,  45 },
    [xi.item.MOG_KUPON_W_EMI    ] = { xi.keyItem.MOG_KUPON_W_EMI,    46 },
    [xi.item.MOG_KUPON_A_EMI    ] = { xi.keyItem.MOG_KUPON_A_EMI,    47 },
    [xi.item.MOG_KUPON_W_SRW    ] = { xi.keyItem.MOG_KUPON_W_SRW,    48 },
    [xi.item.MOG_KUPON_W_SCC    ] = { xi.keyItem.MOG_KUPON_W_SCC,    49 },
    [xi.item.MOG_KUPON_A_SYW    ] = { xi.keyItem.MOG_KUPON_A_SYW,    50 },
    [xi.item.MOG_KUPON_W_ASRW   ] = { xi.keyItem.MOG_KUPON_W_ASRW,   51 },
    [xi.item.MOG_KUPON_W_ASCC   ] = { xi.keyItem.MOG_KUPON_W_ASCC,   52 },
    [xi.item.MOG_KUPON_A_ASYW   ] = { xi.keyItem.MOG_KUPON_A_ASYW,   53 },
    [xi.item.MOG_KUPON_W_R119   ] = { xi.keyItem.MOG_KUPON_W_R119,   54 },
    [xi.item.MOG_KUPON_W_M119   ] = { xi.keyItem.MOG_KUPON_W_M119,   55 },
    [xi.item.MOG_KUPON_W_E119   ] = { xi.keyItem.MOG_KUPON_W_E119,   56 },
    [xi.item.MOG_KUPON_W_A119   ] = { xi.keyItem.MOG_KUPON_W_A119,   57 },
    [xi.item.MOG_KUPON_AW_GEIV  ] = { xi.keyItem.MOG_KUPON_AW_GEIV,  58 },
    [xi.item.MOG_KUPON_A_OMII   ] = { xi.keyItem.MOG_KUPON_A_OMII,   59 },
    [xi.item.MOG_KUPON_I_AF119  ] = { xi.keyItem.MOG_KUPON_I_AF119,  60 },
    [xi.item.MOG_KUPON_AW_OM    ] = { xi.keyItem.MOG_KUPON_AW_OM,    61 },
    [xi.item.MOG_KUPON_W_RMEA   ] = { xi.keyItem.MOG_KUPON_W_RMEA,   62 },
--  [xi.item.NEXT_POTENTIAL_ID  ] = { xi.keyItem.NEXT_POTENTIAL_ID,  63 },
