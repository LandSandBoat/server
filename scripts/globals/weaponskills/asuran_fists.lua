...
weaponskill_object.onUseWeaponSkill = function(player, target, wsID, tp, primary, action, taChar)
    ...
    local params = {}
    params.numHits = 8
    -- This is a 8 hit ws but H2H ws are done in a different way, the off hand hit is been taking into account in another place, it is possible that we are adding one hit too many but lacking data
...
-- http://wiki.ffo.jp/html/2424.html
