...
local GearSets =  {
             ...
             {id = 44, items = {11083, 11103, 11123, 11143, 11163}, matches = 2, matchType = matchtype.any, mods = {{xi.mod.GRIMOIRE_INSTANT_CAST, instantCastRate, instantCastPieceBonus, 0}} },          --  Savant's Attire +2 Set. Set Bonus: Augments Grimoire. Spells that match your current Arts will occasionally cast instantly, without recast.
             ...
             {id = 82, items = {27275, 27276, 27449, 27450, 26778, 26779, 26936, 26937, 27090, 27091}, matches = 2, matchType = matchtype.any, mods = {{xi.mod.GRIMOIRE_INSTANT_CAST, instantCastRate, instantCastPieceBonus, 0}} }, -- 109/119 SCH AF3
