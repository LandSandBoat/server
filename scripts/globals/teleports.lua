...
xi.teleport.destination =
{
    ...
    [ids.EAST_SANDY_GLYPH]      = {  102.877,    0.000,  -50.330,  35, 230 }, -- Southern San d'Oria East Gate -- TODO: Get retail coordinates.
    [ids.WEST_SANDY_GLYPH]      = { -102.522,    0.000,  -50.585,  95, 230 }, -- Southern San d'Oria West Gate -- TODO: Get retail coordinates.
    [ids.NORTH_SANDY_GLYPH]     = { -243.710,    6.999,   41.196, 125, 231 }, -- Northern San d'Oria West Gate -- TODO: Get retail coordinates.
    [ids.WINDY_WATERS_GLYPH]    = {  -30.192,   -4.920,  223.038, 186, 238 }, -- Windurst Waters Gate -- TODO: Get retail coordinates.
    [ids.PORT_WINDY_GLYPH]      = { -223.678,   -7.999,  209.021, 131, 240 }, -- Port Windurst Gate -- TODO: Get retail coordinates.
    [ids.WINDY_WOODS_GLYPH]     = {  103.500,   -5.000,  -48.693,   5, 241 }, -- Windurst Woods Gate -- TODO: Get retail coordinates.
