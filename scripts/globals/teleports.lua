...
xi.teleport.destination =
{
    ...
    [ids.BASTOK_MINES_GLYPH]    = {   -2.658,   -1.001, -120.508,  70, 234 }, -- Bastok Mines Gate -- TODO: Update coordinates.
    [ids.BASTOK_MARKETS_GLYPH]  = { -346.354,  -10.002, -181.252,  87, 235 }, -- Bastok Markets South Gate -- TODO: Update coordinates.
    [ids.PORT_BASTOK_GLYPH]     = {  128.520,    8.496,    4.011, 251, 236 }, -- Port Bastok Gate -- TODO: Update coordinates.
    [ids.EAST_SANDY_GLYPH]      = {  101.292,    1.000,  -48.889,  31, 230 }, -- Southern San d'Oria East Gate -- TODO: Update coordinates.
    [ids.WEST_SANDY_GLYPH]      = { -104.935,    0.000,  -50.120,  95, 230 }, -- Southern San d'Oria West Gate -- TODO: Update coordinates.
    [ids.NORTH_SANDY_GLYPH]     = { -247.201,    6.999,   43.939, 125, 231 }, -- Northern San d'Oria West Gate -- TODO: Update coordinates.
    [ids.WINDY_WATERS_GLYPH]    = {  -30.706,   -4.920,  229.500, 186, 238 }, -- Windurst Waters Gate -- TODO: Update coordinates.
    [ids.PORT_WINDY_GLYPH]      = { -227.169,   -7.999,  212.278, 131, 240 }, -- Port Windurst Gate -- TODO: Update coordinates.
    [ids.WINDY_WOODS_GLYPH]     = {  108.726,   -5.000,  -43.588,   0, 241 }, -- Windurst Woods Gate -- TODO: Update coordinates.
