...
mobskill_object.onMobWeaponSkill = function(target, mob, skill)
    MobStatusEffectMove(mob, target, xi.effect.BLINDNESS, 60, 0, 30)

    local dmgmod = 1
    local info = MobMagicalMove(mob, target, skill, mob:getWeaponDmg()*5, xi.magic.ele.WIND, dmgmod, xi.mobskills.magicalTpBonus.NO_EFFECT)
