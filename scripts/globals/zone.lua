...
xi.region =
{
    ...
    DYNAMIS                    = 21,
    MOVALPOLOS                 = 22,
    TAVNAZIAN_MARQUISATE       = 23,
    TAVNAZIAN_ARCHIPELAGO      = 24,
    PROMYVION                  = 25,
    LUMORIA                    = 26,
    LIMBUS                     = 27,
    EMPIRE_OF_AHT_URHGAN       = 28,
    WEST_AHT_URHGAN            = 29,
    MAMOOL_JA_SAVAGELANDS      = 30,
    HALVUNG_TERRITORY          = 31,
    ARRAPAGO_ISLANDS           = 32,
    RUINS_OF_ALZADAAL          = 33,
    THE_RONFAURE_FRONT         = 34,
    THE_NORVALLEN_FRONT        = 35,
    THE_GUSTABERG_FRONT        = 36,
    THE_DERFLAND_FRONT         = 37,
    THE_SARUTABARUTA_FRONT     = 38,
    THE_ARAGONEU_FRONT         = 39,
    THE_FAUREGANDI_FRONT       = 40,
    THE_VALDEAUNIA_FRONT       = 41,
    ORCISH_HOSTS               = 42,
    QUADAV_SHIELDWARRIORS      = 43,
    YAGUDO_THEOMILITARY        = 44,
    DARK_KINDRED               = 45,
    ABYSSEA                    = 46,
    THE_THRESHOLD              = 47,
    ABDHALJS                   = 48,
    THE_SACRED_CITY_OF_ADOULIN = 49,
    THE_ADOULIN_ISLANDS        = 50,
    EAST_ULBUKA_TERRITORY      = 51,
    RAKAZNAR                   = 52,
    ESCHA                      = 53,
    FAR_EAST                   = 54,
    UNKNOWN = 255
