...
local mobSpawnPoints = -- Set mob spawn points, by layout.
{
    [1] =
    {
    ...
    [8] = -- TODO: We need to add more spawn points to this layout to not run out of.
    {
...
local function lampsActivate(instance)
    ...
    if lampsObjective == xi.nyzul.lampsObjective.REGISTER then
        spawnPoint = math.random(1, #dTableLampPoints)
    ...
    elseif lampsObjective == xi.nyzul.lampsObjective.ACTIVATE_ALL then
        ...
        for i = runicLampOffset, runicLampOffset + runicLamps do
            spawnPoint = math.random(1, #dTableLampPoints)
    ...
    elseif instance:getStage() ~= xi.nyzul.objective.FREE_FLOOR then
        ...
        if spawnedNMs > 0 then
            ...
            if currentFloor % 2 == 0 then
                ...
                mobGroup = pTableOddFloorRandomNMs[floorSection]
            end
