...
local atmaMods =
{
    ...
    [xi.ki.ATMA_OF_THE_BLUDGEONING_BRUTE]      = { xi.mod.REGAIN, 10, xi.mod.THUNDERRES, 50, xi.mod.WATERRES, 50},
    ...
    [xi.ki.ATMA_OF_APPARITIONS]                = { xi.mod.EVA, 20, xi.mod.WINDRES, 50},
    [xi.ki.ATMA_OF_THE_SHIMMERING_SHELL]       = { xi.mod.AGI, 20, xi.mod.FIRERES, 50},
    [xi.ki.ATMA_OF_THE_MURKY_MIASMA]           = { xi.mod.DARKRES, 50, xi.mod.STUNRES, 30},
    ...
    [xi.ki.ATMA_OF_THE_BROTHER_WOLF]           = { xi.mod.MATT, 20, xi.mod.MDEF, 20, xi.mod.FIRERES, 100},
    [xi.ki.ATMA_OF_THE_EARTH_WYRM]             = { xi.mod.EARTHRES, 100, xi.mod.DMG, -20, xi.mod.FORCE_EARTH_DWBONUS, 1},
    [xi.ki.ATMA_OF_THE_ASCENDING_ONE]          = { xi.mod.WINDRES, 100, xi.mod.HASTE_GEAR, 500, xi.mod.SNAP_SHOT, 5},
    ...
    [xi.ki.ATMA_OF_THE_WAR_LION]               = { xi.mod.DEX, 20, xi.mod.THUNDERRES, 100, xi.mod.FORCE_LIGHTNING_DWBONUS, 1},
    [xi.ki.ATMA_OF_THE_FROZEN_FETTERS]         = { xi.mod.INT, 20, xi.mod.ICERES, 100, xi.mod.FORCE_ICE_DWBONUS, 1},
    ...
    [xi.ki.ATMA_OF_THE_HOLY_MOUNTAIN]          = { xi.mod.LIGHTRES, 100, xi.mod.LIGHTACC, 50, xi.mod.FORCE_LIGHT_DWBONUS, 1},
    [xi.ki.ATMA_OF_THE_LAKE_LURKER]            = { xi.mod.MND, 20, xi.mod.WATERRES, 100, xi.mod.FORCE_WATER_DWBONUS, 1},
    ...
    [xi.ki.ATMA_OF_THE_ENDLESS_NIGHTMARE]      = { xi.mod.MND, 20, xi.mod.DARKRES, 100, xi.mod.FORCE_DARK_DWBONUS, 1},
