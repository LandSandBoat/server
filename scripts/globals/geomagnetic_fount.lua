...
xi.geomagneticFount.checkFount = function(player, npc)
    ...
    elseif theGeomagnetron then
        player:messageSpecial(zones[player:getZoneID()].text.GEOMAGNETRON_ATTUNED, 0, xi.keyItem.GEOMAGNETRON) -- Your <keyitem> has been attuned to a geomagnetic fount in the corresponding locale.
