...
xi.shop.curioVendorMoogleStock =
{
    [xi.shop.curio.medicine] =
    {
        ...
        { xi.item.HI_POTION,               600, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.X_POTION,               1200, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.MAX_POTION,            10350, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.ETHER,                  1250, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.HI_ETHER,               2000, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.SUPER_ETHER,            3000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.PRO_ETHER,              7000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.ELIXIR,                15000, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.HI_ELIXIR,             20000, xi.keyItem.RHAPSODY_IN_MAUVE   },
        { xi.item.ANTIDOTE,                300, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.FLASK_OF_EYE_DROPS,     1000, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.FLASK_OF_ECHO_DROPS,     700, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.BOTTLE_OF_ANTACID,      1000, xi.keyItem.RHAPSODY_IN_EMERALD },
        { xi.item.FLASK_OF_HOLY_WATER,    1000, xi.keyItem.RHAPSODY_IN_EMERALD },
        { xi.item.REMEDY,                 3000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.FLASK_OF_PANACEA,      20000, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.BOTTLE_OF_MULSUM,        500, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.PINCH_OF_PRISM_POWDER,   700, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.POT_OF_SILENT_OIL,       700, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.FLASK_OF_DEODORIZER,     250, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.RERAISER,               1000, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.HI_RERAISER,            1500, xi.keyItem.RHAPSODY_IN_EMERALD },
        { xi.item.VILE_ELIXIR,           20000, xi.keyItem.RHAPSODY_IN_MAUVE   },
        { xi.item.VILE_ELIXIR_P1,        40000, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.ICARUS_WING,           15000, xi.keyItem.RHAPSODY_IN_MAUVE   },
    },

    [xi.shop.curio.ammunition] =
    {
        { xi.item.STONE_QUIVER,               400, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.BONE_QUIVER,                680, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.IRON_QUIVER,               1200, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.BEETLE_QUIVER,             1350, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SILVER_QUIVER,             2040, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.HORN_QUIVER,               2340, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SLEEP_QUIVER,              3150, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.SCORPION_QUIVER,           3500, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.DEMON_QUIVER,              7000, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.KABURA_QUIVER,             8800, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.ANTLION_QUIVER,            9900, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.RUSZOR_QUIVER,            11880, xi.keyItem.RHAPSODY_IN_EMERALD },
        { xi.item.GARGOUILLE_QUIVER,        13910, xi.keyItem.RHAPSODY_IN_MAUVE   },
        { xi.item.CHAPULI_QUIVER,           15400, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.MANTID_QUIVER,            15820, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.TULFAIRE_QUIVER,          17610, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.RAAZ_QUIVER,              18450, xi.keyItem.RHAPSODY_IN_PUCE    },
        { xi.item.ADLIVUN_QUIVER,           18450, xi.keyItem.RHAPSODY_IN_PUCE    },
        { xi.item.RAKAZNAR_QUIVER,          18750, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.EMINENT_QUIVER,           19050, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.BRONZE_BOLT_QUIVER,         400, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.BLIND_BOLT_QUIVER,          800, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.ACID_BOLT_QUIVER,          1250, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SLEEP_BOLT_QUIVER,         1500, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.BLOODY_BOLT_QUIVER,        2100, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.VENOM_BOLT_QUIVER,         2100, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.HOLY_BOLT_QUIVER,          2400, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.MYTHRIL_BOLT_QUIVER,       3500, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.DARKSTEEL_BOLT_QUIVER,     5580, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.DARKLING_BOLT_QUIVER,      9460, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.FUSION_BOLT_QUIVER,        9790, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.DARK_ADAMAN_BOLT_QUIVER,  11880, xi.keyItem.RHAPSODY_IN_EMERALD },
        { xi.item.ADAMAN_BOLT_QUIVER,       13780, xi.keyItem.RHAPSODY_IN_MAUVE   },
        { xi.item.OXIDANT_BOLT_QUIVER,      15400, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.MIDRIUM_BOLT_QUIVER,      15400, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.DAMASCUS_BOLT_QUIVER,     15820, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.TITANIUM_BOLT_QUIVER,     17610, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.BISMUTH_BOLT_QUIVER,      18450, xi.keyItem.RHAPSODY_IN_PUCE    },
        { xi.item.ADLIVUN_BOLT_QUIVER,      18450, xi.keyItem.RHAPSODY_IN_PUCE    },
        { xi.item.GASHING_BOLT_QUIVER,      18750, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.RAKAZNAR_BOLT_QUIVER,     18750, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.ABRASION_BOLT_QUIVER,     19050, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.RIGHTEOUS_BOLT_QUIVER,    19050, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.EMINENT_BOLT_QUIVER,      19050, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.BRONZE_BULLET_POUCH,        400, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.BULLET_POUCH,              1920, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SPARTAN_BULLET_POUCH,      2400, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.IRON_BULLET_POUCH,         4800, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.SILVER_BULLET_POUCH,       4800, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.CORSAIR_BULLET_POUCH,      7100, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.STEEL_BULLET_POUCH,        7600, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.DWEOMER_BULLET_POUCH,      9680, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.OBERON_BULLET_POUCH,       9900, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.DARK_ADAMAN_BULLET_POUCH, 12000, xi.keyItem.RHAPSODY_IN_EMERALD },
        { xi.item.ORICHALCUM_BULLET_POUCH,  13910, xi.keyItem.RHAPSODY_IN_MAUVE   },
        { xi.item.ADAMAN_BULLET_POUCH,      14040, xi.keyItem.RHAPSODY_IN_MAUVE   },
        { xi.item.MIDRIUM_BULLET_POUCH,     15400, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.DAMASCUS_BULLET_POUCH,    15820, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.TITANIUM_BULLET_POUCH,    17610, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.BISMUTH_BULLET_POUCH,     18450, xi.keyItem.RHAPSODY_IN_PUCE    },
        { xi.item.ADLIVUN_BULLET_POUCH,     18450, xi.keyItem.RHAPSODY_IN_PUCE    },
        { xi.item.DECIMATING_BULLET_POUCH,  18750, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.RAKAZNAR_BULLET_POUCH,    18750, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.EMINENT_BULLET_POUCH,     19050, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.SHURIKEN_POUCH,            1400, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.JUJI_SHURIKEN_POUCH,       2280, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.MANJI_SHURIKEN_POUCH,      4640, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.FUMA_SHURIKEN_POUCH,       7000, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.IGA_SHURIKEN_POUCH,        9900, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.ROPPO_SHURIKEN_POUCH,     17610, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.HAPPO_SHURIKEN_POUCH,     19050, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.HACHIYA_SHURIKEN_POUCH,   19050, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.SUPPA_SHURIKEN_POUCH,     19050, xi.keyItem.RHAPSODY_IN_OCHRE   },
    },

    [xi.shop.curio.ninjutsuTools] =
    {
        { xi.item.TOOLBAG_UCHITAKE,         3000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_TSURARA,          3000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_KAWAHORI_OGI,     3000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_MAKIBISHI,        3000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_HIRAISHIN,        3000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_MIZU_DEPPO,       3000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_SHIHEI,           5000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_JUSATSU,          5000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_KAGINAWA,         5000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_SAIRUI_RAN,       5000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_KODOKU,           5000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_SHINOBI_TABI,     3000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_SANJAKU_TENUGUI,  3000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.TOOLBAG_SOSHI,            5000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.TOOLBAG_KABENRO,          5000, xi.keyItem.RHAPSODY_IN_EMERALD },
        { xi.item.TOOLBAG_JINKO,            5000, xi.keyItem.RHAPSODY_IN_EMERALD },
        { xi.item.TOOLBAG_RYUNO,            5000, xi.keyItem.RHAPSODY_IN_MAUVE   },
        { xi.item.TOOLBAG_MOKUJIN,          5000, xi.keyItem.RHAPSODY_IN_EMERALD },
        { xi.item.TOOLBAG_INOSHISHINOFUDA, 14000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.TOOLBAG_SHIKANOFUDA,     19000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.TOOLBAG_CHONOFUDA,       19000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.TOOLBAG_RANKA,            5000, xi.keyItem.RHAPSODY_IN_EMERALD },
        { xi.item.TOOLBAG_FURUSUMI,         5000, xi.keyItem.RHAPSODY_IN_MAUVE   },
    },
    [xi.shop.curio.foodStuffs] =
    {
        { xi.item.JUG_OF_SELBINA_MILK,             60, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.FLASK_OF_ORANGE_AU_LAIT,        150, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.JUG_OF_ULEGUERAND_MILK,         170, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.FLASK_OF_APPLE_AU_LAIT,         300, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.FLASK_OF_PEAR_AU_LAIT,          600, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.FLASK_OF_PERSIKOS_AU_LAIT,     2100, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.FLASK_OF_DRAGON_FRUIT_AU_LAIT, 2500, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.BOTTLE_OF_ORANGE_JUICE,         200, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.BOTTLE_OF_MELON_JUICE,         1100, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.BOTTLE_OF_YAGUDO_DRINK,        2000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.BOTTLE_OF_KITRON_JUICE,        2500, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.RICE_BALL,                      160, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.STRIP_OF_MEAT_JERKY,            120, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SLICE_OF_GRILLED_HARE,          184, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.MEAT_MITHKABOB,                 720, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.YELLOW_CURRY_BUN,              3000, xi.keyItem.RHAPSODY_IN_MAUVE   },
        { xi.item.SLICE_OF_MARINARA_PIZZA,       4000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.RABBIT_PIE,                    5000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.RED_CURRY_BUN,                 7000, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.BOILED_CRAB,                    900, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.FISH_MITHKABOB,                1080, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.COEURL_SUB,                    1500, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.ROAST_PIPIRA,                   900, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SLICE_OF_ANCHOVY_PIZZA,         500, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.SLICE_OF_PEPPERONI_PIZZA,       400, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.BLACK_CURRY_BUN,               4000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.TAVNAZIAN_TACO,                4000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.DISH_OF_HOMEMADE_CARBONARA,    4000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.POT_AUF_FEU,                   3500, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.JACK_O_LANTERN,                1000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.PLATE_OF_SQUID_SUSHI,          6000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.PLATE_OF_SOLE_SUSHI,           7000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.PLATE_OF_BREAM_SUSHI,          5000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.PLATE_OF_DORADO_SUSHI,         4000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.PLATE_OF_CRAB_SUSHI,           1500, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.CHOCOLATE_CREPE,                500, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.BUTTER_CREPE,                  1000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.PEAR_CREPE,                    2000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.FRUIT_PARFAIT,                 3000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.APPLE_PIE,                      320, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.MELON_PIE,                      800, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.PUMPKIN_PIE,                   1200, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.SERVING_OF_CRIMSON_JELLY,      7000, xi.keyItem.RHAPSODY_IN_OCHRE   },
        { xi.item.SERVING_OF_ICECAP_ROLANBERRY,  5544, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.CREAM_PUFF,                    1300, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.ROAST_MUSHROOM,                 344, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.ACORN_COOKIE,                    24, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.GINGER_COOKIE,                   12, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.SUGAR_RUSK,                    1000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.CHOCOLATE_RUSK,                2000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.COCONUT_RUSK,                  3000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.CHERRY_MACARON,                1000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.COFFEE_MACARON,                2000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.KITRON_MACARON,                3000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.SALTENA,                       1000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.ELSHENA,                       2000, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.MONTAGNA,                      2500, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.MARINGNA,                      3000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.STUFFED_PITARU,                1000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.POULTRY_PITARU,                2000, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.SEAFOOD_PITARU,                2500, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.B_E_W_PITARU,                  3000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.PIECE_OF_SHIROMOCHI,           3000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.PIECE_OF_KUSAMOCHI,            3000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.PIECE_OF_AKAMOCHI,             3000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.ROLANBERRY_DAIFUKU,            4000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.BEAN_DAIFUKU,                  4000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.GRAPE_DAIFUKU,                 4000, xi.keyItem.RHAPSODY_IN_FUCHSIA },
        { xi.item.BEEF_STEWPOT,                 15000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.SERVING_OF_ZARU_SOBA,         15000, xi.keyItem.RHAPSODY_IN_CRIMSON },
        { xi.item.SPICY_CRACKER,                  450, xi.keyItem.RHAPSODY_IN_CRIMSON },
    },

    [xi.shop.curio.scrolls] =
    {
        { xi.item.SCROLL_OF_INSTANT_WARP,      500, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SCROLL_OF_INSTANT_RERAISE,   500, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SCROLL_OF_INSTANT_RETRACE,   500, xi.keyItem.RHAPSODY_IN_AZURE   },
        { xi.item.SCROLL_OF_INSTANT_PROTECT,   500, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SCROLL_OF_INSTANT_SHELL,     500, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SCROLL_OF_INSTANT_STONESKIN, 500, xi.keyItem.RHAPSODY_IN_UMBER   },
        { xi.item.DIMENSIONAL_RING_HOLLA,   115500, xi.keyItem.RHAPSODY_IN_FUCHSIA, xi.zone.PORT_SAN_DORIA },
        { xi.item.DIMENSIONAL_RING_DEM,     115500, xi.keyItem.RHAPSODY_IN_FUCHSIA, xi.zone.PORT_BASTOK    },
        { xi.item.DIMENSIONAL_RING_MEA,     115500, xi.keyItem.RHAPSODY_IN_FUCHSIA, xi.zone.PORT_WINDURST  },
        { xi.item.ANCIENT_BEASTCOIN,          1000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.ARGYRO_RIVET,               2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_ECARLATE_CLOTH,   2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.ANCIENT_BRASS_INGOT,        2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.UTOPIAN_GOLD_THREAD,        2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SPOOL_OF_BENEDICT_YARN,     2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_BENEDICT_SILK,    2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SPOOL_OF_DIABOLIC_YARN,     2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_DIABOLIC_SILK,    2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_CARDINAL_CLOTH,   2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SPOOL_OF_RUBY_SILK_THREAD,  2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SPOOL_OF_LIGHT_FILAMENT,    2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_SUPPLE_SKIN,      2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.WHITE_RIVET,                2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.CHUNK_OF_SNOWY_CERMET,      2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.BLACK_RIVET,                2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.DARK_ORICHALCUM_INGOT,      2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.FETID_LANOLIN_CUBE,         2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_SMALT_LEATHER,    2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_BROWN_DOESKIN,    2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SPOOL_OF_COILED_YARN,       2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_CHARCOAL_COTTON,  2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SPOOL_OF_CHAMELEON_YARN,    2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SHEET_OF_KUROGANE,          2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SPOOL_OF_SCARLET_ODOSHI,    2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.POT_OF_EBONY_LACQUER,       2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.PLAITED_CORD,               2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.BLUE_RIVET,                 2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SHEET_OF_COBALT_MYTHRIL,    2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_ASTRAL_LEATHER,   2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SPOOL_OF_GLITTERING_YARN,   2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_FLAMESHUN_CLOTH,  2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SPOOL_OF_LUMINIAN_THREAD,   2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_CANVAS_TOILE,     2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SPOOL_OF_SILKWORM_THREAD,   2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_CORDUROY_CLOTH,   2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.PANTIN_WIRE,                2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.GOLD_STUD,                  2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_FILET_LACE,       2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.ELECTRUM_STUD,              2000, xi.keyItem.RHAPSODY_IN_WHITE   },
        { xi.item.SQUARE_OF_BRILLIANTINE,     2000, xi.keyItem.RHAPSODY_IN_WHITE   },
    },

    [xi.shop.curio.keys] =
    {
        { xi.item.GHELSBA_CHEST_KEY,     2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.PALBOROUGH_CHEST_KEY,  2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.GIDDEUS_CHEST_KEY,     2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.RANPERRE_CHEST_KEY,    2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.DANGRUF_CHEST_KEY,     2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.HORUTOTO_CHEST_KEY,    2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.ORDELLE_CHEST_KEY,     2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.GUSGEN_CHEST_KEY,      2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.SHAKHRAMI_CHEST_KEY,   2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.DAVOI_CHEST_KEY,       2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.BEADEAUX_CHEST_KEY,    2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.OZTROJA_CHEST_KEY,     2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.DELKFUTT_CHEST_KEY,    2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.FEIYIN_CHEST_KEY,      2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.ZVAHL_CHEST_KEY,       2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.ELDIEME_CHEST_KEY,     2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.NEST_CHEST_KEY,        2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.GARLAIGE_CHEST_KEY,    2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.BEADEAUX_COFFER_KEY,   5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.DAVOI_COFFER_KEY,      5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.OZTROJA_COFFER_KEY,    5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.NEST_COFFER_KEY,       5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ELDIEME_COFFER_KEY,    5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.GARLAIGE_COFFER_KEY,   5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ZVAHL_COFFER_KEY,      5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.UGGALEPIH_COFFER_KEY,  5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.RANCOR_DEN_COFFER_KEY, 5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.KUFTAL_COFFER_KEY,     5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.BOYAHDA_COFFER_KEY,    5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.CAULDRON_COFFER_KEY,   5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.QUICKSAND_COFFER_KEY,  5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.GROTTO_CHEST_KEY,      2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.ONZOZO_CHEST_KEY,      2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.TORAIMARI_COFFER_KEY,  5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.RUAUN_COFFER_KEY,      5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.GROTTO_COFFER_KEY,     5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.VELUGANNON_COFFER_KEY, 5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.SACRARIUM_CHEST_KEY,   2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.OLDTON_CHEST_KEY,      2500, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.NEWTON_COFFER_KEY,     5000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.PSOXJA_CHEST_KEY,      2500, xi.keyItem.RHAPSODY_IN_WHITE },
    },

    [xi.shop.curio.equipment] =
    {
        { xi.item.ENIF_CORAZZA,       30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ADHARA_MANTEEL,     30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.MURZIM_CORAZZA,     30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.SHEDIR_MANTEEL,     30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.SORTIARIUS_EARRING, 30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ENIF_MANOPOLAS,     30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ADHARA_GAGES,       30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.MURZIM_MANOPOLAS,   30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.SHEDIR_GAGES,       30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ENIF_COSCIALES,     30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ADHARA_SERAWEELS,   30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.MURZIM_COSCIALES,   30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.SHEDIR_SERAWEELS,   30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ENIF_GAMBIERAS,     30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ADHARA_CRACKOWS,    30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.MURZIM_GAMBIERAS,   30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.SHEDIR_CRACKOWS,    30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ENIF_ZUCCHETTO,     30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ADHARA_TURBAN,      30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.MURZIM_ZUCCHETTO,   30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.SHEDIR_TURBAN,      30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.PATENTIA_SASH,      30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.PRODIGIOUS_MANTLE,  30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.ALGIDUS_CAPE,       30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.HOMAM_CORAZZA,      10000, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.NASHIRA_MANTEEL,    10000, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.HOMAM_MANOPOLAS,    10000, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.NASHIRA_GAGES,      10000, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.HOMAM_ZUCCHETTO,    10000, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.NASHIRA_TURBAN,     10000, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.HOMAM_COSCIALES,    10000, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.NASHIRA_SERAWEELS,  10000, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.HOMAM_GAMBIERAS,    10000, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.NASHIRA_CRACKOWS,   10000, xi.keyItem.RHAPSODY_IN_WHITE },
        { xi.item.PSILOMENE,          30000, xi.keyItem.RHAPSODY_IN_UMBER },
        { xi.item.POTENS_GRIP,        30000, xi.keyItem.RHAPSODY_IN_UMBER },
    },
}
