...
abilityObject.onPetAbility = function(target, pet, skill, summoner)
    ...
    summoner:setMP(0)
    totaldamage = xi.summon.avatarFinalAdjustments(damage.dmg, pet, skill, target, xi.attackType.MAGICAL, xi.damageType.WIND, xi.mobskills.shadowBehavior.WIPE_SHADOWS)
