    ...
    [xi.regime.type.GROUNDS] =
    {
        ...
        zone =
        {
            ...
            [xi.zone.MIDDLE_DELKFUTTS_TOWER] =
            {
                ...
                page =
                {
                    { 4, 3, 0, 0, 25, 34, 1090, 782 }, -- goblins/bats
                    { 4, 3, 0, 0, 25, 34, 1090, 783 }, -- gigas/bats
            ...
            [xi.zone.UPPER_DELKFUTTS_TOWER] =
            {
                ...
                page =
                {
                    ...
                    { 2, 2, 2, 0, 62, 69, 1520, 786 }, -- jotunn wallkeeper/gatekeeper/bats
            ...
            [xi.zone.TORAIMARAI_CANAL] =
            {
                ...
                page =
                {
                    ...
                    { 4, 3, 0, 0, 95, 97, 2240, 622 }, -- starmite/dire bats (names different from era names)
            ...
            [xi.zone.KORROLOKA_TUNNEL] =
            {
                ...
                page =
                {
                    ...
                    { 3, 3, 0, 0, 29, 33, 930, 731 }, -- clippers/greater pugils (era has no pugils, changed to 6 clippers)
            ...
            [xi.zone.KUFTAL_TUNNEL] =
            {
                ...
                page =
                {
                    ...
                    { 3, 3, 0, 0, 77, 80, 1660, 741 }, -- ovinniks/greater cockatrice
            ...
            [xi.zone.THE_SHRINE_OF_RUAVITAU] =
            {
                ...
                page =
                {
                    { 10, 0, 0, 0, 71, 71, 2370, 749 }, -- arcana-type (defender)
