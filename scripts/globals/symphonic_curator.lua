...
xi.symphonic_curator.onTrigger = function(player, npc)
    ...
    -- First Page
    songPacks = utils.mask.setBit(songPacks, 1, player:hasKeyItem(xi.keyItem.SHEET_OF_SAN_DORIAN_TUNES))   -- The Kingdom of San d'Oria (107), Chateau d'Oraguille (156), Ronfaure (109)
    songPacks = utils.mask.setBit(songPacks, 2, player:hasKeyItem(xi.keyItem.SHEET_OF_BASTOKAN_TUNES))     -- The Republic of Bastok (152), Metalworks (154), Gustaberg (116)
    songPacks = utils.mask.setBit(songPacks, 3, player:hasKeyItem(xi.keyItem.SHEET_OF_WINDURSTIAN_TUNES))  -- The Federation of Windurst (151), Heavens Tower (162), Sarutabaruta (113)
    songPacks = utils.mask.setBit(songPacks, 4, player:hasKeyItem(xi.keyItem.SHEET_OF_E_ADOULINIAN_TUNES)) -- The Sacred City of Adoulin (63)
    songPacks = utils.mask.setBit(songPacks, 5, player:hasKeyItem(xi.keyItem.SHEET_OF_W_ADOULINIAN_TUNES)) -- The Pioneers (59)
    songPacks = utils.mask.setBit(songPacks, 6, player:hasKeyItem(xi.keyItem.SHEET_OF_ZILART_TUNES))       -- Kazham (135), The Sanctuary of Zi'Tah (190), Tu'Lia (210)

    -- Next page
    songPacks = utils.mask.setBit(songPacks, 7, player:hasKeyItem(xi.keyItem.SHEET_OF_CONFLICT_TUNES))        -- Awakening (119), Belief (195), A Realm of Emptiness (137)
    songPacks = utils.mask.setBit(songPacks, 8, player:hasKeyItem(xi.keyItem.SHEET_OF_PROMATHIA_TUNES))       -- Distant Worlds (900)
    songPacks = utils.mask.setBit(songPacks, 9, player:hasKeyItem(xi.keyItem.SHEET_OF_ADOULINIAN_TUNES))      -- Forever Today (76)
    songPacks = utils.mask.setBit(songPacks, 10, completedROVMissions)                                        -- Rhapsodies of Vana'diel (83)
    songPacks = utils.mask.setBit(songPacks, 11, player:hasKeyItem(xi.keyItem.SHEET_OF_SHADOW_LORD_TUNES))    -- Awakening (The Shadow Lord Battle) (FFRK Ver.) (119)
    songPacks = utils.mask.setBit(songPacks, 12, player:hasKeyItem(xi.keyItem.SHEET_OF_MAPITOTO_TUNES))       -- Full Speed Ahead! (84)
    songPacks = utils.mask.setBit(songPacks, 13, player:hasKeyItem(xi.keyItem.SHEET_OF_ALTAIEU_TUNES))        -- The Celestial Capital - Al'Taieu (233)
    songPacks = utils.mask.setBit(songPacks, 14, player:hasKeyItem(xi.keyItem.SHEET_OF_JEUNO_TUNES))          -- The Grand Duchy of Jeuno (110), Ru'Lude Gardens (117)
    songPacks = utils.mask.setBit(songPacks, 15, player:hasKeyItem(xi.keyItem.SHEET_OF_HARVEST_TUNES))        -- Devils' Delight (29)
    songPacks = utils.mask.setBit(songPacks, 16, player:hasKeyItem(xi.keyItem.SHEET_OF_ANCIENT_TUNES))        -- Griffons Never Die (254), Thunder of the March (180), Stargazing (182)
    songPacks = utils.mask.setBit(songPacks, 17, player:hasKeyItem(xi.keyItem.SHEET_OF_ANCIENT_BATTLE_TUNES)) -- Autumn Footfalls (251), Echoes of a Zephyr (253), The Cosmic Wheel (141)

    -- Next page
    songPacks = utils.mask.setBit(songPacks, 18, player:hasKeyItem(xi.keyItem.SHEET_OF_DESTINY_DESTROYER_TUNES))   -- The Destiny Destroyers (28)
    songPacks = utils.mask.setBit(songPacks, 19, player:hasKeyItem(xi.keyItem.SHEET_OF_CHARACTER_SELECTION_TUNES)) -- Hume Male (133), Hume Female (168), Elvaan Male (132), Elvaan Female (131), Tarutaru Male (167), Tarutaru Female (130), Mithra (166), Galka (165)
    songPacks = utils.mask.setBit(songPacks, 20, player:hasKeyItem(xi.keyItem.SHEET_OF_STARLIGHT_TUNES))           -- Jeuno - Starlight Celebration (239)
    songPacks = utils.mask.setBit(songPacks, 21, player:hasKeyItem(xi.keyItem.SHEET_OF_CHOCOBO_TUNES))             -- Dash de Chocobo (181), Circuit de Chocobo (176), Run Chocobo Run! (177), Choc-a-bye Baby (188)
    songPacks = utils.mask.setBit(songPacks, 22, player:hasKeyItem(xi.keyItem.SHEET_OF_NEAR_EAST_TUNES))           -- Bustle of the Capital (178), Jeweled Boughs (149), Bandits' Market (175), Illusions in the Mist (173)
    songPacks = utils.mask.setBit(songPacks, 23, player:hasKeyItem(xi.keyItem.SHEET_OF_DIVINE_TUNES))              -- Fighters of the Crystal (196)
...
xi.symphonic_curator.onEventFinish = function(player, csid, option, npc)
    if option == 0 then
        -- Reset
        player:changeMusic(xi.musicSlot.MOG_HOUSE, player:getLocalVar('Symphonic_Curator_Music'))
    else
        -- Confirmed, set
