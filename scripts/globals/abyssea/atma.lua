...
xi.atma.atmaMods =
{
    ...
    [xi.ki.ATMA_OF_THE_BANISHER]               = { xi.mod.DARK_MAB, 10, xi.mod.MPP, 5, xi.mod.DARK_MACC, 10 },
    [xi.ki.ATMA_OF_THE_SELLSWORD]              = { xi.mod.STR, 20, xi.mod.DMGMAGIC, -1400, xi.mod.LIGHT_MAB, 10 },
    [xi.ki.ATMA_OF_A_FUTURE_FABULOUS]          = { xi.mod.MDEF, 50, xi.mod.FASTCAST, 2, xi.mod.HASTE_GEAR, 100 },
    [xi.ki.ATMA_OF_CAMARADERIE]                = { xi.mod.STORETP, 10, xi.mod.CURE_CAST_TIME, 15, xi.mod.SONG_RECAST_DELAY, 10 },
    [xi.ki.ATMA_OF_THE_TRUTHSEEKER]            = { xi.mod.DEX, 20, xi.mod.DARK_MEVA, 50, xi.mod.WSACC, 10 },
    [xi.ki.ATMA_OF_THE_AZURE_SKY]              = { xi.mod.MPP, 5, xi.mod.MAGIC_CRITHITRATE, 5, xi.mod.BP_DELAY, -10 },
    [xi.ki.ATMA_OF_ECHOES]                     = { xi.mod.VIT, 20 }, -- Also: day-dependent MACC and elemental WS fTP+0.5 (not implementable in static mod table)
    [xi.ki.ATMA_OF_DREAD]                      = { xi.mod.MEVA, 10, xi.mod.TREASURE_HUNTER, 1, xi.mod.SAMBA_DURATION, 10 },
    [xi.ki.ATMA_OF_AMBITION]                   = { xi.mod.MOVE_SPEED_GEAR_BONUS, 12, xi.mod.FASTCAST, 5, xi.mod.REFRESH, 5 }, -- Note: Speed modifier is the same as positive gear. Meaning, it doesnt stack.
    ...
    [xi.ki.ATMA_OF_HELLS_GUARDIAN]             = { xi.mod.ZANSHIN, 100, xi.mod.MATT, 50, xi.mod.DEMON_KILLER, 10 },
    [xi.ki.ATMA_OF_LUMINOUS_WINGS]             = { xi.mod.SUBTLE_BLOW, 50, xi.mod.ENMITY, 50, xi.mod.ABSORB_DMG_CHANCE, 10 },
    [xi.ki.ATMA_OF_THE_DRAGON_RIDER]           = { xi.mod.MATT, 20, xi.mod.DRAGON_KILLER, 10 }, -- Also: Wyvern HP+50% (not implementable in static mod table)
    [xi.ki.ATMA_OF_THE_IMPENETRABLE]           = { xi.mod.DMGBREATH, -2500, xi.mod.LIZARD_KILLER, 10, xi.mod.REGEN, 15 },
    [xi.ki.ATMA_OF_ALPHA_AND_OMEGA]            = { xi.mod.TRIPLE_ATTACK, 10, xi.mod.ATT, 50, xi.mod.HPP, -25 },
    ...
    [xi.ki.ATMA_OF_PERFECT_ATTENDANCE]         = { xi.mod.REFRESH, 5, xi.mod.REGEN, 10, xi.mod.REGAIN, 10 },
    [xi.ki.ATMA_OF_THE_RESCUER]                = { xi.mod.MDEF, 20, xi.mod.FASTCAST, 5, xi.mod.CURE_POTENCY, 10 },
    [xi.ki.ATMA_OF_NIGHTMARES]                 = { xi.mod.HASTE_GEAR, 500, xi.mod.MEVA, 20, xi.mod.ABSORB_EFFECT_DURATION, 30 },
    ...
    [xi.ki.ATMA_OF_THE_DUCAL_GUARD]            = { xi.mod.GUARD, 10 }, -- Also: HP below 50%: DMG taken -50%, Movement Speed+ (conditional, not implementable)
    [xi.ki.ATMA_OF_HARMONY]                    = { xi.mod.CURE_POTENCY, 10, xi.mod.WALTZ_POTENCY, 10 }, -- Also: Enhancing Magic Skill +10 (no static skill mod available)
    [xi.ki.ATMA_OF_REVELATIONS]                = { xi.mod.MPP, 10 }, -- Also: HP below 50%: Refresh 10, Fast Cast 15% (conditional, not implementable)
    [xi.ki.ATMA_OF_THE_SAVIOR]                 = { xi.mod.ELEM, 30, xi.mod.STATUSRES, 30, xi.mod.ABSORB_DMG_CHANCE, 10 },
}
