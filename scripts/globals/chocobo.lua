...
xi.chocobo.chocoboInfo =
{
    ...
    [xi.zone.SOUTHERN_SAN_DORIA_S]    = { levelReq = 15, sales = 0, premiumCost = false, past = true , pos = {   94, -62,  266,  40, xi.zone.EAST_RONFAURE_S       } },
    [xi.zone.JUGNER_FOREST_S]         = { levelReq = 20, sales = 0, premiumCost = true,  past = true , pos = nil                                                     },
    [xi.zone.BASTOK_MARKETS_S]        = { levelReq = 15, sales = 0, premiumCost = false, past = true , pos = {  380,   0,  147, 192, xi.zone.NORTH_GUSTABERG_S     } },
    [xi.zone.PASHHOW_MARSHLANDS_S]    = { levelReq = 20, sales = 0, premiumCost = true,  past = true , pos = nil                                                     },
    [xi.zone.WINDURST_WATERS_S]       = { levelReq = 15, sales = 0, premiumCost = false, past = true , pos = {  320,  -4,  -46, 192, xi.zone.WEST_SARUTABARUTA_S   } },
    ...
    [xi.zone.LOWER_JEUNO]             = { levelReq = 20, sales = 0, premiumCost = true,  past = false, pos = {  340,  24,  608, 112, xi.zone.ROLANBERRY_FIELDS     } },
    [xi.zone.PORT_JEUNO]              = { levelReq = 20, sales = 0, premiumCost = true,  past = false, pos = { -574,   2,  400,   0, xi.zone.SAUROMUGUE_CHAMPAIGN  } },
    [xi.zone.RABAO]                   = { levelReq = 20, sales = 0, premiumCost = false, past = false, pos = {  420,   8,  360,  64, xi.zone.WESTERN_ALTEPA_DESERT } },
    [xi.zone.KAZHAM]                  = { levelReq = 20, sales = 0, premiumCost = false, past = false, pos = { -240,   0,  528,  64, xi.zone.YUHTUNGA_JUNGLE       } },
    [xi.zone.NORG]                    = { levelReq = 20, sales = 0, premiumCost = false, past = false, pos = { -456,  17, -348,   0, xi.zone.YUHTUNGA_JUNGLE       } },
}
