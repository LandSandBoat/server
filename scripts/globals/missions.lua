...
function finishMissionTimeline(player, guard, csid, option)
    ...
    if (nation == xi.nation.WINDURST) then
        ...
        if (csid == guardlist[guard] and option ~= 1073741824 and option ~= 31 and option > 18) then -- last part of conditional is for converted missions, increment for each converted
