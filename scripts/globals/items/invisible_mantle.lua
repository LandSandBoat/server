...
itemObject.onItemCheck = function(target)
    ...
    if effect ~= nil and effect:getItemSourceID() == 13685 then
...
itemObject.onItemUse = function(target)
    if target:hasStatusEffect(xi.effect.INVISIBLE) then
        ...
        target:addStatusEffect(xi.effect.INVISIBLE, 0, 10, math.floor(180 * xi.settings.main.SNEAK_INVIS_DURATION_MULTIPLIER), 0, 0, 0, 13685)
    end
end
