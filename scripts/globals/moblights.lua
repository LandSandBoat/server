...
xi.abyssea_mob.RemoveDeathListeners = function(mob)
...
xi.abyssea_mob.AddDeathListeners = function(mob)
    ...
    mob:addListener("DEATH", "ABYSSEA_DEATH_LIGHTS_CHECK", function(mobArg, player)
        ...
        xi.abyssea_mob.DropLights(player, mobArg:getName(), deathType, mobArg)

		xi.abyssea_mob.RemoveDeathListeners(mobArg)
    end)
end



xi.abyssea_mob.DropLights = function(killer, mobName, killType, mob)
    if killer then
    ...
    if xi.abyssea_mob.info[mobName] == nil then
        return
    end
    ...
    if xi.abyssea_mob.info[mobName][lightTypes[killType].lightType] ~= nil then
        amount = xi.abyssea_mob.info[mobName][lightTypes[killType].lightType]
    end
