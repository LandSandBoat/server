describe('WOTG Nation Quests - Bastok', function()
    ...
    describe('00 - The Fighting Fourth', function()
        it('should complete the quest and align the player with Bastok', function()
            ...
            player.assert:hasKI(xi.keyItem.BLUE_RECOMMENDATION_LETTER)
            ...
            player.assert
                ...
                :hasKI(xi.keyItem.BATTLE_RATIONS)
            player.assert.no:hasKI(xi.keyItem.BLUE_RECOMMENDATION_LETTER)
            ...
            player.assert.no:hasKI(xi.keyItem.BATTLE_RATIONS)
