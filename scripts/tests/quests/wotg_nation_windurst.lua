describe('WOTG Nation Quests - Windurst', function()
    ...
    describe('00 - Snake on the Plains', function()
        it('should complete the quest and align the player with Windurst', function()
            ...
            player:addKeyItem(xi.keyItem.GREEN_RECOMMENDATION_LETTER)
            ...
            player.assert
                ...
                :hasKI(xi.keyItem.ZONPA_ZIPPAS_ALL_PURPOSE_PUTTY)
            player.assert.no:hasKI(xi.keyItem.GREEN_RECOMMENDATION_LETTER)
            ...
            player.assert.no:hasKI(xi.keyItem.ZONPA_ZIPPAS_ALL_PURPOSE_PUTTY)
