...
local function verifyPerpetuationCost(player, cost)
    ...
    for _ = 1, 5 do
        ...
        assert(
            lostMP == cost,
            string.format('Player did not lose expected MP from having %s summoned. Player lost %u, expected %u.',
                petName, lostMP, cost)
        )
    end
end
...
describe('SMN', function()
    ...
    it('Basic avatar perpetuation cost', function()
        ...
        xi.test.world:skipToVanaDay(xi.day.DARKSDAY)
    ...
    it('Elemental staff perpetuation cost', function()
    ...
    it('Avatar perpetuation cost reduction by day', function()
        ...
        for _, case in ipairs(cases) do
            xi.test.world:skipToVanaDay(case.day)
            player:despawnPet()
    ...
    it('Avatar perpetuation cost reduction by weather', function()
