describe('Bastok Missions', function()
    ...
    describe('The Zeruhn Report', function()
        it('should complete the mission', function()
            ...
            player.assert:hasKI(xi.keyItem.ZERUHN_REPORT)
            ...
            player.assert.no:hasKI(xi.keyItem.ZERUHN_REPORT)
            player.assert
    ...
    describe('A Geological Survey', function()
        it('should complete the mission', function()
            ...
            player.assert
                .no:hasKI(xi.keyItem.BLUE_ACIDITY_TESTER)
                :hasKI(xi.keyItem.RED_ACIDITY_TESTER)

            -- Head back to Cid and give the test results.
            player:gotoZone(xi.zone.METALWORKS)
            player.entities:gotoAndTrigger('Cid', { eventId = 504 })
            player.assert.no:hasKI(xi.keyItem.BLUE_ACIDITY_TESTER)
            player.assert
                :hasMission(xi.mission.log_id.BASTOK, xi.mission.id.bastok.NONE)
    ...
    describe('Magicite', function()
        ...
        it('should complete the mission', function()
            ...
            player.assert
                ...
                :hasKI(xi.keyItem.MESSAGE_TO_JEUNO_BASTOK)
        end)
    end)
end)
