...
xi.settings.main =
{
    ...
    EXP_RATE            = 0.900, -- Multiplies exp from script (except FoV/GoV).
    BOOK_EXP_RATE       = 0.900, -- Multiplies exp from FoV/GoV book pages.
    ...
    HARVESTING_RATE         = 66, -- % chance to recieve an item from haresting.  Set between 0 and 100.
    EXCAVATION_RATE         = 66, -- % chance to recieve an item from excavation.  Set between 0 and 100.
    LOGGING_RATE            = 6, -- % chance to recieve an item from logging.  Set between 0 and 100.
    MINING_RATE             = 66, -- % chance to recieve an item from mining.  Set between 0 and 100.
    ...
    COFFER_MAX_ILLUSION_TIME = 1800,  -- 30 minutes
    COFFER_MIN_ILLUSION_TIME = 600,   -- 10 minutes
    CHEST_MAX_ILLUSION_TIME  = 1800,  -- 30 minutes
    ...
    FRIGICITE_TIME  = 299,   -- When OLDSCHOOL_G2 is enabled, this is the time (in seconds) you have from killing Boreal NMs to click the '???' target.
    ASSAULT_MINIMUM = 1,     -- Minimum amount of people needed to start an assault mission. TOAU era is 3, Default is 1.

    -- SALVAGE SETTINGS
    SALVAGE_MINIMUM_MEMBER_REQ = 1, -- Minimum number of party members required to enter a Salvage. ToAU era 6
    SALVAGE_TEMP_CHEST_RATE    = 10, -- Percent chance of 100 that a temporary item chest will spawn in Salvage.
    ...
    FORCE_SPAWN_QM_RESET_TIME    = 0,   -- Number of seconds the ??? remains hidden for after the despawning of the mob it force spawns.
