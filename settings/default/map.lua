...
xi.settings.map =
{
    ...
    -- If enabled (alongside PACKETGUARD_ENABLED), infringements will result in player connection being dropped, leading to their client timing out
    PACKETGUARD_DROP_CONNECTION = true,
