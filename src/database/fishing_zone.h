...
namespace xidb
{
  ...
  struct fishing_zone: sqlpp::table_t<fishing_zone,
               fishing_zone_::zoneid,
               fishing_zone_::name,
               fishing_zone_::fishid>
  {
    struct _alias_t
    {
      ...
      {
        T fishing_zone;
        T& operator()() { return fishing_zone; }
        const T& operator()() const { return fishing_zone; }
      };
    };
  };
} // namespace xidb
