...
enum MSGBASIC_ID : uint16_t
{
    ...
    MSGBASIC_TARGET_ABSORBS_HP              = 263, // <target> recovers <amount> HP.
    ...
    MSGBASIC_TARGET_RECOVERS_HP             = 327, // <target> recovers <amount> HP.
    ...
    MSGBASIC_TARGET_RECOVERS_HP2            = 367, // <target> recovers <amount> HP.
