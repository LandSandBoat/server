...
// Everything CPathFind needs from "the thing being moved", behind one interface so path logic runs
// without a live entity/zone/AI/Lua. This will be useful for setting up tests later.
//
// See EntityPathOwner.
class PathOwner
{
