...
auto Path::pruneTailWithin(float within) -> void
{
    ...
    // Drop intermediate waypoints within `within` of the destination (after PathInRange) so the
    // entity stops short instead of walking the last few yalms onto the destination tile.
