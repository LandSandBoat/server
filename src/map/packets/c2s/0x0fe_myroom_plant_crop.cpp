...
auto GP_CLI_COMMAND_MYROOM_PLANT_CROP::validate(Scheduler& scheduler, MapSession* PSession, const CCharEntity* PChar) const -> PacketValidationResult
{
...
void GP_CLI_COMMAND_MYROOM_PLANT_CROP::process(Scheduler& scheduler, MapSession* PSession, CCharEntity* PChar) const
{
