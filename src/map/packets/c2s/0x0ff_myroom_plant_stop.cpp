...
auto GP_CLI_COMMAND_MYROOM_PLANT_STOP::validate(Scheduler& scheduler, MapSession* PSession, const CCharEntity* PChar) const -> PacketValidationResult
{
...
void GP_CLI_COMMAND_MYROOM_PLANT_STOP::process(Scheduler& scheduler, MapSession* PSession, CCharEntity* PChar) const
{
