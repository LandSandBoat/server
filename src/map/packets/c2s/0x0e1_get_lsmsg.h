...
// https://github.com/atom0s/XiPackets/tree/main/world/client/0x00E1
// This packet is sent by the client when requesting the current linkshell message of an equipped linkshell. (ie. /lsmes, /linkshell2mes)
GP_CLI_PACKET(GP_CLI_COMMAND_GET_LSMSG,
