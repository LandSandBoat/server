...
auto GP_CLI_COMMAND_TROPHY_ENTRY::validate(Scheduler& scheduler, MapSession* PSession, const CCharEntity* PChar) const -> PacketValidationResult
{
...
void GP_CLI_COMMAND_TROPHY_ENTRY::process(Scheduler& scheduler, MapSession* PSession, CCharEntity* PChar) const
{
