...
CInstance* CInstanceLoader::LoadInstance()
{
    ...
    if (!instance->Failed() && ret != SQL_ERROR /*&& Sql_NumRows(SqlInstanceHandle) != 0*/)
    {
        while (Sql_NextRow(SqlInstanceHandle) == SQL_SUCCESS)
        {
            ...
            PMob->setModifier(Mod::FIRE_SDT, (int16)Sql_GetFloatData(SqlInstanceHandle, 41));    // Modifier 54, base 10000 stored as signed integer. Positives signify less damage.
            PMob->setModifier(Mod::ICE_SDT, (int16)Sql_GetFloatData(SqlInstanceHandle, 42));     // Modifier 55, base 10000 stored as signed integer. Positives signify less damage.
            PMob->setModifier(Mod::WIND_SDT, (int16)Sql_GetFloatData(SqlInstanceHandle, 43));    // Modifier 56, base 10000 stored as signed integer. Positives signify less damage.
            PMob->setModifier(Mod::EARTH_SDT, (int16)Sql_GetFloatData(SqlInstanceHandle, 44));   // Modifier 57, base 10000 stored as signed integer. Positives signify less damage.
            PMob->setModifier(Mod::THUNDER_SDT, (int16)Sql_GetFloatData(SqlInstanceHandle, 45)); // Modifier 58, base 10000 stored as signed integer. Positives signify less damage.
            PMob->setModifier(Mod::WATER_SDT, (int16)Sql_GetFloatData(SqlInstanceHandle, 46));   // Modifier 59, base 10000 stored as signed integer. Positives signify less damage.
            PMob->setModifier(Mod::LIGHT_SDT, (int16)Sql_GetFloatData(SqlInstanceHandle, 47));   // Modifier 60, base 10000 stored as signed integer. Positives signify less damage.
            PMob->setModifier(Mod::DARK_SDT, (int16)Sql_GetFloatData(SqlInstanceHandle, 48));    // Modifier 61, base 10000 stored as signed integer. Positives signify less damage.
