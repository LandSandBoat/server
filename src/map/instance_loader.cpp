...
CInstance* CInstanceLoader::LoadInstance()
{
    ...
    if (!m_PInstance->Failed() && ret != SQL_ERROR /*&& sql->NumRows() != 0*/)
    {
        while (_sql->NextRow() == SQL_SUCCESS)
        {
            ...
            PMob->setModifier(Mod::SLASH_SDT, (uint16)(_sql->GetIntData(37)));
            PMob->setModifier(Mod::PIERCE_SDT, (uint16)(_sql->GetIntData(38)));
            PMob->setModifier(Mod::HTH_SDT, (uint16)(_sql->GetIntData(39)));
            PMob->setModifier(Mod::IMPACT_SDT, (uint16)(_sql->GetIntData(40)));
