    ...
    void LoadPetList()
    {
        ...
        if (_sql->Query(Query) != SQL_ERROR && _sql->NumRows() != 0)
        {
            while (_sql->NextRow() == SQL_SUCCESS)
            {
                ...
                Pet->slash_sdt  = (uint16)(_sql->GetIntData(28));
                Pet->pierce_sdt = (uint16)(_sql->GetIntData(29));
                Pet->hth_sdt    = (uint16)(_sql->GetIntData(30));
                Pet->impact_sdt = (uint16)(_sql->GetIntData(31));
