    ...
    CMobEntity* InstantiateAlly(uint32 groupid, uint16 zoneID, CInstance* instance)
    {
        ...
        if (ret != SQL_ERROR && _sql->NumRows() != 0)
        {
            if (_sql->NextRow() == SQL_SUCCESS)
            {
                ...
                PMob->setModifier(Mod::SLASH_SDT, (uint16)(_sql->GetIntData(34)));
                PMob->setModifier(Mod::PIERCE_SDT, (uint16)(_sql->GetIntData(35)));
                PMob->setModifier(Mod::HTH_SDT, (uint16)(_sql->GetIntData(36)));
                PMob->setModifier(Mod::IMPACT_SDT, (uint16)(_sql->GetIntData(37)));
