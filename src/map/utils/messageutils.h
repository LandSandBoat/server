...
const std::unordered_map<MsgBasic, MsgBasic> aoeVariants = {
    ...
    { MsgBasic::USES_ABILITY_FORTIFIED_UNDEAD, MsgBasic::TARGET_FORTIFIED_UNDEAD },
    { MsgBasic::USES_ABILITY_FORTIFIED_ARCANA, MsgBasic::TARGET_FORTIFIED_ARCANA },
    { MsgBasic::USES_ABILITY_FORTIFIED_DEMONS, MsgBasic::TARGET_FORTIFIED_DEMONS },
    { MsgBasic::USES_ABILITY_FORTIFIED_DRAGONS, MsgBasic::TARGET_FORTIFIED_DRAGONS },
    { MsgBasic::USES_ABILITY_GAINS_EFFECT, MsgBasic::TARGET_GAINS_EFFECT },
    { MsgBasic::USES_ABILITY_EFFECT, MsgBasic::RECEIVES_EFFECT_ABILITY },
    ...
    { MsgBasic::ROLL_MAIN, MsgBasic::RECEIVES_EFFECT_ABILITY },
    { MsgBasic::DOUBLEUP, MsgBasic::RECEIVES_EFFECT_ABILITY },
