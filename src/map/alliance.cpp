...
void CAlliance::dissolveAlliance(bool playerInitiated)
{
    ...
    //     {
    //         CCharParty* party = partyList.at(0);
    //         this->delParty(party);
    //         //party->ReloadParty();
    //     }
    //
...
void CAlliance::removeParty(CCharParty* party)
{
    // if (party == nullptr)
    // {
...
void CAlliance::delParty(CCharParty* party)
{
    // if (party == nullptr)
    // {
...
void CAlliance::addParty(CCharParty* party)
{
    // if (party == nullptr)
    // {
...
void CAlliance::pushParty(CCharParty* PParty, uint8 number)
{
    // if (PParty == nullptr)
    // {
...
CCharParty* CAlliance::getMainParty()
{
    return aLeader;
}

// Assigns a party leader for the party
void CAlliance::setMainParty(CCharParty* aLeader)
{
