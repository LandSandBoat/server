// https://github.com/TrinityCore/TrinityCore/blob/master/src/common/Debugging/WheatyExceptionReport.h
...
class WheatyExceptionReport
{
    public:
        ...
        static void __cdecl WheatyCrtHandler(wchar_t const* expression, wchar_t const* function,
            wchar_t const* file, unsigned int line, uintptr_t pReserved);
    ...
    private:
        ...
        static void FormatOutputValue(char * pszCurrBuffer, BasicType basicType, DWORD64 length,
            PVOID pAddress, size_t bufferSize, size_t countOverride = 0);
