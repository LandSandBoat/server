...
#define DebugParty(...)       LOGGER_BODY_CONDITIONAL(SPDLOG_LOGGER_DEBUG, "debug", "logging.DEBUG_PARTY", __FILE__, __LINE__, __VA_ARGS__)
...
#define DebugPartyFmt(...)       LOGGER_BODY_CONDITIONAL_FMT(SPDLOG_LOGGER_DEBUG, "debug", "logging.DEBUG_PARTY", __FILE__, __LINE__, __VA_ARGS__)
