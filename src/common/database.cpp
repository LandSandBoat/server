...
auto db::detail::validateQueryContent(std::string const& query) -> bool
{
    ...
    if (query.find("%s") != std::string::npos)
    {
        return false;
    }

    if (query.find("%d") != std::string::npos)
    {
        return false;
    }

    if (query.find("%f") != std::string::npos)
    {
        return false;
    }

    if (query.find("%i") != std::string::npos)
    {
        return false;
    }

    if (query.find("%u") != std::string::npos)
    {
        return false;
    }
