...
void SettingsManager::ParseSettingsLine(std::string const& section, std::string const& line)
{
    ...
    auto        enumSetting  = (*get_variant_settings_lookup())[lookupString];
...
void SettingsManager::ReadServerMessage()
{
    // TODO
