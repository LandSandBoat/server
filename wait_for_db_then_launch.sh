...
cd ..
# Start servers
echo "starting ixion_connect"
nohup ./ixion_connect > ixion_connect.log &
sleep 5
echo "starting ixion_game"
nohup ./ixion_game > ixion_game.log &
sleep 5
echo "starting ixion_search"
./ixion_search > ixion_search.log
