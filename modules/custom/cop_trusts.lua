...
m:addOverride("xi.zone.Tavnazian_Safehold.npcs._0qa.onTrigger", function(player, npc)
...
m:addOverride("xi.zone.Misareaux_Coast.npcs._0p0.onTrigger", function(player, npc)
    if player:getCurrentMission(COP) >= xi.mission.id.cop.DAWN then
