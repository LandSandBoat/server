...
xi.mafia.CONTRACTS =
{
    ...
    [76]  = { mobId = zones[xi.zone.MAMOOK].mob.DRAGONSCALED_BAGAAL_JA, mobName = 'Dragonscaled Bagaal Ja', item = xi.item.BEAST_BAZUBANDS, itemName = 'Beast Bazubands', reward = 700, bonus = 100 },
    ...
    [118] = { mobId = zones[xi.zone.DEN_OF_RANCOR].HAKUTAKU, mobName = 'Hakutaku', item = xi.item.OPTICAL_HAT, itemName = 'Optical Hat', reward = 1000, bonus = 1000 },
    ...
    [214] = { mobId = zones[xi.zone.GARLAIGE_CITADEL].SKEWER_SAM, mobName = 'Skewer Sam', item = xi.item.WIND_SPEAR, itemName = 'Wind Spear', reward = 300, bonus = 100 },
    ...
    [230] = { mobId = zones[xi.zone.SOUTH_GUSTABERG].mob.TACOCO, mobName = 'Tacoco', item = xi.item.ARMIGERS_LACE, itemName = 'Armiger\'s Lace', reward = 150, bonus = 100 },
