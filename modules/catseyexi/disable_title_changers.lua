...
m:addOverride("xi.zones.Selbina.npcs.Yulon_Polon.onTrigger" = function(player, npc)
    player:PrintToPlayer("Title changer NPC's have been disabled to prevent exploiting of weekly hunts")
end)
...
m:addOverride("xi.zones.Tavnazian_Safehold.npcs.Aligi-Kufrongi.onTrigger" = function(player, npc)
    player:PrintToPlayer("Title changer NPC's have been disabled to prevent exploiting of weekly hunts")
end)
...
m:addOverride("xi.zones.Windurst_Waters_[S].npcs.Cattah Pamjah.onTrigger" = function(player, npc)
    player:PrintToPlayer("Title changer NPC's have been disabled to prevent exploiting of weekly hunts")
end)
