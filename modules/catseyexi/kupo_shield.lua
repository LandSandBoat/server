...
m:addOverride("xi.zones.Bastok_Markets.npcs.Nudara.hasKeyItem" = function(player)
    if (player:hasKeyItem(xi.keyItem.WAY_OF_THE_ALCHEMIST) or
        ...
        player:hasKeyItem(xi.keyItem.WAY_OF_THE_CARPENTER) or
        player:hasKeyItem(xi.keyItem.WAY_OF_THE_CULINARIAN) or
        player:hasKeyItem(xi.keyItem.WAY_OF_THE_GOLDSMITH) or
        player:hasKeyItem(xi.keyItem.WAY_OF_THE_WEAVER) or
