                    ...
                    local menu =
                {
                    ...
                    options =
                    {
                        ...
                        },
                        {
                            "Earth Crystal",
                            function(playerArg)
                                playerArg:addItem(4107, eligibleCrystals)
                                playerArg:PrintToPlayer("Take your crystals and get outta here!")
                                playerArg:setCharVar("CrystalCruncher", storedCrystals - eligibleCrystals * 3)
                            end,
                        },
                        {
                            "Lightning Crystal",
                            function(playerArg)
                                playerArg:addItem(4108, eligibleCrystals)
                                playerArg:PrintToPlayer("Take your crystals and get outta here!")
                                playerArg:setCharVar("CrystalCruncher", storedCrystals - eligibleCrystals * 3)
                            end,
                        },
                        {
                            "Wind Crystal",
                            function(playerArg)
                                playerArg:addItem(4106, eligibleCrystals)
                                playerArg:PrintToPlayer("Take your crystals and get outta here!")
                                playerArg:setCharVar("CrystalCruncher", storedCrystals - eligibleCrystals * 3)
                            end,
                        },
                        {
                            "Ice Crystal",
                            function(playerArg)
                                playerArg:addItem(4105, eligibleCrystals)
                                playerArg:PrintToPlayer("Take your crystals and get outta here!")
                                playerArg:setCharVar("CrystalCruncher", storedCrystals - eligibleCrystals * 3)
                            end,
                        },
