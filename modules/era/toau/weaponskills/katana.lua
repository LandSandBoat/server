-----------------------------------
-- ToAU era katana weaponskill module
...
local m = Module:new('toau_weaponskills_katana')
...
m:addOverride('xi.actions.weaponskills.blade_ku.onUseWeaponSkill', function(player, target, wsID, tp, primary, action, taChar)
    ...
    params.str_wsc   = 0.1
    params.dex_wsc   = 0.1
    params.accVaries = { 1.0, 1.1, 1.2 } -- TODO: Change to flat values
