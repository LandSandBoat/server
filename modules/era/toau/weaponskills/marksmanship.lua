-----------------------------------
-- ToAU era marksmanship weaponskill module
...
local m = Module:new('toau_weaponskills_marksmanship')
...
m:addOverride('xi.actions.weaponskills.sniper_shot.onUseWeaponSkill', function(player, target, wsID, tp, primary, action, taChar)
    ...
    params.ftpMod  = { 1.0, 1.0, 1.0 }
    params.agi_wsc = 0.3
    params.critVaries = { 0, 0.15, 0.30 } -- TODO Needs verification
    ...
    local power         = 10 -- TODO - Investigate INT Down potency - might be level based
...
m:addOverride('xi.actions.weaponskills.slug_shot.onUseWeaponSkill', function(player, target, wsID, tp, primary, action, taChar)
    ...
    -- (-50 / -25 / 0) Note this is a PENALTY. https://wiki.ffo.jp/html/2547.html
...
m:addOverride('xi.actions.weaponskills.heavy_shot.onUseWeaponSkill', function(player, target, wsID, tp, primary, action, taChar)
    ...
    params.agi_wsc    = 0.3
    params.critVaries = { 0.1, 0.3, 0.5 } -- TODO Investigate Crit Chance
