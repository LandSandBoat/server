...
-- Cauzeriste/Chaupire (Northern San d'Oria) Woodworking Guild (S)
...
INSERT INTO `guild_shops` VALUES (513,17155,21000,128100,20,0,5);
...
-- Retto-Marutto/Shih Tayuun (Bonecraft Guild) Windurst Woods (S)
...
INSERT INTO `guild_shops` VALUES (514,17319,3,21,8910,1782,3);
...
-- Kuzah Hpirohpon/Meriri (Clothcraft Guild) Windurst Woods (S)
...
-- Graegham/Mendoline (Selbina) Fishing Guild (S)
...
-- Maymunah/Odaba (Bastok Mines) Alchemist Guild (S)
...
-- Teerth/Visala (Goldsmith Guild) Bastok Markets (S)
...
-- Cletae/Kueh Igunahmori (Leathercraft Guild) Southern San d'Oria (S)
...
-- Chomo Jinjahl/Kopopo (Windurst Waters) Cooking Guild (S)
...
-- Doggomehr/Lucretia (Northern San d'Oria) Smithing Guild (S)
...
-- Amulya/Vicious Eye (Metalworks) Smithing Guild (S)
...
INSERT INTO `guild_shops` VALUES (60425,2459,68062,254100,255,48,100); -- Minium
