-- --------------------------------------------------------
-- Guild Point Rewards - Era Corrections
-- --------------------------------------------------------
-- 
...
-- pre-2010 revisions when available for era-accurate values.
--
...
-- ========================================================
-- ITEM CORRECTIONS (pre-2010 historical data)
...
-- ========================================================
-- VALUE & MAX VALUE CORRECTIONS (pre-2010 historical data)
...
UPDATE `guild_item_points` SET `points`=736, `max_points`=4000 WHERE `guildid`=3 AND `itemid`=12771 AND `pattern`=6; -- Brass Finger Gauntlets +1: 432/3280 -> 736/4000
-- Novice (rank 3)
