...
-----------------------------------
local m = Module:new('era_effect_holy_circle', xi.pre(xi.expansion.WOTG))

m:addOverride('xi.effects.holy_circle.onEffectGain', function(target, effect)
