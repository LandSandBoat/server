    ...
    local normalMobLookup =
    {
        ...
        [4] = -- Vanguard Eye
        {
            [xi.zone.DYNAMIS_BEAUCEDINE] = -- Spawn Hydras (Done)
            {
                ...
                [4]  = {"H. Black Mage", 164, 134, 497, 359}, -- HBLM
            ...
            [xi.zone.DYNAMIS_XARCABARD] = -- Spawn Kindred (Done)
            {
                ...
                [4]  = {"K. Black Mage", 30, 135, 497, 358}, -- KBLM
        ...
        [92] = -- Goblin Replica
        {
            ...
            [4]  = {"V. Shaman", 127, 134, 497, 327}, -- GBLM
        ...
        [93] = -- Orc Statue
        {
            ...
            [4]  = {"V. Mesmerizer", 75, 134, 497, 334}, -- OBLM
        ...
        [94] = -- Quadav Statue (Done)
        {
            ...
            [4]  = {"V. Thaumaturge", 42, 134, 497, 337}, -- QBLM
        ...
        [95] = -- Yagudo Statue
        {
            ...
            [4]  = {"V. Prelate", 105, 134, 497, 360}, -- YBLM
...
xi.dynamis.nonStandardDynamicSpawn = function(mobIndex, oMob, forceLink, zoneID, target, oMobIndex)
    ...
    local nonStandardLookup =
    {
        ["Statue"] =
        {
            ["Vanguard Eye"] = {"Vanguard Eye" , 163, 134, 2561, 497, 11}, -- Vanguard Eye (VEye)
            ["Prototype Eye"] = {"Prototype Eye" , 61, 42, 2561, 497, 11}, -- Prototype Eye (PEye)
            ...
            ["Serjeant Tombstone"] = {"Serj. Tombstone" , 89, 134, 2201, 497, 93}, -- Orc Statue (OStat)
            ["Warchief Tombstone"] = {"War. Tombstone" , 90, 134, 2201, 50, 93}, -- Orc Statue (OWStat)
            ["Tombstone Prototype"] = {"Tomb. Prototype" , 20, 42, 2201, 497, 93}, -- Orc Statue (TPStat)
            ...
            ["Avatar Idol"] = {"Avatar Idol" , 124, 134, 195, 497, 95}, -- Yagudo Statue (YStat)
            ["Manifest Icon"] = {"Manifest Icon" , 68, 39, 195, 497, 95}, -- Yagudo Statue (YMStat)
            ["Avatar Icon"] = {"Avatar Icon" , 123, 134, 195, 497, 95}, -- Yagudo Statue (AIStat)
            ["Icon Prototype"] = {"Icon Prototype" , 32, 42, 195, 497, 95}, -- Yagudo Statue (YPStat)
        },
        ["Nightmare"] =
        {
...
xi.dynamis.nmDynamicSpawn = function(mobIndex, oMobIndex, forceLink, zoneID, target, oMob, mainDynaLord)
    ...
    xi.dynamis.nmInfoLookup =
    {
        ...
        -- Goblin
        -- Dynamis - Beaucedine
        ["Ascetox Ratgums"] = {"A.Ratgums", 143, 134, 176, 497, 1213, "Beastmen"}, -- Asce (BLM)
        ["Bordox Kittyback"] = {"B.Kittyback", 146, 134, 176, 0, 1213, "Beastmen"}, -- Bord (THF)
        ["Brewnix Bittypupils"] = {"B.Bittypupils", 142, 134, 176, 1, 1213, "Beastmen"}, -- Brew (WHM)
        ["Draklix Scalecrust"] = {"D.Scalecrust", 149, 134, 176, 0, 1213, "Beastmen"}, -- Drak (DRG)
        ["Droprix Granitepalms"] = {"D.Granitepalms", 139, 134, 176, 0, 1213, "Beastmen"}, -- Drop (MNK)
        ["Gibberox Pimplebeak"] = {"G.Pimplebeak", 144, 134, 176, 3, 1213, "Beastmen"}, -- Gibb (RDM)
        ["Moltenox Stubthumbs"] = {"M.Stubthunmbs", 136, 134, 176, 0, 1213, "Beastmen"}, -- Molt (WAR)
        ["Morblox Chubbychin"] = {"M.Chubbychin", 153, 134, 176, 0, 1213, "Beastmen"}, -- Morb (SMN)
        ["Routsix Rubbertendon"] = {"R.Rubbertendon", 151, 134, 176, 0, 1213, "Beastmen"}, -- Rout (BST)
        ["Ruffbix Jumbolobes"] = {"R.Jumolobes", 148, 134, 176, 4, 1213, "Beastmen"}, -- Ruff (PLD)
        ["Shisox Widebrow"] = {"S.Widebrow", 156, 134, 176, 0, 1213, "Beastmen"}, -- Shis (SAM)
        ["Slinkix Trufflesniff"] = {"S.Trufflesniff", 155, 134, 176, 0, 1213, "Beastmen"}, -- Slin (RNG)
        ["Swypestix Tigershins"] = {"S.Tigershins", 145, 134, 176, 7, 1213, "Beastmen"}, -- Swyp (NIN)
        ["Tocktix Thinlids"] = {"T.Thinlids", 150, 134, 176, 5, 1213, "Beastmen"}, -- Tock (DRK)
        ["Whistix Toadthroat"] = {"W.Toadthroat", 34, 188, 176, 6, 1213, "Beastmen"}, -- Whis (BRD)
        -- Dynamis - Buburimu
        ["Gosspix Blabberlips"] = {"G.Blabberlips", 144, 134,2667, 1213, "Beastmen"}, -- Goss (RDM)
        ["Shamblix Rottenheart"] = {"S.Rottenheart", 150, 134,2667, 5, 1213, "Beastmen"}, -- Sham (DRK)
        ["Woodnix Shrillwhistle"] = {"W.Shrillwhistle", 151, 134, 2667, 0, 1213, "Beastmen"}, -- Wood (BST)
        -- Dynamis - Jeuno
        ["Bandrix Rockjaw"] = {"B.Rockjaw", 146, 134, 143, 0, 1213, "Beastmen"}, -- Band (THF)
        ["Buffrix Eargone"] = {"B.Eargone", 148, 134, 143, 4, 1213, "Beastmen"}, -- Buff (PLD)
        ["Clocktix Longnail"] = {"C.Longnail", 150, 134, 143, 5, 1213, "Beastmen"}, -- Cloc (DRK)
        ["Elixmix Hooknose"] = {"E.Hooknose", 142, 134, 143, 1, 1213, "Beastmen"}, -- Elix (WHM)
        ["Gabblox Magpietongue"] = {"G.Magpietongue", 144, 134, 143, 3, 1213, "Beastmen"}, -- Gabb (RDM)
        ["Hermitrix Toothrot"] = {"H.Toothrot", 143, 134, 143, 497, 1213, "Beastmen"}, -- Herm (BLM)
        ["Humnox Drumbelly"] = {"H.Drumbelly", 34, 188, 143, 6, 1213, "Beastmen"}, -- Humn (BRD)
        ["Lurklox Dhalmelneck"] = {"L.Dhalmelneck", 155, 134, 143, 0, 1213, "Beastmen"}, -- Lurk (RNG)
        ["Morgmox Moldnoggin"] = {"M.Moldnoggin", 153, 134, 143, 0, 1213, "Beastmen"}, -- Morg (SMN)
        ["Sparkspox Sweatbrow"] = {"S.Sweatbrow", 136, 134, 143, 0, 1213, "Beastmen"}, -- Spar (WAR)
        ["Ticktox Beadeyes"] = {"T.Beadeyes", 150, 134, 143, 5, 1213, "Beastmen"}, -- Tick (DRK)
        ["Trailblix Goatmug"] = {"T.Goatmug", 151, 134, 143, 0, 1213, "Beastmen"}, -- Trai (BST)
        ["Tufflix Loglimbs"] = {"T.Loglimbs", 148, 134, 143, 4, 1213, "Beastmen"}, -- Tuff (PLD)
        ["Wyrmwix Snakespecs"] = {"W.Snakespecs", 149, 134, 143, 0, 1213, "Beastmen"}, -- Snak (DRG)
        ["Karashix Swollenskull"] = {"K.Swollenskull", 156, 134, 143, 0, 1213, "Beastmen"}, -- Kara (SAM)
        ["Kikklix Longlegs"] = {"K.Longlegs", 139, 134, 143, 0, 1213, "Beastmen"}, -- Kikk (MNK)
        ["Rutrix Hamgams"] = {"R.Hamgams", 151, 134, 143, 0, 1213, "Beastmen"}, -- Rutr (BST)
        ["Snypestix Eaglebeak"] = {"S.Eaglebeak", 145, 134, 143, 7, 1213, "Beastmen"}, -- Snyp (NIN)
        ["Mortilox Wartpaws"] = {"M.Wartpaws", 153, 134, 143, 0, 1213, "Beastmen"}, -- Mort (SMN)
        ["Jabkix Pigeonpecs"] = {"J.Pigeonpecs", 139, 134, 143, 0, 1213, "Beastmen"}, -- Jabk (MNK)
        ["Smeltix Thickhide"] = {"S.Thickhide", 136, 134, 143, 0, 1213, "Beastmen"}, -- Smel (WAR)
        ["Wasabix Callusdigit"] = {"W.Callusdigit", 156, 134, 143, 0, 1213, "Beastmen"}, -- Wasa (SAM)
        ["Anvilix Sootwrists"] = {"A.Sootwrists", 136, 134, 143, 0, 1213, "Beastmen"}, -- Anvi (WAR)
        ["Blazox Boneybod"] = {"B.Boneybod", 151, 134, 143, 0, 1213, "Beastmen"}, -- Blaz (BST)
        ["Bootrix Jaggedelbow"] = {"B.Jaggedelbow", 139, 134, 143, 0, 1213, "Beastmen"}, -- Boot (MNK)
        ["Distilix Stickytoes"] = {"D.Stickytoes", 142, 134, 143, 1, 1213, "Beastmen"}, -- Dist (WHM)
        ["Eremix Snottynostril"] = {"E.Snottynostril", 143, 134, 143, 497, 1213, "Beastmen"}, -- Erem (BLM)
        ["Jabbrox Grannyguise"] = {"J.Grannyguise", 144, 134, 143, 3, 1213, "Beastmen"}, -- Jabb (RDM)
        ["Mobpix Mucousmouth"] = {"M.Mucousmouth", 146, 134, 143, 0, 1213, "Beastmen"}, -- Mobp (THF)
        ...
        ["Deathcaller Bidfbid"] = {"D.Bidfbid", 73, 134, 493, 0, 1200, "Beastmen"}, -- DBid (SMN)
        ["Drakefeast Wubmfub"] = {"D.Wubmfub", 88, 134, 493, 0, 1200, "Beastmen"}, -- DWub (DRG)
        ["Elvaanlopper Grokdok"] = {"E.Grokdok", 82, 134, 493, 0, 1200, "Beastmen"}, -- EGro (RNG)
        ["Galkarider Retzpratz"] = {"G.Retzpratz", 71, 134, 493, 0, 1200, "Beastmen"}, -- GRet (RNG)
        ["Heavymail Djidzbad"] = {"H.Djidzbad", 80, 134, 493, 4, 1200, "Beastmen"}, -- HDji (PLD)
        ["Humegutter Adzjbadj"] = {"H.Adzjbadj", 60, 134, 493, 0, 1200, "Beastmen"}, -- HAbz (WAR)
        ["Jeunoraider Gepkzip"] = {"J.Gepkzip", 63, 134, 493, 7, 1200, "Beastmen"}, -- JGep (NIN)
        ["Lockbuster Zapdjipp"] = {"L.Zapdjipp", 79, 134, 493, 0, 1200, "Beastmen"}, -- LZap (THF)
        ["Mithraslaver Debhabob"] = {"M.Debhabob", 85, 134, 493, 0, 1200, "Beastmen"}, -- MDeb (BST)
        ["Skinmask Ugghfogg"] = {"S.Ugghfogg", 83, 134, 493, 5, 1200, "Beastmen"}, -- SUgg (DRK)
        ["Spinalsucker Galflmall"] = {"S.Galflmall", 73, 134, 493, 3, 1200, "Beastmen"}, -- SGal (RDM)
        ["Taruroaster Biggsjig"] = {"T.Biggsjig", 84, 134, 493, 497, 1200, "Beastmen"}, -- TBig (BLM)
        ["Ultrasonic Zeknajak"] = {"U.Zeknajak", 87, 134, 493, 6, 1200, "Beastmen"}, -- UZek (BRD)
        ["Wraithdancer Gidbnod"] = {"W.Gidbnod", 63, 134, 493, 1, 1200, "Beastmen"}, -- WGid (WHM)
        -- Dynamis Buburimu
        ["Elvaansticker Bxafraff"] = {"E.Bxafraff", 88, 134, 760, 0, 1200, "Beastmen"}, -- Elva (DRG)
        ["Flamecaller Zoeqdoq"] = {"F.Zoeqdoq", 84, 134, 760, 497, 1200, "Beastmen"}, -- Flam (BLM)
        ["Hamfist Gukhbuk"] = {"H.Gukhbuk", 65, 134, 760, 0, 1200, "Beastmen"}, -- Hamf (MNK)
        ["Lyncean Juvgneg"] = {"L.Juvgneg", 82, 134, 760, 0, 1200, "Beastmen"}, -- Lync (RNG)
        -- Dynamis - San d'Oria
        ...
        -- Quadav
        -- Dynamis - Beaucedine
        ["Be'Zhe Keeprazer"] = {"B.Keeprazer", 53, 134, 261, 0, 1212, "Beastmen"}, -- BeZh (SMN)
        ["De'Bho Pyrohand"] = {"D.Pyrohand", 43, 134, 261, 497, 1212, "Beastmen"}, --DeBh (BLM)
        ["Ga'Fho Venomtouch"] = {"G.Venomtouch", 39, 134, 261, 3, 1212, "Beastmen"}, -- GaFh (WHM)
        ["Go'Tyo Magenapper"] = {"G.Magenapper", 44, 134, 261, 0, 1212, "Beastmen"}, -- GoTy (DRG)
        ["Gu'Khu Dukesniper"] = {"G.Dukesniper", 50, 134, 261, 0, 1212, "Beastmen"}, -- GuKh (RNG)
        ["Gu'Nha Wallstormer"] = {"G.Wallstormer", 24, 134, 261, 0, 1212, "Beastmen"}, -- Guha (WAR)
        ["Ji'Fhu Infiltrator"] = {"J.Infiltrator", 37, 134, 261, 0, 1212, "Beastmen"}, -- JiFh (THF)
        ["Ji'Khu Towercleaver"] = {"J.Towercleaver", 51, 134, 261, 0, 1212, "Beastmen"}, -- JiKh (SAM)
        ["Mi'Rhe Whisperblade"] = {"M.Whisperblade", 52, 134, 261, 7, 1212, "Beastmen"}, -- MiRh (NIN)
        ["Mu'Gha Legionkiller"] = {"M.Legionkiller", 47, 134, 261, 4, 1212, "Beastmen"}, -- MuGh (PLD)
        ["Na'Hya Floodmaker"] = {"N.Floodmaker", 28, 134, 261, 3, 1212, "Beastmen"}, -- NaHy (RDM)
        ["Nu'Bhi Spiraleye"] = {"N.Spiraleye", 41, 134, 261, 6, 1212, "Beastmen"}, -- NuBh (BRD)
        ["So'Gho Adderhandler"] = {"S.Adderhandler", 48, 134, 261, 0, 1212, "Beastmen"}, -- SoGh (BST)
        ["So'Zho Metalbender"] = {"S.Metalbender", 46, 134, 261, 0, 1212, "Beastmen"}, -- SoZh (MNK)
        ["Ta'Hyu Gallanthunter"] = {"T.Gallanthunter", 40, 134, 261, 5, 1212, "Beastmen"}, -- TaHy (DRK)
        -- Dynamis Buburimu
        ["Gi'Bhe Flesheater"] = {"G.Flesheater", 39, 134, 2901, 1, 1212, "Beastmen"}, -- GiBh (WHM)
        ["Qu'Pho Bloodspiller"] = {"Q.Bloodspiller", 24, 134, 2901, 0, 1212, "Beastmen"}, -- QuPh (WAR)
        ["Te'Zha Ironclad"] = {"T.Ironclad", 47, 134, 2901, 4, 1212, "Beastmen"}, -- TeZh (PLD)
        ["Va'Rhu Bodysnatcher"] = {"V.Bodysnatcher", 37, 134, 2901, 0, 1212, "Beastmen"}, -- VaRh (THF)
        -- Dynamis - Bastok (Done)
        ["Aa'Nyu Dismantler"] = {"A.Dismantler", 40, 134, 2907, 5, 1212, "Beastmen"}, -- AaNy (DRK)
        ["Gu'Nhi Noondozer"] = {"G.Noondozer", 53, 134, 2907, 0, 1212, "Beastmen"}, -- GuNh (SMN)
        ["Be'Ebo Tortoisedriver"] = {"B.Tortoisedriver", 48, 134, 2907, 0, 1212, "Beastmen"}, -- BeEb (BST)
        ["Gi'Pha Manameister"] = {"G.Manameister", 43, 134, 2907, 497, 1212, "Beastmen"}, -- GiPh (BLM)
        ["Ko'Dho Cannonball"] = {"K.Cannonball", 46, 134, 2907, 0, 1212, "Beastmen"}, -- KoDh (MNK)
        ["Ze'Vho Fallsplitter"] = {"Z.Fallsplitter", 40, 134, 2907, 5, 1212, "Beastmen"}, -- ZeVh (DRK)
        ["Effigy Shield PLD"] = {"Effigy Shield", 30, 134, 2907, 4, 1212, "Beastmen"}, -- EPLD (PLD)
        ["Effigy Shield NIN"] = {"Effigy Shield", 32, 134, 2907, 7, 1212, "Beastmen"}, -- ENIN (NIN)
        ["Effigy Shield BRD"] = {"Effigy Shield", 23, 134, 2907, 6, 1212, "Beastmen"}, -- EBRD (BRD)
        ["Effigy Shield DRK"] = {"Effigy Shield", 38, 134, 2907, 5, 1212, "Beastmen"}, -- EDRK (DRK)
        ["Effigy Shield SAM"] = {"Effigy Shield", 31, 134, 2907, 0, 1212, "Beastmen"}, -- ESAM (SAM)
        -- Yagudo
        -- Dynamis - Beaucedine
        ["Bhuu Wjato the Firepool"] = {"B.Firepool", 106, 134, 265, 497, 1201, "Beastmen"}, -- Bhuu (BLM)
        ["Caa Xaza the Madpiercer"] = {"C.Madpiercer", 107, 134, 265, 3, 1201, "Beastmen"}, -- CaaX (RDM)
        ["Foo Peku the Bloodcloak"] = {"F.Bloodcloak", 94, 134, 265, 0, 1201, "Beastmen"}, -- FooP (WAR)
        ["Guu Waji the Preacher"] = {"G.Preacher", 113, 134, 265, 4, 1201, "Beastmen"}, -- GuuW (PLD)
        ["Hee Mida the Meticulous"] = {"H.Meticulous", 120, 134, 265, 0, 1201, "Beastmen"}, -- HeeM (RNG)
        ["Knii Hoqo the Bisector"] = {"K.Bisector", 121, 134, 265, 0, 1201, "Beastmen"}, -- Knii (SAM)
        ["Koo Saxu the Everfast"] = {"K.Everfast", 102, 134, 265, 1, 1201, "Beastmen"}, -- KooS (WHM)
        ["Kuu Xuka the Nimble"] = {"K.Nimble", 115, 134, 265, 7, 1201, "Beastmen"}, -- KuuX (NIN)
        ["Maa Zaua the Wyrmkeeper"] = {"M.Wyrmkeeper", 109, 134, 265, 0, 1201, "Beastmen"}, -- MaaZ (DRG)
        ["Nee Huxa the Judgemental"] = {"N.Judgemental", 114, 134, 265, 5, 1201, "Beastmen"}, -- NeeH (DRK)
        ["Puu Timu the Phantasmal"] = {"P.Phantasmal", 122, 134, 265, 0, 1201, "Beastmen"}, -- PuuT (SMN)
        ["Ryy Qihi the Idolrobber"] = {"R.Idolrobber", 110, 134, 265, 0, 1201, "Beastmen"}, -- RyyQ (THF)
        ["Soo Jopo the Fiendking"] = {"S.Fiendking", 116, 134, 265, 0, 1201, "Beastmen"}, -- SooJ (BST)
        ["Xaa Chau the Roctalon"] = {"X.Roctalon", 97, 134, 265, 0, 1201, "Beastmen"}, -- XaaC (MNK)
        ["Xhoo Fuza the Sublime"] = {"X.Sublime", 119, 134, 265, 6, 1201, "Beastmen"}, -- Xhoo (BRD)
        -- Dynamis - Buburimu
        ["Baa Dava the Bibliopage"] = {"B.Bibliopage", 91, 317, 2085, 0, 1201, "Beastmen"}, -- BaaD (SMN)
        ["Doo Peku the Fleetfoot"] = {"D.Fleetfoot", 115, 134, 2085, 7, 1201, "Beastmen"}, -- DooP (NIN)
        ["Koo Rahi the Levinblade"] = {"K.Levinblade", 121, 134, 2085, 0, 1201, "Beastmen"}, -- KooR (SAM)
        ["Ree Nata the Melomanic"] = {"R.Melomanic", 119, 134, 2085, 6, 1201, "Beastmen"}, -- ReeN (BRD)
        -- Dynamis - Windurst
        ["Xoo Kaza the Solemn"] = {"X.Solemn", 106, 134, 1560, 497, 1201, "Beastmen"}, -- XooK (BLM)
        ["Haa Pevi the Stentorian"] = {"H.Stentorian", 91, 317, 1560, 0, 1201, "Beastmen"}, -- HaaP (SMN)
        ["Wuu Qoho the Razorclaw"] = {"W.Razorclaw", 97, 134, 1560, 0, 1201, "Beastmen"}, -- WuuQ (MNK)
        ["Loo Hepe the Eyepiercer"] = {"L.Eyepiercer", 107, 134, 1560, 3, 1201, "Beastmen"}, -- LooH (RDM)
        ["Muu Febi the Steadfast"] = {"Muu.Steadfast", 113, 134, 1560, 4, 1201, "Beastmen"}, -- MuuF (PLD)
        ["Maa Febi the Steadfast"] = {"Maa.Steadfast", 113, 134, 1560, 4, 1201, "Beastmen"}, -- MaaF (PLD)
        -- Kindred
        -- Dynamis - Xarcabard
        ...
        ["Marquis Orias"] = {"M.Orias", 46, 135, 1630, 497, 358, "Beastmen"}, -- Oria (BLM)
        ...
        ["Goublefaupe"] = {"Goublefaupe", 6, 134, 1211, 499, 359, "Goublefaupe"}, -- Goub (WAR/PLD/RDM)
        ["Mildaunegeux"] = {"Mildaunegeux", 8, 134, 1672, 7, 359, "Mildaunegeux"}, -- Mild (MNK/THF/NIN)
        ["Quiebitiel"] = {"Quiebitiel", 7, 134, 2066, 498, 359, "Quiebitiel"}, -- Quie (WHM/BLM/BRD)
        ...
        ["Angra Mainyu"] = {"Angra Mainyu", 1, 134, 0, 497, 4, "Angra Mainyu"}, -- Angr
        ...
        ["Dynamis Tombstone"] = {"D. Tombstone" , 20, 42, 2201, 497, 93, "Enabled Auto Attack"}, -- Dynamis Tombstone (DynT)
        ["Dynamis Effigy"] = {"D. Effigy" , 9, 42, 20, 0, 94, "Enabled Auto Attack"}, -- Dynamis Effigy (DynE)
        ["Dynamis Icon"] = {"D. Icon" , 32, 42, 195, 497, 95, "Enabled Auto Attack"}, -- Dynamis Icon (DynI)
        -- Dynamis - Buburimu Non-Beastmen
        ["Aitvaras"] = {"Aitvaras", 105, 40, 230, 0, 1209, "Buburimu Dwagon"}, -- Aitv
        ["Alklha"] = {"Alklha", 105, 40, 230, 0, 1207, "Buburimu Dwagon"}, -- Alkl
        ["Barong"] = {"Barong", 105, 40, 230, 0, 1205, "Buburimu Dwagon"}, -- Baro
        ["Basilic"] = {"Basilic", 105, 40, 230, 0, 1208, "Buburimu Dwagon"}, -- Basi
        ["Jurik"] = {"Jurik", 105, 40, 230, 0, 1204, "Buburimu Dwagon"}, -- Juri
        ["Koschei"] = {"Koschei", 105, 40, 230, 0, 1210, "Buburimu Dwagon"}, -- Kosc
        ["Stihi"] = {"Stihi", 105, 40, 230, 0, 11212, "Buburimu Dwagon"}, -- Stih
        ["Stollenwurm"] = {"Stollenwurm", 105, 40, 230, 0, 1211, "Buburimu Dwagon"}, -- Stol
        ["Tarasca"] = {"Tarasca", 105, 40, 230, 0, 1206, "Buburimu Dwagon"}, -- Tara
        ["Vishap"] = {"Vishap", 105, 40, 230, 0, 1203, "Buburimu Dwagon"}, -- Vish
        ...
        ["Nant'ina"] = {"Nant'ina", 8, 39, 2910, 0, 0, "Nant'ina"}, -- Nant
