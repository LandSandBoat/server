...
m:addOverrideByEra('xi.effects.last_resort.onEffectGain', {
...
m:addOverrideByEra('xi.job_utils.dark_knight.useArcaneCircle', {
...
m:addOverrideByEra('xi.job_utils.dark_knight.useLastResort', {
    [xi.expansion.ABYSSEA] = function(player, target, ability)
...
-- TODO: find a patch note or source for this change
m:addOverrideByEra('xi.effects.dark_seal.onEffectGain', {
...
-- TODO: find a patch note or source for this change
m:addOverrideByEra('xi.job_utils.dark_knight.useDarkSeal', {
...
-- TODO: find a patch note or source for this change
m:addOverrideByEra('xi.job_utils.dark_knight.useDiabolicEye', {
    [xi.expansion.ABYSSEA] = function(player, target, ability, action)
...
m:addOverrideByEra('xi.effects.arcane_circle.onEffectGain', {
