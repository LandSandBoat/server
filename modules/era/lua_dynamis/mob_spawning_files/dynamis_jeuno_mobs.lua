...
xi.dynamis.mobList[zoneID][3  ].nmchildren = { true, 158 } -- Wyrmwix Snakespecs
xi.dynamis.mobList[zoneID][10 ].nmchildren = { true, 157 } -- Hermitrix Toothrot
xi.dynamis.mobList[zoneID][18 ].nmchildren = { true, 159 } -- Morgmox Moldnoggin
xi.dynamis.mobList[zoneID][23 ].nmchildren = { true, 164 } -- Humnox Drumbelly
xi.dynamis.mobList[zoneID][26 ].nmchildren = { true, 163 } -- Buffrix Eargone
xi.dynamis.mobList[zoneID][29 ].nmchildren = { true, 160 } -- Sparkspox Sweatbrow
xi.dynamis.mobList[zoneID][40 ].nmchildren = { true, 161 } -- Elixmix Hooknose
xi.dynamis.mobList[zoneID][43 ].nmchildren = { true, 167 } -- Trailblix Goatmug
xi.dynamis.mobList[zoneID][45 ].nmchildren = { true, 162 } -- Bandrix Rockjaw
xi.dynamis.mobList[zoneID][49 ].nmchildren = { true, 166 } -- Lurklox Dhalmelneck
xi.dynamis.mobList[zoneID][62 ].nmchildren = { true, 165 } -- Ticktox Beadyeyes
xi.dynamis.mobList[zoneID][73 ].nmchildren = { true, 151 } -- Gabblox Magpietongue
xi.dynamis.mobList[zoneID][74 ].nmchildren = { true, 152 } -- Tufflix Loglimbs
xi.dynamis.mobList[zoneID][75 ].nmchildren = { true, 153 } -- Cloktix Longnail
xi.dynamis.mobList[zoneID][86 ].nmchildren = { true, 169 } -- Karashix Swollenskull
xi.dynamis.mobList[zoneID][87 ].nmchildren = { true, 171 } -- Rutrix Hamgams
xi.dynamis.mobList[zoneID][88 ].nmchildren = { true, 172 } -- Snypestix Eaglebeak
xi.dynamis.mobList[zoneID][95 ].nmchildren = { true, 170 } -- Mortilox Wartpaws
xi.dynamis.mobList[zoneID][105].nmchildren = { true, 155 } -- Jabkix Pigeonpecs
xi.dynamis.mobList[zoneID][106].nmchildren = { true, 156 } -- Wasabix Callusdigit
xi.dynamis.mobList[zoneID][107].nmchildren = { true, 154 } -- Smeltix Thickhide
xi.dynamis.mobList[zoneID][120].nmchildren = { true, 168 } -- Kikklix Longlegs
xi.dynamis.mobList[zoneID][124].nmchildren = { true, 180 } -- Tymexox Ninefingers
xi.dynamis.mobList[zoneID][125].nmchildren = { true, 183 } -- Slystix Megapeepers
xi.dynamis.mobList[zoneID][133].nmchildren = { true, 174 } -- Bootrix Jaggedelbow
xi.dynamis.mobList[zoneID][134].nmchildren = { true, 173 } -- Anvilix Sootwrists
xi.dynamis.mobList[zoneID][135].nmchildren = { true, 175 } -- Mobpix Mucousmouth
xi.dynamis.mobList[zoneID][142].nmchildren = { true, 179 } -- Scruffix Shaggychest
xi.dynamis.mobList[zoneID][145].nmchildren = { true, 181 } -- Blazox Boneybod
xi.dynamis.mobList[zoneID][146].nmchildren = { true, 177 } -- Eremix Snottynostril
xi.dynamis.mobList[zoneID][148].nmchildren = { true, 178 } -- Jabbrox Grannyguise
xi.dynamis.mobList[zoneID][149].nmchildren = { true, 182 } -- Prowlox Barrelbelly
xi.dynamis.mobList[zoneID][150].nmchildren = { true, 176 } -- Distilix Stickytoes
