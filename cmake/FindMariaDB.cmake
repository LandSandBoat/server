if(WIN32)
    ...
    if(BUILD_MARIADB_FROM_SOURCE)
        ...
        cpmaddpackage(
            ...
            GIT_TAG
            907ed6878648d5470f2a95820628e81f6ef78e13
            OPTIONS
        ...
        add_custom_command(
            TARGET copy_mariadb_dll_to_ext
            COMMAND ${CMAKE_COMMAND} -E copy ${mariadb_BINARY_DIR}/libmariadb/${CMAKE_BUILD_TYPE}/libmariadb.lib ${CMAKE_SOURCE_DIR}/ext/mariadb/${libpath}/libmariadb.lib
            COMMAND ${CMAKE_COMMAND} -E copy ${mariadb_BINARY_DIR}/libmariadb/${CMAKE_BUILD_TYPE}/libmariadb.dll ${CMAKE_SOURCE_DIR}/ext/mariadb/${libpath}/libmariadb.dll
            COMMAND ${CMAKE_COMMAND} -E copy_directory ${mariadb_SOURCE_DIR}/include ${CMAKE_SOURCE_DIR}/ext/mariadb/include
            COMMAND ${CMAKE_COMMAND} -E copy_directory ${mariadb_BINARY_DIR}/include ${CMAKE_SOURCE_DIR}/ext/mariadb/include
        )
    endif()
endif()
...
find_library(
    ...
    NAMES libmariadb
          ...
          libmysql64
          mysql64
    PATHS ${PROJECT_SOURCE_DIR}/ext/mariadb/${lib_dir}/
          /usr/
          /usr/bin/
          /usr/include/
          /usr/lib/
