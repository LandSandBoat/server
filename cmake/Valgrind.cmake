...
if(ENABLE_VALGRIND)
    ...
    add_custom_target(
        ...
        COMMAND ${VALGRIND_COMMAND} --tool=memcheck --leak-check=full --show-reachable=yes --undef-value-errors=yes --track-origins=no --child-silent-after-fork=no --trace-children=no
                --log-file=${CMAKE_SOURCE_DIR}/xi_map.memcheck.log ./xi_map
    ...
    add_custom_target(
        ...
        COMMAND ${VALGRIND_COMMAND} --tool=callgrind --log-file=${CMAKE_SOURCE_DIR}/xi_map.callgrind.log ./xi_map
