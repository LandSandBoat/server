...
if(TRACY_ENABLE)
    ...
    if(NOT EXISTS ${CMAKE_SOURCE_DIR}/ext/tracy/tracy-0.7.3/TracyClient.cpp)
    ...
    target_include_directories(tracy_client PUBLIC ${CMAKE_SOURCE_DIR}/ext/tracy/tracy-0.7.3/)
