if(WIN32)
    if(BUILD_MARIADBCPP_FROM_SOURCE)
        CPMAddPackage(
...
add_library(mariadbclientcpp INTERFACE)
target_link_libraries(mariadbclientcpp INTERFACE ${MARIADBCPP_LIBRARY})
target_include_directories(mariadbclientcpp SYSTEM INTERFACE ${MARIADBCPP_INCLUDE_DIR})
